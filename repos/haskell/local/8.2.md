...
- Created: `2018-03-14T04:52:06.616634302Z`
...
### `dpkg` source package: `cabal-install-2.0=2.0.0.1+git20171204.0.e430993-5~14.04`

Binary Packages:

- `cabal-install-2.0=2.0.0.1+git20171204.0.e430993-5~14.04`
