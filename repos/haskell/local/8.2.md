...
### `dpkg` source package: `bind9=1:9.10.3.dfsg.P4-12.3+deb9u4`
...
```console
$ apt-get source -qq --print-uris bind9=1:9.10.3.dfsg.P4-12.3+deb9u4
'http://deb.debian.org/debian/pool/main/b/bind9/bind9_9.10.3.dfsg.P4-12.3+deb9u4.dsc' bind9_9.10.3.dfsg.P4-12.3+deb9u4.dsc 3941 SHA256:2f5a544e738d2291f06df9ff15a7894c5c2b13e330383cd6ae92ea22cb819a12
'http://deb.debian.org/debian/pool/main/b/bind9/bind9_9.10.3.dfsg.P4.orig.tar.gz' bind9_9.10.3.dfsg.P4.orig.tar.gz 8641072 SHA256:895077c868d06eea39c1526624f2278a3b51a3358b5aa50f48a0f1c16a7ab6e6
'http://deb.debian.org/debian/pool/main/b/bind9/bind9_9.10.3.dfsg.P4-12.3+deb9u4.debian.tar.xz' bind9_9.10.3.dfsg.P4-12.3+deb9u4.debian.tar.xz 90068 SHA256:e8f30fa21116170efb6046bede564ee6c4c9985127cf241c5e1402858b8a5b01
```

Other potentially useful URLs:

- https://sources.debian.net/src/bind9/1:9.10.3.dfsg.P4-12.3+deb9u4/ (for browsing the source)
- https://sources.debian.net/src/bind9/1:9.10.3.dfsg.P4-12.3+deb9u4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/bind9/1:9.10.3.dfsg.P4-12.3+deb9u4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `cabal-install-2.2=2.2+git20180328.0.987570d-6~deb9`

Binary Packages:

- `cabal-install-2.2=2.2+git20180328.0.987570d-6~deb9`

Licenses: (parsed from: `/usr/share/doc/cabal-install-2.2/copyright`)
...
### `dpkg` source package: `ghc-8.2.2=8.2.2-3~deb9`

Binary Packages:

- `ghc-8.2.2=8.2.2-3~deb9`

Licenses: (parsed from: `/usr/share/doc/ghc-8.2.2/copyright`)
