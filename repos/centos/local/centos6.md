...
### `rpm` package: `bind-libs-9.8.2-0.68.rc1.el6_10.1.x86_64`

Licenses (from `rpm --query`): ISC

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `bind-utils-9.8.2-0.68.rc1.el6_10.1.x86_64`
...
### `rpm` package: `yum-plugin-fastestmirror-1.1.30-42.el6_10.noarch`
