...
- Created: `2019-03-14T21:21:38.578744948Z`
...
### `rpm` package: `audit-libs-2.4.1-5.el7.x86_64`
...
### `rpm` package: `bind-license-9.9.4-29.el7.noarch`

Licenses (from `rpm --query`): ISC

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `binutils-2.23.52.0.1-55.el7.x86_64`
...
### `rpm` package: `centos-release-7-2.1511.el7.centos.2.10.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `chkconfig-1.3.61-5.el7.x86_64`

Licenses (from `rpm --query`): GPLv2

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `coreutils-8.22-15.el7.x86_64`
...
### `rpm` package: `curl-7.29.0-25.el7.centos.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `cyrus-sasl-lib-2.1.26-19.2.el7.x86_64`

Licenses (from `rpm --query`): BSD with advertising

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `dbus-1.6.12-13.el7.x86_64`
...
### `rpm` package: `device-mapper-libs-1.02.107-5.el7.x86_64`
...
### `rpm` package: `dracut-033-359.el7.x86_64`

Licenses (from `rpm --query`): GPLv2+ and LGPLv2+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `elfutils-libelf-0.163-3.el7.x86_64`

Licenses (from `rpm --query`): GPLv2+ or LGPLv3+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `elfutils-libs-0.163-3.el7.x86_64`

Licenses (from `rpm --query`): GPLv2+ or LGPLv3+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `expat-2.1.0-8.el7.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `file-libs-5.11-31.el7.x86_64`

Licenses (from `rpm --query`): BSD

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `filesystem-3.2-20.el7.x86_64`
...
### `rpm` package: `glibc-2.17-105.el7.x86_64`

Licenses (from `rpm --query`): LGPLv2+ and LGPLv2+ with exceptions and GPLv2+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `glibc-common-2.17-105.el7.x86_64`

Licenses (from `rpm --query`): LGPLv2+ and LGPLv2+ with exceptions and GPLv2+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `gmp-6.0.0-11.el7.x86_64`

Licenses (from `rpm --query`): LGPLv3+ or GPLv2+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `gnupg2-2.0.22-3.el7.x86_64`
...
### `rpm` package: `iputils-20121221-7.el7.x86_64`
...
### `rpm` package: `kmod-libs-20-5.el7.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `kpartx-0.4.9-85.el7.x86_64`

Licenses (from `rpm --query`): GPL+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `krb5-libs-1.13.2-10.el7.x86_64`
...
### `rpm` package: `libblkid-2.23.2-26.el7.x86_64`
...
### `rpm` package: `libcurl-7.29.0-25.el7.centos.x86_64`
...
### `rpm` package: `libselinux-2.2.2-6.el7.x86_64`

Licenses (from `rpm --query`): Public Domain

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `libsemanage-2.1.10-18.el7.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `libsepol-2.1.9-3.el7.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `libss-1.42.9-7.el7.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `libssh2-1.4.3-10.el7.x86_64`

Licenses (from `rpm --query`): BSD

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `libstdc++-4.8.5-4.el7.x86_64`

Licenses (from `rpm --query`): GPLv3+ and GPLv3+ with exceptions and GPLv2+ with exceptions and LGPLv2+ and BSD

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `libtasn1-3.8-2.el7.x86_64`
...
### `rpm` package: `lua-5.1.4-14.el7.x86_64`
...
### `rpm` package: `nspr-4.10.8-2.el7_1.x86_64`

Licenses (from `rpm --query`): MPLv2.0

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `nss-3.19.1-18.el7.x86_64`

Licenses (from `rpm --query`): MPLv2.0

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `nss-softokn-3.16.2.3-13.el7_1.x86_64`

Licenses (from `rpm --query`): MPLv2.0

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `nss-softokn-freebl-3.16.2.3-13.el7_1.x86_64`

Licenses (from `rpm --query`): MPLv2.0

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `nss-sysinit-3.19.1-18.el7.x86_64`

Licenses (from `rpm --query`): MPLv2.0

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `nss-tools-3.19.1-18.el7.x86_64`

Licenses (from `rpm --query`): MPLv2.0

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `nss-util-3.19.1-4.el7_1.x86_64`

Licenses (from `rpm --query`): MPLv2.0

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `openldap-2.4.40-8.el7.x86_64`

Licenses (from `rpm --query`): OpenLDAP

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `openssl-libs-1.0.1e-42.el7.9.x86_64`
...
### `rpm` package: `pam-1.1.8-12.el7_1.1.x86_64`
...
### `rpm` package: `pcre-8.32-15.el7.x86_64`

Licenses (from `rpm --query`): BSD

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `pinentry-0.8.1-14.el7.x86_64`
...
### `rpm` package: `python-pycurl-7.19.0-17.el7.x86_64`

Licenses (from `rpm --query`): LGPLv2+ or MIT

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `python-urlgrabber-3.10-7.el7.noarch`
...
### `rpm` package: `rpm-build-libs-4.11.3-17.el7.x86_64`

Licenses (from `rpm --query`): GPLv2+ and LGPLv2+ with exceptions

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `rpm-libs-4.11.3-17.el7.x86_64`

Licenses (from `rpm --query`): GPLv2+ and LGPLv2+ with exceptions

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `rpm-python-4.11.3-17.el7.x86_64`
...
### `rpm` package: `setup-2.8.71-6.el7.noarch`

Licenses (from `rpm --query`): Public Domain

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `shadow-utils-4.1.5.1-18.el7.x86_64`
...
### `rpm` package: `systemd-219-19.el7.x86_64`

Licenses (from `rpm --query`): LGPLv2+ and MIT and GPLv2+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `systemd-libs-219-19.el7.x86_64`

Licenses (from `rpm --query`): LGPLv2+ and MIT

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `tar-1.26-29.el7.x86_64`

Licenses (from `rpm --query`): GPLv3+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `tzdata-2015g-1.el7.noarch`
...
### `rpm` package: `xz-5.1.2-12alpha.el7.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `xz-libs-5.1.2-12alpha.el7.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `yum-3.4.3-132.el7.centos.0.1.noarch`
...
### `rpm` package: `zlib-1.2.7-15.el7.x86_64`
