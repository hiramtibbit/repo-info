...
- Created: `2018-03-14T04:44:33.005512404Z`
...
### `dpkg` source package: `gcc-4.4=4.4.7-2`

Binary Packages:

- `gcc-4.4-base:amd64=4.4.7-2`

Licenses: (parsed from: `/usr/share/doc/gcc-4.4-base/copyright`)
...
```console
$ apt-get source -qq --print-uris gcc-4.4=4.4.7-2
'http://deb.debian.org/debian/pool/main/g/gcc-4.4/gcc-4.4_4.4.7-2.dsc' gcc-4.4_4.4.7-2.dsc 3885 SHA256:7fb532baf096aba3f9e6fbb5c7ad1d208f5b916cceb5663903c97de58a972b82
'http://deb.debian.org/debian/pool/main/g/gcc-4.4/gcc-4.4_4.4.7.orig.tar.gz' gcc-4.4_4.4.7.orig.tar.gz 49910915 SHA256:9f3afc1f1a0ef32b8ea21d5d1cb68873e854a517ae95316181c9224b0835d6fc
'http://deb.debian.org/debian/pool/main/g/gcc-4.4/gcc-4.4_4.4.7-2.diff.gz' gcc-4.4_4.4.7-2.diff.gz 1251746 SHA256:64e1f127e030baf9658a533579e6418a22cf150b5b38a9c2d8f079788284e98a
```

Other potentially useful URLs:

- https://sources.debian.net/src/gcc-4.4/4.4.7-2/ (for browsing the source)
- https://sources.debian.net/src/gcc-4.4/4.4.7-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gcc-4.4/4.4.7-2/ (for access to the source package after it no longer exists in the archive)
