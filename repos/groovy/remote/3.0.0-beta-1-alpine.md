...
### `groovy:3.0.0-beta-1-alpine` - linux; amd64
...
### `groovy:3.0.0-beta-1-alpine` - linux; arm variant v6
...
### `groovy:3.0.0-beta-1-alpine` - linux; arm64 variant v8
...
### `groovy:3.0.0-beta-1-alpine` - linux; 386
...
### `groovy:3.0.0-beta-1-alpine` - linux; ppc64le
...
### `groovy:3.0.0-beta-1-alpine` - linux; s390x
