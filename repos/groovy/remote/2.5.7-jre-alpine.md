...
### `groovy:2.5.7-jre-alpine` - linux; amd64
...
### `groovy:2.5.7-jre-alpine` - linux; arm variant v6
...
### `groovy:2.5.7-jre-alpine` - linux; arm64 variant v8
...
### `groovy:2.5.7-jre-alpine` - linux; 386
...
### `groovy:2.5.7-jre-alpine` - linux; ppc64le
...
### `groovy:2.5.7-jre-alpine` - linux; s390x
