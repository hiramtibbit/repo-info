...
### `groovy:3.0.0-alpha-2-jdk-alpine` - linux; arm64 variant v8
...
### `groovy:3.0.0-alpha-2-jdk-alpine` - linux; 386
...
### `groovy:3.0.0-alpha-2-jdk-alpine` - linux; ppc64le
...
### `groovy:3.0.0-alpha-2-jdk-alpine` - linux; s390x
