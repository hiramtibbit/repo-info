...
### `groovy:3.0.0-alpha-1-jdk` - linux; arm variant v5
...
### `groovy:3.0.0-alpha-1-jdk` - linux; arm variant v7
...
### `groovy:3.0.0-alpha-1-jdk` - linux; arm64 variant v8
...
### `groovy:3.0.0-alpha-1-jdk` - linux; 386
...
### `groovy:3.0.0-alpha-1-jdk` - linux; ppc64le
...
### `groovy:3.0.0-alpha-1-jdk` - linux; s390x
