...
```console
$ docker pull groovy@sha256:84ab522d07a858e7cf28ef34d457e28b2c95c79a692946b84c2c0d7b152d3105
```
...
```console
$ docker pull groovy@sha256:87f5248b6b26e2c29d8b64af2b7c23219c3148d69f0a55ee93f51f7559336722
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **106.8 MB (106770504 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cbd8c2459c0135744aff1eb83773b92dab5def72e1b8b2acbea0600f3b6a62ef`
-	Default Command: `["groovysh"]`
...
# Wed, 20 Jun 2018 10:43:56 GMT
ENV GROOVY_HOME=/opt/groovy
# Wed, 27 Jun 2018 10:46:00 GMT
ENV GROOVY_VERSION=3.0.0-alpha-2
# Wed, 27 Jun 2018 10:46:11 GMT
RUN set -o errexit -o nounset 	&& echo "Installing build dependencies" 	&& apk add --no-cache --virtual .build-deps 		ca-certificates 		gnupg 		openssl 		unzip 		&& echo "Downloading Groovy" 	&& wget -O groovy.zip "https://dist.apache.org/repos/dist/release/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip" 		&& echo "Importing keys listed in http://www.apache.org/dist/groovy/KEYS from key server" 	&& export GNUPGHOME="$(mktemp -d)" 	&& for key in 		"7FAA0F2206DE228F0DB01AD741321490758AAD6F" 		"331224E1D7BE883D16E8A685825C06C827AF6B66" 		"34441E504A937F43EB0DAEF96A65176A0FB1CD0B" 		"9A810E3B766E089FFB27C70F11B595CEDC4AEBB5" 		"81CABC23EECA0790E8989B361FF96E10F0E13706" 	; do 		for server in 			"ha.pool.sks-keyservers.net" 			"hkp://p80.pool.sks-keyservers.net:80" 			"pgp.mit.edu" 		; do 			echo "  Trying ${server}"; 			if gpg --keyserver "${server}" --recv-keys "${key}"; then 				break; 			fi; 		done; 	done; 	if [ $(gpg --list-keys | grep -c "pub ") -ne 5 ]; then 		echo "ERROR: Failed to fetch GPG keys" >&2; 		exit 1; 	fi 		&& echo "Checking download signature" 	&& wget -O groovy.zip.asc "https://dist.apache.org/repos/dist/release/groovy/${GROOVY_VERSION}/distribution/apache-groovy-binary-${GROOVY_VERSION}.zip.asc" 	&& gpg --batch --verify groovy.zip.asc groovy.zip 	&& rm -rf "${GNUPGHOME}" 	&& rm groovy.zip.asc 		&& echo "Installing Groovy" 	&& unzip groovy.zip 	&& rm groovy.zip 	&& mkdir /opt 	&& mv "groovy-${GROOVY_VERSION}" "${GROOVY_HOME}/" 	&& ln -s "${GROOVY_HOME}/bin/grape" /usr/bin/grape 	&& ln -s "${GROOVY_HOME}/bin/groovy" /usr/bin/groovy 	&& ln -s "${GROOVY_HOME}/bin/groovyc" /usr/bin/groovyc 	&& ln -s "${GROOVY_HOME}/bin/groovyConsole" /usr/bin/groovyConsole 	&& ln -s "${GROOVY_HOME}/bin/groovydoc" /usr/bin/groovydoc 	&& ln -s "${GROOVY_HOME}/bin/groovysh" /usr/bin/groovysh 	&& ln -s "${GROOVY_HOME}/bin/java2groovy" /usr/bin/java2groovy 		&& echo "Cleaning up build dependencies" 	&& apk del .build-deps 		&& echo "Adding groovy user and group" 	&& addgroup -S -g 1000 groovy 	&& adduser -D -S -G groovy -u 1000 -s /bin/ash groovy 	&& mkdir -p /home/groovy/.groovy/grapes 	&& chown -R groovy:groovy /home/groovy 		&& echo "Symlinking root .groovy to groovy .groovy" 	&& ln -s /home/groovy/.groovy /root/.groovy
# Wed, 27 Jun 2018 10:46:17 GMT
USER [groovy]
# Wed, 27 Jun 2018 10:46:17 GMT
VOLUME [/home/groovy/.groovy/grapes]
...
-	Layers:
	...
	-	`sha256:921fb35a63a4bd3c213a75ff00e8aba29227aeefd47bd34d667def7c09890a22`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1674e181cb38c497b9722bdead95b418c7a0a6791b214a9d11301e4c611fc20d`  
		Last Modified: Wed, 27 Jun 2018 10:50:46 GMT  
		Size: 33.7 MB (33665060 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:896a6d160c446f43086363792631a0e6bb8195dff3c6c34ca5b295005f6847c5`  
		Last Modified: Wed, 27 Jun 2018 10:50:41 GMT  
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull groovy@sha256:a876f1d6a6552d903596bd5e325dd1f84739b39ea4b4b0ce5546579779f9d858
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **105.0 MB (105008304 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b56e4d5f5b439bc3ff73168fc11dee3f9496ca3b27e21a2cfb5bf26e1406018`
-	Default Command: `["groovysh"]`
...
-	Layers:
	...
	-	`sha256:48533ff1d3b0077dc3e063678fc940c86ab784bbf5532e86ea4df5da83287476`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:50a9d01cb8d0dc384b15ff8bafeb49788629bca2b0eaa561589acd2fd218b18e`  
		Last Modified: Wed, 27 Jun 2018 11:45:13 GMT  
		Size: 33.7 MB (33664981 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:566be155466d617368979f2a8cfa419b743e5efa11a527face14ad973922c493`  
		Last Modified: Wed, 27 Jun 2018 11:45:10 GMT  
		Size: 140.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
