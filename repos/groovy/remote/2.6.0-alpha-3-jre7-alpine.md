...
```console
$ docker pull groovy@sha256:ad31542f48894194a7dc7afeaa21f7b4194874354b30744dbb3dd40804a44687
```
...
### `groovy:2.6.0-alpha-3-jre7-alpine` - linux; 386
...
### `groovy:2.6.0-alpha-3-jre7-alpine` - linux; ppc64le
...
### `groovy:2.6.0-alpha-3-jre7-alpine` - linux; s390x
