...
### `groovy:2.6.0-alpha-3-jre` - linux; arm variant v5
...
### `groovy:2.6.0-alpha-3-jre` - linux; arm variant v7
...
### `groovy:2.6.0-alpha-3-jre` - linux; arm64 variant v8
...
### `groovy:2.6.0-alpha-3-jre` - linux; 386
...
### `groovy:2.6.0-alpha-3-jre` - linux; ppc64le
...
### `groovy:2.6.0-alpha-3-jre` - linux; s390x
