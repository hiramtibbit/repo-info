...
### `groovy:2.4.16-jdk` - linux; arm variant v5
...
### `groovy:2.4.16-jdk` - linux; arm variant v7
...
### `groovy:2.4.16-jdk` - linux; arm64 variant v8
...
### `groovy:2.4.16-jdk` - linux; ppc64le
