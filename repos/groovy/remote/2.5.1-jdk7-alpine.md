...
### `groovy:2.5.1-jdk7-alpine` - linux; amd64
...
### `groovy:2.5.1-jdk7-alpine` - linux; arm64 variant v8
...
### `groovy:2.5.1-jdk7-alpine` - linux; 386
...
### `groovy:2.5.1-jdk7-alpine` - linux; ppc64le
...
### `groovy:2.5.1-jdk7-alpine` - linux; s390x
