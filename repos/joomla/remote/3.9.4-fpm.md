...
```console
$ docker pull joomla@sha256:97e220a25e6388f34695941c6611618d96c055624085249ebe1aaf3d34612354
```
...
### `joomla:3.9.4-fpm` - linux; arm variant v5
...
### `joomla:3.9.4-fpm` - linux; arm variant v7
...
### `joomla:3.9.4-fpm` - linux; arm64 variant v8
...
### `joomla:3.9.4-fpm` - linux; ppc64le
