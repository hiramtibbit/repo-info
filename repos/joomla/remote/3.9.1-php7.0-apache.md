...
### `joomla:3.9.1-php7.0-apache` - linux; amd64
...
### `joomla:3.9.1-php7.0-apache` - linux; arm variant v5
...
### `joomla:3.9.1-php7.0-apache` - linux; arm64 variant v8
...
### `joomla:3.9.1-php7.0-apache` - linux; 386
...
### `joomla:3.9.1-php7.0-apache` - linux; ppc64le
