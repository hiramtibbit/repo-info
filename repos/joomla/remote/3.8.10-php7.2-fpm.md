...
### `joomla:3.8.10-php7.2-fpm` - linux; arm variant v5
...
### `joomla:3.8.10-php7.2-fpm` - linux; arm variant v7
...
### `joomla:3.8.10-php7.2-fpm` - linux; arm64 variant v8
...
### `joomla:3.8.10-php7.2-fpm` - linux; 386
...
### `joomla:3.8.10-php7.2-fpm` - linux; ppc64le
