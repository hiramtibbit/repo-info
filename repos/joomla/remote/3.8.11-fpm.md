...
```console
$ docker pull joomla@sha256:e6c0c2881f9eae3d7e81f441439b7661aca67bc58a6b4f0f3e2f94f1076d5638
```
...
### `joomla:3.8.11-fpm` - linux; arm variant v5
...
### `joomla:3.8.11-fpm` - linux; arm variant v7
...
### `joomla:3.8.11-fpm` - linux; arm64 variant v8
...
### `joomla:3.8.11-fpm` - linux; ppc64le
