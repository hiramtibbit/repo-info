...
```console
$ docker pull joomla@sha256:80235869da64a85b51f04b8903602a544590496e76a605ccb22e9e60bee10dec
```
...
### `joomla:3.9.2-php7.1-fpm` - linux; amd64
...
### `joomla:3.9.2-php7.1-fpm` - linux; arm variant v5
...
### `joomla:3.9.2-php7.1-fpm` - linux; arm variant v7
...
### `joomla:3.9.2-php7.1-fpm` - linux; arm64 variant v8
...
### `joomla:3.9.2-php7.1-fpm` - linux; 386
...
### `joomla:3.9.2-php7.1-fpm` - linux; ppc64le
...
### `joomla:3.9.2-php7.1-fpm` - linux; s390x
