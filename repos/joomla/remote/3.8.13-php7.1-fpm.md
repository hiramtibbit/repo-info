...
### `joomla:3.8.13-php7.1-fpm` - linux; amd64
...
### `joomla:3.8.13-php7.1-fpm` - linux; arm variant v5
...
### `joomla:3.8.13-php7.1-fpm` - linux; arm variant v7
...
### `joomla:3.8.13-php7.1-fpm` - linux; arm64 variant v8
...
### `joomla:3.8.13-php7.1-fpm` - linux; 386
...
### `joomla:3.8.13-php7.1-fpm` - linux; ppc64le
...
### `joomla:3.8.13-php7.1-fpm` - linux; s390x
