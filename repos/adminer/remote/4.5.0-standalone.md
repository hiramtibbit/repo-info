...
### `adminer:4.5.0-standalone` - linux; amd64
...
### `adminer:4.5.0-standalone` - linux; arm variant v6
...
### `adminer:4.5.0-standalone` - linux; arm64 variant v8
...
### `adminer:4.5.0-standalone` - linux; 386
...
### `adminer:4.5.0-standalone` - linux; ppc64le
