...
### `adminer:4.7.0-fastcgi` - linux; amd64
...
### `adminer:4.7.0-fastcgi` - linux; arm variant v6
...
### `adminer:4.7.0-fastcgi` - linux; arm64 variant v8
...
### `adminer:4.7.0-fastcgi` - linux; 386
...
### `adminer:4.7.0-fastcgi` - linux; ppc64le
