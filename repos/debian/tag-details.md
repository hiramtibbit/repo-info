...
-	[`debian:9`](#debian9)
-	[`debian:9.5`](#debian95)
-	[`debian:9.5-slim`](#debian95-slim)
-	[`debian:9-slim`](#debian9-slim)
-	[`debian:buster`](#debianbuster)
-	[`debian:buster-20181011`](#debianbuster-20181011)
-	[`debian:buster-20181011-slim`](#debianbuster-20181011-slim)
-	[`debian:buster-slim`](#debianbuster-slim)
-	[`debian:experimental`](#debianexperimental)
-	[`debian:experimental-20181011`](#debianexperimental-20181011)
-	[`debian:jessie`](#debianjessie)
-	[`debian:jessie-20181011`](#debianjessie-20181011)
-	[`debian:jessie-20181011-slim`](#debianjessie-20181011-slim)
...
-	[`debian:oldoldstable-20181011`](#debianoldoldstable-20181011)
-	[`debian:oldoldstable-20181011-slim`](#debianoldoldstable-20181011-slim)
...
-	[`debian:oldstable-20181011`](#debianoldstable-20181011)
-	[`debian:oldstable-20181011-slim`](#debianoldstable-20181011-slim)
...
-	[`debian:rc-buggy-20181011`](#debianrc-buggy-20181011)
-	[`debian:sid`](#debiansid)
-	[`debian:sid-20181011`](#debiansid-20181011)
-	[`debian:sid-20181011-slim`](#debiansid-20181011-slim)
-	[`debian:sid-slim`](#debiansid-slim)
-	[`debian:stable`](#debianstable)
-	[`debian:stable-20181011`](#debianstable-20181011)
-	[`debian:stable-20181011-slim`](#debianstable-20181011-slim)
-	[`debian:stable-backports`](#debianstable-backports)
-	[`debian:stable-slim`](#debianstable-slim)
-	[`debian:stretch`](#debianstretch)
-	[`debian:stretch-20181011`](#debianstretch-20181011)
-	[`debian:stretch-20181011-slim`](#debianstretch-20181011-slim)
-	[`debian:stretch-backports`](#debianstretch-backports)
-	[`debian:stretch-slim`](#debianstretch-slim)
-	[`debian:testing`](#debiantesting)
-	[`debian:testing-20181011`](#debiantesting-20181011)
-	[`debian:testing-20181011-slim`](#debiantesting-20181011-slim)
-	[`debian:testing-slim`](#debiantesting-slim)
-	[`debian:unstable`](#debianunstable)
-	[`debian:unstable-20181011`](#debianunstable-20181011)
-	[`debian:unstable-20181011-slim`](#debianunstable-20181011-slim)
-	[`debian:unstable-slim`](#debianunstable-slim)
-	[`debian:wheezy`](#debianwheezy)
-	[`debian:wheezy-20181011`](#debianwheezy-20181011)
-	[`debian:wheezy-20181011-slim`](#debianwheezy-20181011-slim)
...
```console
$ docker pull debian@sha256:edeb9dee5ec65f5b4b4154c37a43cfceb1d9e5bac763f9810df134689989bbba
```
...
```console
$ docker pull debian@sha256:30197b2cf1fa2e507653903262f199390d982fed86e23cd7b6798510b2f025e0
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.4 MB (28430740 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc9ad24156e12c479af03ee6306d537879fce77dd0e655f86b723ba5455a4633`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:0091964d01b2d4cb4b21e4c3518624a82fcef3f5de928c3f85a035b364d18823
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.3 MB (30270069 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:ab746848b851d939f598ebd20a9fba7b983e8ba1da04bcf5430aea9bddcb66d0`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:bcde5ae66332212478cf8240e214b32fbda9576106f0dfafb68004be52b6d169
```
...
```console
$ docker pull debian@sha256:ecc3a740d92f8219e5258e0c9ba75054143c1576bc94035bc4646eaf18f4712b
```
...
```console
$ docker pull debian@sha256:13fc1d4e94d71a99a581261fac977aa377b8b644a75c4f0dff70db34d1cd591e
```
...
```console
$ docker pull debian@sha256:1e38493fe0b3e57d18ed5e5bbcacc8376514e082deee1fa13673715f14aeb571
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.7 MB (49720982 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9d895fb5491ce7a7f8cd5c45738dbe1146929f3fae9f596c93b896a3ebaa7dc6`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:e63641b631c7638163ff9f7b8d3499473c614d53658e2d01b85d6606b141d9ae
```
...
```console
$ docker pull debian@sha256:a25c809691f30be2c3bb4c23f93c7eadb5cdd0a1fb37dfed522d6c2658b1d457
```
...
### `debian:oldoldstable-20181011` - linux; amd64
...
### `debian:oldoldstable-20181011` - linux; arm variant v5
...
### `debian:oldoldstable-20181011` - linux; arm variant v7
...
### `debian:oldoldstable-20181011` - linux; 386
...
## `debian:oldoldstable-20181011-slim`

```console
$ docker pull debian@sha256:42577102995c4fdd31e13d9a70988cd55731c9302b3070834181fd9a379da726
```
...
```console
$ docker pull debian@sha256:c753f95d3f69e22386d37a9ef3c1174263cd0cc880acc3386c016bb8a116eac7
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **18.5 MB (18499949 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:021fc5134fc0a13325b49ad11eab3af176f5daefb3b54a9e2ee0e7b7ef8d561d`
-	Default Command: `["bash"]`

```dockerfile
# Wed, 05 Sep 2018 10:40:47 GMT
ADD file:e7f32c2c758097328f543fa386c1dd64d7d2ae4e00602323841e54068f85103d in / 
# Wed, 05 Sep 2018 10:40:47 GMT
CMD ["bash"]
```

-	Layers:
	-	`sha256:610314295a7e343b431c8818b96cc7957b13c2fb383843eadc237fb8f6991ea8`  
		Last Modified: Wed, 05 Sep 2018 10:49:07 GMT  
		Size: 18.5 MB (18499949 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
## `debian:oldstable-20181011-slim`

```console
$ docker pull debian@sha256:605aee3fa5b3f1655c68afd7bfc3373ef873de0121535a452d38c2d6c54606d4
```
...
### `debian:oldstable-20181011-slim` - linux; amd64
...
### `debian:oldstable-20181011-slim` - linux; arm variant v5
...
### `debian:oldstable-20181011-slim` - linux; arm variant v7
...
### `debian:oldstable-20181011-slim` - linux; 386
...
```console
$ docker pull debian@sha256:2a850769e68eed3d580d8bd97f398e9b37480346aa5b58c136b3d533ecb5f115
```
...
```console
$ docker pull debian@sha256:f5eacce81dcb5438459af3f39dac67cd944f0349fd5dde3b0c05796ba3fd53e3
```
...
### `debian:stable-20181011-slim` - linux; amd64
...
### `debian:stable-20181011-slim` - linux; arm variant v5
...
### `debian:stable-20181011-slim` - linux; arm variant v7
...
### `debian:stable-20181011-slim` - linux; arm64 variant v8
...
### `debian:stable-20181011-slim` - linux; 386
...
### `debian:stable-20181011-slim` - linux; ppc64le
...
### `debian:stable-20181011-slim` - linux; s390x
...
```console
$ docker pull debian@sha256:a9b6bfd8c02f385ae23141899ffe49d4fac64dcf07e16855622f7b3069d0d75d
```
...
### `debian:stretch-20181011-slim` - linux; amd64
...
### `debian:stretch-20181011-slim` - linux; arm variant v5
...
### `debian:stretch-20181011-slim` - linux; arm variant v7
...
### `debian:stretch-20181011-slim` - linux; arm64 variant v8
...
### `debian:stretch-20181011-slim` - linux; 386
...
### `debian:stretch-20181011-slim` - linux; ppc64le
...
### `debian:stretch-20181011-slim` - linux; s390x
...
```console
$ docker pull debian@sha256:9393aa02b9c1f9192254f4ee421fb939f7d5fbad4a81fa4f8ab87cb6906afecf
```
...
## `debian:testing-20181011-slim`

```console
$ docker pull debian@sha256:0b49365863b8c9479e3b9919c724f5d4b6984ffc5ce78bec2d02441d61184341
```
...
## `debian:unstable-20181011-slim`

```console
$ docker pull debian@sha256:9cd8bcb54f22a391fcba2a741336b7e9c95ae0ef2390816ec199bacbe18c5389
```
...
```console
$ docker pull debian@sha256:bf1846ab4fc5eede6badcf021a426c89b0472238c186caf83aca88ffaee01e4f
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.0 MB (24046677 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5ecabf860986f913c546acd8607a2a1e44a9f99c7c7456d80d2bcd6b9982cfad`
-	Default Command: `["bash"]`

```dockerfile
# Wed, 05 Sep 2018 08:56:48 GMT
ADD file:e60046f0d407364bfdeff822aa246b0a71057cf89304e8988e3f62d3854a7a73 in / 
# Wed, 05 Sep 2018 08:56:48 GMT
CMD ["bash"]
```

-	Layers:
	-	`sha256:56f28066ecda9ea5a0e7c64393b8b1a9ff0cbb6c8c0e09420be8ff35f61b1956`  
		Last Modified: Wed, 05 Sep 2018 09:06:20 GMT  
		Size: 24.0 MB (24046677 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull debian@sha256:86df86bd44251a0d936de3bb3bf6cca9197b0275028f6a30a57b7ce617795451
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.4 MB (24421537 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9be05df9b39be31efc443a27bb7251f82fe73c5e89b3bb479497a41ffe8d9243`
-	Default Command: `["bash"]`

```dockerfile
# Wed, 05 Sep 2018 08:57:17 GMT
ADD file:e8c8dba2dd39103478856ed539ec97be97bcb92dae70f15d38e8a424ce879cc8 in / 
# Wed, 05 Sep 2018 08:57:33 GMT
CMD ["bash"]
```

-	Layers:
	-	`sha256:7de75d569f078592a56f5b14d465c6f2a7cfe7cdbc4c9a7fe45c7005f8f1cf81`  
		Last Modified: Wed, 05 Sep 2018 09:13:49 GMT  
		Size: 24.4 MB (24421537 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `debian:unstable-20181011-slim` - linux; 386

```console
$ docker pull debian@sha256:200e68099130e9b93a58d1a59b059c6a819ea00d0ca5755c566868c5e8ac8574
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.9 MB (26855374 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:157d38f6d2f510bf023bc205c81c3fe16ea4fe4a1438aadcc40cc7a378a47b2a`
-	Default Command: `["bash"]`

```dockerfile
# Wed, 05 Sep 2018 10:45:27 GMT
ADD file:6a79dfa340dd26445250a536990ef959e875394d89304f45f229202e66cac54a in / 
# Wed, 05 Sep 2018 10:45:27 GMT
CMD ["bash"]
```

-	Layers:
	-	`sha256:d6cb670af63d188dfb02930714dcb14dd45d1f989fc5500a0277facd5ac334f2`  
		Last Modified: Wed, 05 Sep 2018 10:53:45 GMT  
		Size: 26.9 MB (26855374 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
