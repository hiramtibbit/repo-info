...
-	[`debian:9`](#debian9)
-	[`debian:9.8`](#debian98)
-	[`debian:9.8-slim`](#debian98-slim)
-	[`debian:9-slim`](#debian9-slim)
-	[`debian:buster`](#debianbuster)
-	[`debian:buster-20190326`](#debianbuster-20190326)
-	[`debian:buster-20190326-slim`](#debianbuster-20190326-slim)
-	[`debian:buster-slim`](#debianbuster-slim)
-	[`debian:experimental`](#debianexperimental)
-	[`debian:experimental-20190326`](#debianexperimental-20190326)
-	[`debian:jessie`](#debianjessie)
-	[`debian:jessie-20190326`](#debianjessie-20190326)
-	[`debian:jessie-20190326-slim`](#debianjessie-20190326-slim)
-	[`debian:jessie-slim`](#debianjessie-slim)
-	[`debian:latest`](#debianlatest)
-	[`debian:oldstable`](#debianoldstable)
-	[`debian:oldstable-20190326`](#debianoldstable-20190326)
-	[`debian:oldstable-20190326-slim`](#debianoldstable-20190326-slim)
-	[`debian:oldstable-slim`](#debianoldstable-slim)
-	[`debian:rc-buggy`](#debianrc-buggy)
-	[`debian:rc-buggy-20190326`](#debianrc-buggy-20190326)
-	[`debian:sid`](#debiansid)
-	[`debian:sid-20190326`](#debiansid-20190326)
-	[`debian:sid-20190326-slim`](#debiansid-20190326-slim)
-	[`debian:sid-slim`](#debiansid-slim)
-	[`debian:stable`](#debianstable)
-	[`debian:stable-20190326`](#debianstable-20190326)
-	[`debian:stable-20190326-slim`](#debianstable-20190326-slim)
-	[`debian:stable-backports`](#debianstable-backports)
-	[`debian:stable-slim`](#debianstable-slim)
-	[`debian:stretch`](#debianstretch)
-	[`debian:stretch-20190326`](#debianstretch-20190326)
-	[`debian:stretch-20190326-slim`](#debianstretch-20190326-slim)
-	[`debian:stretch-backports`](#debianstretch-backports)
-	[`debian:stretch-slim`](#debianstretch-slim)
-	[`debian:testing`](#debiantesting)
-	[`debian:testing-20190326`](#debiantesting-20190326)
-	[`debian:testing-20190326-slim`](#debiantesting-20190326-slim)
-	[`debian:testing-slim`](#debiantesting-slim)
-	[`debian:unstable`](#debianunstable)
-	[`debian:unstable-20190326`](#debianunstable-20190326)
-	[`debian:unstable-20190326-slim`](#debianunstable-20190326-slim)
-	[`debian:unstable-slim`](#debianunstable-slim)

## `debian:8`

```console
$ docker pull debian@sha256:5f2694cad8a3d89079123d3a89cad1bd3ea0c96d77122d6fd2e39bda5b983b12
```
...
```console
$ docker pull debian@sha256:3962e58c284aef51a801c77356f80e312c6b6f160a7966dae0a45fa7e6c851b9
```
...
```console
$ docker pull debian@sha256:41216e5495eeb026a51809001b1336ac350f5be358c7ee2cb55462171e19722f
```
...
### `debian:9.8-slim` - linux; amd64

```console
$ docker pull debian@sha256:d4f7ac076cf641652722c33b026fccd52933bb5c26aa703d3cef2dd5b022422a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.5 MB (22496048 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c08899734c039b0f480e439e70f54b12037d68cb9d5d3dec21a38909201e7903`
-	Default Command: `["bash"]`
...
### `debian:9.8-slim` - linux; arm variant v5

```console
$ docker pull debian@sha256:b90bd471832786f9a637c061110b9850d5dd8f46ada5853920bd9fa385e57b97
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **21.2 MB (21160663 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0fb0d3d490c1df74c626afeb4b4570bdcf14e00bc665c427980a22f2febda71c`
-	Default Command: `["bash"]`
...
### `debian:9.8-slim` - linux; arm variant v7

```console
$ docker pull debian@sha256:efe17060223ac364190710b2cee7c7f5310813ccff92cb7409465f2aa59ea04a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **19.3 MB (19282494 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dcf222607ef8a7b8aaf9e934e2c1f176bb1cb17289c157a09a0085085a64f42c`
-	Default Command: `["bash"]`
...
### `debian:9.8-slim` - linux; arm64 variant v8

```console
$ docker pull debian@sha256:4e51fda4109288bfcba7f3d7f63b7a4749c820806459b035d731383e23f756f0
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **20.3 MB (20340179 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bee706db6442c3994afc9763caee480bb31e3b22bded20ce0e3b32e98b028ee6`
-	Default Command: `["bash"]`
...
### `debian:9.8-slim` - linux; 386

```console
$ docker pull debian@sha256:19fbb3b72f4b9b58877e8d73a2d944835ff8f730e09847480cf48b5d8f09e8c8
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **23.1 MB (23125745 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:65a43069746540c92003d8bb5cdb1e2954255d1fd25556692c7bd69305dd5144`
-	Default Command: `["bash"]`
...
### `debian:9.8-slim` - linux; ppc64le

```console
$ docker pull debian@sha256:b9138836e17543b6a92bff50f5a3bc33931435b3c08bcafd246117c9a081aaa7
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.8 MB (22751385 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4db5e49df75e4671e8890fbc63f2b88d90711b9181cf76d32536515438781e2b`
-	Default Command: `["bash"]`
...
### `debian:9.8-slim` - linux; s390x

```console
$ docker pull debian@sha256:996d0bbdd2db163ba2c0575afdcf8c452bf8a6fbc54c5bca59d38607bc07e47b
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.3 MB (22345383 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3341ef3ed6d3d54a494030f8ed266e16fad9b8ebc15fac2b3e8b8517b5d663f1`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:0e1913085762d420852de5f3e9200118679af4bda3572b32f2fa4d641af2d601
```
...
## `debian:buster-20190326-slim`

```console
$ docker pull debian@sha256:8f0b92ec0e2bb12acb49a55ebd24f621346cfaeac2e3ad71acfbf1d66f0a3445
```
...
### `debian:jessie-20190326-slim` - linux; amd64
...
### `debian:jessie-20190326-slim` - linux; arm variant v5
...
### `debian:jessie-20190326-slim` - linux; arm variant v7
...
### `debian:jessie-20190326-slim` - linux; 386
...
## `debian:oldstable-20190326-slim`

```console
$ docker pull debian@sha256:37908387e4cf0fbe7e9e63c9688bcc80a15c0655edbd811f60a7f23428574d55
```
...
```console
$ docker pull debian@sha256:07430e3de8953ccd30abec89122e11e3380af743f0064848e2cfae2518f7bc09
```
...
```console
$ docker pull debian@sha256:952ca2006bcca1caf4f67229bba3db7d087e451a827455defd0446fc8c7931f1
```
...
```console
$ docker pull debian@sha256:51988c6b06e020240c07b4469322ab25d0a832f7d9855cda8b37f56b96b03bda
```
...
```console
$ docker pull debian@sha256:541ac6952c4a14caa48fb5c0087f4f949ab8b693196b0aa77f4dd65acbef7e30
```
...
## `debian:stable-20190326-slim`

```console
$ docker pull debian@sha256:a9695bd2c7cdf7ecfc318ca690b1efb186d2a22dc3a030b3fd247c66811c15d1
```
...
```console
$ docker pull debian@sha256:c6cd5a047226db425ac977b180d536930fffe0659636e24589dd7c40439d5d85
```
...
### `debian:stretch-20190326` - linux; amd64
...
### `debian:stretch-20190326` - linux; arm variant v5
...
### `debian:stretch-20190326` - linux; arm variant v7
...
### `debian:stretch-20190326` - linux; arm64 variant v8
...
### `debian:stretch-20190326` - linux; 386
...
### `debian:stretch-20190326` - linux; ppc64le
...
### `debian:stretch-20190326` - linux; s390x
...
### `debian:stretch-20190326-slim` - linux; amd64
...
### `debian:stretch-20190326-slim` - linux; arm variant v5
...
### `debian:stretch-20190326-slim` - linux; arm variant v7
...
### `debian:stretch-20190326-slim` - linux; arm64 variant v8
...
### `debian:stretch-20190326-slim` - linux; 386
...
### `debian:stretch-20190326-slim` - linux; ppc64le
...
### `debian:stretch-20190326-slim` - linux; s390x
...
## `debian:testing-20190326-slim`

```console
$ docker pull debian@sha256:d9b812fc072c480c9b3bf72721c3e49a31bf9e092f4aad30a4fd372141c878a3
```
...
```console
$ docker pull debian@sha256:0844e6b72d8fbe65a683cf8bcb9ecdce7c6aca9052ae6cacd741d2c31a9041b2
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **24.8 MB (24769874 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2d9f0f4596f746b9faf11fe1f9592d5b3583cbc2c8bc338a5d73ece25ff90804`
-	Default Command: `["bash"]`

```dockerfile
# Wed, 27 Mar 2019 08:54:41 GMT
ADD file:408089278fcfae7cea529027042c312ee55247c101ba804094a2b7f2e6a5ce26 in / 
# Wed, 27 Mar 2019 08:54:42 GMT
CMD ["bash"]
```

-	Layers:
	-	`sha256:f5dde356cba421b1117ba796f314f2f9cedbd367107b94355861c956ab3f5731`  
		Last Modified: Wed, 27 Mar 2019 09:00:12 GMT  
		Size: 24.8 MB (24769874 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull debian@sha256:7216a66a09b0e523be578c802ef78e2d696a527625fc20cd0abaec9e3cd81d76
```
...
```console
$ docker pull debian@sha256:b4e063c8d40fb4fa87b82048aa7289a8d63e750af6b28f1b44f7c2e93ad2d3dd
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.0 MB (48001661 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b7ee2a697771675fc9ed597313650e1d7f0ebba0a45aa5bdfcfd36dd8fe523fc`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:edce35bdd603f803202cbec290532059f415abfdbdde67cf0ec84f347b33c797
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.1 MB (49075705 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6dabadbf5488801a49010a8ea0b0c87d3d3ef5eeedba9ec228b084eae3dcaea2`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:d77609a93b13c8697827ed2fba174baff93b665d5792288f9d412008aa853920
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **54.0 MB (54027871 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:786c37b87914699b476612a1794512b06e50c301147ae6ea08e9afb949b0aa9a`
-	Default Command: `["bash"]`
...
### `debian:unstable-20190326` - linux; amd64
...
### `debian:unstable-20190326` - linux; arm variant v5
...
### `debian:unstable-20190326` - linux; arm variant v7
...
### `debian:unstable-20190326` - linux; arm64 variant v8
...
### `debian:unstable-20190326` - linux; 386
...
### `debian:unstable-20190326` - linux; ppc64le
...
### `debian:unstable-20190326` - linux; s390x
...
## `debian:unstable-20190326-slim`

```console
$ docker pull debian@sha256:d03927f5438e4ff64c6409d3dbc3913a94d2bfcaa5765ddfffaa375f03f8aaad
```
