...
```console
$ docker pull debian@sha256:c5e34d1e93f3e06517cb19dec7e54230da22bdb3b39417757b97c7e15691be3c
```
...
```console
$ docker pull debian@sha256:e8e19950797443676474a4d12624325371f739f195abb3162c67df8d0fba0c50
```
