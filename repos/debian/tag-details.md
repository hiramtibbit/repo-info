...
-	[`debian:buster-20181226`](#debianbuster-20181226)
-	[`debian:buster-20181226-slim`](#debianbuster-20181226-slim)
-	[`debian:buster-slim`](#debianbuster-slim)
-	[`debian:experimental`](#debianexperimental)
-	[`debian:experimental-20181226`](#debianexperimental-20181226)
-	[`debian:jessie`](#debianjessie)
-	[`debian:jessie-20181226`](#debianjessie-20181226)
-	[`debian:jessie-20181226-slim`](#debianjessie-20181226-slim)
...
-	[`debian:oldoldstable-20181226`](#debianoldoldstable-20181226)
-	[`debian:oldoldstable-20181226-slim`](#debianoldoldstable-20181226-slim)
...
-	[`debian:oldstable-20181226`](#debianoldstable-20181226)
-	[`debian:oldstable-20181226-slim`](#debianoldstable-20181226-slim)
...
-	[`debian:rc-buggy-20181226`](#debianrc-buggy-20181226)
-	[`debian:sid`](#debiansid)
-	[`debian:sid-20181226`](#debiansid-20181226)
-	[`debian:sid-20181226-slim`](#debiansid-20181226-slim)
-	[`debian:sid-slim`](#debiansid-slim)
-	[`debian:stable`](#debianstable)
-	[`debian:stable-20181226`](#debianstable-20181226)
-	[`debian:stable-20181226-slim`](#debianstable-20181226-slim)
-	[`debian:stable-backports`](#debianstable-backports)
-	[`debian:stable-slim`](#debianstable-slim)
-	[`debian:stretch`](#debianstretch)
-	[`debian:stretch-20181226`](#debianstretch-20181226)
-	[`debian:stretch-20181226-slim`](#debianstretch-20181226-slim)
-	[`debian:stretch-backports`](#debianstretch-backports)
-	[`debian:stretch-slim`](#debianstretch-slim)
-	[`debian:testing`](#debiantesting)
-	[`debian:testing-20181226`](#debiantesting-20181226)
-	[`debian:testing-20181226-slim`](#debiantesting-20181226-slim)
-	[`debian:testing-slim`](#debiantesting-slim)
-	[`debian:unstable`](#debianunstable)
-	[`debian:unstable-20181226`](#debianunstable-20181226)
-	[`debian:unstable-20181226-slim`](#debianunstable-20181226-slim)
-	[`debian:unstable-slim`](#debianunstable-slim)
-	[`debian:wheezy`](#debianwheezy)
-	[`debian:wheezy-20181226`](#debianwheezy-20181226)
-	[`debian:wheezy-20181226-slim`](#debianwheezy-20181226-slim)
...
```console
$ docker pull debian@sha256:f1ed9db169a5edd0468699675cbbeb88a9ef48c25b003fb0966c3842fa178c43
```
...
```console
$ docker pull debian@sha256:ab001ffbba168dc94ef2d6eb21dec56b0f26c14f9021084c541bc5e8870d3552
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **38.0 MB (37992205 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a7ff697f633d087a66b612c8c1b7dd1476d701bfd82a3fbea1c9dc8e3349c2ab`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:8716ae2e8002230f8081138f8db732c41ab3ee3fb124543aea6f08a4e4fe46e4
```
...
```console
$ docker pull debian@sha256:58a80e0b6aa4d960ee2a5452b0230c406c47ed30a66555ba753c8e1710a434f5
```
...
```console
$ docker pull debian@sha256:bde7063f7071d0bd288fa8a43e0d76ebfd97458383e8d338bbc083b5c49a4480
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **44.0 MB (44029352 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:70a8624b38ba6978f90dd4cff486d55b28c159ac389b0d0c39abc4a19b84fde5`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:8161ca5033a56d80ed0f2bdd718bfdf246254e0444a3dd0ee769f7575c12bd6d
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **43.1 MB (43116478 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0e2c4bdd0f9924d8ae9cb021f45bf5b1269d9b49a0e98d2fdd1f44318b233f44`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:be5ecc3026656f1e2cd0536c2ded73e6ef9128bc71f20af93f26d9c39a52a5c3
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.6 MB (45605695 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6413a85417309a2511d2de4e9e17df1cf80392e6483f156edfa29441a2f05802`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:6c31161e090aa3f62b9ee1414b58f0a352b42b2b7827166e57724a8662fe4b38
```
...
```console
$ docker pull debian@sha256:4eca568e83c4123d47b91b5f0a9ad958e331f8604a1983c7696c9092c0728799
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **22.5 MB (22492916 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd04d03c4529ec362343b104702005679c5b98b0c7c33fb13e8fbc3def342fa4`
-	Default Command: `["bash"]`
...
## `debian:buster-20181226-slim`

```console
$ docker pull debian@sha256:3ef002c34fcf91375864f50d10a4eeea25d365ec1dae5e090234e367b9f9f9aa
```
...
```console
$ docker pull debian@sha256:717e734a045169cc2c1dc5b132c4ecc1f3da2f3137395ccd366a981204ddaf68
```
...
### `debian:jessie-20181226-slim` - linux; amd64
...
### `debian:jessie-20181226-slim` - linux; arm variant v5
...
### `debian:jessie-20181226-slim` - linux; arm variant v7
...
### `debian:jessie-20181226-slim` - linux; 386
...
```console
$ docker pull debian@sha256:ae80cc1412ef9b0d0466e68ced49a4bc2631c93c3aaee8f8c9418d7e47793fa9
```
...
## `debian:oldoldstable-20181226-slim`

```console
$ docker pull debian@sha256:dc35423be4dec73568261904521d772bd8a7286727cc12aef27fcac2eb39b15d
```
...
```console
$ docker pull debian@sha256:5af4f752d29547ab3e100201d9b65e7a0b7f7d32fba20fc558a91fc41bb9342c
```
...
## `debian:oldstable-20181226-slim`

```console
$ docker pull debian@sha256:98461506e6949e2d0dd85fa9c3925e781a2382e50ca17b2cd648b64152a21969
```
...
```console
$ docker pull debian@sha256:c1ac04646be84b0055d2d8d2928798944e7ba91579750c49d21064b9e72c53c2
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **28.5 MB (28464860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fa5446b2c50a6cc74f4b15e82a7b2c62ee9e662d4adb21928dcb2a06c6185085`
-	Default Command: `["bash"]`

```dockerfile
# Sat, 29 Dec 2018 09:52:40 GMT
ADD file:4c26625f4691e996930d55b15180a3ddcce13fc33aa700bd6fb9c04369a79536 in / 
# Sat, 29 Dec 2018 09:52:41 GMT
CMD ["bash"]
```

-	Layers:
	-	`sha256:75ceec74121965d70818aa0316f7bf8f1661f0023e8a36002e5eb96cc958459f`  
		Last Modified: Sat, 29 Dec 2018 10:01:32 GMT  
...
```console
$ docker pull debian@sha256:4897384eea515b05134d87a7799b2233c38e0a8029955e69820b83788e56e1e0
```
...
```console
$ docker pull debian@sha256:c817b49f1bd2516e1ac90f16068258e51f83ea3e06d2c3da16b5dd3a3731627e
```
...
### `debian:sid-20181226-slim` - linux; amd64
...
### `debian:sid-20181226-slim` - linux; arm variant v5
...
### `debian:sid-20181226-slim` - linux; arm variant v7
...
### `debian:sid-20181226-slim` - linux; arm64 variant v8
...
### `debian:sid-20181226-slim` - linux; 386
...
### `debian:sid-20181226-slim` - linux; ppc64le
...
### `debian:sid-20181226-slim` - linux; s390x
...
```console
$ docker pull debian@sha256:f768ade0218785e325a29e700c02d64c38bc468b0bcd4239a9d30b0e14e3765a
```
...
```console
$ docker pull debian@sha256:84285f500525d7bbb871bf44da06c1e1d6325585a94e1371ebbf2015ea617c9c
```
...
### `debian:stretch-20181226-slim` - linux; amd64
...
### `debian:stretch-20181226-slim` - linux; arm variant v5
...
### `debian:stretch-20181226-slim` - linux; arm variant v7
...
### `debian:stretch-20181226-slim` - linux; arm64 variant v8
...
### `debian:stretch-20181226-slim` - linux; 386
...
### `debian:stretch-20181226-slim` - linux; ppc64le
...
### `debian:stretch-20181226-slim` - linux; s390x
...
```console
$ docker pull debian@sha256:ed75d35f205b02b6bceda49cb15139db482b75426c8200951facc87497322816
```
...
```console
$ docker pull debian@sha256:8acff28f9d7409b84756b6bd31ea8b3c18412dcfc485c2f6680ca38c7f72bec6
```
...
## `debian:unstable-20181226-slim`

```console
$ docker pull debian@sha256:c2e5434559e0842792134c54b6d15c8bcb39f94506bffe1567c2fa9323e94204
```
