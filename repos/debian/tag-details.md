...
```console
$ docker pull debian@sha256:595f51eb79359155d8d70401a559114769d44ef06f94de21d39013119e7e4620
```
...
```console
$ docker pull debian@sha256:16cbb26f3966d9b9a9fcec8f8482ce4abaa69bff6e0dc2c0045cd357810567cd
```
...
```console
$ docker pull debian@sha256:d4d4bc28ac378d0890cc784873d1d8eeec2f8c331e15d204ddd7aca8d18bce84
```
...
```console
$ docker pull debian@sha256:e96aa56edf908df2786921417ee68b3cf3efd3fe911448179d3ff6ad96054b80
```
...
```console
$ docker pull debian@sha256:7e321ba1430f0885a3ff7c1cb18b67ddbc28e586a0cacbec2376ea92175a82ac
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **26.3 MB (26286960 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1bee6ba145a0c184a4cb9ab4a226e79b863566f81ba657d99064a6e285462dc8`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:c3a252e5285bcb6dc32d86f418158f011752c7be51eed3d06b6f4bdfc189d813
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.3 MB (30270010 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b3be44d93665eb73764e66de920ebb32398608b139efc8a2d9b06b19eb66c192`
-	Default Command: `["bash"]`
...
```console
$ docker pull debian@sha256:42d32c0bc29ddfd75a69f2979a2e10394314ee27bf64bde8d533b14c4d2319e5
```
...
```console
$ docker pull debian@sha256:2ac86f29b1b198ece97eb768ff457d9020b687c3f868b24d55fb0f792209fdb6
```
...
```console
$ docker pull debian@sha256:17ba7749f51b1125cf049d25597dd11640048c17692244e3a87bd5c908706815
```
...
```console
$ docker pull debian@sha256:ac5952528d67e67fc0c2207a3243779e116b966029a3cb6de84dae7f6fff1e06
```
...
```console
$ docker pull debian@sha256:8cc803f772b34b7b1b63a2789b779e9bc30a376a4e9482037fcac42a681f9842
```
...
```console
$ docker pull debian@sha256:a4373aca74af1ab58763fbe8a6f21ba5ef580f917895ad5cb338670ce2cd555e
```
...
```console
$ docker pull debian@sha256:12af28371d95536c7ad95df31142196e52f1a2071b380a46df0680ecccd345e7
```
