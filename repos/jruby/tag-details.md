...
```console
$ docker pull jruby@sha256:2fc8274395a2a3b198a19b6bedb0cdd658515c8b5594e61e720c1da2fe5ab392
```
...
```console
$ docker pull jruby@sha256:7678cab65cdacd7e1083ba021bdd7cb116bd6d77f858fc42a0134fcd849c5b03
```
