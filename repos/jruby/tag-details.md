...
```console
$ docker pull jruby@sha256:d32d0bfc972c4bfb89a5d21dc59d9b6e2accfaa788b46e91533b32906beac5e0
```
...
```console
$ docker pull jruby@sha256:fc4c61b3e5b3957a6a6e586b160e99c804177dac00842d4196b98f4cdc7f04cd
```
