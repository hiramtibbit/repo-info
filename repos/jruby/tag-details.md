...
```console
$ docker pull jruby@sha256:7daec2283eed386be7b18d1edad2db4347bfb347f481217a618ffca01bbd9be0
```
...
```console
$ docker pull jruby@sha256:3c11107211d1ae7d3ffc3dd1da1f63202b329e3ccfbb33b2f65613b5a108a565
```
