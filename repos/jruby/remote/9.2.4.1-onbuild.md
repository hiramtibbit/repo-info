...
### `jruby:9.2.4.1-onbuild` - linux; amd64
...
### `jruby:9.2.4.1-onbuild` - linux; arm variant v5
...
### `jruby:9.2.4.1-onbuild` - linux; arm64 variant v8
...
### `jruby:9.2.4.1-onbuild` - linux; 386
...
### `jruby:9.2.4.1-onbuild` - linux; ppc64le
