...
### `jruby:9.2.2.0-onbuild` - linux; amd64
...
### `jruby:9.2.2.0-onbuild` - linux; arm variant v5
...
### `jruby:9.2.2.0-onbuild` - linux; arm64 variant v8
...
### `jruby:9.2.2.0-onbuild` - linux; 386
...
### `jruby:9.2.2.0-onbuild` - linux; ppc64le
