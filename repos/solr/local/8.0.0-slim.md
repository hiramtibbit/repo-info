...
- Created: `2019-04-29T17:41:21.383421288Z`
- Virtual Size: ~ 481.59 Mb  
...
Licenses: (parsed from: `/usr/share/doc/dirmngr/copyright`, `/usr/share/doc/gpgv/copyright`)
...
### `dpkg` source package: `gnupg2=2.2.12-1~bpo9+1`

Binary Packages:

- `gpg=2.2.12-1~bpo9+1`
- `gpgconf=2.2.12-1~bpo9+1`

Licenses: (parsed from: `/usr/share/doc/gpg/copyright`, `/usr/share/doc/gpgconf/copyright`)
...
```console
$ apt-get source -qq --print-uris gnupg2=2.2.12-1~bpo9+1
'http://deb.debian.org/debian/pool/main/g/gnupg2/gnupg2_2.2.12-1~bpo9+1.dsc' gnupg2_2.2.12-1~bpo9+1.dsc 3547 SHA256:3bf25b231b3701a4575011da05baad42b78e9df9fb1622d8bc012200771bbb7c
...
'http://deb.debian.org/debian/pool/main/g/gnupg2/gnupg2_2.2.12-1~bpo9+1.debian.tar.xz' gnupg2_2.2.12-1~bpo9+1.debian.tar.xz 63452 SHA256:831a198db5b0341aac6c4896cea7ecab01f6d064def9171fd2825db214c98379
```

Other potentially useful URLs:

- https://sources.debian.net/src/gnupg2/2.2.12-1~bpo9+1/ (for browsing the source)
- https://sources.debian.net/src/gnupg2/2.2.12-1~bpo9+1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gnupg2/2.2.12-1~bpo9+1/ (for access to the source package after it no longer exists in the archive)
