...
- Created: `2018-12-28T01:05:12.411216649Z`
- Virtual Size: ~ 682.11 Mb  
...
### `dpkg` source package: `gnupg2=2.2.10-3~bpo9+1`

Binary Packages:

- `gpg=2.2.10-3~bpo9+1`
- `gpgconf=2.2.10-3~bpo9+1`
...
```console
$ apt-get source -qq --print-uris gnupg2=2.2.10-3~bpo9+1
'http://deb.debian.org/debian/pool/main/g/gnupg2/gnupg2_2.2.10-3~bpo9+1.dsc' gnupg2_2.2.10-3~bpo9+1.dsc 3547 SHA256:0ab83daf42a3b82f20475a1bde888d4064c1605a5155366db70729b51dbdc0bd
...
'http://deb.debian.org/debian/pool/main/g/gnupg2/gnupg2_2.2.10-3~bpo9+1.debian.tar.xz' gnupg2_2.2.10-3~bpo9+1.debian.tar.xz 65112 SHA256:b45750d3949adb9c8309c48bd6d440758a8469b70211eb09c295ac4b4dcf3622
```

Other potentially useful URLs:

- https://sources.debian.net/src/gnupg2/2.2.10-3~bpo9+1/ (for browsing the source)
- https://sources.debian.net/src/gnupg2/2.2.10-3~bpo9+1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gnupg2/2.2.10-3~bpo9+1/ (for access to the source package after it no longer exists in the archive)
