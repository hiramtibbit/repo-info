...
```console
$ docker pull solr@sha256:902491063a74ec6781127ef9933911ee782110989917e12ec94b3deb8717e081
```
...
### `solr:8.0.0-slim` - linux; arm variant v5
...
### `solr:8.0.0-slim` - linux; arm variant v7
