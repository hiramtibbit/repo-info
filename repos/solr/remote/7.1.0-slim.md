...
```console
$ docker pull solr@sha256:bd87defe00cdc2023b97c700cbb630d6d47f4554a63a19a007643d1fe54b5b23
```
...
```console
$ docker pull solr@sha256:e6ef12b8ca060e5e7c7e419ead172b97602d589d0ee08d5c293147aeda09980a
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **236.2 MB (236155424 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:477eb882e4e9a0ef664e499b0919b5223b044b1dac72fe1a6f3dc5219480ff3e`
...
-	Layers:
	...
	-	`sha256:007423ab74a752e680df55b8e49645b89e50d6d9d19b622ac6e680b2af901496`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4d988496e66ff6af41aef6203d4d9f5d7a4b56ac02076b90a421d29d8ade7915`  
		Last Modified: Thu, 01 Nov 2018 22:48:15 GMT  
		Size: 4.2 KB (4225 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:933590aa76debfa57c83cc3824e70325793f471d174d7ef1f5ba4d913667b732`  
		Last Modified: Thu, 01 Nov 2018 22:48:15 GMT  
...
```console
$ docker pull solr@sha256:fd7c382b8340184deb7bfbcd12688054271b5562fbc3954da8409c1e7ec6613b
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.4 MB (225355014 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a327ae68272c4da55cf7b64371842d56b198d3c95a40ff3e8e40b9a6c2fc7fd`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["solr-foreground"]`
...
RUN apt-get update &&   apt-get -y install lsof procps wget gpg &&   rm -rf /var/lib/apt/lists/*
# Wed, 31 Oct 2018 10:21:31 GMT
ENV SOLR_USER=solr SOLR_UID=8983 SOLR_GROUP=solr SOLR_GID=8983 SOLR_VERSION=7.1.0 SOLR_URL=https://archive.apache.org/dist/lucene/solr/7.1.0/solr-7.1.0.tgz SOLR_SHA256=5cd25cc2634e47efbb529658d6ddd406a7cd1b211affa26563a28db2d80b8133 SOLR_KEYS=38D2EA16DDF5FC722EBC433FDC92616F177050F6 PATH=/opt/solr/bin:/opt/docker-solr/scripts:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Wed, 31 Oct 2018 10:21:31 GMT
ENV GOSU_VERSION=1.10
# Wed, 31 Oct 2018 10:21:31 GMT
ENV GOSU_KEY=B42F6819007F00F88E364FD4036A9C25BF357DD4
# Wed, 31 Oct 2018 10:21:32 GMT
RUN groupadd -r --gid $SOLR_GID $SOLR_GROUP &&   useradd -r --uid $SOLR_UID --gid $SOLR_GID $SOLR_USER
# Wed, 31 Oct 2018 10:21:36 GMT
RUN set -e;   export GNUPGHOME="/tmp/gnupg_home" &&   mkdir -p "$GNUPGHOME" &&   chmod 700 "$GNUPGHOME" &&   for key in $SOLR_KEYS $GOSU_KEY; do     found='';     for server in       ha.pool.sks-keyservers.net       hkp://keyserver.ubuntu.com:80       hkp://p80.pool.sks-keyservers.net:80       pgp.mit.edu     ; do       echo "  trying $server for $key";       gpg --keyserver "$server" --keyserver-options timeout=10 --recv-keys "$key" && found=yes && break;     done;     test -z "$found" && echo >&2 "error: failed to fetch $key from several disparate servers -- network issues?" && exit 1;   done;   exit 0
# Wed, 31 Oct 2018 10:22:54 GMT
RUN set -e;   export GNUPGHOME="/tmp/gnupg_home" &&   dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')" &&   wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch" &&   wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc" &&   gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu &&   rm /usr/local/bin/gosu.asc &&   chmod +x /usr/local/bin/gosu &&   gosu nobody true &&   mkdir -p /opt/solr &&   echo "downloading $SOLR_URL" &&   wget -nv $SOLR_URL -O /opt/solr.tgz &&   echo "downloading $SOLR_URL.asc" &&   wget -nv $SOLR_URL.asc -O /opt/solr.tgz.asc &&   echo "$SOLR_SHA256 */opt/solr.tgz" | sha256sum -c - &&   (>&2 ls -l /opt/solr.tgz /opt/solr.tgz.asc) &&   gpg --batch --verify /opt/solr.tgz.asc /opt/solr.tgz &&   tar -C /opt/solr --extract --file /opt/solr.tgz --strip-components=1 &&   rm /opt/solr.tgz* &&   rm -Rf /opt/solr/docs/ &&   mkdir -p /opt/solr/server/solr/lib /opt/solr/server/solr/mycores /opt/solr/server/logs /docker-entrypoint-initdb.d /opt/docker-solr /opt/mysolrhome &&   sed -i -e 's/"\$(whoami)" == "root"/$(id -u) == 0/' /opt/solr/bin/solr &&   sed -i -e 's/lsof -PniTCP:/lsof -t -PniTCP:/' /opt/solr/bin/solr &&   sed -i -e '/-Dsolr.clustering.enabled=true/ a SOLR_OPTS="$SOLR_OPTS -Dsun.net.inetaddr.ttl=60 -Dsun.net.inetaddr.negative.ttl=60"' /opt/solr/bin/solr.in.sh &&   chown -R $SOLR_USER:$SOLR_GROUP /opt/solr
# Wed, 31 Oct 2018 10:22:55 GMT
COPY dir:559a3b850dcec4cf3808cc890e2a3da7dea47e3e083fe4065a61affa123bfbce in /opt/docker-solr/scripts 
# Wed, 31 Oct 2018 10:22:57 GMT
RUN chown -R $SOLR_USER:$SOLR_GROUP /opt/docker-solr /opt/mysolrhome
# Wed, 31 Oct 2018 10:22:57 GMT
EXPOSE 8983/tcp
# Wed, 31 Oct 2018 10:22:57 GMT
WORKDIR /opt/solr
# Wed, 31 Oct 2018 10:22:58 GMT
USER [solr]
# Wed, 31 Oct 2018 10:22:58 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 31 Oct 2018 10:22:59 GMT
CMD ["solr-foreground"]
```
...
-	Layers:
	...
	-	`sha256:bcb6a93dfaabba17e5159349b9beafd95ca5daca86fef4cf5b6150346e7f1dc2`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:be5ce7a9db1364f99071bece6e582fb39e0ddc51b0387ed1ebe019b6d72b4849`  
		Last Modified: Wed, 31 Oct 2018 10:32:26 GMT  
		Size: 4.2 KB (4226 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e6f15721ff539d695a77520fb6441dee7f06268a35394d08149e6a2b2ffac026`  
		Last Modified: Wed, 31 Oct 2018 10:32:26 GMT  
		Size: 73.2 KB (73172 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f7156d6c0cd5accb0e94c6f971d3d63c119a4272559e0397ceb84526f3407066`  
		Last Modified: Wed, 31 Oct 2018 10:32:46 GMT  
		Size: 153.1 MB (153072635 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:bad6cf529486d70da4ba5dddb5df9e4dc27ed65e3041694aabf41113b8918e5a`  
		Last Modified: Wed, 31 Oct 2018 10:32:26 GMT  
		Size: 4.3 KB (4251 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b22af4c9dc0c5caeeb8a06e19265013e983cee02c9a2881182621dbc39348e06`  
		Last Modified: Wed, 31 Oct 2018 10:32:26 GMT  
...
```console
$ docker pull solr@sha256:d87f5766e3cde55fccc06c7b40b757a377eff9dad451dda3319bcdd0a0f1b1c1
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.8 MB (225801681 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:37e5bfc2799de9de46542ba3bd8b2d1f529c63dac63d28a81ab8ceaf5d40808c`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["solr-foreground"]`
...
RUN set -e;   export GNUPGHOME="/tmp/gnupg_home" &&   dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')" &&   wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch" &&   wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc" &&   gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu &&   rm /usr/local/bin/gosu.asc &&   chmod +x /usr/local/bin/gosu &&   gosu nobody true &&   mkdir -p /opt/solr &&   echo "downloading $SOLR_URL" &&   wget -nv $SOLR_URL -O /opt/solr.tgz &&   echo "downloading $SOLR_URL.asc" &&   wget -nv $SOLR_URL.asc -O /opt/solr.tgz.asc &&   echo "$SOLR_SHA256 */opt/solr.tgz" | sha256sum -c - &&   (>&2 ls -l /opt/solr.tgz /opt/solr.tgz.asc) &&   gpg --batch --verify /opt/solr.tgz.asc /opt/solr.tgz &&   tar -C /opt/solr --extract --file /opt/solr.tgz --strip-components=1 &&   rm /opt/solr.tgz* &&   rm -Rf /opt/solr/docs/ &&   mkdir -p /opt/solr/server/solr/lib /opt/solr/server/solr/mycores /opt/solr/server/logs /docker-entrypoint-initdb.d /opt/docker-solr /opt/mysolrhome &&   sed -i -e 's/"\$(whoami)" == "root"/$(id -u) == 0/' /opt/solr/bin/solr &&   sed -i -e 's/lsof -PniTCP:/lsof -t -PniTCP:/' /opt/solr/bin/solr &&   sed -i -e '/-Dsolr.clustering.enabled=true/ a SOLR_OPTS="$SOLR_OPTS -Dsun.net.inetaddr.ttl=60 -Dsun.net.inetaddr.negative.ttl=60"' /opt/solr/bin/solr.in.sh &&   chown -R $SOLR_USER:$SOLR_GROUP /opt/solr
# Tue, 30 Oct 2018 14:40:38 GMT
COPY dir:559a3b850dcec4cf3808cc890e2a3da7dea47e3e083fe4065a61affa123bfbce in /opt/docker-solr/scripts 
# Tue, 30 Oct 2018 14:40:45 GMT
RUN chown -R $SOLR_USER:$SOLR_GROUP /opt/docker-solr /opt/mysolrhome
# Tue, 30 Oct 2018 14:40:45 GMT
EXPOSE 8983/tcp
# Tue, 30 Oct 2018 14:40:46 GMT
WORKDIR /opt/solr
# Tue, 30 Oct 2018 14:40:47 GMT
USER [solr]
# Tue, 30 Oct 2018 14:40:57 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Tue, 30 Oct 2018 14:40:58 GMT
CMD ["solr-foreground"]
```
...
-	Layers:
	...
	-	`sha256:4297d03290f74778f193c91e09d19016cda208f3e78def8ebf1a20b6f743ea18`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d572338637a8fed440fcda0ff8e0f1f78246a4b0b14acd0bd6804945d72f8af3`  
		Last Modified: Tue, 30 Oct 2018 14:56:10 GMT  
		Size: 4.2 KB (4222 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ffa94079791bdaf21b071387b14b20a939040ecf945efc72b098498c6217caa7`  
		Last Modified: Tue, 30 Oct 2018 14:56:10 GMT  
		Size: 4.3 KB (4252 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull solr@sha256:edd0d04b1511e6f2314708d13a258a03393c3e80a6475469dea3f7d4d6e1b567
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **229.0 MB (228986209 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69031a6f92c9098aacb0ea5ec6c2449a385e4c2da3b043c3a7d799c3b2e07f35`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["solr-foreground"]`
...
RUN set -e;   export GNUPGHOME="/tmp/gnupg_home" &&   dpkgArch="$(dpkg --print-architecture | awk -F- '{ print $NF }')" &&   wget -O /usr/local/bin/gosu "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch" &&   wget -O /usr/local/bin/gosu.asc "https://github.com/tianon/gosu/releases/download/$GOSU_VERSION/gosu-$dpkgArch.asc" &&   gpg --batch --verify /usr/local/bin/gosu.asc /usr/local/bin/gosu &&   rm /usr/local/bin/gosu.asc &&   chmod +x /usr/local/bin/gosu &&   gosu nobody true &&   mkdir -p /opt/solr &&   echo "downloading $SOLR_URL" &&   wget -nv $SOLR_URL -O /opt/solr.tgz &&   echo "downloading $SOLR_URL.asc" &&   wget -nv $SOLR_URL.asc -O /opt/solr.tgz.asc &&   echo "$SOLR_SHA256 */opt/solr.tgz" | sha256sum -c - &&   (>&2 ls -l /opt/solr.tgz /opt/solr.tgz.asc) &&   gpg --batch --verify /opt/solr.tgz.asc /opt/solr.tgz &&   tar -C /opt/solr --extract --file /opt/solr.tgz --strip-components=1 &&   rm /opt/solr.tgz* &&   rm -Rf /opt/solr/docs/ &&   mkdir -p /opt/solr/server/solr/lib /opt/solr/server/solr/mycores /opt/solr/server/logs /docker-entrypoint-initdb.d /opt/docker-solr /opt/mysolrhome &&   sed -i -e 's/"\$(whoami)" == "root"/$(id -u) == 0/' /opt/solr/bin/solr &&   sed -i -e 's/lsof -PniTCP:/lsof -t -PniTCP:/' /opt/solr/bin/solr &&   sed -i -e '/-Dsolr.clustering.enabled=true/ a SOLR_OPTS="$SOLR_OPTS -Dsun.net.inetaddr.ttl=60 -Dsun.net.inetaddr.negative.ttl=60"' /opt/solr/bin/solr.in.sh &&   chown -R $SOLR_USER:$SOLR_GROUP /opt/solr
# Wed, 31 Oct 2018 10:51:34 GMT
COPY dir:559a3b850dcec4cf3808cc890e2a3da7dea47e3e083fe4065a61affa123bfbce in /opt/docker-solr/scripts 
# Wed, 31 Oct 2018 10:51:37 GMT
RUN chown -R $SOLR_USER:$SOLR_GROUP /opt/docker-solr /opt/mysolrhome
# Wed, 31 Oct 2018 10:51:38 GMT
EXPOSE 8983/tcp
# Wed, 31 Oct 2018 10:51:41 GMT
WORKDIR /opt/solr
# Wed, 31 Oct 2018 10:51:42 GMT
USER [solr]
# Wed, 31 Oct 2018 10:51:43 GMT
ENTRYPOINT ["docker-entrypoint.sh"]
# Wed, 31 Oct 2018 10:51:44 GMT
CMD ["solr-foreground"]
```
...
-	Layers:
	...
	-	`sha256:b70bdc60ecda8a2d55fbd90c96b2ed2fa8ced4e3192564740035647869e9318a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cc679f97619b24141f6bf5e5e95e02f33d94cad92cbbd28df6bc187d5995faf5`  
		Last Modified: Wed, 31 Oct 2018 11:02:54 GMT  
		Size: 4.2 KB (4250 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:daab092765fe1f6d659a127bb8d1ab4cf91f27ab40f0da01d06a65405d4eac4c`  
		Last Modified: Wed, 31 Oct 2018 11:02:54 GMT  
		Size: 4.3 KB (4254 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull solr@sha256:4bad17ca532ff961e379d79f8a412b83b09ad8ffe3b608e32cc6d58cd397466f
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **227.9 MB (227905569 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a691f979c132310bcea66fa053cf48afe5d51e2428af5fcdf7fcbd687c666a53`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["solr-foreground"]`
...
-	Layers:
	...
	-	`sha256:bbbed507f6ae9ad231b90c238b97e12b82e016cfb9a56fe42db8a9d40dde1307`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d1aedc756eeda81683d6a80442b2be93603a735a0f3331c7af2faa617843212`  
		Last Modified: Tue, 30 Oct 2018 14:10:50 GMT  
		Size: 4.2 KB (4223 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fe2a8ee49e2918dac57c7bf9f28a16bcb771e624f18f407433848a11c0af69b8`  
		Last Modified: Tue, 30 Oct 2018 14:10:50 GMT  
		Size: 4.3 KB (4253 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
