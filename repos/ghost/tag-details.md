...
```console
$ docker pull ghost@sha256:55d4c99c5e1c2045b3ebba4c3db20e65cdf7a4009a874659127603699b6725b1
```
...
```console
$ docker pull ghost@sha256:8c793fe90bbd056470d0660ea8a860f26555f25ecd4fc988524b55cdd30ffadf
```
