...
```console
$ docker pull ghost@sha256:bd86c6262dc6fc2cbb73496b6438008d391abea5e216872a065bef35da23918e
```
...
```console
$ docker pull ghost@sha256:fff2c15af25a01249f7fb285eed5546d8e036fb069a4882b50d7be500eae43da
```
