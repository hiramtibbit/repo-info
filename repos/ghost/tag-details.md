...
```console
$ docker pull ghost@sha256:01a68db22854eaf7b672848929c008f242b7e1bd2cd984cd7d96661c0f21dae0
```
...
```console
$ docker pull ghost@sha256:a9a6e56bdebadc88a28c2719992d49adf34e9d5679f63a647faa8d9a2dfc26db
```
