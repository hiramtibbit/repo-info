...
```console
$ docker pull ghost@sha256:89c063844bbf3bd62f7c71906be9317bda822e67ea0924709aff97dc18d52b16
```
...
### `ghost:2.13.1` - linux; arm64 variant v8
...
### `ghost:2.13.1-alpine` - linux; arm variant v6
...
### `ghost:2.13.1-alpine` - linux; ppc64le
