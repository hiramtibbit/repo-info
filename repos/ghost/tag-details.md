...
```console
$ docker pull ghost@sha256:8cd1a35024af317780a694b84a056829d2b5dba5aeb81cc3fd41fda4745dd68b
```
...
```console
$ docker pull ghost@sha256:33f1acdca60c75918796de75a7cda357a8b287c4b0540d6b6e861fcb35d123f4
```
