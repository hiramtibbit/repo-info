...
- Created: `2018-04-30T18:14:25.624288808Z`
- Virtual Size: ~ 327.50 Mb  
...
- Environment:
  ...
  - `PERCONA_MAJOR=5.6`
  - `PERCONA_VERSION=5.6.39-83.1-1.jessie`
...
### `dpkg` source package: `percona-server-5.6=5.6.39-83.1-1.jessie`

Binary Packages:

- `libperconaserverclient18.1=5.6.39-83.1-1.jessie`
- `percona-server-client-5.6=5.6.39-83.1-1.jessie`
- `percona-server-common-5.6=5.6.39-83.1-1.jessie`
- `percona-server-server-5.6=5.6.39-83.1-1.jessie`
