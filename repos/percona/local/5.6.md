...
- Created: `2018-08-22T23:15:41.425944443Z`
...
- Environment:
  ...
  - `PERCONA_MAJOR=5.6`
  - `PERCONA_VERSION=5.6.41-84.1-1.stretch`
...
### `dpkg` source package: `percona-server-5.6=5.6.41-84.1-1.stretch`

Binary Packages:

- `libperconaserverclient18.1=5.6.41-84.1-1.stretch`
- `percona-server-client-5.6=5.6.41-84.1-1.stretch`
- `percona-server-common-5.6=5.6.41-84.1-1.stretch`
- `percona-server-server-5.6=5.6.41-84.1-1.stretch`
