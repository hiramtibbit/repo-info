...
- Created: `2018-07-31T17:17:59.487740873Z`
...
- Environment:
  ...
  - `PERCONA_MAJOR=5.6`
  - `PERCONA_VERSION=5.6.40-84.0-1.stretch`
...
### `dpkg` source package: `libdbd-mysql-perl=4.041-2`
...
```console
$ apt-get source -qq --print-uris libdbd-mysql-perl=4.041-2
'http://deb.debian.org/debian/pool/main/libd/libdbd-mysql-perl/libdbd-mysql-perl_4.041-2.dsc' libdbd-mysql-perl_4.041-2.dsc 2512 SHA256:55b440a4c5ff0bb04393e0c749617992db3889bb9971a9faae6ef153a9d56a7c
'http://deb.debian.org/debian/pool/main/libd/libdbd-mysql-perl/libdbd-mysql-perl_4.041.orig.tar.gz' libdbd-mysql-perl_4.041.orig.tar.gz 150508 SHA256:4777de11c464b515db9da95c08c225900d0594b65ba3256982dc21f9f9379040
'http://deb.debian.org/debian/pool/main/libd/libdbd-mysql-perl/libdbd-mysql-perl_4.041-2.debian.tar.xz' libdbd-mysql-perl_4.041-2.debian.tar.xz 11404 SHA256:ea8e348f5c60a7a617598432e577750a614141e43eb52ba571ffe34e6575a22c
```

Other potentially useful URLs:

- https://sources.debian.net/src/libdbd-mysql-perl/4.041-2/ (for browsing the source)
- https://sources.debian.net/src/libdbd-mysql-perl/4.041-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libdbd-mysql-perl/4.041-2/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `libdbi-perl=1.636-1`

Binary Packages:

- `libdbi-perl=1.636-1+b1`
...
```console
$ apt-get source -qq --print-uris libdbi-perl=1.636-1
'http://deb.debian.org/debian/pool/main/libd/libdbi-perl/libdbi-perl_1.636-1.dsc' libdbi-perl_1.636-1.dsc 2433 SHA256:d5d5c641c6a43f33ca3630ec0311c06c3c207138c73f246a982bd454080f96b7
'http://deb.debian.org/debian/pool/main/libd/libdbi-perl/libdbi-perl_1.636.orig.tar.gz' libdbi-perl_1.636.orig.tar.gz 595433 SHA256:8f7ddce97c04b4b7a000e65e5d05f679c964d62c8b02c94c1a7d815bb2dd676c
'http://deb.debian.org/debian/pool/main/libd/libdbi-perl/libdbi-perl_1.636-1.debian.tar.xz' libdbi-perl_1.636-1.debian.tar.xz 12232 SHA256:6e06b6bb037b454a6af19a689bd9ffaf51580b32ee07665b9a76c8214e8c7dd4
```

Other potentially useful URLs:

- https://sources.debian.net/src/libdbi-perl/1.636-1/ (for browsing the source)
- https://sources.debian.net/src/libdbi-perl/1.636-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libdbi-perl/1.636-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `percona-server-5.6=5.6.40-84.0-1.stretch`

Binary Packages:

- `libperconaserverclient18.1=5.6.40-84.0-1.stretch`
- `percona-server-client-5.6=5.6.40-84.0-1.stretch`
- `percona-server-common-5.6=5.6.40-84.0-1.stretch`
- `percona-server-server-5.6=5.6.40-84.0-1.stretch`

Licenses: (parsed from: `/usr/share/doc/libperconaserverclient18.1/copyright`, `/usr/share/doc/percona-server-client-5.6/copyright`, `/usr/share/doc/percona-server-common-5.6/copyright`, `/usr/share/doc/percona-server-server-5.6/copyright`)
