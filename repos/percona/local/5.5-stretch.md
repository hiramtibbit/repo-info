...
- Created: `2018-07-31T17:19:33.709026191Z`
...
- Environment:
  ...
  - `PERCONA_MAJOR=5.5`
  - `PERCONA_VERSION=5.5.60-rel38.12-1.stretch`
...
### `dpkg` source package: `percona-server-5.5=5.5.60-rel38.12-1.stretch`

Binary Packages:

- `libperconaserverclient18=5.5.60-rel38.12-1.stretch`
- `percona-server-client-5.5=5.5.60-rel38.12-1.stretch`
- `percona-server-common-5.5=5.5.60-rel38.12-1.stretch`
- `percona-server-server-5.5=5.5.60-rel38.12-1.stretch`
