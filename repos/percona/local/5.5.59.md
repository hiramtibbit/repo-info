...
- Created: `2018-02-17T06:55:02.491981349Z`
...
- Environment:
  ...
  - `PERCONA_MAJOR=5.5`
  - `PERCONA_VERSION=5.5.59-rel38.11-1.jessie`
...
### `dpkg` source package: `percona-server-5.5=5.5.59-rel38.11-1.jessie`

Binary Packages:

- `libperconaserverclient18=5.5.59-rel38.11-1.jessie`
- `percona-server-client-5.5=5.5.59-rel38.11-1.jessie`
- `percona-server-common-5.5=5.5.59-rel38.11-1.jessie`
- `percona-server-server-5.5=5.5.59-rel38.11-1.jessie`

Licenses: (parsed from: `/usr/share/doc/libperconaserverclient18/copyright`, `/usr/share/doc/percona-server-client-5.5/copyright`, `/usr/share/doc/percona-server-common-5.5/copyright`, `/usr/share/doc/percona-server-server-5.5/copyright`)
