...
- Created: `2018-10-02T18:00:14.390146063Z`
...
- Environment:
  ...
  - `PERCONA_MAJOR=5.5`
  - `PERCONA_VERSION=5.5.61-rel38.13-1.stretch`
...
### `dpkg` source package: `percona-server-5.5=5.5.61-rel38.13-1.stretch`

Binary Packages:

- `libperconaserverclient18=5.5.61-rel38.13-1.stretch`
- `percona-server-client-5.5=5.5.61-rel38.13-1.stretch`
- `percona-server-common-5.5=5.5.61-rel38.13-1.stretch`
- `percona-server-server-5.5=5.5.61-rel38.13-1.stretch`
