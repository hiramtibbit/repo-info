...
- Created: `2018-03-14T13:46:43.280504791Z`
...
- Environment:
  ...
  - `PERCONA_MAJOR=5.7`
  - `PERCONA_VERSION=5.7.21-20-1.jessie`
...
### `dpkg` source package: `debsums=2.0.53`

Binary Packages:

- `debsums=2.0.53`

Licenses: (parsed from: `/usr/share/doc/debsums/copyright`)
...
```console
$ apt-get source -qq --print-uris debsums=2.0.53
'http://deb.debian.org/debian/pool/main/d/debsums/debsums_2.0.53.dsc' debsums_2.0.53.dsc 1671 SHA256:45e9495152c216b7da7f8bac3c7a6c5bea3584ecb21853e8f39cdd89d75932fe
'http://deb.debian.org/debian/pool/main/d/debsums/debsums_2.0.53.tar.xz' debsums_2.0.53.tar.xz 46908 SHA256:3dfb176b244ed68974c73bc9c6dc44721718ecd2c52c34b2baf0be332456344e
```

Other potentially useful URLs:

- https://sources.debian.net/src/debsums/2.0.53/ (for browsing the source)
- https://sources.debian.net/src/debsums/2.0.53/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/debsums/2.0.53/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `libfile-fcntllock-perl=0.22-1`
...
```console
$ apt-get source -qq --print-uris libfile-fcntllock-perl=0.22-1
'http://deb.debian.org/debian/pool/main/libf/libfile-fcntllock-perl/libfile-fcntllock-perl_0.22-1.dsc' libfile-fcntllock-perl_0.22-1.dsc 2091 SHA256:3c60e7b21d99955503f3348f9ed25e269a76a00e6cbe98d7eeb10ba64a7acf0a
...
'http://deb.debian.org/debian/pool/main/libf/libfile-fcntllock-perl/libfile-fcntllock-perl_0.22-1.debian.tar.xz' libfile-fcntllock-perl_0.22-1.debian.tar.xz 2052 SHA256:1112c2677d3286d8c0ae80771cd0505b3bcdd4a7959f8e3ebf69514ca2a2a166
```

Other potentially useful URLs:

- https://sources.debian.net/src/libfile-fcntllock-perl/0.22-1/ (for browsing the source)
- https://sources.debian.net/src/libfile-fcntllock-perl/0.22-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libfile-fcntllock-perl/0.22-1/ (for access to the source package after it no longer exists in the archive)

### `dpkg` source package: `libfile-fnmatch-perl=0.02-2`

Binary Packages:

- `libfile-fnmatch-perl=0.02-2+b1`

Licenses: (parsed from: `/usr/share/doc/libfile-fnmatch-perl/copyright`)
...
```console
$ apt-get source -qq --print-uris libfile-fnmatch-perl=0.02-2
'http://deb.debian.org/debian/pool/main/libf/libfile-fnmatch-perl/libfile-fnmatch-perl_0.02-2.dsc' libfile-fnmatch-perl_0.02-2.dsc 2166 SHA256:06b6456e8dc2de948e627cf824d6b735f957c894ca258b8173bca26006000f06
'http://deb.debian.org/debian/pool/main/libf/libfile-fnmatch-perl/libfile-fnmatch-perl_0.02.orig.tar.gz' libfile-fnmatch-perl_0.02.orig.tar.gz 32609 SHA256:962454b8e86bea8b132bf8af35757d0c6a8f5d599015bd6a5d68cb7ae7a9e916
'http://deb.debian.org/debian/pool/main/libf/libfile-fnmatch-perl/libfile-fnmatch-perl_0.02-2.debian.tar.xz' libfile-fnmatch-perl_0.02-2.debian.tar.xz 1960 SHA256:dbe4f03a822830378ba044e7e8be9d3b8cf6a3df1504129d42e1be5da3bba871
```

Other potentially useful URLs:

- https://sources.debian.net/src/libfile-fnmatch-perl/0.02-2/ (for browsing the source)
- https://sources.debian.net/src/libfile-fnmatch-perl/0.02-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libfile-fnmatch-perl/0.02-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `percona-server-5.7=5.7.21-20-1.jessie`

Binary Packages:

- `percona-server-client-5.7=5.7.21-20-1.jessie`
- `percona-server-common-5.7=5.7.21-20-1.jessie`
- `percona-server-server-5.7=5.7.21-20-1.jessie`
