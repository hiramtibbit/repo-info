...
- Created: `2018-06-06T18:42:14.922320304Z`
...
- Environment:
  ...
  - `PERCONA_MAJOR=5.5`
  - `PERCONA_VERSION=5.5.60-rel38.12-1.jessie`
...
### `dpkg` source package: `percona-server-5.5=5.5.60-rel38.12-1.jessie`

Binary Packages:

- `libperconaserverclient18=5.5.60-rel38.12-1.jessie`
- `percona-server-client-5.5=5.5.60-rel38.12-1.jessie`
- `percona-server-common-5.5=5.5.60-rel38.12-1.jessie`
- `percona-server-server-5.5=5.5.60-rel38.12-1.jessie`
