...
- Created: `2018-11-16T01:28:44.882003213Z`
...
- Environment:
  ...
  - `PERCONA_MAJOR=5.7`
  - `PERCONA_VERSION=5.7.23-24-1.stretch`
...
### `dpkg` source package: `debsums=2.2.2`
...
```console
$ apt-get source -qq --print-uris debsums=2.2.2
'http://deb.debian.org/debian/pool/main/d/debsums/debsums_2.2.2.dsc' debsums_2.2.2.dsc 1788 SHA256:e90d5135c01d5f7a46c7f75b1da5963c3c21af0e4c3f8a956d64a329bb5ecc19
'http://deb.debian.org/debian/pool/main/d/debsums/debsums_2.2.2.tar.xz' debsums_2.2.2.tar.xz 50832 SHA256:aa61896f93a6bbfe0161c21dcd67529ae8e1ec8c3ccf244523c52c4ad8253d97
```

Other potentially useful URLs:

- https://sources.debian.net/src/debsums/2.2.2/ (for browsing the source)
- https://sources.debian.net/src/debsums/2.2.2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/debsums/2.2.2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `percona-server-5.7=5.7.23-24-1.stretch`

Binary Packages:

- `percona-server-client-5.7=5.7.23-24-1.stretch`
- `percona-server-common-5.7=5.7.23-24-1.stretch`
- `percona-server-server-5.7=5.7.23-24-1.stretch`
