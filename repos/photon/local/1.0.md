...
### `rpm` package: `bash-4.3.48-2.ph1.x86_64`

Licenses (from `rpm --query`): GPLv3

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `bzip2-1.0.6-6.ph1.x86_64`

Licenses (from `rpm --query`): BSD

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `ca-certificates-20180919-1.ph1.x86_64`
...
### `rpm` package: `curl-7.59.0-7.ph1.x86_64`

Licenses (from `rpm --query`): MIT

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `elfutils-libelf-0.169-3.ph1.x86_64`
...
### `rpm` package: `filesystem-1.1-3.ph1.x86_64`
...
### `rpm` package: `glib-2.47.6-3.ph1.x86_64`

Licenses (from `rpm --query`): LGPLv2+

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `glibc-2.22-25.ph1.x86_64`
...
### `rpm` package: `libassuan-2.4.3-1.ph1.x86_64`
...
### `rpm` package: `libgcc-5.3.0-5.ph1.x86_64`
...
### `rpm` package: `libsolv-0.6.19-6.ph1.x86_64`

Licenses (from `rpm --query`): BSD

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `libssh2-1.8.0-2.ph1.x86_64`

Licenses (from `rpm --query`): BSD

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `libstdc++-5.3.0-5.ph1.x86_64`
...
### `rpm` package: `nspr-4.15-1.ph1.x86_64`

Licenses (from `rpm --query`): MPLv2.0

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `nss-3.31.1-1.ph1.x86_64`

Licenses (from `rpm --query`): MPLv2.0

**WARNING:** unable to find source (`yumdownloader` failed or returned no results)!

### `rpm` package: `openssl-1.0.2r-1.ph1.x86_64`
...
### `rpm` package: `sqlite-autoconf-3.26.0-1.ph1.x86_64`
...
### `rpm` package: `vim-7.4-11.ph1.x86_64`
