...
```console
apr-util-dev-1.6.1-r5 description:
The Apache Portable Runtime Utility Library (development files)

apr-util-dev-1.6.1-r5 webpage:
http://apr.apache.org/

apr-util-dev-1.6.1-r5 installed size:
823296

apr-util-dev-1.6.1-r5 license:
Apache-2.0
...
```console
apr-util-ldap-1.6.1-r5 description:
The Apache Portable Runtime Utility Library - LDAP driver

apr-util-ldap-1.6.1-r5 webpage:
http://apr.apache.org/

apr-util-ldap-1.6.1-r5 installed size:
32768

apr-util-ldap-1.6.1-r5 license:
Apache-2.0
...
```console
cyrus-sasl-dev-2.1.27-r1 description:
Cyrus Simple Authentication Service Layer (SASL) (development files)

cyrus-sasl-dev-2.1.27-r1 webpage:
https://cyrusimap.org/

cyrus-sasl-dev-2.1.27-r1 installed size:
921600

cyrus-sasl-dev-2.1.27-r1 license:
custom
...
```console
libfdisk-2.33-r0 description:
Partitioning library for fdisk-like programs

libfdisk-2.33-r0 webpage:
http://git.kernel.org/cgit/utils/util-linux/util-linux.git

libfdisk-2.33-r0 installed size:
389120

libfdisk-2.33-r0 license:
GPL-2.0 GPL-2.0-or-later LGPL-2.0-or-later BSD Public-Domain
...
```console
libsmartcols-2.33-r0 description:
Formatting library for ls-like programs.

libsmartcols-2.33-r0 webpage:
http://git.kernel.org/cgit/utils/util-linux/util-linux.git

libsmartcols-2.33-r0 installed size:
200704
...
```console
mariadb-connector-c-dev-3.0.8-r0 description:
The MariaDB Native Client library (C driver) (development files)

mariadb-connector-c-dev-3.0.8-r0 webpage:
https://mariadb.org/

mariadb-connector-c-dev-3.0.8-r0 installed size:
245760

mariadb-connector-c-dev-3.0.8-r0 license:
LGPL-2.1-or-later
...
```console
openssl-dev-1.1.1b-r1 description:
Toolkit for Transport Layer Security (TLS) (development files)

openssl-dev-1.1.1b-r1 webpage:
https://www.openssl.org

openssl-dev-1.1.1b-r1 installed size:
20541440

openssl-dev-1.1.1b-r1 license:
OpenSSL
...
```console
util-linux-dev-2.33-r0 description:
Random collection of Linux utilities (development files)

util-linux-dev-2.33-r0 webpage:
http://git.kernel.org/cgit/utils/util-linux/util-linux.git

util-linux-dev-2.33-r0 installed size:
2916352

util-linux-dev-2.33-r0 license:
GPL-2.0 GPL-2.0-or-later LGPL-2.0-or-later BSD Public-Domain
