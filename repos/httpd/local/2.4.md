...
- Created: `2018-10-16T01:59:11.986004831Z`
- Virtual Size: ~ 177.58 Mb  
...
- https://sources.debian.net/src/lua5.2/5.2.3-1.1/ (for browsing the source)
- https://sources.debian.net/src/lua5.2/5.2.3-1.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/lua5.2/5.2.3-1.1/ (for access to the source package after it no longer exists in the archive)
...
- `libldap2-dev:amd64=2.4.40+dfsg-1+deb8u4`
...
- https://sources.debian.net/src/openssl/1.0.2l-1~bpo8+1/ (for browsing the source)
- https://sources.debian.net/src/openssl/1.0.2l-1~bpo8+1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/openssl/1.0.2l-1~bpo8+1/ (for access to the source package after it no longer exists in the archive)
