...
### `wordpress:5.1-php7.2-fpm-alpine` - linux; amd64
...
### `wordpress:5.1-php7.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:5.1-php7.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:5.1-php7.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:5.1-php7.2-fpm-alpine` - linux; 386
...
### `wordpress:5.1-php7.2-fpm-alpine` - linux; ppc64le
