...
### `wordpress:5.0.2-php5.6-fpm` - linux; arm variant v7
...
### `wordpress:5.0.2-php5.6-fpm` - linux; arm64 variant v8
...
### `wordpress:5.0.2-php5.6-fpm` - linux; 386
...
### `wordpress:5.0.2-php5.6-fpm` - linux; s390x
