...
```console
$ docker pull wordpress@sha256:7ff5ca643c580bc3810b4ad0b35132da97936f51765f188f493e27837b233dab
```
...
### `wordpress:5.2.2-php7.1` - linux; arm64 variant v8
...
### `wordpress:5.2.2-php7.1` - linux; ppc64le
