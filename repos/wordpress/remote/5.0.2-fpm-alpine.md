## `wordpress:5.0.2-fpm-alpine`

```console
$ docker pull wordpress@sha256:336b0d7aa60e65899bb48da99bbb635cb2699b5041defb07059e6224d89f6d0c
```
...
### `wordpress:5.0.2-fpm-alpine` - linux; amd64
...
### `wordpress:5.0.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:5.0.2-fpm-alpine` - linux; 386
...
### `wordpress:5.0.2-fpm-alpine` - linux; ppc64le
