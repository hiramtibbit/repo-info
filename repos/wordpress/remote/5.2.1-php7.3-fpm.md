...
```console
$ docker pull wordpress@sha256:adb41810ae4e20c61082e5e242f81cc1b9bbf25d910b53f003957c346db34489
```
...
### `wordpress:5.2.1-php7.3-fpm` - linux; amd64
...
### `wordpress:5.2.1-php7.3-fpm` - linux; arm variant v5
...
### `wordpress:5.2.1-php7.3-fpm` - linux; arm variant v7
...
### `wordpress:5.2.1-php7.3-fpm` - linux; arm64 variant v8
...
### `wordpress:5.2.1-php7.3-fpm` - linux; 386
