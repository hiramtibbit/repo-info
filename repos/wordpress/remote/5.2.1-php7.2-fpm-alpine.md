...
```console
$ docker pull wordpress@sha256:14b4a47ef2b37f1efbf229f777bd7a288b1921a51a035342bd5f3c80ae07fd48
```
...
### `wordpress:5.2.1-php7.2-fpm-alpine` - linux; amd64
...
### `wordpress:5.2.1-php7.2-fpm-alpine` - linux; arm variant v6
...
### `wordpress:5.2.1-php7.2-fpm-alpine` - linux; arm variant v7
...
### `wordpress:5.2.1-php7.2-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:5.2.1-php7.2-fpm-alpine` - linux; 386
