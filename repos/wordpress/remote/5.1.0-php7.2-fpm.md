## `wordpress:5.1.0-php7.2-fpm`

```console
$ docker pull wordpress@sha256:753eb74b54503c19a044931c7efd3e4cd102cbed4f217efcb5c70c9c5bab4875
```
...
### `wordpress:5.1.0-php7.2-fpm` - linux; amd64
...
### `wordpress:5.1.0-php7.2-fpm` - linux; arm variant v5
...
### `wordpress:5.1.0-php7.2-fpm` - linux; arm variant v7
...
### `wordpress:5.1.0-php7.2-fpm` - linux; arm64 variant v8
...
### `wordpress:5.1.0-php7.2-fpm` - linux; 386
...
### `wordpress:5.1.0-php7.2-fpm` - linux; ppc64le
