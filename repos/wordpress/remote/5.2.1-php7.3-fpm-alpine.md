...
```console
$ docker pull wordpress@sha256:0c016a292278198c907ea167d249990c50d62b58e47da713dbe69f9d6ba09553
```
...
### `wordpress:5.2.1-php7.3-fpm-alpine` - linux; amd64
...
### `wordpress:5.2.1-php7.3-fpm-alpine` - linux; arm variant v6
...
### `wordpress:5.2.1-php7.3-fpm-alpine` - linux; arm variant v7
...
### `wordpress:5.2.1-php7.3-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:5.2.1-php7.3-fpm-alpine` - linux; 386
