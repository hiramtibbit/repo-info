...
### `wordpress:5.2.1-php7.2-fpm` - linux; amd64
...
### `wordpress:5.2.1-php7.2-fpm` - linux; arm variant v5
...
### `wordpress:5.2.1-php7.2-fpm` - linux; arm variant v7
...
### `wordpress:5.2.1-php7.2-fpm` - linux; arm64 variant v8
...
### `wordpress:5.2.1-php7.2-fpm` - linux; 386
...
### `wordpress:5.2.1-php7.2-fpm` - linux; ppc64le
