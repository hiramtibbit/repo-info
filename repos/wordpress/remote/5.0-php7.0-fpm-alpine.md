...
### `wordpress:5.0-php7.0-fpm-alpine` - linux; arm variant v6
...
### `wordpress:5.0-php7.0-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:5.0-php7.0-fpm-alpine` - linux; 386
...
### `wordpress:5.0-php7.0-fpm-alpine` - linux; ppc64le
