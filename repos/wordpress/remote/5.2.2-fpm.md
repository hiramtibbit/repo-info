...
```console
$ docker pull wordpress@sha256:a7d916cf7d81f9b27ab6be5725ec06a4ca5bd910ca268fb95b36d1d80fc8af91
```
...
### `wordpress:5.2.2-fpm` - linux; arm variant v5
...
### `wordpress:5.2.2-fpm` - linux; arm variant v7
...
### `wordpress:5.2.2-fpm` - linux; arm64 variant v8
...
### `wordpress:5.2.2-fpm` - linux; ppc64le
