...
### `wordpress:4.9.5-fpm-alpine` - linux; amd64
...
### `wordpress:4.9.5-fpm-alpine` - linux; arm64 variant v8
...
### `wordpress:4.9.5-fpm-alpine` - linux; 386
...
### `wordpress:4.9.5-fpm-alpine` - linux; ppc64le
