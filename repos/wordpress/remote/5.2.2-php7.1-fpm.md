...
```console
$ docker pull wordpress@sha256:4acfc2df50c03fb5e95d02aaf18e15ec4ca621698642036116eaf90d5eb0d6be
```
...
### `wordpress:5.2.2-php7.1-fpm` - linux; arm64 variant v8
...
### `wordpress:5.2.2-php7.1-fpm` - linux; ppc64le
