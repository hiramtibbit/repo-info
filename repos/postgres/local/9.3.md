...
- Created: `2018-02-16T22:40:39.910812419Z`
...
### `dpkg` source package: `exim4=4.84.2-2+deb8u5`

Binary Packages:

- `exim4=4.84.2-2+deb8u5`
- `exim4-base=4.84.2-2+deb8u5`
- `exim4-config=4.84.2-2+deb8u5`
- `exim4-daemon-light=4.84.2-2+deb8u5`
...
```console
$ apt-get source -qq --print-uris exim4=4.84.2-2+deb8u5
'http://security.debian.org/pool/updates/main/e/exim4/exim4_4.84.2-2+deb8u5.dsc' exim4_4.84.2-2+deb8u5.dsc 2982 SHA256:61ebdcb9be9ed4ac81fb3124748b3c259002dd51b8005c2cb29c552eae07df72
...
'http://security.debian.org/pool/updates/main/e/exim4/exim4_4.84.2-2+deb8u5.debian.tar.xz' exim4_4.84.2-2+deb8u5.debian.tar.xz 425092 SHA256:c45062b4020cb2d8445ededc57563deb0ef5c4b1c00cdf0263e19f1766c7ace2
```

Other potentially useful URLs:

- https://sources.debian.net/src/exim4/4.84.2-2+deb8u5/ (for browsing the source)
- https://sources.debian.net/src/exim4/4.84.2-2+deb8u5/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/exim4/4.84.2-2+deb8u5/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `postgresql-10=10.2-1.pgdg80+1`

Binary Packages:

- `libpq5:amd64=10.2-1.pgdg80+1`
...
```console
$ apt-get source -qq --print-uris postgresql-10=10.2-1.pgdg80+1
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-10/postgresql-10_10.2-1.pgdg80+1.dsc' postgresql-10_10.2-1.pgdg80+1.dsc 2690 SHA256:81fe3af34b5e3ffd7332880f28a24097ec6552d5b1214d6e42e6ecef58cf16fe
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-10/postgresql-10_10.2.orig.tar.bz2' postgresql-10_10.2.orig.tar.bz2 19901836 SHA256:fe32009b62ddb97f7f014307ce9d0edb6972f5a698e63cb531088e147d145bad
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-10/postgresql-10_10.2-1.pgdg80+1.debian.tar.xz' postgresql-10_10.2-1.pgdg80+1.debian.tar.xz 21984 SHA256:b69aa9813a5cad4da6feb5ab374985aec05566610ff6a499ad3ec28f2c3e8856
```

### `dpkg` source package: `postgresql-9.3=9.3.21-1.pgdg80+1`

Binary Packages:

- `postgresql-9.3=9.3.21-1.pgdg80+1`
- `postgresql-client-9.3=9.3.21-1.pgdg80+1`
- `postgresql-contrib-9.3=9.3.21-1.pgdg80+1`
...
```console
$ apt-get source -qq --print-uris postgresql-9.3=9.3.21-1.pgdg80+1
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-9.3/postgresql-9.3_9.3.21-1.pgdg80+1.dsc' postgresql-9.3_9.3.21-1.pgdg80+1.dsc 2722 SHA256:58c8d128ba6a9f3a0e0c9db194d5ff904b2af6d2e4325989510318e401a7eadb
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-9.3/postgresql-9.3_9.3.21.orig.tar.bz2' postgresql-9.3_9.3.21.orig.tar.bz2 17014472 SHA256:b9babc5148188a410e023d7178a5678e989ec2e276498de6cd0028bc331a40e0
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-9.3/postgresql-9.3_9.3.21-1.pgdg80+1.debian.tar.xz' postgresql-9.3_9.3.21-1.pgdg80+1.debian.tar.xz 31460 SHA256:f51d7ea379276b2416b899dd15dbca204b1b98b8e0f4eea6c18887e7a709dd63
```

### `dpkg` source package: `postgresql-common=190.pgdg80+1`
...
```console
$ apt-get source -qq --print-uris postgresql-common=190.pgdg80+1
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-common/postgresql-common_190.pgdg80+1.dsc' postgresql-common_190.pgdg80+1.dsc 1473 SHA256:c4bc6d8c2415d779e3d69b5e886dbefbf64a8e64e3f97b706996a9eb2e8a3317
'http://apt.postgresql.org/pub/repos/apt/pool/main/p/postgresql-common/postgresql-common_190.pgdg80+1.tar.xz' postgresql-common_190.pgdg80+1.tar.xz 208000 SHA256:f0ce59d6a03d7f3c2356e6029099e853b1e8442f312cdecf34031457ad24582b
```
