...
```console
$ docker pull postgres@sha256:f7b4508e88dff53576a40328106db325cdc7da610fbf9bcd17a2af12bbc233bd
```
...
```console
$ docker pull postgres@sha256:7d1fc758f08286f68a9791189f34eb5a3144f7fd93f276e0a2da2e7a012d1819
```
