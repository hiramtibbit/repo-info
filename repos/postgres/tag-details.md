...
```console
$ docker pull postgres@sha256:739c7a0cd7ccfffc9f23148af9276bd0f8b56998911bceac84c7c8184c7ea41f
```
...
```console
$ docker pull postgres@sha256:df70f10874fcbc4961acddad3e96d4ec9ce0ee2229a9605135d0f6ef3d80ca86
```
