...
- Image ID: `sha256:9d98b98fbdf43624a1e9eaeb6563469c7fd9aab1f369daa8f1e76bb8d60e049c`
- Created: `2019-05-08T02:15:09.814800159Z`
- Virtual Size: ~ 664.62 Mb  
...
```console
$ apt-get source -qq --print-uris imagemagick=8:6.8.9.9-5+deb8u15
'http://security.debian.org/debian-security/pool/updates/main/i/imagemagick/imagemagick_6.8.9.9-5+deb8u15.dsc' imagemagick_6.8.9.9-5+deb8u15.dsc 4387 SHA256:313ecc4eb9075674656bfd4fa1cb473f3e0520a485ee3ebdc97d75fdef69840d
...
'http://security.debian.org/debian-security/pool/updates/main/i/imagemagick/imagemagick_6.8.9.9-5+deb8u15.debian.tar.xz' imagemagick_6.8.9.9-5+deb8u15.debian.tar.xz 299836 SHA256:24369e245732ba470c2283e19c41a3e87acba01eb9cdc95eb52e62b6d946b588
```

Other potentially useful URLs:

- https://sources.debian.net/src/imagemagick/8:6.8.9.9-5+deb8u15/ (for browsing the source)
- https://sources.debian.net/src/imagemagick/8:6.8.9.9-5+deb8u15/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/imagemagick/8:6.8.9.9-5+deb8u15/ (for access to the source package after it no longer exists in the archive)
...
```console
$ apt-get source -qq --print-uris jquery=1.7.2+dfsg-3.2+deb8u6
'http://security.debian.org/debian-security/pool/updates/main/j/jquery/jquery_1.7.2+dfsg-3.2+deb8u6.dsc' jquery_1.7.2+dfsg-3.2+deb8u6.dsc 2028 SHA256:ebb8947e539092493b9684146bdf9456689acc179f76717e7d3417e5e804c5db
...
'http://security.debian.org/debian-security/pool/updates/main/j/jquery/jquery_1.7.2+dfsg-3.2+deb8u6.debian.tar.xz' jquery_1.7.2+dfsg-3.2+deb8u6.debian.tar.xz 6348 SHA256:007b6eb38a4787c74173840b1dec1e86cd50494398b8fda50208b83718508ab3
```

Other potentially useful URLs:

- https://sources.debian.net/src/jquery/1.7.2+dfsg-3.2+deb8u6/ (for browsing the source)
- https://sources.debian.net/src/jquery/1.7.2+dfsg-3.2+deb8u6/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/jquery/1.7.2+dfsg-3.2+deb8u6/ (for access to the source package after it no longer exists in the archive)
