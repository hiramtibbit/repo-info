...
- Created: `2018-10-16T06:22:30.099266062Z`
- Virtual Size: ~ 669.79 Mb  
...
- `libcurl4-openssl-dev:amd64=7.38.0-4+deb8u12`
...
### `dpkg` source package: `imagemagick=8:6.8.9.9-5+deb8u14`

Binary Packages:

- `imagemagick=8:6.8.9.9-5+deb8u14`
- `imagemagick-6.q16=8:6.8.9.9-5+deb8u14`
- `imagemagick-common=8:6.8.9.9-5+deb8u14`
- `libmagickcore-6-arch-config:amd64=8:6.8.9.9-5+deb8u14`
- `libmagickcore-6-headers=8:6.8.9.9-5+deb8u14`
- `libmagickcore-6.q16-2:amd64=8:6.8.9.9-5+deb8u14`
- `libmagickcore-6.q16-2-extra:amd64=8:6.8.9.9-5+deb8u14`
- `libmagickcore-6.q16-dev:amd64=8:6.8.9.9-5+deb8u14`
- `libmagickcore-dev=8:6.8.9.9-5+deb8u14`
- `libmagickwand-6-headers=8:6.8.9.9-5+deb8u14`
- `libmagickwand-6.q16-2:amd64=8:6.8.9.9-5+deb8u14`
- `libmagickwand-6.q16-dev:amd64=8:6.8.9.9-5+deb8u14`
- `libmagickwand-dev=8:6.8.9.9-5+deb8u14`
...
```console
$ apt-get source -qq --print-uris imagemagick=8:6.8.9.9-5+deb8u14
'http://security.debian.org/debian-security/pool/updates/main/i/imagemagick/imagemagick_6.8.9.9-5+deb8u14.dsc' imagemagick_6.8.9.9-5+deb8u14.dsc 4228 SHA256:f29946f8630d34e09edfa3fffb12e0c4e7a34bc72f4b9b757de47ed4b5373ca5
...
'http://security.debian.org/debian-security/pool/updates/main/i/imagemagick/imagemagick_6.8.9.9-5+deb8u14.debian.tar.xz' imagemagick_6.8.9.9-5+deb8u14.debian.tar.xz 299976 SHA256:74839398d80486414f3c012b7786b9d9720e73231bf30721cd273237e50cdef7
```

Other potentially useful URLs:

- https://sources.debian.net/src/imagemagick/8:6.8.9.9-5+deb8u14/ (for browsing the source)
- https://sources.debian.net/src/imagemagick/8:6.8.9.9-5+deb8u14/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/imagemagick/8:6.8.9.9-5+deb8u14/ (for access to the source package after it no longer exists in the archive)
...
'http://deb.debian.org/debian/pool/main/m/mysql-5.5/mysql-5.5_5.5.60-0+deb8u1.dsc' mysql-5.5_5.5.60-0+deb8u1.dsc 3262 SHA256:7824cf6679015b030ac4ffedd0e84236c6e0a7b0197eabd15a7ee4e16b940d7f
'http://deb.debian.org/debian/pool/main/m/mysql-5.5/mysql-5.5_5.5.60.orig.tar.gz' mysql-5.5_5.5.60.orig.tar.gz 21025041 SHA256:a34112e1748823f6dfd0d129fe29a629cf35b8702f9dfaf1f24caf89ab523d1c
'http://deb.debian.org/debian/pool/main/m/mysql-5.5/mysql-5.5_5.5.60-0+deb8u1.debian.tar.xz' mysql-5.5_5.5.60-0+deb8u1.debian.tar.xz 232948 SHA256:4c3deb93fd81750b7d2c0ba0f376f72ccc61fe9552895fe5ad3940282792e63e
```
...
### `dpkg` source package: `openssh=1:6.7p1-5+deb8u7`

Binary Packages:

- `openssh-client=1:6.7p1-5+deb8u7`
...
```console
$ apt-get source -qq --print-uris openssh=1:6.7p1-5+deb8u7
'http://security.debian.org/debian-security/pool/updates/main/o/openssh/openssh_6.7p1-5+deb8u7.dsc' openssh_6.7p1-5+deb8u7.dsc 2756 SHA256:8f8ec5af0065b70f6ad4c2289f3f3bdb43d01c9fa63349d821179a7be9daded2
...
'http://security.debian.org/debian-security/pool/updates/main/o/openssh/openssh_6.7p1-5+deb8u7.debian.tar.xz' openssh_6.7p1-5+deb8u7.debian.tar.xz 165996 SHA256:e3ad4ccf99232da756630dc8a782f05dfa3d6979145585bafaeb2819fe903266
```

Other potentially useful URLs:

- https://sources.debian.net/src/openssh/1:6.7p1-5+deb8u7/ (for browsing the source)
...
```console
$ apt-get source -qq --print-uris patch=2.7.5-1+deb8u1
'http://deb.debian.org/debian/pool/main/p/patch/patch_2.7.5-1+deb8u1.dsc' patch_2.7.5-1+deb8u1.dsc 1860 SHA256:5cf36254ba67fa20973387617c4d22c9ffb4774aab29cb80424344921a875c1f
...
'http://deb.debian.org/debian/pool/main/p/patch/patch_2.7.5-1+deb8u1.debian.tar.xz' patch_2.7.5-1+deb8u1.debian.tar.xz 10612 SHA256:4b0158c62f63e24b42d7bcfbd6f7268176f9b29b2150c0d3633234e82c3b0d20
```

Other potentially useful URLs:

- https://sources.debian.net/src/patch/2.7.5-1+deb8u1/ (for browsing the source)
- https://sources.debian.net/src/patch/2.7.5-1+deb8u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/patch/2.7.5-1+deb8u1/ (for access to the source package after it no longer exists in the archive)
...
- `libtiff5-dev:amd64=4.0.3-12.3+deb8u6`
- `libtiffxx5:amd64=4.0.3-12.3+deb8u6`
