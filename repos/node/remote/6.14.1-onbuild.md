...
### `node:6.14.1-onbuild` - linux; amd64
...
### `node:6.14.1-onbuild` - linux; arm variant v7
...
### `node:6.14.1-onbuild` - linux; arm64 variant v8
...
### `node:6.14.1-onbuild` - linux; ppc64le
...
### `node:6.14.1-onbuild` - linux; s390x
