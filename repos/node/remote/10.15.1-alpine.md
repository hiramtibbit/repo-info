...
```console
$ docker pull node@sha256:bd463e98e9d3e817c9b19ccf30055b63f5adea56624fd0b8836a329308da89dd
```
...
### `node:10.15.1-alpine` - linux; amd64
...
### `node:10.15.1-alpine` - linux; arm variant v6
...
### `node:10.15.1-alpine` - linux; arm64 variant v8
...
### `node:10.15.1-alpine` - linux; ppc64le
