...
```console
$ docker pull node@sha256:ca12dd0664cba60c0dee18fb0cfa73336285f0d0ac915d61cb1c8a04aa0f74e6
```
...
### `node:9.6` - linux; amd64

```console
$ docker pull node@sha256:6aedde74f014b9801cb0867ee61868774862ff5e8faed205bee3b2a51a04b46c
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **269.7 MB (269721101 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29831ba76d9371cece19db2fd3bed889eb471a4a5d6634102011cb1105a8e167`
...
### `node:9.6` - linux; arm variant v7

```console
$ docker pull node@sha256:837beadfd72a9a1fab7f2a9e16ecbd2e74ef86bd79b132190833c2e92e2896fe
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **239.6 MB (239583595 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:659dab8b255a91fd7be86928994157fca6aa56bbada74c495b4a7f4b290cb722`
-	Default Command: `["node"]`
...
### `node:9.6` - linux; arm64 variant v8

```console
$ docker pull node@sha256:cb3c11563ed4ab3f4ca4af50ad227c61a6b756099bfad534e82f758d5406b90a
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **245.2 MB (245228991 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e05a1f5c13bccf2dcffe49f07270e4ff03953562b4111d3468776706d4308d3d`
-	Default Command: `["node"]`
...
RUN set -ex   && for key in     94AE36675C464D64BAFA68DD7434390BDBE9B9C5     FD3A5288F042B6850C66B31F09FE44734EB7990E     71DCFD284A79C3B38668286BC97EC7A07EDE3FC1     DD8F2338BAE7501E3DD5AC78C273792F7D83545D     C4F0DFFF4E8C1A8236409D08E73BC641CC11F4C8     B9AE9905FFD7803F25714661B63B535A4C206CA9     56730D5401028683275BD23C23EFEFE93C4CFFFE     77984A986EBC2AA786BC0F66B01FBB92821C587A   ; do     gpg --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys "$key" ||     gpg --keyserver hkp://ipv4.pool.sks-keyservers.net --recv-keys "$key" ||     gpg --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done
# Sat, 24 Feb 2018 13:00:27 GMT
ENV NODE_VERSION=9.6.1
# Sat, 24 Feb 2018 13:00:37 GMT
RUN ARCH= && dpkgArch="$(dpkg --print-architecture)"   && case "${dpkgArch##*-}" in     amd64) ARCH='x64';;     ppc64el) ARCH='ppc64le';;     s390x) ARCH='s390x';;     arm64) ARCH='arm64';;     armhf) ARCH='armv7l';;     i386) ARCH='x86';;     *) echo "unsupported architecture"; exit 1 ;;   esac   && curl -SLO "https://nodejs.org/dist/v$NODE_VERSION/node-v$NODE_VERSION-linux-$ARCH.tar.xz"   && curl -SLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/SHASUMS256.txt.asc"   && gpg --batch --decrypt --output SHASUMS256.txt SHASUMS256.txt.asc   && grep " node-v$NODE_VERSION-linux-$ARCH.tar.xz\$" SHASUMS256.txt | sha256sum -c -   && tar -xJf "node-v$NODE_VERSION-linux-$ARCH.tar.xz" -C /usr/local --strip-components=1 --no-same-owner   && rm "node-v$NODE_VERSION-linux-$ARCH.tar.xz" SHASUMS256.txt.asc SHASUMS256.txt   && ln -s /usr/local/bin/node /usr/local/bin/nodejs
# Sat, 24 Feb 2018 13:00:37 GMT
ENV YARN_VERSION=1.3.2
# Sat, 24 Feb 2018 13:00:43 GMT
RUN set -ex   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     gpg --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys "$key" ||     gpg --keyserver hkp://ipv4.pool.sks-keyservers.net --recv-keys "$key" ||     gpg --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done   && curl -fSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && mkdir -p /opt/yarn   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/yarn --strip-components=1   && ln -s /opt/yarn/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn/bin/yarn /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz
# Sat, 24 Feb 2018 13:00:43 GMT
CMD ["node"]
```
...
-	Layers:
	...
	-	`sha256:b1651f48243cc340c8524495a9974f54e510e1cee78b9582ade86beba397c531`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:5dff1c10a60ab07dfdc918d038fee189c2fcaedcc111979613fad3e11d59105f`  
		Last Modified: Sat, 24 Feb 2018 13:32:55 GMT  
		Size: 18.5 MB (18475024 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d0508d9bae4421c4ca481efc26d6c507ef7c51d2b2b27181914d1e21a2dcef4c`  
		Last Modified: Sat, 24 Feb 2018 13:32:48 GMT  
...
```console
$ docker pull node@sha256:2d051f2e317ce95be6a65f5121e4a4ae4285fb35eae2784b91a44adf95b8cfde
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **273.3 MB (273273206 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c370cfe7bb7eee753d9166c61b53289d425d53aabea2eb4945d322c1ec079bd1`
-	Default Command: `["node"]`
...
RUN set -ex   && for key in     94AE36675C464D64BAFA68DD7434390BDBE9B9C5     FD3A5288F042B6850C66B31F09FE44734EB7990E     71DCFD284A79C3B38668286BC97EC7A07EDE3FC1     DD8F2338BAE7501E3DD5AC78C273792F7D83545D     C4F0DFFF4E8C1A8236409D08E73BC641CC11F4C8     B9AE9905FFD7803F25714661B63B535A4C206CA9     56730D5401028683275BD23C23EFEFE93C4CFFFE     77984A986EBC2AA786BC0F66B01FBB92821C587A   ; do     gpg --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys "$key" ||     gpg --keyserver hkp://ipv4.pool.sks-keyservers.net --recv-keys "$key" ||     gpg --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done
# Sat, 24 Feb 2018 22:27:21 GMT
ENV NODE_VERSION=9.6.1
# Sat, 24 Feb 2018 22:33:51 GMT
RUN ARCH= && dpkgArch="$(dpkg --print-architecture)"   && case "${dpkgArch##*-}" in     amd64) ARCH='x64';;     ppc64el) ARCH='ppc64le';;     s390x) ARCH='s390x';;     arm64) ARCH='arm64';;     armhf) ARCH='armv7l';;     i386) ARCH='x86';;     *) echo "unsupported architecture"; exit 1 ;;   esac   && curl -SLO "https://nodejs.org/dist/v$NODE_VERSION/node-v$NODE_VERSION-linux-$ARCH.tar.xz"   && curl -SLO --compressed "https://nodejs.org/dist/v$NODE_VERSION/SHASUMS256.txt.asc"   && gpg --batch --decrypt --output SHASUMS256.txt SHASUMS256.txt.asc   && grep " node-v$NODE_VERSION-linux-$ARCH.tar.xz\$" SHASUMS256.txt | sha256sum -c -   && tar -xJf "node-v$NODE_VERSION-linux-$ARCH.tar.xz" -C /usr/local --strip-components=1 --no-same-owner   && rm "node-v$NODE_VERSION-linux-$ARCH.tar.xz" SHASUMS256.txt.asc SHASUMS256.txt   && ln -s /usr/local/bin/node /usr/local/bin/nodejs
# Sat, 24 Feb 2018 22:33:52 GMT
ENV YARN_VERSION=1.3.2
# Sat, 24 Feb 2018 22:33:57 GMT
RUN set -ex   && for key in     6A010C5166006599AA17F08146C2130DFD2497F5   ; do     gpg --keyserver hkp://p80.pool.sks-keyservers.net:80 --recv-keys "$key" ||     gpg --keyserver hkp://ipv4.pool.sks-keyservers.net --recv-keys "$key" ||     gpg --keyserver hkp://pgp.mit.edu:80 --recv-keys "$key" ;   done   && curl -fSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz"   && curl -fSLO --compressed "https://yarnpkg.com/downloads/$YARN_VERSION/yarn-v$YARN_VERSION.tar.gz.asc"   && gpg --batch --verify yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz   && mkdir -p /opt/yarn   && tar -xzf yarn-v$YARN_VERSION.tar.gz -C /opt/yarn --strip-components=1   && ln -s /opt/yarn/bin/yarn /usr/local/bin/yarn   && ln -s /opt/yarn/bin/yarn /usr/local/bin/yarnpkg   && rm yarn-v$YARN_VERSION.tar.gz.asc yarn-v$YARN_VERSION.tar.gz
# Sat, 24 Feb 2018 22:33:57 GMT
CMD ["node"]
```
...
-	Layers:
	...
	-	`sha256:46d247aff2e868841dd39fd04c5cb43d5d934168197561bfccadf276297d1723`  
		...
		Size: 117.6 KB (117627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4ce26e135dc595b970900839b786b5438d848ae00b1d654df3fb031d9ddd8c73`  
		Last Modified: Sun, 25 Feb 2018 00:05:33 GMT  
		Size: 18.1 MB (18072089 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7fb3d872fe9af8c431f0be9eead4f7d09dcc1b5de131ccc0eca2b6db6f8c2d07`  
		Last Modified: Sun, 25 Feb 2018 00:05:25 GMT  
		Size: 1.0 MB (1010352 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `node:9.6` - linux; ppc64le

```console
$ docker pull node@sha256:8b55da8f9a1f5f95c69ffd7f7399bfc21ceb2264fb9e50cf8fc848fb79425b20
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **256.2 MB (256199172 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:cfd0932ee7e7cc6171dd4fb47c6beb4f025456eb8faa65ce64d7a8ce2da97f54`
-	Default Command: `["node"]`
...
### `node:9.6` - linux; s390x

```console
$ docker pull node@sha256:91395fe245575b8e6bd2865a0638254af0e320e950e022c1bd7c07e389164b85
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **251.8 MB (251750744 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:69d424607f721099a61cf7272a25800b13a646d5ab91a605b780de3c354cafd0`
-	Default Command: `["node"]`
