...
```console
$ docker pull node@sha256:aa44ed1114e6e285ae950ec4a3e52100a4ff4f2f753c9a237357408417d8f9b5
```
...
```console
$ docker pull node@sha256:7b767e34d06ad1154ec105c15a79411642379c6dac7a6aa18905c4593b6a080a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **329.6 MB (329637897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0383f837165591864e2f9a69175bfe1e6894f735686f3d97e4699458a1ced162`
-	Default Command: `["node"]`
