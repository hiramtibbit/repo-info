...
### `node:10.12.0-jessie` - linux; amd64
...
### `node:10.12.0-jessie` - linux; arm variant v7
...
### `node:10.12.0-jessie` - linux; arm64 variant v8
...
### `node:10.12.0-jessie` - linux; ppc64le
...
### `node:10.12.0-jessie` - linux; s390x
