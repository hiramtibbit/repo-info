...
```console
$ docker pull node@sha256:717f84f9aa6a51a5c2914100812937261551e50a88f2323acc0b1d43a081b6e2
```
...
```console
$ docker pull node@sha256:14734ea4e162ba32073a4d9513eb0eb661fe5151d558f11545144b48ffd1710b
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **326.5 MB (326517990 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:daa43560ebd566950643f89721b8085287e8a6727298ce6271db8c8f4c31a47d`
-	Default Command: `["node"]`
