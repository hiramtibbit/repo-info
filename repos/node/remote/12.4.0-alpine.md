...
### `node:12.4.0-alpine` - linux; amd64
...
### `node:12.4.0-alpine` - linux; arm variant v6
...
### `node:12.4.0-alpine` - linux; arm64 variant v8
...
### `node:12.4.0-alpine` - linux; ppc64le
...
### `node:12.4.0-alpine` - linux; s390x
