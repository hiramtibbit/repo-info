...
```console
$ docker pull python@sha256:a22d07f5f5c30bd3bb2930facff5e86376616719661cb71ebcefa455721a0df8
```
...
### `python:2.7.15-windowsservercore-1709` - windows version 10.0.16299.547; amd64
