...
```console
$ docker pull python@sha256:befcca1d250e876ba0c171f65483b9e1717d7192a26a9f1cd38159358301475b
```
...
### `python:3.8.0a3-windowsservercore` - windows version 10.0.14393.2906; amd64
...
### `python:3.8.0a3-windowsservercore` - windows version 10.0.17134.706; amd64
...
### `python:3.8.0a3-windowsservercore` - windows version 10.0.17763.437; amd64
