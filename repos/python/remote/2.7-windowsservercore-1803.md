...
```console
$ docker pull python@sha256:62d6a0ecae51c676120a95990d4394c00997980fe6e037ee35efaf88862a32f5
```
...
### `python:2.7-windowsservercore-1803` - windows version 10.0.17134.829; amd64
