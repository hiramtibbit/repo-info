...
```console
$ docker pull geonetwork@sha256:80937c09e3d8a18714adf30f2b730d8ecc172ccd5ba99b7ae63ae020be587047
```
...
### `geonetwork:3.4.4` - linux; arm variant v5
...
### `geonetwork:3.4.4` - linux; arm variant v7
...
### `geonetwork:3.4.4` - linux; arm64 variant v8

```console
$ docker pull geonetwork@sha256:c44d03ac3d816390b176a787fbe52264a391635e677d59db69a53463d0fa9776
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **383.2 MB (383215220 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e0767eaec212660cbfcafc0aa1340bc723811e27a4cc887619e862290b713531`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
CMD ["catalina.sh" "run"]
# Fri, 21 Dec 2018 18:37:43 GMT
ENV GN_FILE=geonetwork.war
# Fri, 21 Dec 2018 18:37:44 GMT
ENV DATA_DIR=/usr/local/tomcat/webapps/geonetwork/WEB-INF/data
# Fri, 21 Dec 2018 18:37:45 GMT
ENV JAVA_OPTS=-Djava.security.egd=file:/dev/./urandom -Djava.awt.headless=true -server -Xms512m -Xmx2024m -XX:NewSize=512m -XX:MaxNewSize=1024m -XX:+UseConcMarkSweepGC
# Fri, 21 Dec 2018 18:37:45 GMT
ENV GN_VERSION=3.4.4
# Fri, 21 Dec 2018 18:37:46 GMT
ENV GN_DOWNLOAD_MD5=279ea63b0f75499d02316b320cf3db3e
# Fri, 21 Dec 2018 18:37:47 GMT
WORKDIR /usr/local/tomcat/webapps
# Fri, 21 Dec 2018 18:38:43 GMT
RUN curl -fSL -o $GN_FILE      https://sourceforge.net/projects/geonetwork/files/GeoNetwork_opensource/v${GN_VERSION}/geonetwork.war/download &&      echo "$GN_DOWNLOAD_MD5 *$GN_FILE" | md5sum -c &&      mkdir -p geonetwork &&      unzip -e $GN_FILE -d geonetwork &&      rm $GN_FILE
# Fri, 21 Dec 2018 18:38:44 GMT
COPY file:fcee1ded842f9b80c807c1cef013ef44bfe36355c5364789718ccc1163675e78 in /entrypoint.sh 
...
-	Layers:
	...
	-	`sha256:1624a124a32788e45db6d128310b8f9c759175a08fb8e83475a97ec22a11f48b`  
		...
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ec5318070fd7654dd40c4313e9d456d11260b21e258274ee00c5c7f7390d8a99`  
		Last Modified: Fri, 21 Dec 2018 18:41:01 GMT  
		Size: 196.7 MB (196734741 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:05578b36e8995c2f7b34ee769a5ec0ecf5a462083b5d80456381757cfef89c45`  
		Last Modified: Fri, 21 Dec 2018 18:40:20 GMT  
		Size: 249.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `geonetwork:3.4.4` - linux; 386

```console
$ docker pull geonetwork@sha256:7d47cb952a848bd5094455435a94043fec4eb02521e298a533ef8d654fbfd3e5
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **398.0 MB (397997734 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:030ef86665e59d74e2fa9ffdbe39d97db9bb7518330827a4714d042721ab1b29`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 20 Dec 2018 13:04:09 GMT
CMD ["catalina.sh" "run"]
# Thu, 20 Dec 2018 13:26:25 GMT
ENV GN_FILE=geonetwork.war
# Thu, 20 Dec 2018 13:26:25 GMT
ENV DATA_DIR=/usr/local/tomcat/webapps/geonetwork/WEB-INF/data
# Thu, 20 Dec 2018 13:26:26 GMT
ENV JAVA_OPTS=-Djava.security.egd=file:/dev/./urandom -Djava.awt.headless=true -server -Xms512m -Xmx2024m -XX:NewSize=512m -XX:MaxNewSize=1024m -XX:+UseConcMarkSweepGC
# Thu, 20 Dec 2018 13:26:26 GMT
ENV GN_VERSION=3.4.4
# Thu, 20 Dec 2018 13:26:26 GMT
...
# Thu, 20 Dec 2018 13:26:26 GMT
WORKDIR /usr/local/tomcat/webapps
# Thu, 20 Dec 2018 13:27:32 GMT
RUN curl -fSL -o $GN_FILE      https://sourceforge.net/projects/geonetwork/files/GeoNetwork_opensource/v${GN_VERSION}/geonetwork.war/download &&      echo "$GN_DOWNLOAD_MD5 *$GN_FILE" | md5sum -c &&      mkdir -p geonetwork &&      unzip -e $GN_FILE -d geonetwork &&      rm $GN_FILE
# Thu, 20 Dec 2018 13:27:33 GMT
COPY file:fcee1ded842f9b80c807c1cef013ef44bfe36355c5364789718ccc1163675e78 in /entrypoint.sh 
# Thu, 20 Dec 2018 13:27:33 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 20 Dec 2018 13:27:33 GMT
...
-	Layers:
	...
	-	`sha256:35dacb6e78d3e89eee2abc29c19069ef9e952fbfdb0261bdd79be77c8ae7024b`  
		...
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:2544051bf25660da0729bcec9cbea51f980f4ce943b73ee6ab8b4d7b8dcc71e0`  
		Last Modified: Thu, 20 Dec 2018 13:28:23 GMT  
		Size: 196.7 MB (196734734 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:f01e3454d4c2a851d24fa13aa398fb8be0cab47f8173d4caea49338bd8739364`  
		Last Modified: Thu, 20 Dec 2018 13:28:02 GMT  
		Size: 249.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `geonetwork:3.4.4` - linux; ppc64le

```console
$ docker pull geonetwork@sha256:fb6cd10d31760b21a1bf5a51d0add33831d869193905484d14f7c7afd5f0f96d
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **388.0 MB (388022803 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f36603ef2236d5e10d98ef6005e7256c24a98243652a5f428a19e83beb2e937b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
ENV TOMCAT_MAJOR=8
# Thu, 20 Dec 2018 10:06:00 GMT
ENV TOMCAT_VERSION=8.5.37
# Thu, 20 Dec 2018 10:06:04 GMT
ENV TOMCAT_SHA512=be6d6df8b49a760b2e181d4a45d8e6dc7bba5ef2ec6a000f8562cf5f34db5b7fac300cba65bca782bfd25a9f9d8d4a48625f1ad046115c1d6629ea5f210a2718
# Thu, 20 Dec 2018 10:06:09 GMT
ENV TOMCAT_TGZ_URLS=https://www.apache.org/dyn/closer.cgi?action=download&filename=tomcat/tomcat-8/v8.5.37/bin/apache-tomcat-8.5.37.tar.gz 	https://www-us.apache.org/dist/tomcat/tomcat-8/v8.5.37/bin/apache-tomcat-8.5.37.tar.gz 	https://www.apache.org/dist/tomcat/tomcat-8/v8.5.37/bin/apache-tomcat-8.5.37.tar.gz 	https://archive.apache.org/dist/tomcat/tomcat-8/v8.5.37/bin/apache-tomcat-8.5.37.tar.gz
# Thu, 20 Dec 2018 10:06:12 GMT
ENV TOMCAT_ASC_URLS=https://www.apache.org/dyn/closer.cgi?action=download&filename=tomcat/tomcat-8/v8.5.37/bin/apache-tomcat-8.5.37.tar.gz.asc 	https://www-us.apache.org/dist/tomcat/tomcat-8/v8.5.37/bin/apache-tomcat-8.5.37.tar.gz.asc 	https://www.apache.org/dist/tomcat/tomcat-8/v8.5.37/bin/apache-tomcat-8.5.37.tar.gz.asc 	https://archive.apache.org/dist/tomcat/tomcat-8/v8.5.37/bin/apache-tomcat-8.5.37.tar.gz.asc
# Thu, 20 Dec 2018 10:10:15 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 		apt-get install -y --no-install-recommends gnupg dirmngr; 		export GNUPGHOME="$(mktemp -d)"; 	for key in $GPG_KEYS; do 		gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys "$key"; 	done; 		apt-get install -y --no-install-recommends wget ca-certificates; 		success=; 	for url in $TOMCAT_TGZ_URLS; do 		if wget -O tomcat.tar.gz "$url"; then 			success=1; 			break; 		fi; 	done; 	[ -n "$success" ]; 		echo "$TOMCAT_SHA512 *tomcat.tar.gz" | sha512sum -c -; 		success=; 	for url in $TOMCAT_ASC_URLS; do 		if wget -O tomcat.tar.gz.asc "$url"; then 			success=1; 			break; 		fi; 	done; 	[ -n "$success" ]; 		gpg --batch --verify tomcat.tar.gz.asc tomcat.tar.gz; 	tar -xvf tomcat.tar.gz --strip-components=1; 	rm bin/*.bat; 	rm tomcat.tar.gz*; 	command -v gpgconf && gpgconf --kill all || :; 	rm -rf "$GNUPGHOME"; 		nativeBuildDir="$(mktemp -d)"; 	tar -xvf bin/tomcat-native.tar.gz -C "$nativeBuildDir" --strip-components=1; 	apt-get install -y --no-install-recommends 		dpkg-dev 		gcc 		libapr1-dev 		libssl-dev 		make 		"openjdk-${JAVA_VERSION%%[.~bu-]*}-jdk=$JAVA_DEBIAN_VERSION" 	; 	( 		export CATALINA_HOME="$PWD"; 		cd "$nativeBuildDir/native"; 		gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 		./configure 			--build="$gnuArch" 			--libdir="$TOMCAT_NATIVE_LIBDIR" 			--prefix="$CATALINA_HOME" 			--with-apr="$(which apr-1-config)" 			--with-java-home="$(docker-java-home)" 			--with-ssl=yes; 		make -j "$(nproc)"; 		make install; 	); 	rm -rf "$nativeBuildDir"; 	rm bin/tomcat-native.tar.gz; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 	rm -rf /var/lib/apt/lists/*; 		find ./bin/ -name '*.sh' -exec sed -ri 's|^#!/bin/sh$|#!/usr/bin/env bash|' '{}' +; 		chmod -R +rX .; 	chmod 777 logs work
# Thu, 20 Dec 2018 10:10:36 GMT
RUN set -e 	&& nativeLines="$(catalina.sh configtest 2>&1)" 	&& nativeLines="$(echo "$nativeLines" | grep 'Apache Tomcat Native')" 	&& nativeLines="$(echo "$nativeLines" | sort -u)" 	&& if ! echo "$nativeLines" | grep 'INFO: Loaded APR based Apache Tomcat Native library' >&2; then 		echo >&2 "$nativeLines"; 		exit 1; 	fi
# Thu, 20 Dec 2018 10:10:42 GMT
EXPOSE 8080
# Thu, 20 Dec 2018 10:10:48 GMT
CMD ["catalina.sh" "run"]
# Thu, 20 Dec 2018 10:58:00 GMT
ENV GN_FILE=geonetwork.war
# Thu, 20 Dec 2018 10:58:02 GMT
ENV DATA_DIR=/usr/local/tomcat/webapps/geonetwork/WEB-INF/data
# Thu, 20 Dec 2018 10:58:03 GMT
ENV JAVA_OPTS=-Djava.security.egd=file:/dev/./urandom -Djava.awt.headless=true -server -Xms512m -Xmx2024m -XX:NewSize=512m -XX:MaxNewSize=1024m -XX:+UseConcMarkSweepGC
# Thu, 20 Dec 2018 10:58:06 GMT
ENV GN_VERSION=3.4.4
# Thu, 20 Dec 2018 10:58:08 GMT
ENV GN_DOWNLOAD_MD5=279ea63b0f75499d02316b320cf3db3e
# Thu, 20 Dec 2018 10:58:11 GMT
WORKDIR /usr/local/tomcat/webapps
# Thu, 20 Dec 2018 11:00:06 GMT
RUN curl -fSL -o $GN_FILE      https://sourceforge.net/projects/geonetwork/files/GeoNetwork_opensource/v${GN_VERSION}/geonetwork.war/download &&      echo "$GN_DOWNLOAD_MD5 *$GN_FILE" | md5sum -c &&      mkdir -p geonetwork &&      unzip -e $GN_FILE -d geonetwork &&      rm $GN_FILE
# Thu, 20 Dec 2018 11:00:12 GMT
COPY file:fcee1ded842f9b80c807c1cef013ef44bfe36355c5364789718ccc1163675e78 in /entrypoint.sh 
# Thu, 20 Dec 2018 11:00:16 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 20 Dec 2018 11:00:22 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:43818ef190753ad098f4c52ed78d9387e4f1b26a8ff9c69131d886306f8c9db0`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:454a5177cfb337a0be4f32c75d1b9186ced12a6a4e5a7de44220a2f904b33ab7`  
		Last Modified: Thu, 20 Dec 2018 10:39:55 GMT  
		Size: 14.1 MB (14078789 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b42da1269a89267beefccf298368b804332b4a49bee9f47e26bf88fc3ee5d7c6`  
		Last Modified: Thu, 20 Dec 2018 10:39:42 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8fd015aa23eb03cf336ef7fe132a81c6e62a3b791650a3a7c69bad203ab8f83a`  
		Last Modified: Thu, 20 Dec 2018 11:04:04 GMT  
		Size: 196.7 MB (196734769 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:b6e0813ff59f66a01a9c83850a5450749c057d2f0d092274c9f4477ddb7dbfb6`  
		Last Modified: Thu, 20 Dec 2018 11:03:40 GMT  
		Size: 250.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `geonetwork:3.4.4` - linux; s390x

```console
$ docker pull geonetwork@sha256:04278f372cb2f264215bfe32d1dc7b6420d88dc239ddc93f061f6d4ae3539c7a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **387.9 MB (387893007 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:414fd17d49328ceeef5b67181a00507a8623e13e0b717c7f93499101ec8f3a8b`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["catalina.sh","run"]`
...
# Thu, 20 Dec 2018 13:24:04 GMT
CMD ["catalina.sh" "run"]
# Thu, 20 Dec 2018 13:45:24 GMT
ENV GN_FILE=geonetwork.war
# Thu, 20 Dec 2018 13:45:25 GMT
ENV DATA_DIR=/usr/local/tomcat/webapps/geonetwork/WEB-INF/data
# Thu, 20 Dec 2018 13:45:25 GMT
ENV JAVA_OPTS=-Djava.security.egd=file:/dev/./urandom -Djava.awt.headless=true -server -Xms512m -Xmx2024m -XX:NewSize=512m -XX:MaxNewSize=1024m -XX:+UseConcMarkSweepGC
# Thu, 20 Dec 2018 13:45:25 GMT
...
# Thu, 20 Dec 2018 13:45:25 GMT
WORKDIR /usr/local/tomcat/webapps
# Thu, 20 Dec 2018 13:45:37 GMT
RUN curl -fSL -o $GN_FILE      https://sourceforge.net/projects/geonetwork/files/GeoNetwork_opensource/v${GN_VERSION}/geonetwork.war/download &&      echo "$GN_DOWNLOAD_MD5 *$GN_FILE" | md5sum -c &&      mkdir -p geonetwork &&      unzip -e $GN_FILE -d geonetwork &&      rm $GN_FILE
# Thu, 20 Dec 2018 13:45:37 GMT
COPY file:fcee1ded842f9b80c807c1cef013ef44bfe36355c5364789718ccc1163675e78 in /entrypoint.sh 
# Thu, 20 Dec 2018 13:45:37 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 20 Dec 2018 13:45:38 GMT
CMD ["catalina.sh" "run"]
```
...
-	Layers:
	...
	-	`sha256:20476cc87431dd2b8652371ae10df7652c8786ae4dc40ef33858676e27eaea91`  
		...
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c5a431c07544ab418f653278b631b2e1fd330bcc19d58af7a838b73b3ad09efc`  
		Last Modified: Thu, 20 Dec 2018 13:46:27 GMT  
		Size: 196.7 MB (196734773 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:331cf7378121c217c4816fc335ffbd7e103f944b3a535166e4b29e6ca0753951`  
		Last Modified: Thu, 20 Dec 2018 13:46:07 GMT  
		Size: 249.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
