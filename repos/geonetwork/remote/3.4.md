...
```console
$ docker pull geonetwork@sha256:ae748ddb50bcb510edf593c3cbbf180aabecd525d24e4d9c21d461740d3c23c1
```
...
```console
$ docker pull geonetwork@sha256:10fa0491ca8313ec5f17c347b0817d054f33b5ac77c699db568c2c858bd1bd68
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **392.3 MB (392347677 bytes)**  
