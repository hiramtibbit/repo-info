...
### `nginx:1.15.12-perl` - linux; amd64
...
### `nginx:1.15.12-perl` - linux; arm variant v7
...
### `nginx:1.15.12-perl` - linux; arm64 variant v8
...
### `nginx:1.15.12-perl` - linux; ppc64le
...
### `nginx:1.15.12-perl` - linux; s390x
