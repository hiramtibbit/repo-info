...
-	[`nginx:1.15`](#nginx115)
-	[`nginx:1.15.2`](#nginx1152)
-	[`nginx:1.15.2-alpine`](#nginx1152-alpine)
-	[`nginx:1.15.2-alpine-perl`](#nginx1152-alpine-perl)
-	[`nginx:1.15.2-perl`](#nginx1152-perl)
...
### `nginx:1.15.2-alpine` - linux; amd64
...
### `nginx:1.15.2-alpine` - linux; arm variant v6
...
### `nginx:1.15.2-alpine` - linux; arm64 variant v8
...
### `nginx:1.15.2-alpine` - linux; ppc64le
...
```console
$ docker pull nginx@sha256:06c8ac16f4b93abd8d94e87aa1afcf8861c8a482a1f5fbb4f1195938c252ffce
```
...
### `nginx:1.15.2-alpine-perl` - linux; arm variant v6
...
### `nginx:1.15.2-alpine-perl` - linux; arm64 variant v8
...
### `nginx:1.15.2-alpine-perl` - linux; 386
...
### `nginx:1.15.2-alpine-perl` - linux; ppc64le
...
### `nginx:1.15.2-perl` - linux; arm64 variant v8
...
### `nginx:1.15.2-perl` - linux; ppc64le
