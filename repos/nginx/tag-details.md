...
-	[`nginx:1.13`](#nginx113)
-	[`nginx:1.13.10`](#nginx11310)
-	[`nginx:1.13.10-alpine`](#nginx11310-alpine)
-	[`nginx:1.13.10-alpine-perl`](#nginx11310-alpine-perl)
-	[`nginx:1.13.10-perl`](#nginx11310-perl)
...
### `nginx:1.13.10` - linux; arm variant v7
...
### `nginx:1.13.10-alpine` - linux; arm64 variant v8
...
### `nginx:1.13.10-alpine` - linux; 386
...
### `nginx:1.13.10-alpine` - linux; ppc64le
...
### `nginx:1.13.10-alpine-perl` - linux; amd64
...
### `nginx:1.13.10-alpine-perl` - linux; arm64 variant v8
...
### `nginx:1.13.10-alpine-perl` - linux; 386
...
### `nginx:1.13.10-alpine-perl` - linux; ppc64le
...
### `nginx:1.13.10-alpine-perl` - linux; s390x
