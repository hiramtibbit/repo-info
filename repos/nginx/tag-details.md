...
```console
$ docker pull nginx@sha256:1c1904acacb3c494df70c578ec777b0fb7b2b7d1e45d01f447396d1a7302d967
```
...
```console
$ docker pull nginx@sha256:3add6e62aaa68ea9b7ef5e9a7366223dae46b02f8c6580a7c5127cad07cb8193
```
