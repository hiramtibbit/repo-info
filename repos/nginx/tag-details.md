...
-	[`nginx:1`](#nginx1)
-	[`nginx:1.14`](#nginx114)
-	[`nginx:1.14.0`](#nginx1140)
-	[`nginx:1.14.0-alpine`](#nginx1140-alpine)
-	[`nginx:1.14.0-alpine-perl`](#nginx1140-alpine-perl)
-	[`nginx:1.14.0-perl`](#nginx1140-perl)
-	[`nginx:1.14-alpine`](#nginx114-alpine)
-	[`nginx:1.14-alpine-perl`](#nginx114-alpine-perl)
-	[`nginx:1.14-perl`](#nginx114-perl)
-	[`nginx:1.15`](#nginx115)
-	[`nginx:1.15.5`](#nginx1155)
-	[`nginx:1.15.5-alpine`](#nginx1155-alpine)
-	[`nginx:1.15.5-alpine-perl`](#nginx1155-alpine-perl)
-	[`nginx:1.15.5-perl`](#nginx1155-perl)
...
```console
$ docker pull nginx@sha256:751c74dc6c44bec4ea02492cbab2143633bd5bbfca8756853406340f84cd8072
```
...
### `nginx:1.14.0-alpine` - linux; amd64
...
### `nginx:1.14.0-alpine` - linux; arm variant v6
...
### `nginx:1.14.0-alpine` - linux; arm64 variant v8
...
### `nginx:1.14.0-alpine` - linux; ppc64le
...
### `nginx:1.14.0-alpine` - linux; s390x
...
### `nginx:1.15.5-alpine` - linux; arm variant v6
...
### `nginx:1.15.5-alpine` - linux; ppc64le
...
```console
$ docker pull nginx@sha256:7c2a6f61276ca5e6251f9d9cdd3dab897b2cc9ca2d0c1b1e682dc95547226b2f
```
...
### `nginx:1.15.5-alpine-perl` - linux; amd64
...
### `nginx:1.15.5-alpine-perl` - linux; arm variant v6
...
### `nginx:1.15.5-alpine-perl` - linux; ppc64le
...
### `nginx:1.15.5-perl` - linux; arm64 variant v8
...
### `nginx:1.15.5-perl` - linux; ppc64le
