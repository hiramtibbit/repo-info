...
```console
$ docker pull nginx@sha256:ee87a791f7d75f7c82f022e894edb71748e4076e742091fb7c134e079e68a654
```
...
### `nginx:1.14.1-alpine` - linux; arm variant v6
...
### `nginx:1.14.1-alpine` - linux; s390x
