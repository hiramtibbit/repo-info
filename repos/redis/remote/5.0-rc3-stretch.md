...
### `redis:5.0-rc3-stretch` - linux; amd64
...
### `redis:5.0-rc3-stretch` - linux; arm variant v5
...
### `redis:5.0-rc3-stretch` - linux; arm variant v7
...
### `redis:5.0-rc3-stretch` - linux; arm64 variant v8
...
### `redis:5.0-rc3-stretch` - linux; 386
...
### `redis:5.0-rc3-stretch` - linux; ppc64le
...
### `redis:5.0-rc3-stretch` - linux; s390x
