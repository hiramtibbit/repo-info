...
### `redis:5.0.1-alpine` - linux; arm variant v6
...
### `redis:5.0.1-alpine` - linux; arm64 variant v8
...
### `redis:5.0.1-alpine` - linux; ppc64le
...
### `redis:5.0.1-alpine` - linux; s390x
