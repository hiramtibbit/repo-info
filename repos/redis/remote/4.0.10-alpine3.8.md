...
### `redis:4.0.10-alpine3.8` - linux; amd64
...
### `redis:4.0.10-alpine3.8` - linux; arm variant v6
...
### `redis:4.0.10-alpine3.8` - linux; arm64 variant v8
...
### `redis:4.0.10-alpine3.8` - linux; 386
...
### `redis:4.0.10-alpine3.8` - linux; ppc64le
...
### `redis:4.0.10-alpine3.8` - linux; s390x
