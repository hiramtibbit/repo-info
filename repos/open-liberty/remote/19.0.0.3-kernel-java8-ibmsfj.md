...
```console
$ docker pull open-liberty@sha256:44548c0b14c3e8b3af253cd2787233fe2b35986e7593afb4b1c60b7f08d7bae8
```
...
```console
$ docker pull open-liberty@sha256:8627e6e81f9b9e8e815adf4fa1db4d93e67af06572d73fcbdd86730b9e0a4902
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.9 MB (197942638 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f71e8747f9cddfd2f022d2c602585e5835b8b7554b6abeecfea8b75bc572158e`
