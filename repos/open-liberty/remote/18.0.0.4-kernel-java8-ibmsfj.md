...
```console
$ docker pull open-liberty@sha256:4e344a3af7dd83f9b15b004b49d5625122007f8ccd6a3f874be3ea4885cc869c
```
...
### `open-liberty:18.0.0.4-kernel-java8-ibmsfj` - linux; amd64

```console
$ docker pull open-liberty@sha256:bb9002e9dd7a62af3beac2fa319f1d135def44ee58d4819e268e213021a9ee30
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.5 MB (196525860 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb3e06b3529030cade62338480d9b9fac5de66b425d6c40dd109a44847b169c0`
