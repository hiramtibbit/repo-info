...
### `open-liberty:18.0.0.4-microProfile2` - linux; amd64
...
### `open-liberty:18.0.0.4-microProfile2` - linux; 386
...
### `open-liberty:18.0.0.4-microProfile2` - linux; ppc64le
...
### `open-liberty:18.0.0.4-microProfile2` - linux; s390x
