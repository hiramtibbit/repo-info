...
### `erlang:21.1.3-slim` - linux; amd64
...
### `erlang:21.1.3-slim` - linux; arm variant v7
...
### `erlang:21.1.3-slim` - linux; arm64 variant v8
...
### `erlang:21.1.3-slim` - linux; ppc64le
