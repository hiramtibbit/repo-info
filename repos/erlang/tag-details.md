...
### `erlang:20.3.8.10` - linux; arm variant v7
...
### `erlang:20.3.8.10` - linux; arm64 variant v8
...
### `erlang:20.3.8.10-alpine` - linux; 386
...
### `erlang:20.3.8.10-alpine` - linux; s390x
