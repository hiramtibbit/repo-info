...
### `erlang:22.0.2-alpine` - linux; amd64
...
### `erlang:22.0.2-alpine` - linux; arm64 variant v8
...
### `erlang:22.0.2-alpine` - linux; 386
...
### `erlang:22.0.2-alpine` - linux; ppc64le
...
### `erlang:22.0.2-alpine` - linux; s390x
