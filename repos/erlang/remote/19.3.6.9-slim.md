...
### `erlang:19.3.6.9-slim` - linux; amd64
...
### `erlang:19.3.6.9-slim` - linux; arm variant v7
...
### `erlang:19.3.6.9-slim` - linux; arm64 variant v8
...
### `erlang:19.3.6.9-slim` - linux; 386
...
### `erlang:19.3.6.9-slim` - linux; s390x
