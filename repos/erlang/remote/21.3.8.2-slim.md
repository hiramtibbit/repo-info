...
```console
$ docker pull erlang@sha256:4c298cad7887075a2fed5697a358f3cc51018f02ef19d13515157e6b8eb1008a
```
...
### `erlang:21.3.8.2-slim` - linux; amd64
...
### `erlang:21.3.8.2-slim` - linux; 386
