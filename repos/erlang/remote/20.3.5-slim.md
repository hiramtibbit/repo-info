...
```console
$ docker pull erlang@sha256:31994d913796a36e9850a0a39008b106d4996ed5fbd0baf01cd8c96787597cea
```
...
### `erlang:20.3.5-slim` - linux; ppc64le
...
### `erlang:20.3.5-slim` - linux; s390x
