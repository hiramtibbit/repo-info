...
```console
$ docker pull ibmjava@sha256:15af60aad458030c41b5d3c8a33db61ceac1af7bc25057ce3e7b7df8a245b557
```
...
```console
$ docker pull ibmjava@sha256:39e5687c9f64672de5ebb9dec0c6ecd3bd27aff59ec48aa2c5899bce53f1cd39
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **171.5 MB (171523991 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:11ba8a383c5e63acd47ff51b847d36625b5d69e540a9c21cb462fd9ecd71f50b`
-	Default Command: `["\/bin\/bash"]`
