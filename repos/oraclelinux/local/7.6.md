...
### `rpm` package: `GeoIP-1.5.0-13.el7.x86_64`

Licenses (from `rpm --query`): LGPLv2+ and GPLv2+ and CC-BY-SA

Source:

```console
$ yumdownloader --quiet --source --urls GeoIP-1.5.0-13.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/GeoIP-1.5.0-13.el7.src.rpm
```
...
### `rpm` package: `bind-libs-lite-9.9.4-73.el7_6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls bind-libs-lite-9.9.4-73.el7_6
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/bind-9.9.4-73.el7_6.src.rpm
```
...
### `rpm` package: `binutils-2.27-34.base.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls binutils-2.27-34.base.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/binutils-2.27-34.base.0.1.el7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/cryptsetup-2.0.3-3.el7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/curl-7.29.0-51.el7.src.rpm
```
...
### `rpm` package: `device-mapper-1.02.149-10.0.1.el7_6.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls device-mapper-1.02.149-10.0.1.el7_6.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/lvm2-2.02.180-10.0.1.el7_6.3.src.rpm
```

### `rpm` package: `device-mapper-libs-1.02.149-10.0.1.el7_6.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls device-mapper-libs-1.02.149-10.0.1.el7_6.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/lvm2-2.02.180-10.0.1.el7_6.3.src.rpm
```

### `rpm` package: `dhclient-4.2.5-68.0.1.el7_5.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls dhclient-4.2.5-68.0.1.el7_5.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/dhcp-4.2.5-68.0.1.el7_5.1.src.rpm
```

### `rpm` package: `dhcp-common-4.2.5-68.0.1.el7_5.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls dhcp-common-4.2.5-68.0.1.el7_5.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/dhcp-4.2.5-68.0.1.el7_5.1.src.rpm
```

### `rpm` package: `dhcp-libs-4.2.5-68.0.1.el7_5.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls dhcp-libs-4.2.5-68.0.1.el7_5.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/dhcp-4.2.5-68.0.1.el7_5.1.src.rpm
```
...
### `rpm` package: `dracut-033-554.0.3.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls dracut-033-554.0.3.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/dracut-033-554.0.3.el7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/glib2-2.56.1-2.el7.src.rpm
```

### `rpm` package: `glibc-2.17-260.0.15.el7_6.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls glibc-2.17-260.0.15.el7_6.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/glibc-2.17-260.0.15.el7_6.3.src.rpm
```

### `rpm` package: `glibc-common-2.17-260.0.15.el7_6.3.x86_64`
...
```console
$ yumdownloader --quiet --source --urls glibc-common-2.17-260.0.15.el7_6.3
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/glibc-2.17-260.0.15.el7_6.3.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/hostname-3.13-3.el7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/hwdata-0.252-9.1.el7.src.rpm
```
...
### `rpm` package: `initscripts-9.49.46-1.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls iproute-4.16.0-1.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/UEKR5/x86_64//getPackageSource/iproute-4.16.0-1.0.1.el7.src.rpm
```
...
### `rpm` package: `kmod-20-23.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls kmod-20-23.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/kmod-20-23.0.1.el7.src.rpm
```

### `rpm` package: `kmod-libs-20-23.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls kmod-libs-20-23.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/kmod-20-23.0.1.el7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/device-mapper-multipath-0.4.9-123.el7.src.rpm
```
...
### `rpm` package: `libgcc-4.8.5-36.0.1.el7_6.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgcc-4.8.5-36.0.1.el7_6.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/gcc-4.8.5-36.0.1.el7_6.1.src.rpm
```
...
### `rpm` package: `libgudev1-219-62.0.4.el7_6.5.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgudev1-219-62.0.4.el7_6.5
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-62.0.4.el7_6.5.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/libssh2-1.4.3-12.el7_6.2.src.rpm
```

### `rpm` package: `libstdc++-4.8.5-36.0.1.el7_6.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libstdc++-4.8.5-36.0.1.el7_6.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/gcc-4.8.5-36.0.1.el7_6.1.src.rpm
```
...
### `rpm` package: `logrotate-3.8.6-17.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls logrotate-3.8.6-17.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/logrotate-3.8.6-17.el7.src.rpm
```
...
### `rpm` package: `lz4-1.7.5-2.0.1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls lz4-1.7.5-2.0.1.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/lz4-1.7.5-2.0.1.el7.src.rpm
```
...
### `rpm` package: `nss-softokn-3.36.0-5.0.1.el7_5.x86_64`
...
### `rpm` package: `openssh-7.4p1-16.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls openssh-7.4p1-16.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/openssh-7.4p1-16.el7.src.rpm
```

### `rpm` package: `openssh-clients-7.4p1-16.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls openssh-clients-7.4p1-16.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/openssh-7.4p1-16.el7.src.rpm
```

### `rpm` package: `openssh-server-7.4p1-16.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls openssh-server-7.4p1-16.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/openssh-7.4p1-16.el7.src.rpm
```
...
### `rpm` package: `oracle-logos-70.0.3-4.0.9.el7.noarch`
...
```console
$ yumdownloader --quiet --source --urls oracle-logos-70.0.3-4.0.9.el7.noarch
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/oracle-logos-70.0.3-4.0.9.el7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/pam-1.1.8-22.el7.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/passwd-0.79-4.el7.src.rpm
```
...
### `rpm` package: `policycoreutils-2.5-29.0.1.el7_6.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls policycoreutils-2.5-29.0.1.el7_6.1
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/policycoreutils-2.5-29.0.1.el7_6.1.src.rpm
```
...
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/procps-ng-3.3.10-23.el7.src.rpm
```
...
### `rpm` package: `python-dmidecode-3.12.2-3.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls python-dmidecode-3.12.2-3.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/python-dmidecode-3.12.2-3.el7.src.rpm
```

### `rpm` package: `python-ethtool-0.8-7.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls python-ethtool-0.8-7.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/python-ethtool-0.8-7.el7.src.rpm
```
...
### `rpm` package: `rhn-check-2.0.2-24.0.5.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls rhn-check-2.0.2-24.0.5.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/rhn-client-tools-2.0.2-24.0.5.el7.src.rpm
```

### `rpm` package: `rhn-client-tools-2.0.2-24.0.5.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls rhn-client-tools-2.0.2-24.0.5.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/rhn-client-tools-2.0.2-24.0.5.el7.src.rpm
```

### `rpm` package: `rhn-setup-2.0.2-24.0.5.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls rhn-setup-2.0.2-24.0.5.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/rhn-client-tools-2.0.2-24.0.5.el7.src.rpm
```
...
### `rpm` package: `rsyslog-8.24.0-34.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls rsyslog-8.24.0-34.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/rsyslog-8.24.0-34.el7.src.rpm
```
...
### `rpm` package: `systemd-219-62.0.4.el7_6.5.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-219-62.0.4.el7_6.5
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-62.0.4.el7_6.5.src.rpm
```

### `rpm` package: `systemd-libs-219-62.0.4.el7_6.5.x86_64`
...
```console
$ yumdownloader --quiet --source --urls systemd-libs-219-62.0.4.el7_6.5
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/systemd-219-62.0.4.el7_6.5.src.rpm
```
...
### `rpm` package: `usermode-1.111-5.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls usermode-1.111-5.el7
https://yum.oracle.com/repo/OracleLinux/OL7/latest/x86_64//getPackageSource/usermode-1.111-5.el7.src.rpm
```
...
### `rpm` package: `yum-utils-1.1.31-50.0.1.el7.noarch`
