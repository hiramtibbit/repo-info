...
```console
$ yumdownloader --quiet --source --urls binutils-2.20.51.0.2-5.48.el6
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/binutils-2.20.51.0.2-5.48.el6.src.rpm
```
...
### `rpm` package: `dbus-libs-1.2.24-9.0.1.el6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls dbus-libs-1.2.24-9.0.1.el6
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/dbus-1.2.24-9.0.1.el6.src.rpm
```
...
### `rpm` package: `initscripts-9.03.61-1.0.2.el6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls initscripts-9.03.61-1.0.2.el6
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/initscripts-9.03.61-1.0.2.el6.src.rpm
```
...
### `rpm` package: `libgudev1-147-2.73.0.1.el6_8.2.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgudev1-147-2.73.0.1.el6_8.2
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/udev-147-2.73.0.1.el6_8.2.src.rpm
```
...
### `rpm` package: `libudev-147-2.73.0.1.el6_8.2.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libudev-147-2.73.0.1.el6_8.2
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/udev-147-2.73.0.1.el6_8.2.src.rpm
```
...
### `rpm` package: `module-init-tools-3.9-26.0.1.el6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls module-init-tools-3.9-26.0.1.el6
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/module-init-tools-3.9-26.0.1.el6.src.rpm
```
...
### `rpm` package: `openssh-5.3p1-123.el6_9.x86_64`
...
```console
$ yumdownloader --quiet --source --urls openssh-5.3p1-123.el6_9
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/openssh-5.3p1-123.el6_9.src.rpm
```

### `rpm` package: `openssh-clients-5.3p1-123.el6_9.x86_64`
...
```console
$ yumdownloader --quiet --source --urls openssh-clients-5.3p1-123.el6_9
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/openssh-5.3p1-123.el6_9.src.rpm
```

### `rpm` package: `openssh-server-5.3p1-123.el6_9.x86_64`
...
```console
$ yumdownloader --quiet --source --urls openssh-server-5.3p1-123.el6_9
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/openssh-5.3p1-123.el6_9.src.rpm
```
...
### `rpm` package: `policycoreutils-2.0.83-30.1.0.1.el6_8.x86_64`
...
```console
$ yumdownloader --quiet --source --urls policycoreutils-2.0.83-30.1.0.1.el6_8
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/policycoreutils-2.0.83-30.1.0.1.el6_8.src.rpm
```
...
### `rpm` package: `pyOpenSSL-0.13.1-2.el6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls pyOpenSSL-0.13.1-2.el6
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/pyOpenSSL-0.13.1-2.el6.src.rpm
```
...
### `rpm` package: `python-dmidecode-3.10.15-2.el6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls python-dmidecode-3.10.15-2.el6
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/python-dmidecode-3.10.15-2.el6.src.rpm
```

### `rpm` package: `python-ethtool-0.6-6.el6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls python-ethtool-0.6-6.el6
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/python-ethtool-0.6-6.el6.src.rpm
```
...
### `rpm` package: `rhn-check-1.0.0.1-45.0.4.el6.noarch`
...
```console
$ yumdownloader --quiet --source --urls rhn-check-1.0.0.1-45.0.4.el6.noarch
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/rhn-client-tools-1.0.0.1-45.0.4.el6.src.rpm
```

### `rpm` package: `rhn-client-tools-1.0.0.1-45.0.4.el6.noarch`
...
```console
$ yumdownloader --quiet --source --urls rhn-client-tools-1.0.0.1-45.0.4.el6.noarch
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/rhn-client-tools-1.0.0.1-45.0.4.el6.src.rpm
```

### `rpm` package: `rhn-setup-1.0.0.1-45.0.4.el6.noarch`
...
```console
$ yumdownloader --quiet --source --urls rhn-setup-1.0.0.1-45.0.4.el6.noarch
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/rhn-client-tools-1.0.0.1-45.0.4.el6.src.rpm
```
...
### `rpm` package: `tcp_wrappers-libs-7.6-58.el6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls tcp_wrappers-libs-7.6-58.el6
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/tcp_wrappers-7.6-58.el6.src.rpm
```
...
### `rpm` package: `udev-147-2.73.0.1.el6_8.2.x86_64`
...
```console
$ yumdownloader --quiet --source --urls udev-147-2.73.0.1.el6_8.2
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/udev-147-2.73.0.1.el6_8.2.src.rpm
```
