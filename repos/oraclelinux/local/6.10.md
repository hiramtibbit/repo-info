...
- Created: `2019-04-12T00:40:05.43604783Z`
...
### `rpm` package: `glibc-2.12-1.212.0.2.el6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls glibc-2.12-1.212.0.2.el6
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/glibc-2.12-1.212.0.2.el6.src.rpm
```

### `rpm` package: `glibc-common-2.12-1.212.0.2.el6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls glibc-common-2.12-1.212.0.2.el6
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/glibc-2.12-1.212.0.2.el6.src.rpm
```
...
### `rpm` package: `initscripts-9.03.61-1.0.3.el6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls initscripts-9.03.61-1.0.3.el6
https://yum.oracle.com/repo/OracleLinux/OL6/latest/x86_64//getPackageSource/initscripts-9.03.61-1.0.3.el6.src.rpm
```
