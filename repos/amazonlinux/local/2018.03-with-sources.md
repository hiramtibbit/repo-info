...
### `rpm` package: `ca-certificates-2017.2.14-65.0.1.17.amzn1.noarch`
...
```console
$ yumdownloader --quiet --source --urls ca-certificates-2017.2.14-65.0.1.17.amzn1.noarch
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/main/c31535f74c6e/SRPMS//Packages/ca-certificates-2017.2.14-65.0.1.17.amzn1.src.rpm
```
...
### `rpm` package: `curl-7.61.1-7.91.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls curl-7.61.1-7.91.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/curl-7.61.1-7.91.amzn1.src.rpm
```
...
### `rpm` package: `file-libs-5.30-11.34.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls file-libs-5.30-11.34.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/main/c31535f74c6e/SRPMS//Packages/file-5.30-11.34.amzn1.src.rpm
```
...
### `rpm` package: `glib2-2.36.3-5.18.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls glib2-2.36.3-5.18.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/main/c31535f74c6e/SRPMS//Packages/glib2-2.36.3-5.18.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/glibc-2.17-260.175.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/gnupg2-2.0.28-2.33.amzn1.src.rpm
```

### `rpm` package: `gpg-pubkey-21c0f39f-56d0e29a`
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/krb5-1.15.1-34.44.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/e2fsprogs-1.43.5-2.43.amzn1.src.rpm
```

### `rpm` package: `libcurl-7.61.1-7.91.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libcurl-7.61.1-7.91.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/curl-7.61.1-7.91.amzn1.src.rpm
```
...
### `rpm` package: `libssh2-1.4.2-2.13.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libssh2-1.4.2-2.13.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/main/c31535f74c6e/SRPMS//Packages/libssh2-1.4.2-2.13.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/libxml2-2.9.1-6.3.52.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/nspr-4.19.0-1.43.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/nss-3.36.0-5.82.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/nss-softokn-3.36.0-5.42.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/nss-util-3.36.0-1.54.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/openldap-2.4.40-16.31.amzn1.src.rpm
```

### `rpm` package: `openssl-1.0.2k-16.146.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls openssl-1.0.2k-16.146.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/openssl-1.0.2k-16.146.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/pcre-8.21-7.8.amzn1.src.rpm
```
...
### `rpm` package: `python27-2.7.15-1.124.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls python27-2.7.15-1.124.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/python27-2.7.15-1.124.amzn1.src.rpm
```
...
### `rpm` package: `python27-libs-2.7.15-1.124.amzn1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls python27-libs-2.7.15-1.124.amzn1
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/python27-2.7.15-1.124.amzn1.src.rpm
```
...
### `rpm` package: `tzdata-2018c-1.70.amzn1.noarch`
...
```console
$ yumdownloader --quiet --source --urls tzdata-2018c-1.70.amzn1.noarch
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/main/c31535f74c6e/SRPMS//Packages/tzdata-2018c-1.70.amzn1.src.rpm
```
...
Enabling amzn-updates-source repository
Enabling amzn-main-source repository
http://packages.us-west-1.amazonaws.com/2018.03/updates/dd437dd3d023/SRPMS//Packages/yum-utils-1.1.31-46.30.amzn1.src.rpm
```
