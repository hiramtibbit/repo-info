...
- Created: `2018-11-19T22:28:55.212110905Z`
- Virtual Size: ~ 374.88 Mb  
...
- Environment:
  ...
  - `MARIADB_MAJOR=10.1`
  - `MARIADB_VERSION=1:10.1.37+maria-1~bionic`
...
### `dpkg` source package: `mariadb-10.1=1:10.1.37+maria-1~bionic`

Binary Packages:

- `libmariadbclient18=1:10.1.37+maria-1~bionic`
- `libmysqlclient18=1:10.1.37+maria-1~bionic`
- `mariadb-backup-10.1=1:10.1.37+maria-1~bionic`
- `mariadb-client-10.1=1:10.1.37+maria-1~bionic`
- `mariadb-client-core-10.1=1:10.1.37+maria-1~bionic`
- `mariadb-common=1:10.1.37+maria-1~bionic`
- `mariadb-server=1:10.1.37+maria-1~bionic`
- `mariadb-server-10.1=1:10.1.37+maria-1~bionic`
- `mariadb-server-core-10.1=1:10.1.37+maria-1~bionic`
- `mysql-common=1:10.1.37+maria-1~bionic`
...
```console
$ apt-get source -qq --print-uris mariadb-10.1=1:10.1.37+maria-1~bionic
'http://ftp.osuosl.org/pub/mariadb/repo/10.1/ubuntu/pool/main/m/mariadb-10.1/mariadb-10.1_10.1.37+maria-1~bionic.dsc' mariadb-10.1_10.1.37+maria-1~bionic.dsc 2600 SHA256:facae87a018e3a30566b18a470b504d88038189dc17cc9cfa9ee409758150f39
'http://ftp.osuosl.org/pub/mariadb/repo/10.1/ubuntu/pool/main/m/mariadb-10.1/mariadb-10.1_10.1.37+maria-1~bionic.tar.gz' mariadb-10.1_10.1.37+maria-1~bionic.tar.gz 60875590 SHA256:fc1295fc745a50a74433ab1fb0f6dd0998aa98b227f6d594fcba200988e6641a
```
...
### `dpkg` source package: `openssl1.0=1.0.2n-1ubuntu5.1`
...
```console
$ apt-get source -qq --print-uris openssl1.0=1.0.2n-1ubuntu5.1
'http://archive.ubuntu.com/ubuntu/pool/main/o/openssl1.0/openssl1.0_1.0.2n-1ubuntu5.1.dsc' openssl1.0_1.0.2n-1ubuntu5.1.dsc 2713 SHA256:2eb1d177cfde498a5752cfe770b6dce14fff67a14b56b7cc893973210f8db727
...
'http://archive.ubuntu.com/ubuntu/pool/main/o/openssl1.0/openssl1.0_1.0.2n-1ubuntu5.1.debian.tar.xz' openssl1.0_1.0.2n-1ubuntu5.1.debian.tar.xz 105232 SHA256:20163224a66a5f23c64ef4ba3a80ed1afd2c3865585838c1774bbbd207df74a0
```
