...
```console
apr-util-1.6.1-r5 description:
The Apache Portable Runtime Utility Library

apr-util-1.6.1-r5 webpage:
http://apr.apache.org/

apr-util-1.6.1-r5 installed size:
204800

apr-util-1.6.1-r5 license:
Apache-2.0
...
```console
coreutils-8.30-r0 description:
The basic file, shell and text manipulation utilities

coreutils-8.30-r0 webpage:
https://www.gnu.org/software/coreutils/

coreutils-8.30-r0 installed size:
1105920

coreutils-8.30-r0 license:
GPL-3.0-or-later
...
```console
lz4-libs-1.8.3-r2 description:
LZ4 is lossless compression algorithm with fast decoder @ multiple GB/s per core. (libraries)

lz4-libs-1.8.3-r2 webpage:
https://github.com/lz4/lz4

lz4-libs-1.8.3-r2 installed size:
118784

lz4-libs-1.8.3-r2 license:
...
```console
subversion-1.11.1-r0 description:
Replacement for CVS, another versioning system (svn)

subversion-1.11.1-r0 webpage:
https://subversion.apache.org

subversion-1.11.1-r0 installed size:
1097728

subversion-1.11.1-r0 license:
Apache-2.0 BSD
...
```console
subversion-libs-1.11.1-r0 description:
Replacement for CVS, another versioning system (svn) (libraries)

subversion-libs-1.11.1-r0 webpage:
https://subversion.apache.org

subversion-libs-1.11.1-r0 installed size:
3825664

subversion-libs-1.11.1-r0 license:
Apache-2.0 BSD
