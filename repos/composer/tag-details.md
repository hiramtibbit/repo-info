...
```console
$ docker pull composer@sha256:ae36258d0adca328525660bc66fb470d316570beef55407e7765badb327ffb2e
```
...
```console
$ docker pull composer@sha256:25b187f65dddf7594e4b8db0ffc448e5d9f3ad38e45305db94bda08f1d4ee63c
```
