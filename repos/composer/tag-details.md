...
```console
$ docker pull composer@sha256:645cba330567ffb2662d5781eb2fdaa5e82b992a4204a69ca554a82d8cb983fe
```
...
```console
$ docker pull composer@sha256:d0aae8faf0d4bed3a7e04bbe88f9530bf58abd1cef6395bf70a89531d2af0845
```
