...
```console
$ docker pull composer@sha256:b359c298cde2a5bdd93338b6e379bffba1c2af8dcc5fe61786cf8459194e28f6
```
...
```console
$ docker pull composer@sha256:bd82789862bd3373a7eca52c8989f68ecf0896454f7d877d6500a13a5d4541a2
```
...
```console
$ docker pull composer@sha256:ae2503b2fa46d9684b217831076b90f49a2348a514175b9ee1b5074807b3615f
```
