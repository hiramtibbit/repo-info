...
```console
$ docker pull composer@sha256:fa3c1cb3d37afe34f9063691c24821e0020396044f0effe5930795443a51fd2a
```
...
```console
$ docker pull composer@sha256:7577f95307cb8e937786c98b9601656de02470e04d19e9b73bdb046db77cc36d
```
