...
```console
$ docker pull composer@sha256:37f9fe1294342e5c9925f84e7f561711699ff604e7f7e9ffb13638288714484a
```
...
```console
$ docker pull composer@sha256:3000dc3d3b6bfcbf813ba7eef495119bc4b6cad0bfd355bc7e647abf400c9c60
```
