...
-	[`composer:1.7.0`](#composer170)
-	[`composer:latest`](#composerlatest)

## `composer:1`

```console
$ docker pull composer@sha256:006e3f8c65ea289d105e10afda14f60c981246abb5c6dccb0df8eca71e9b512c
```
...
```console
$ docker pull composer@sha256:4c2dac0de9aabd9d4e7c053ab75a8ef9802e6eb3c23e0dae458779a5bd886a50
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **62.2 MB (62242720 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:84ef9ecd5264d368d6c70552a0e9d93ab2abd0805188a52daf603836fa588939`
-	Entrypoint: `["\/bin\/sh","\/docker-entrypoint.sh"]`
-	Default Command: `["composer"]`
...
# Sat, 21 Jul 2018 17:18:55 GMT
ENV COMPOSER_HOME=/tmp
# Sat, 04 Aug 2018 10:39:16 GMT
ENV COMPOSER_VERSION=1.7.0
# Sat, 04 Aug 2018 10:39:19 GMT
RUN curl --silent --fail --location --retry 3 --output /tmp/installer.php --url https://raw.githubusercontent.com/composer/getcomposer.org/b107d959a5924af895807021fcef4ffec5a76aa9/web/installer  && php -r "     \$signature = '544e09ee996cdf60ece3804abc52599c22b1f40f4323403c44d44fdfdd586475ca9813a858088ffbc1f233e9b180f061';     \$hash = hash('SHA384', file_get_contents('/tmp/installer.php'));     if (!hash_equals(\$signature, \$hash)) {         unlink('/tmp/installer.php');         echo 'Integrity check failed, installer is either corrupt or worse.' . PHP_EOL;         exit(1);     }"  && php /tmp/installer.php --no-ansi --install-dir=/usr/bin --filename=composer --version=${COMPOSER_VERSION}  && composer --ansi --version --no-interaction  && rm -rf /tmp/* /tmp/.htaccess
# Sat, 04 Aug 2018 10:39:19 GMT
COPY file:295943a303e8f27de4302b6aa3687bce4b1d1392335efaaab9ecd37bec5ab4c5 in /docker-entrypoint.sh 
# Sat, 04 Aug 2018 10:39:20 GMT
WORKDIR /app
# Sat, 04 Aug 2018 10:39:20 GMT
ENTRYPOINT ["/bin/sh" "/docker-entrypoint.sh"]
# Sat, 04 Aug 2018 10:39:20 GMT
...
-	Layers:
	...
	-	`sha256:eeaa703a7356130764f20f22b0ce0bded0ba6ebd645edbd2cde96b17bcdfe68e`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:ea4d6bbdc0c35ce650520f3e7fa5a9cf89e8286b283c370343a8af30727385ea`  
		Last Modified: Sat, 04 Aug 2018 10:40:03 GMT  
		Size: 477.6 KB (477571 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89cfba20a31dab0b8170ec2ca8d6fbdffc02c862f9805f5e44dddb34e4fa640b`  
		Last Modified: Sat, 04 Aug 2018 10:40:02 GMT  
		Size: 534.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6a1be16b937abcc872469ab0279544de5c19863398b69b1bb6940dab75d9f964`  
		Last Modified: Sat, 04 Aug 2018 10:40:03 GMT  
		Size: 92.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
