...
```console
$ docker pull memcached@sha256:f36ce628233a2d0a4abdd224dc20ec45a148ebf987e4731c95f0ce350dbdc07d
```
...
```console
$ docker pull memcached@sha256:56385d096d1bbe5e6dafadf44a8bdb5185a54e9f75e8f00e32db001633b97c42
```
