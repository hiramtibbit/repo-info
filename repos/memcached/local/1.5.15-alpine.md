...
- Created: `2019-05-23T21:41:58.895558657Z`
...
- Environment:
  ...
  - `MEMCACHED_SHA1=9e54bf92c4c6cf861d38119461df35cf2dd790ae`
...
```console
libevent-2.1.8-r6 description:
An event notification library

libevent-2.1.8-r6 webpage:
http://libevent.org/

libevent-2.1.8-r6 installed size:
688128

libevent-2.1.8-r6 license:
BSD-3-Clause
