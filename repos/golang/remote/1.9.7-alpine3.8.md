...
### `golang:1.9.7-alpine3.8` - linux; arm variant v6
...
### `golang:1.9.7-alpine3.8` - linux; arm64 variant v8
...
### `golang:1.9.7-alpine3.8` - linux; 386
...
### `golang:1.9.7-alpine3.8` - linux; ppc64le
...
### `golang:1.9.7-alpine3.8` - linux; s390x
