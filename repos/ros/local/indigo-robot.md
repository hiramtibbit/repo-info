...
- Created: `2019-04-26T23:39:27.184470286Z`
...
### `dpkg` source package: `gst-plugins-base0.10=0.10.36-1.1ubuntu2.1`

Binary Packages:

- `libgstreamer-plugins-base0.10-0:amd64=0.10.36-1.1ubuntu2.1`

Licenses: (parsed from: `/usr/share/doc/libgstreamer-plugins-base0.10-0/copyright`)
...
```console
$ apt-get source -qq --print-uris gst-plugins-base0.10=0.10.36-1.1ubuntu2.1
'http://archive.ubuntu.com/ubuntu/pool/main/g/gst-plugins-base0.10/gst-plugins-base0.10_0.10.36-1.1ubuntu2.1.dsc' gst-plugins-base0.10_0.10.36-1.1ubuntu2.1.dsc 3778 SHA256:305326c656a2ce36ff48a89a4a03adefe54eca349f026ac463c2b396639ba9d7
'http://archive.ubuntu.com/ubuntu/pool/main/g/gst-plugins-base0.10/gst-plugins-base0.10_0.10.36.orig.tar.bz2' gst-plugins-base0.10_0.10.36.orig.tar.bz2 3036143 SHA256:2cd3b0fa8e9b595db8f514ef7c2bdbcd639a0d63d154c00f8c9b609321f49976
'http://archive.ubuntu.com/ubuntu/pool/main/g/gst-plugins-base0.10/gst-plugins-base0.10_0.10.36-1.1ubuntu2.1.debian.tar.gz' gst-plugins-base0.10_0.10.36-1.1ubuntu2.1.debian.tar.gz 42790 SHA256:47f6472117e6cb1dba01c0fb29752b5d79e8ea260186e72b571fbc3bd615f7ed
```

### `dpkg` source package: `gstreamer0.10=0.10.36-1.2ubuntu3`

Binary Packages:

- `libgstreamer0.10-0:amd64=0.10.36-1.2ubuntu3`

Licenses: (parsed from: `/usr/share/doc/libgstreamer0.10-0/copyright`)
...
```console
$ apt-get source -qq --print-uris gstreamer0.10=0.10.36-1.2ubuntu3
'http://archive.ubuntu.com/ubuntu/pool/main/g/gstreamer0.10/gstreamer0.10_0.10.36-1.2ubuntu3.dsc' gstreamer0.10_0.10.36-1.2ubuntu3.dsc 3320 SHA256:11237e0da70afdfd56e84a65ea32b3a841047641ae1280cd9f778845a2fc5c90
'http://archive.ubuntu.com/ubuntu/pool/main/g/gstreamer0.10/gstreamer0.10_0.10.36.orig.tar.bz2' gstreamer0.10_0.10.36.orig.tar.bz2 3655705 SHA256:e556a529e0a8cf1cd0afd0cab2af5488c9524e7c3f409de29b5d82bb41ae7a30
'http://archive.ubuntu.com/ubuntu/pool/main/g/gstreamer0.10/gstreamer0.10_0.10.36-1.2ubuntu3.debian.tar.gz' gstreamer0.10_0.10.36-1.2ubuntu3.debian.tar.gz 45644 SHA256:67cf50ed3138091b5666fcc9d41812005bcfd4e1a47aab22589f60c6b1b04f4f
```
...
### `dpkg` source package: `jasper=1.900.1-14ubuntu3.5`

Binary Packages:

- `libjasper1:amd64=1.900.1-14ubuntu3.5`
...
- `libgssrpc4:amd64=1.12+dfsg-2ubuntu5.4`
- `libk5crypto3:amd64=1.12+dfsg-2ubuntu5.4`
- `libkadm5clnt-mit9:amd64=1.12+dfsg-2ubuntu5.4`
- `libkadm5srv-mit9:amd64=1.12+dfsg-2ubuntu5.4`
- `libkdb5-7:amd64=1.12+dfsg-2ubuntu5.4`
- `libkrb5-3:amd64=1.12+dfsg-2ubuntu5.4`
- `libkrb5-dev=1.12+dfsg-2ubuntu5.4`
...
### `dpkg` source package: `libarchive=3.1.2-7ubuntu2.8`

Binary Packages:

- `libarchive13:amd64=3.1.2-7ubuntu2.8`
...
```console
$ apt-get source -qq --print-uris libarchive=3.1.2-7ubuntu2.8
'http://archive.ubuntu.com/ubuntu/pool/main/liba/libarchive/libarchive_3.1.2-7ubuntu2.8.dsc' libarchive_3.1.2-7ubuntu2.8.dsc 2396 SHA256:555a005f88a40027f0e45e6afe57d9367f3d79d75cbdc03c84e199054a19eca7
...
'http://archive.ubuntu.com/ubuntu/pool/main/liba/libarchive/libarchive_3.1.2-7ubuntu2.8.debian.tar.gz' libarchive_3.1.2-7ubuntu2.8.debian.tar.gz 54929 SHA256:b83e52bb189e6e432377229b8acb2b6aaab6f6918bcaf04fd886d9fbee5f8b85
```
...
### `dpkg` source package: `libgd2=2.1.0-3ubuntu0.11`

Binary Packages:

- `libgd3:amd64=2.1.0-3ubuntu0.11`
...
```console
$ apt-get source -qq --print-uris libgd2=2.1.0-3ubuntu0.11
'http://archive.ubuntu.com/ubuntu/pool/main/libg/libgd2/libgd2_2.1.0-3ubuntu0.11.dsc' libgd2_2.1.0-3ubuntu0.11.dsc 2430 SHA256:230a5de4953103aa1334e74294ac2475b679626e9f195e634b5fb167b2bba40b
...
'http://archive.ubuntu.com/ubuntu/pool/main/libg/libgd2/libgd2_2.1.0-3ubuntu0.11.debian.tar.gz' libgd2_2.1.0-3ubuntu0.11.debian.tar.gz 95789 SHA256:ca228fe9b525ef1d62a84792a4ffa21ada26b42899c101f7ac71653c4e093dcf
```
...
### `dpkg` source package: `libjpeg-turbo=1.3.0-0ubuntu2.1`

Binary Packages:

- `libjpeg-turbo8:amd64=1.3.0-0ubuntu2.1`
...
```console
$ apt-get source -qq --print-uris libjpeg-turbo=1.3.0-0ubuntu2.1
'http://archive.ubuntu.com/ubuntu/pool/main/libj/libjpeg-turbo/libjpeg-turbo_1.3.0-0ubuntu2.1.dsc' libjpeg-turbo_1.3.0-0ubuntu2.1.dsc 2252 SHA256:fb123f3c76d93948d9f4c06f86fdbe687369c51cd959ebbe25ca9264d7d9e949
...
'http://archive.ubuntu.com/ubuntu/pool/main/libj/libjpeg-turbo/libjpeg-turbo_1.3.0-0ubuntu2.1.debian.tar.gz' libjpeg-turbo_1.3.0-0ubuntu2.1.debian.tar.gz 31716 SHA256:5f66dd891c5bf9c6c3eb49ffa8a96a631e54bb987db2821c30c36173f9f562e6
```
...
- `libxml2-dev:amd64=2.9.1+dfsg1-3ubuntu4.13`
...
### `dpkg` source package: `mysql-5.5=5.5.62-0ubuntu0.14.04.1`

Binary Packages:

- `libmysqlclient-dev=5.5.62-0ubuntu0.14.04.1`
- `libmysqlclient18:amd64=5.5.62-0ubuntu0.14.04.1`
...
```console
$ apt-get source -qq --print-uris mysql-5.5=5.5.62-0ubuntu0.14.04.1
'http://archive.ubuntu.com/ubuntu/pool/main/m/mysql-5.5/mysql-5.5_5.5.62-0ubuntu0.14.04.1.dsc' mysql-5.5_5.5.62-0ubuntu0.14.04.1.dsc 3187 SHA256:24bf81a2afca76608beca2e5f9a32e90c83f67fa72533e6e7b027de09349afbb
'http://archive.ubuntu.com/ubuntu/pool/main/m/mysql-5.5/mysql-5.5_5.5.62.orig.tar.gz' mysql-5.5_5.5.62.orig.tar.gz 21111902 SHA256:b1e7853bc1f04aabf6771e0ad947f35ac8d237f4b35d0706d1095c9526ff99d7
'http://archive.ubuntu.com/ubuntu/pool/main/m/mysql-5.5/mysql-5.5_5.5.62-0ubuntu0.14.04.1.debian.tar.gz' mysql-5.5_5.5.62-0ubuntu0.14.04.1.debian.tar.gz 317084 SHA256:de1e7f0e98cf04b85a17e12e3357f0424a5bf55e56441ae44ad0411299baffed
```
...
### `dpkg` source package: `paramiko=1.10.1-1git1ubuntu0.2`
...
```console
$ apt-get source -qq --print-uris paramiko=1.10.1-1git1ubuntu0.2
'http://archive.ubuntu.com/ubuntu/pool/main/p/paramiko/paramiko_1.10.1-1git1ubuntu0.2.dsc' paramiko_1.10.1-1git1ubuntu0.2.dsc 2195 SHA256:bb44124d355b21212d5ce832ed146cc56b3eae4069ede22ed1d75dbdd7b8a683
...
'http://archive.ubuntu.com/ubuntu/pool/main/p/paramiko/paramiko_1.10.1-1git1ubuntu0.2.debian.tar.gz' paramiko_1.10.1-1git1ubuntu0.2.debian.tar.gz 11860 SHA256:fa83457a96bff991f9e0d14350d80882755ea62d4eefa576fabf1f7b8df21c83
```
...
### `dpkg` source package: `poco=1.3.6p1-4+deb7u1build1`

Binary Packages:

- `libpoco-dev=1.3.6p1-4+deb7u1build1`
...
```console
$ apt-get source -qq --print-uris poco=1.3.6p1-4+deb7u1build1
'http://archive.ubuntu.com/ubuntu/pool/universe/p/poco/poco_1.3.6p1-4+deb7u1build1.dsc' poco_1.3.6p1-4+deb7u1build1.dsc 3172 SHA256:cf35bccd9f5cdeb1e189ac580996bb2dc8f564fb59d4dc60ff5e097104e1c393
...
'http://archive.ubuntu.com/ubuntu/pool/universe/p/poco/poco_1.3.6p1-4+deb7u1build1.diff.gz' poco_1.3.6p1-4+deb7u1build1.diff.gz 16075 SHA256:a68d91023639c5a806616d8805250ffba461751cf4b302928781eb94aa778e07
```
...
- `libpq-dev=9.3.24-0ubuntu0.14.04`
...
### `dpkg` source package: `pycurl=7.19.3-0ubuntu3`

Binary Packages:

- `python-pycurl=7.19.3-0ubuntu3`

Licenses: (parsed from: `/usr/share/doc/python-pycurl/copyright`)
...
```console
$ apt-get source -qq --print-uris pycurl=7.19.3-0ubuntu3
'http://archive.ubuntu.com/ubuntu/pool/main/p/pycurl/pycurl_7.19.3-0ubuntu3.dsc' pycurl_7.19.3-0ubuntu3.dsc 1749 SHA256:e2a28df2be2cb506e0aff8f499c82d365f5f32ef9552932d086e22f7a617b5e5
'http://archive.ubuntu.com/ubuntu/pool/main/p/pycurl/pycurl_7.19.3.orig.tar.gz' pycurl_7.19.3.orig.tar.gz 113771 SHA256:05e48835fe445ff327dcd373f49d9970e0b828a07cd4d08a23264507a742d616
'http://archive.ubuntu.com/ubuntu/pool/main/p/pycurl/pycurl_7.19.3-0ubuntu3.debian.tar.gz' pycurl_7.19.3-0ubuntu3.debian.tar.gz 8117 SHA256:d81d5f56339ed934b1b99aec2b1a0858e530d27b4daf4cf09712aa715c053826
```

### `dpkg` source package: `pyparsing=2.0.1+dfsg1-1build1`
...
```console
$ apt-get source -qq --print-uris pyparsing=2.0.1+dfsg1-1build1
'http://archive.ubuntu.com/ubuntu/pool/main/p/pyparsing/pyparsing_2.0.1+dfsg1-1build1.dsc' pyparsing_2.0.1+dfsg1-1build1.dsc 1644 SHA256:a178d1b7d495fb23971938d0eb4531af3b4b687bdf9a1127bc1853d43db6d173
'http://archive.ubuntu.com/ubuntu/pool/main/p/pyparsing/pyparsing_2.0.1+dfsg1.orig.tar.gz' pyparsing_2.0.1+dfsg1.orig.tar.gz 1045531 SHA256:bd8028fd98cefd6a0ffdff15d697333a130baf6c9e2e7dd2a8589119283eb94f
'http://archive.ubuntu.com/ubuntu/pool/main/p/pyparsing/pyparsing_2.0.1+dfsg1-1build1.debian.tar.gz' pyparsing_2.0.1+dfsg1-1build1.debian.tar.gz 6649 SHA256:3a841b039a2ecd6b62520de108aca1b889266daabf812276105f1c8038abd9a8
```
...
- `libpython2.7:amd64=2.7.6-8ubuntu0.5`
- `libpython2.7-dev:amd64=2.7.6-8ubuntu0.5`
- `libpython2.7-minimal:amd64=2.7.6-8ubuntu0.5`
- `libpython2.7-stdlib:amd64=2.7.6-8ubuntu0.5`
- `python2.7=2.7.6-8ubuntu0.5`
- `python2.7-dev=2.7.6-8ubuntu0.5`
...
```console
$ apt-get source -qq --print-uris python2.7=2.7.6-8ubuntu0.5
'http://archive.ubuntu.com/ubuntu/pool/main/p/python2.7/python2.7_2.7.6-8ubuntu0.5.dsc' python2.7_2.7.6-8ubuntu0.5.dsc 3231 SHA256:46dd65031c2029e34e72592fecd445e555bae789bbf82418eaf2f9e214f35397
...
'http://archive.ubuntu.com/ubuntu/pool/main/p/python2.7/python2.7_2.7.6-8ubuntu0.5.diff.gz' python2.7_2.7.6-8ubuntu0.5.diff.gz 643247 SHA256:3621ba408e8a6052ba7f31d74af64b2be44bcba6db03fa87af2baf7edc268824
```
...
- `libsqlite3-dev:amd64=3.8.2-1ubuntu2.2`
...
### `dpkg` source package: `tiff=4.0.3-7ubuntu0.11`

Binary Packages:

- `libtiff5:amd64=4.0.3-7ubuntu0.11`
...
```console
$ apt-get source -qq --print-uris tiff=4.0.3-7ubuntu0.11
'http://archive.ubuntu.com/ubuntu/pool/main/t/tiff/tiff_4.0.3-7ubuntu0.11.dsc' tiff_4.0.3-7ubuntu0.11.dsc 2314 SHA256:a22412901f18221432d91b0892662e682650089cef39249d44b355444518724c
...
'http://archive.ubuntu.com/ubuntu/pool/main/t/tiff/tiff_4.0.3-7ubuntu0.11.debian.tar.gz' tiff_4.0.3-7ubuntu0.11.debian.tar.gz 98083 SHA256:d2158bd4a195857178b8e1bba108a04e664843499aa26da45dee09cbf7dbf771
```
...
### `dpkg` source package: `torque=2.4.16+dfsg-1.3ubuntu1.1`
...
```console
$ apt-get source -qq --print-uris torque=2.4.16+dfsg-1.3ubuntu1.1
'http://archive.ubuntu.com/ubuntu/pool/universe/t/torque/torque_2.4.16+dfsg-1.3ubuntu1.1.dsc' torque_2.4.16+dfsg-1.3ubuntu1.1.dsc 2735 SHA256:35da750664d029e396efc1651ead191631f9d9075650c53556bc68354f86dad1
...
'http://archive.ubuntu.com/ubuntu/pool/universe/t/torque/torque_2.4.16+dfsg-1.3ubuntu1.1.debian.tar.gz' torque_2.4.16+dfsg-1.3ubuntu1.1.debian.tar.gz 24420 SHA256:d757a884ca7e846b614fce9cf7ec1a1055fb64c1c063f7c372729231b0c2ec92
```
...
### `dpkg` source package: `urdfdom-headers=0.2.3+dfsg-1`

Binary Packages:

- `liburdfdom-headers-dev=0.2.3+dfsg-1`
...
```console
$ apt-get source -qq --print-uris urdfdom-headers=0.2.3+dfsg-1
'http://archive.ubuntu.com/ubuntu/pool/universe/u/urdfdom-headers/urdfdom-headers_0.2.3+dfsg-1.dsc' urdfdom-headers_0.2.3+dfsg-1.dsc 2122 SHA256:35519bc8ce4b6543488f83c81e1b3b0a02363bdb435a915f268a515991c71ee4
'http://archive.ubuntu.com/ubuntu/pool/universe/u/urdfdom-headers/urdfdom-headers_0.2.3+dfsg.orig.tar.gz' urdfdom-headers_0.2.3+dfsg.orig.tar.gz 10122 SHA256:6b1f27b002c6d897b43ed57988133f40aac093a2a6e84d9bf08ed36a13b401ae
'http://archive.ubuntu.com/ubuntu/pool/universe/u/urdfdom-headers/urdfdom-headers_0.2.3+dfsg-1.debian.tar.gz' urdfdom-headers_0.2.3+dfsg-1.debian.tar.gz 2141 SHA256:c05a360a5c54da4b96a829d9579dd28476db2548d12d071a0fb8194a2c688e27
```

### `dpkg` source package: `urdfdom=0.2.10+dfsg-1`

Binary Packages:

- `liburdfdom-dev:amd64=0.2.10+dfsg-1`
- `liburdfdom-model-state0.2:amd64=0.2.10+dfsg-1`
- `liburdfdom-model0.2:amd64=0.2.10+dfsg-1`
- `liburdfdom-sensor0.2:amd64=0.2.10+dfsg-1`
- `liburdfdom-tools=0.2.10+dfsg-1`
- `liburdfdom-world0.2:amd64=0.2.10+dfsg-1`

Licenses: (parsed from: `/usr/share/doc/liburdfdom-dev/copyright`, `/usr/share/doc/liburdfdom-model-state0.2/copyright`, `/usr/share/doc/liburdfdom-model0.2/copyright`, `/usr/share/doc/liburdfdom-sensor0.2/copyright`, `/usr/share/doc/liburdfdom-tools/copyright`, `/usr/share/doc/liburdfdom-world0.2/copyright`)
...
```console
$ apt-get source -qq --print-uris urdfdom=0.2.10+dfsg-1
'http://archive.ubuntu.com/ubuntu/pool/universe/u/urdfdom/urdfdom_0.2.10+dfsg-1.dsc' urdfdom_0.2.10+dfsg-1.dsc 2480 SHA256:f6ab1d70e15f84621cf3c5464ff72e8aae1d5a96aac6ed7648d5a5d8e1c6c144
'http://archive.ubuntu.com/ubuntu/pool/universe/u/urdfdom/urdfdom_0.2.10+dfsg.orig.tar.gz' urdfdom_0.2.10+dfsg.orig.tar.gz 40011 SHA256:e200f5adefa6bf8304e56ab8a3e1c04d3b6cced5df472f4aeb430ff81f1ffa0d
'http://archive.ubuntu.com/ubuntu/pool/universe/u/urdfdom/urdfdom_0.2.10+dfsg-1.debian.tar.xz' urdfdom_0.2.10+dfsg-1.debian.tar.xz 4508 SHA256:da423b1dd8db908b65eb3908247d64354cf0ab8d3f4809b39b6a73f1a47d474f
```
...
### `dpkg` source package: `urlgrabber=3.9.1-4ubuntu3.14.04.1`

Binary Packages:

- `python-urlgrabber=3.9.1-4ubuntu3.14.04.1`

Licenses: (parsed from: `/usr/share/doc/python-urlgrabber/copyright`)
...
```console
$ apt-get source -qq --print-uris urlgrabber=3.9.1-4ubuntu3.14.04.1
'http://archive.ubuntu.com/ubuntu/pool/main/u/urlgrabber/urlgrabber_3.9.1-4ubuntu3.14.04.1.dsc' urlgrabber_3.9.1-4ubuntu3.14.04.1.dsc 1836 SHA256:09b6bb62fa55b42094a31703f84b83609735eb9d12347f0d9d09b4029b1872b2
'http://archive.ubuntu.com/ubuntu/pool/main/u/urlgrabber/urlgrabber_3.9.1.orig.tar.gz' urlgrabber_3.9.1.orig.tar.gz 72343 SHA256:4437076c8708e5754ea04540e46c7f4f233734ee3590bb8a96389264fb0650d0
'http://archive.ubuntu.com/ubuntu/pool/main/u/urlgrabber/urlgrabber_3.9.1-4ubuntu3.14.04.1.debian.tar.gz' urlgrabber_3.9.1-4ubuntu3.14.04.1.debian.tar.gz 12175 SHA256:df39d7b19096bcc9aac4a51c71955775cb3709cf87bde6a67a40e27d460ceab7
```
...
### `dpkg` source package: `wxwidgets2.8=2.8.12.1+dfsg-2ubuntu2`

Binary Packages:

- `libwxbase2.8-0:amd64=2.8.12.1+dfsg-2ubuntu2`
- `libwxgtk-media2.8-0:amd64=2.8.12.1+dfsg-2ubuntu2`
- `libwxgtk2.8-0:amd64=2.8.12.1+dfsg-2ubuntu2`
- `python-wxgtk2.8=2.8.12.1+dfsg-2ubuntu2`
- `python-wxtools=2.8.12.1+dfsg-2ubuntu2`
...
```console
$ apt-get source -qq --print-uris wxwidgets2.8=2.8.12.1+dfsg-2ubuntu2
'http://archive.ubuntu.com/ubuntu/pool/universe/w/wxwidgets2.8/wxwidgets2.8_2.8.12.1+dfsg-2ubuntu2.dsc' wxwidgets2.8_2.8.12.1+dfsg-2ubuntu2.dsc 3590 SHA256:8366f11ec0a5c5942ca56b95b6c246af74d2c67f0857035570916c0064deeb28
'http://archive.ubuntu.com/ubuntu/pool/universe/w/wxwidgets2.8/wxwidgets2.8_2.8.12.1+dfsg.orig.tar.xz' wxwidgets2.8_2.8.12.1+dfsg.orig.tar.xz 16757004 SHA256:abb1417b4cf655f1a3608951b956960e313f3c1fca330fdb6378f4e6feefb29a
'http://archive.ubuntu.com/ubuntu/pool/universe/w/wxwidgets2.8/wxwidgets2.8_2.8.12.1+dfsg-2ubuntu2.debian.tar.gz' wxwidgets2.8_2.8.12.1+dfsg-2ubuntu2.debian.tar.gz 246915 SHA256:4947e396e63b7a02e44782727d328e263b982f363d25299d57b1df9fa80a63e2
```
...
- `zlib1g-dev:amd64=1:1.2.8.dfsg-1ubuntu1.1`
