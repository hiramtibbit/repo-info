...
- Created: `2018-06-12T01:11:39.745763718Z`
...
### `dpkg` source package: `apt=1.2.26`

Binary Packages:

- `apt=1.2.26`
- `libapt-pkg5.0:amd64=1.2.26`
...
```console
$ apt-get source -qq --print-uris base-files=9.4ubuntu4.6
'http://archive.ubuntu.com/ubuntu/pool/main/b/base-files/base-files_9.4ubuntu4.6.dsc' base-files_9.4ubuntu4.6.dsc 1193 SHA256:b1e7c9f61aa50a9a691d02b445c3ba90032f48463345298644341913fc127cab
'http://archive.ubuntu.com/ubuntu/pool/main/b/base-files/base-files_9.4ubuntu4.6.tar.xz' base-files_9.4ubuntu4.6.tar.xz 63136 SHA256:04f87a0bd347b1154760e2ac1b9da1e00d4fa0fa383888d95ab21e7652a22987
```
...
- `libcups2:amd64=2.1.3-4ubuntu0.4`
...
### `dpkg` source package: `libgcrypt20=1.6.5-2ubuntu0.4`

Binary Packages:

- `libgcrypt20:amd64=1.6.5-2ubuntu0.4`
...
```console
$ apt-get source -qq --print-uris libgcrypt20=1.6.5-2ubuntu0.4
'http://archive.ubuntu.com/ubuntu/pool/main/libg/libgcrypt20/libgcrypt20_1.6.5-2ubuntu0.4.dsc' libgcrypt20_1.6.5-2ubuntu0.4.dsc 2639 SHA256:8563d406770c214117424b8d5f67bbbb44f988c18ec3bed8f593984661bff0b3
...
'http://archive.ubuntu.com/ubuntu/pool/main/libg/libgcrypt20/libgcrypt20_1.6.5-2ubuntu0.4.debian.tar.xz' libgcrypt20_1.6.5-2ubuntu0.4.debian.tar.xz 36840 SHA256:c27b1256f1d63cf3c7e410d3be397ada333be229edbfb6d24723325f7deb9748
```
...
### `dpkg` source package: `linux=4.4.0-128.154`

Binary Packages:

- `linux-libc-dev:amd64=4.4.0-128.154`
...
- `libegl1-mesa-dev:amd64=17.2.8-0ubuntu0~16.04.1`
...
- `libgles2-mesa:amd64=17.2.8-0ubuntu0~16.04.1`
- `libgles2-mesa-dev:amd64=17.2.8-0ubuntu0~16.04.1`
...
### `dpkg` source package: `ros-kinetic-collada-parser=1.12.12-0xenial-20180508-073113-0800`

Binary Packages:

- `ros-kinetic-collada-parser=1.12.12-0xenial-20180508-073113-0800`
...
### `dpkg` source package: `ros-kinetic-collada-urdf=1.12.12-0xenial-20180516-160938-0800`

Binary Packages:

- `ros-kinetic-collada-urdf=1.12.12-0xenial-20180516-160938-0800`
...
### `dpkg` source package: `ros-kinetic-diagnostic-common-diagnostics=1.9.3-0xenial-20180516-164849-0800`

Binary Packages:

- `ros-kinetic-diagnostic-common-diagnostics=1.9.3-0xenial-20180516-164849-0800`
...
### `dpkg` source package: `ros-kinetic-diagnostics=1.9.3-0xenial-20180516-172413-0800`

Binary Packages:

- `ros-kinetic-diagnostics=1.9.3-0xenial-20180516-172413-0800`
...
### `dpkg` source package: `ros-kinetic-geometry=1.11.9-0xenial-20180516-174307-0800`

Binary Packages:

- `ros-kinetic-geometry=1.11.9-0xenial-20180516-174307-0800`
...
### `dpkg` source package: `ros-kinetic-joint-state-publisher=1.12.13-0xenial-20180516-152338-0800`

Binary Packages:

- `ros-kinetic-joint-state-publisher=1.12.13-0xenial-20180516-152338-0800`
...
### `dpkg` source package: `ros-kinetic-kdl-parser=1.12.10-0xenial-20180316-145043-0800`

Binary Packages:

- `ros-kinetic-kdl-parser=1.12.10-0xenial-20180316-145043-0800`
...
### `dpkg` source package: `ros-kinetic-python-qt-binding=0.3.3-0xenial-20180222-204609-0800`

Binary Packages:

- `ros-kinetic-python-qt-binding=0.3.3-0xenial-20180222-204609-0800`
...
### `dpkg` source package: `ros-kinetic-robot-model=1.12.11-0xenial-20180516-185134-0800`

Binary Packages:

- `ros-kinetic-robot-model=1.12.11-0xenial-20180516-185134-0800`
...
### `dpkg` source package: `ros-kinetic-robot-state-publisher=1.13.6-0xenial-20180516-164446-0800`

Binary Packages:

- `ros-kinetic-robot-state-publisher=1.13.6-0xenial-20180516-164446-0800`
...
### `dpkg` source package: `ros-kinetic-robot=1.3.2-0xenial-20180516-190415-0800`

Binary Packages:

- `ros-kinetic-robot=1.3.2-0xenial-20180516-190415-0800`
...
### `dpkg` source package: `ros-kinetic-ros-base=1.3.2-0xenial-20180516-185926-0800`

Binary Packages:

- `ros-kinetic-ros-base=1.3.2-0xenial-20180516-185926-0800`
...
### `dpkg` source package: `ros-kinetic-ros-core=1.3.2-0xenial-20180516-185519-0800`

Binary Packages:

- `ros-kinetic-ros-core=1.3.2-0xenial-20180516-185519-0800`
...
### `dpkg` source package: `ros-kinetic-rosconsole-bridge=0.5.1-0xenial-20180222-205946-0800`

Binary Packages:

- `ros-kinetic-rosconsole-bridge=0.5.1-0xenial-20180222-205946-0800`
...
### `dpkg` source package: `ros-kinetic-tf-conversions=1.11.9-0xenial-20180516-163346-0800`

Binary Packages:

- `ros-kinetic-tf-conversions=1.11.9-0xenial-20180516-163346-0800`
...
### `dpkg` source package: `ros-kinetic-tf2-kdl=0.5.17-0xenial-20180516-161842-0800`

Binary Packages:

- `ros-kinetic-tf2-kdl=0.5.17-0xenial-20180516-161842-0800`
...
### `dpkg` source package: `ros-kinetic-tf2-msgs=0.5.17-0xenial-20180516-135344-0800`

Binary Packages:

- `ros-kinetic-tf2-msgs=0.5.17-0xenial-20180516-135344-0800`
...
### `dpkg` source package: `ros-kinetic-tf2-py=0.5.17-0xenial-20180516-160356-0800`

Binary Packages:

- `ros-kinetic-tf2-py=0.5.17-0xenial-20180516-160356-0800`
...
### `dpkg` source package: `ros-kinetic-tf2-ros=0.5.17-0xenial-20180516-160935-0800`

Binary Packages:

- `ros-kinetic-tf2-ros=0.5.17-0xenial-20180516-160935-0800`
...
### `dpkg` source package: `ros-kinetic-tf2=0.5.17-0xenial-20180516-135756-0800`

Binary Packages:

- `ros-kinetic-tf2=0.5.17-0xenial-20180516-135756-0800`
...
### `dpkg` source package: `ros-kinetic-tf=1.11.9-0xenial-20180516-161707-0800`

Binary Packages:

- `ros-kinetic-tf=1.11.9-0xenial-20180516-161707-0800`
...
### `dpkg` source package: `ros-kinetic-urdf=1.12.12-0xenial-20180316-123650-0800`

Binary Packages:

- `ros-kinetic-urdf=1.12.12-0xenial-20180316-123650-0800`
...
- `libpam-systemd:amd64=229-4ubuntu21.2`
- `libsystemd0:amd64=229-4ubuntu21.2`
- `libudev-dev:amd64=229-4ubuntu21.2`
...
```console
$ apt-get source -qq --print-uris systemd=229-4ubuntu21.2
'http://archive.ubuntu.com/ubuntu/pool/main/s/systemd/systemd_229-4ubuntu21.2.dsc' systemd_229-4ubuntu21.2.dsc 4124 SHA256:cafb2d2f7d5a1ac7fbf40713d0e949e0c79f534b8ed92b55b962434ce473fb4e
...
'http://archive.ubuntu.com/ubuntu/pool/main/s/systemd/systemd_229-4ubuntu21.2.debian.tar.xz' systemd_229-4ubuntu21.2.debian.tar.xz 259928 SHA256:935a2c2bfc434cc84678635fe05c49829b5b69e05dc3fbd55f797c91ac10cdce
```
