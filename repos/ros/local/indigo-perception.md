...
- Created: `2019-06-07T23:26:49.721231827Z`
...
### `dpkg` source package: `apparmor=2.10.95-0ubuntu2.6~14.04.4`

Binary Packages:

- `dh-apparmor=2.10.95-0ubuntu2.6~14.04.4`
...
```console
$ apt-get source -qq --print-uris apparmor=2.10.95-0ubuntu2.6~14.04.4
'http://archive.ubuntu.com/ubuntu/pool/main/a/apparmor/apparmor_2.10.95-0ubuntu2.6~14.04.4.dsc' apparmor_2.10.95-0ubuntu2.6~14.04.4.dsc 3161 SHA256:8091802ab8cba9fdef1dc7c164d3580cc356e346b863b60ef741e6e36bf53738
...
'http://archive.ubuntu.com/ubuntu/pool/main/a/apparmor/apparmor_2.10.95-0ubuntu2.6~14.04.4.debian.tar.gz' apparmor_2.10.95-0ubuntu2.6~14.04.4.debian.tar.gz 187519 SHA256:aa9ea2ede0b4599baf59c8b0205c0ad23a2d731b63680ddb4a2f783a5cb84a94
```
...
### `dpkg` source package: `gettext=0.18.3.1-1ubuntu3.1`

Binary Packages:

- `gettext=0.18.3.1-1ubuntu3.1`
- `gettext-base=0.18.3.1-1ubuntu3.1`
- `libasprintf-dev:amd64=0.18.3.1-1ubuntu3.1`
- `libasprintf0c2:amd64=0.18.3.1-1ubuntu3.1`
- `libgettextpo-dev:amd64=0.18.3.1-1ubuntu3.1`
- `libgettextpo0:amd64=0.18.3.1-1ubuntu3.1`
...
```console
$ apt-get source -qq --print-uris gettext=0.18.3.1-1ubuntu3.1
'http://archive.ubuntu.com/ubuntu/pool/main/g/gettext/gettext_0.18.3.1-1ubuntu3.1.dsc' gettext_0.18.3.1-1ubuntu3.1.dsc 2328 SHA256:94482332cde883e7026fe5c87f617065bb9842b1e8ba453f6ce2441003cebcd2
...
### `dpkg` source package: `libxslt=1.1.28-2ubuntu0.2`

Binary Packages:

- `libxslt1.1:amd64=1.1.28-2ubuntu0.2`
...
```console
$ apt-get source -qq --print-uris libxslt=1.1.28-2ubuntu0.2
'http://archive.ubuntu.com/ubuntu/pool/main/libx/libxslt/libxslt_1.1.28-2ubuntu0.2.dsc' libxslt_1.1.28-2ubuntu0.2.dsc 2424 SHA256:bf7ec1368c663d23b4fcc73526784f5369128f5ef395e04494c685fc6921e2cf
...
'http://archive.ubuntu.com/ubuntu/pool/main/libx/libxslt/libxslt_1.1.28-2ubuntu0.2.debian.tar.gz' libxslt_1.1.28-2ubuntu0.2.debian.tar.gz 48789 SHA256:60d8f090425febbc0b84dbcb786db6d6f21d9848562d10084d8f21c15bc9898c
```
...
### `dpkg` source package: `opencv=2.4.8+dfsg1-2ubuntu1.2`

Binary Packages:

- `libcv-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libcvaux-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libhighgui-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-calib3d-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-calib3d2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-contrib-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-contrib2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-core-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-core2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-dev=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-features2d-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-features2d2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-flann-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-flann2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-gpu-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-gpu2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-highgui-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-highgui2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-imgproc-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-imgproc2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-legacy-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-legacy2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-ml-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-ml2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-objdetect-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-objdetect2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-ocl-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-ocl2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-photo-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-photo2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-stitching-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-stitching2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-superres-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-superres2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-ts-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-ts2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-video-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-video2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-videostab-dev:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv-videostab2.4:amd64=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv2.4-java=2.4.8+dfsg1-2ubuntu1.2`
- `libopencv2.4-jni=2.4.8+dfsg1-2ubuntu1.2`
- `opencv-data=2.4.8+dfsg1-2ubuntu1.2`
- `python-opencv=2.4.8+dfsg1-2ubuntu1.2`
...
```console
$ apt-get source -qq --print-uris opencv=2.4.8+dfsg1-2ubuntu1.2
'http://archive.ubuntu.com/ubuntu/pool/universe/o/opencv/opencv_2.4.8+dfsg1-2ubuntu1.2.dsc' opencv_2.4.8+dfsg1-2ubuntu1.2.dsc 5607 SHA256:04b2c0f40f35d6de33bf2ff963b78141a60b0f41961f6e40abf424a469a3fd40
...
'http://archive.ubuntu.com/ubuntu/pool/universe/o/opencv/opencv_2.4.8+dfsg1-2ubuntu1.2.debian.tar.gz' opencv_2.4.8+dfsg1-2ubuntu1.2.debian.tar.gz 39452 SHA256:b9dfe40814908245db7a7f8007eb2b58dfcf16204381661ef8c0e61ce332690f
```
...
'http://packages.ros.org/ros/ubuntu/pool/main/p/pcl-1.7/pcl-1.7_1.7.1-3+trusty3.debian.tar.xz' pcl-1.7_1.7.1-3+trusty3.debian.tar.xz 7296 SHA512:c6e3e3518729e45db96eae9509122f0e3f271f0cd8b6d7e1b15888063ee818b04bf6b49ceb8e92d08457962281099232c91be21716377562f53250240cbf6e4b
'http://packages.ros.org/ros/ubuntu/pool/main/p/pcl-1.7/pcl-1.7_1.7.1-3+trusty3.dsc' pcl-1.7_1.7.1-3+trusty3.dsc 4993 SHA512:168e8db61d389bb678578793dabcdb333e3d98957318d7a12e0b053b54807e32cda54cf22aa3e82b1dc1529a592634ba06875814f378213330280ba60a010360
'http://packages.ros.org/ros/ubuntu/pool/main/p/pcl-1.7/pcl-1.7_1.7.1.orig.tar.gz' pcl-1.7_1.7.1.orig.tar.gz 64085158 SHA512:222a7e678b465bcf56e56f173b44f849d59e38c1d6075d8c65c4a2b711c8f564b447b3f9880b8bcfd523fb38fcf5ed8427b21fcf079dcc567b4ee27d2bd27c2a
```
...
### `dpkg` source package: `ros-indigo-camera-calibration-parsers=1.11.13-0trusty-20190604-105550-0800`

Binary Packages:

- `ros-indigo-camera-calibration-parsers=1.11.13-0trusty-20190604-105550-0800`
...
### `dpkg` source package: `ros-indigo-camera-calibration=1.12.23-0trusty-20190604-120323-0800`

Binary Packages:

- `ros-indigo-camera-calibration=1.12.23-0trusty-20190604-120323-0800`
...
### `dpkg` source package: `ros-indigo-camera-info-manager=1.11.13-0trusty-20190604-121448-0800`

Binary Packages:

- `ros-indigo-camera-info-manager=1.11.13-0trusty-20190604-121448-0800`
...
### `dpkg` source package: `ros-indigo-compressed-depth-image-transport=1.9.5-0trusty-20190604-122603-0800`

Binary Packages:

- `ros-indigo-compressed-depth-image-transport=1.9.5-0trusty-20190604-122603-0800`
...
### `dpkg` source package: `ros-indigo-compressed-image-transport=1.9.5-0trusty-20190604-122604-0800`

Binary Packages:

- `ros-indigo-compressed-image-transport=1.9.5-0trusty-20190604-122604-0800`
...
### `dpkg` source package: `ros-indigo-cv-bridge=1.11.16-0trusty-20190604-114342-0800`

Binary Packages:

- `ros-indigo-cv-bridge=1.11.16-0trusty-20190604-114342-0800`
...
### `dpkg` source package: `ros-indigo-depth-image-proc=1.12.23-0trusty-20190604-124608-0800`

Binary Packages:

- `ros-indigo-depth-image-proc=1.12.23-0trusty-20190604-124608-0800`
...
### `dpkg` source package: `ros-indigo-image-common=1.11.13-0trusty-20190604-125544-0800`

Binary Packages:

- `ros-indigo-image-common=1.11.13-0trusty-20190604-125544-0800`
...
### `dpkg` source package: `ros-indigo-image-geometry=1.11.16-0trusty-20190604-090824-0800`

Binary Packages:

- `ros-indigo-image-geometry=1.11.16-0trusty-20190604-090824-0800`
...
### `dpkg` source package: `ros-indigo-image-pipeline=1.12.23-0trusty-20190604-151702-0800`

Binary Packages:

- `ros-indigo-image-pipeline=1.12.23-0trusty-20190604-151702-0800`
...
### `dpkg` source package: `ros-indigo-image-proc=1.12.23-0trusty-20190604-124953-0800`

Binary Packages:

- `ros-indigo-image-proc=1.12.23-0trusty-20190604-124953-0800`
...
### `dpkg` source package: `ros-indigo-image-publisher=1.12.23-0trusty-20190604-123839-0800`

Binary Packages:

- `ros-indigo-image-publisher=1.12.23-0trusty-20190604-123839-0800`
...
### `dpkg` source package: `ros-indigo-image-rotate=1.12.23-0trusty-20190604-125614-0800`

Binary Packages:

- `ros-indigo-image-rotate=1.12.23-0trusty-20190604-125614-0800`
...
### `dpkg` source package: `ros-indigo-image-transport-plugins=1.9.5-0trusty-20190604-150653-0800`

Binary Packages:

- `ros-indigo-image-transport-plugins=1.9.5-0trusty-20190604-150653-0800`
...
### `dpkg` source package: `ros-indigo-image-transport=1.11.13-0trusty-20190604-120634-0800`

Binary Packages:

- `ros-indigo-image-transport=1.11.13-0trusty-20190604-120634-0800`
...
### `dpkg` source package: `ros-indigo-image-view=1.12.23-0trusty-20190604-123854-0800`

Binary Packages:

- `ros-indigo-image-view=1.12.23-0trusty-20190604-123854-0800`
...
### `dpkg` source package: `ros-indigo-laser-assembler=1.7.3-0trusty-20190604-134916-0800`

Binary Packages:

- `ros-indigo-laser-assembler=1.7.3-0trusty-20190604-134916-0800`
...
### `dpkg` source package: `ros-indigo-laser-filters=1.8.5-0trusty-20190604-134918-0800`

Binary Packages:

- `ros-indigo-laser-filters=1.8.5-0trusty-20190604-134918-0800`
...
### `dpkg` source package: `ros-indigo-laser-geometry=1.6.4-0trusty-20190604-130827-0800`

Binary Packages:

- `ros-indigo-laser-geometry=1.6.4-0trusty-20190604-130827-0800`
...
### `dpkg` source package: `ros-indigo-laser-pipeline=1.6.1-0trusty-20190604-140944-0800`

Binary Packages:

- `ros-indigo-laser-pipeline=1.6.1-0trusty-20190604-140944-0800`
...
### `dpkg` source package: `ros-indigo-pcl-conversions=0.2.1-0trusty-20190604-110126-0800`

Binary Packages:

- `ros-indigo-pcl-conversions=0.2.1-0trusty-20190604-110126-0800`
...
### `dpkg` source package: `ros-indigo-pcl-msgs=0.2.0-0trusty-20190604-090840-0800`

Binary Packages:

- `ros-indigo-pcl-msgs=0.2.0-0trusty-20190604-090840-0800`
...
### `dpkg` source package: `ros-indigo-pcl-ros=1.2.9-0trusty-20190604-130914-0800`

Binary Packages:

- `ros-indigo-pcl-ros=1.2.9-0trusty-20190604-130914-0800`
...
### `dpkg` source package: `ros-indigo-perception-pcl=1.2.9-0trusty-20190604-133322-0800`

Binary Packages:

- `ros-indigo-perception-pcl=1.2.9-0trusty-20190604-133322-0800`
...
### `dpkg` source package: `ros-indigo-perception=1.1.6-0trusty-20190604-152659-0800`

Binary Packages:

- `ros-indigo-perception=1.1.6-0trusty-20190604-152659-0800`
...
### `dpkg` source package: `ros-indigo-pointcloud-to-laserscan=1.3.1-0trusty-20190604-125736-0800`

Binary Packages:

- `ros-indigo-pointcloud-to-laserscan=1.3.1-0trusty-20190604-125736-0800`
...
### `dpkg` source package: `ros-indigo-polled-camera=1.11.13-0trusty-20190604-121721-0800`

Binary Packages:

- `ros-indigo-polled-camera=1.11.13-0trusty-20190604-121721-0800`
...
### `dpkg` source package: `ros-indigo-stereo-image-proc=1.12.23-0trusty-20190604-150410-0800`

Binary Packages:

- `ros-indigo-stereo-image-proc=1.12.23-0trusty-20190604-150410-0800`
...
### `dpkg` source package: `ros-indigo-tf2-geometry-msgs=0.5.20-0trusty-20190604-124659-0800`

Binary Packages:

- `ros-indigo-tf2-geometry-msgs=0.5.20-0trusty-20190604-124659-0800`
...
### `dpkg` source package: `ros-indigo-tf2-sensor-msgs=0.5.20-0trusty-20190604-124644-0800`

Binary Packages:

- `ros-indigo-tf2-sensor-msgs=0.5.20-0trusty-20190604-124644-0800`
...
### `dpkg` source package: `ros-indigo-theora-image-transport=1.9.5-0trusty-20190604-125434-0800`

Binary Packages:

- `ros-indigo-theora-image-transport=1.9.5-0trusty-20190604-125434-0800`
...
### `dpkg` source package: `ros-indigo-vision-opencv=1.11.16-0trusty-20190604-115406-0800`

Binary Packages:

- `ros-indigo-vision-opencv=1.11.16-0trusty-20190604-115406-0800`
...
- `libtiff5-dev:amd64=4.0.3-7ubuntu0.11`
- `libtiffxx5:amd64=4.0.3-7ubuntu0.11`
