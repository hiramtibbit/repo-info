...
- Created: `2018-12-29T00:52:41.367827745Z`
...
- `libassimp-dev=3.3.1~dfsg-4+b1`
- `libassimp3v5=3.3.1~dfsg-4+b1`
...
'http://deb.debian.org/debian/pool/main/a/assimp/assimp_3.3.1~dfsg-4.dsc' assimp_3.3.1~dfsg-4.dsc 2294 SHA256:c22a15c23b73175ef4148ff349c79eb408bc1b8ad04ff2e13e18ddd829078c38
'http://deb.debian.org/debian/pool/main/a/assimp/assimp_3.3.1~dfsg.orig.tar.gz' assimp_3.3.1~dfsg.orig.tar.gz 2398532 SHA256:3185674dbacc620827732d259c5cc822e30874e62bbeecc2a91a2926af11dbff
'http://deb.debian.org/debian/pool/main/a/assimp/assimp_3.3.1~dfsg-4.debian.tar.xz' assimp_3.3.1~dfsg-4.debian.tar.xz 19312 SHA256:78b7bf1dc62c2e9f6ca788ca0baf9000dd692d4c562d596b94d0f1c5f6adb2e9
```

Other potentially useful URLs:

- https://sources.debian.net/src/assimp/3.3.1~dfsg-4/ (for browsing the source)
- https://sources.debian.net/src/assimp/3.3.1~dfsg-4/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/assimp/3.3.1~dfsg-4/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `collada-dom=2.4.4+ds1-2`

Binary Packages:

- `libcollada-dom2.4-dp-dev=2.4.4+ds1-2+b2`
- `libcollada-dom2.4-dp0=2.4.4+ds1-2+b2`
...
```console
$ apt-get source -qq --print-uris collada-dom=2.4.4+ds1-2
'http://deb.debian.org/debian/pool/main/c/collada-dom/collada-dom_2.4.4+ds1-2.dsc' collada-dom_2.4.4+ds1-2.dsc 2404 SHA256:e994276141608dae68370276c1f857326e559a1e1ecf9057b0572b699e8ec6e7
'http://deb.debian.org/debian/pool/main/c/collada-dom/collada-dom_2.4.4+ds1.orig.tar.xz' collada-dom_2.4.4+ds1.orig.tar.xz 408084 SHA256:260146a1463ad73b93367e1a29b9384a7ea5b03e89e06ef259024f32cc04e005
'http://deb.debian.org/debian/pool/main/c/collada-dom/collada-dom_2.4.4+ds1-2.debian.tar.xz' collada-dom_2.4.4+ds1-2.debian.tar.xz 24260 SHA256:e4535d94dc2221029b357dd921d994ff6487df0a50fb583fb33e60d68b507c23
```

Other potentially useful URLs:

- https://sources.debian.net/src/collada-dom/2.4.4+ds1-2/ (for browsing the source)
- https://sources.debian.net/src/collada-dom/2.4.4+ds1-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/collada-dom/2.4.4+ds1-2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `ros-lunar-angles=1.9.11-0stretch-20180906-143605-0800`

Binary Packages:

- `ros-lunar-angles=1.9.11-0stretch-20180906-143605-0800`
...
### `dpkg` source package: `ros-lunar-collada-parser=1.12.12-0stretch-20180906-202044-0800`

Binary Packages:

- `ros-lunar-collada-parser=1.12.12-0stretch-20180906-202044-0800`
...
### `dpkg` source package: `ros-lunar-collada-urdf=1.12.12-0stretch-20181109-230128-0800`

Binary Packages:

- `ros-lunar-collada-urdf=1.12.12-0stretch-20181109-230128-0800`
...
### `dpkg` source package: `ros-lunar-control-msgs=1.4.0-1stretch-20181109-202357-0800`

Binary Packages:

- `ros-lunar-control-msgs=1.4.0-1stretch-20181109-202357-0800`
...
### `dpkg` source package: `ros-lunar-diagnostic-aggregator=1.9.3-0stretch-20181109-201052-0800`

Binary Packages:

- `ros-lunar-diagnostic-aggregator=1.9.3-0stretch-20181109-201052-0800`
...
### `dpkg` source package: `ros-lunar-diagnostic-analysis=1.9.3-0stretch-20181109-201102-0800`

Binary Packages:

- `ros-lunar-diagnostic-analysis=1.9.3-0stretch-20181109-201102-0800`
...
### `dpkg` source package: `ros-lunar-diagnostic-common-diagnostics=1.9.3-0stretch-20181117-125144-0800`

Binary Packages:

- `ros-lunar-diagnostic-common-diagnostics=1.9.3-0stretch-20181117-125144-0800`
...
### `dpkg` source package: `ros-lunar-diagnostic-updater=1.9.3-0stretch-20181109-201120-0800`

Binary Packages:

- `ros-lunar-diagnostic-updater=1.9.3-0stretch-20181109-201120-0800`
...
### `dpkg` source package: `ros-lunar-diagnostics=1.9.3-0stretch-20181117-132335-0800`

Binary Packages:

- `ros-lunar-diagnostics=1.9.3-0stretch-20181117-132335-0800`
...
### `dpkg` source package: `ros-lunar-eigen-conversions=1.11.9-0stretch-20181109-202643-0800`

Binary Packages:

- `ros-lunar-eigen-conversions=1.11.9-0stretch-20181109-202643-0800`
...
### `dpkg` source package: `ros-lunar-eigen-stl-containers=0.1.8-0stretch-20180808-131827-0800`

Binary Packages:

- `ros-lunar-eigen-stl-containers=0.1.8-0stretch-20180808-131827-0800`
...
### `dpkg` source package: `ros-lunar-executive-smach=2.0.1-0stretch-20181109-214752-0800`

Binary Packages:

- `ros-lunar-executive-smach=2.0.1-0stretch-20181109-214752-0800`
...
### `dpkg` source package: `ros-lunar-filters=1.8.1-0stretch-20180906-200425-0800`

Binary Packages:

- `ros-lunar-filters=1.8.1-0stretch-20180906-200425-0800`
...
### `dpkg` source package: `ros-lunar-geometric-shapes=0.5.4-0stretch-20181109-211221-0800`

Binary Packages:

- `ros-lunar-geometric-shapes=0.5.4-0stretch-20181109-211221-0800`
...
### `dpkg` source package: `ros-lunar-geometry=1.11.9-0stretch-20181117-131259-0800`

Binary Packages:

- `ros-lunar-geometry=1.11.9-0stretch-20181117-131259-0800`
...
### `dpkg` source package: `ros-lunar-joint-state-publisher=1.12.13-0stretch-20181109-213836-0800`

Binary Packages:

- `ros-lunar-joint-state-publisher=1.12.13-0stretch-20181109-213836-0800`
...
### `dpkg` source package: `ros-lunar-kdl-conversions=1.11.9-0stretch-20181109-203609-0800`

Binary Packages:

- `ros-lunar-kdl-conversions=1.11.9-0stretch-20181109-203609-0800`
...
### `dpkg` source package: `ros-lunar-kdl-parser=1.12.11-0stretch-20180906-202108-0800`

Binary Packages:

- `ros-lunar-kdl-parser=1.12.11-0stretch-20180906-202108-0800`
...
### `dpkg` source package: `ros-lunar-octomap=1.9.0-0stretch-20180808-131444-0800`

Binary Packages:

- `ros-lunar-octomap=1.9.0-0stretch-20180808-131444-0800`
...
### `dpkg` source package: `ros-lunar-orocos-kdl=1.3.1-0stretch-20180808-132102-0800`

Binary Packages:

- `ros-lunar-orocos-kdl=1.3.1-0stretch-20180808-132102-0800`
...
### `dpkg` source package: `ros-lunar-python-orocos-kdl=1.3.1-0stretch-20180808-132538-0800`

Binary Packages:

- `ros-lunar-python-orocos-kdl=1.3.1-0stretch-20180808-132538-0800`
...
### `dpkg` source package: `ros-lunar-python-qt-binding=0.3.4-0stretch-20180817-160604-0800`

Binary Packages:

- `ros-lunar-python-qt-binding=0.3.4-0stretch-20180817-160604-0800`
...
### `dpkg` source package: `ros-lunar-random-numbers=0.3.1-1stretch-20180808-131659-0800`

Binary Packages:

- `ros-lunar-random-numbers=0.3.1-1stretch-20180808-131659-0800`
...
### `dpkg` source package: `ros-lunar-resource-retriever=1.12.4-0stretch-20180906-144902-0800`

Binary Packages:

- `ros-lunar-resource-retriever=1.12.4-0stretch-20180906-144902-0800`
...
### `dpkg` source package: `ros-lunar-robot-model=1.12.11-0stretch-20181109-231032-0800`

Binary Packages:

- `ros-lunar-robot-model=1.12.11-0stretch-20181109-231032-0800`
...
### `dpkg` source package: `ros-lunar-robot-state-publisher=1.13.6-0stretch-20181117-122344-0800`

Binary Packages:

- `ros-lunar-robot-state-publisher=1.13.6-0stretch-20181117-122344-0800`
...
### `dpkg` source package: `ros-lunar-robot=1.3.2-0stretch-20181117-132412-0800`

Binary Packages:

- `ros-lunar-robot=1.3.2-0stretch-20181117-132412-0800`
...
### `dpkg` source package: `ros-lunar-self-test=1.9.3-0stretch-20181109-201642-0800`

Binary Packages:

- `ros-lunar-self-test=1.9.3-0stretch-20181109-201642-0800`
...
### `dpkg` source package: `ros-lunar-smach-msgs=2.0.1-0stretch-20180817-161236-0800`

Binary Packages:

- `ros-lunar-smach-msgs=2.0.1-0stretch-20180817-161236-0800`
...
### `dpkg` source package: `ros-lunar-smach-ros=2.0.1-0stretch-20181109-201801-0800`

Binary Packages:

- `ros-lunar-smach-ros=2.0.1-0stretch-20181109-201801-0800`
...
### `dpkg` source package: `ros-lunar-smach=2.0.1-0stretch-20180808-132134-0800`

Binary Packages:

- `ros-lunar-smach=2.0.1-0stretch-20180808-132134-0800`
...
### `dpkg` source package: `ros-lunar-tf-conversions=1.11.9-0stretch-20181117-130313-0800`

Binary Packages:

- `ros-lunar-tf-conversions=1.11.9-0stretch-20181117-130313-0800`
...
### `dpkg` source package: `ros-lunar-tf2-kdl=0.5.20-0stretch-20181117-104646-0800`

Binary Packages:

- `ros-lunar-tf2-kdl=0.5.20-0stretch-20181117-104646-0800`
...
### `dpkg` source package: `ros-lunar-tf2-msgs=0.5.20-0stretch-20181117-102322-0800`

Binary Packages:

- `ros-lunar-tf2-msgs=0.5.20-0stretch-20181117-102322-0800`
...
### `dpkg` source package: `ros-lunar-tf2-py=0.5.20-0stretch-20181117-103358-0800`

Binary Packages:

- `ros-lunar-tf2-py=0.5.20-0stretch-20181117-103358-0800`
...
### `dpkg` source package: `ros-lunar-tf2-ros=0.5.20-0stretch-20181117-104027-0800`

Binary Packages:

- `ros-lunar-tf2-ros=0.5.20-0stretch-20181117-104027-0800`
...
### `dpkg` source package: `ros-lunar-tf2=0.5.20-0stretch-20181117-103052-0800`

Binary Packages:

- `ros-lunar-tf2=0.5.20-0stretch-20181117-103052-0800`
...
### `dpkg` source package: `ros-lunar-tf=1.11.9-0stretch-20181117-121253-0800`

Binary Packages:

- `ros-lunar-tf=1.11.9-0stretch-20181117-121253-0800`
...
### `dpkg` source package: `ros-lunar-urdf-parser-plugin=1.12.12-0stretch-20180808-131756-0800`

Binary Packages:

- `ros-lunar-urdf-parser-plugin=1.12.12-0stretch-20180808-131756-0800`
...
### `dpkg` source package: `ros-lunar-urdf=1.12.12-0stretch-20180906-200641-0800`

Binary Packages:

- `ros-lunar-urdf=1.12.12-0stretch-20180906-200641-0800`
...
### `dpkg` source package: `ros-lunar-xacro=1.12.2-0stretch-20180906-213236-0800`

Binary Packages:

- `ros-lunar-xacro=1.12.2-0stretch-20180906-213236-0800`
