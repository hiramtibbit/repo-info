...
- Created: `2018-04-29T12:11:39.149160809Z`
...
- `libvorbisfile3:amd64=1.3.4-2+deb8u1`
...
### `dpkg` source package: `poco=1.3.6p1-5+deb8u1`

Binary Packages:

- `libpoco-dev=1.3.6p1-5+deb8u1`
- `libpococrypto9=1.3.6p1-5+deb8u1`
- `libpocodata9=1.3.6p1-5+deb8u1`
- `libpocofoundation9=1.3.6p1-5+deb8u1`
- `libpocomysql9=1.3.6p1-5+deb8u1`
- `libpoconet9=1.3.6p1-5+deb8u1`
- `libpoconetssl9=1.3.6p1-5+deb8u1`
- `libpocoodbc9=1.3.6p1-5+deb8u1`
- `libpocosqlite9=1.3.6p1-5+deb8u1`
- `libpocoutil9=1.3.6p1-5+deb8u1`
- `libpocoxml9=1.3.6p1-5+deb8u1`
- `libpocozip9=1.3.6p1-5+deb8u1`
...
```console
$ apt-get source -qq --print-uris poco=1.3.6p1-5+deb8u1
'http://security.debian.org/debian-security/pool/updates/main/p/poco/poco_1.3.6p1-5+deb8u1.dsc' poco_1.3.6p1-5+deb8u1.dsc 3127 SHA256:35c534b26f0548284616c799db6b5c0df55433ab6572d510a7cf1206a3c08142
'http://security.debian.org/debian-security/pool/updates/main/p/poco/poco_1.3.6p1-5+deb8u1.tar.gz' poco_1.3.6p1-5+deb8u1.tar.gz 3196093 SHA256:1949a91419addd2ac5fda0030873cfc7ed70f6ad75f8633b7612cfd477e36352
```

Other potentially useful URLs:

- https://sources.debian.net/src/poco/1.3.6p1-5+deb8u1/ (for browsing the source)
- https://sources.debian.net/src/poco/1.3.6p1-5+deb8u1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/poco/1.3.6p1-5+deb8u1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `ros-kinetic-actionlib=1.11.13-0jessie-20180316-113724-0800`

Binary Packages:

- `ros-kinetic-actionlib=1.11.13-0jessie-20180316-113724-0800`
...
### `dpkg` source package: `ros-kinetic-angles=1.9.11-0jessie-20180222-174803-0800`

Binary Packages:

- `ros-kinetic-angles=1.9.11-0jessie-20180222-174803-0800`
...
### `dpkg` source package: `ros-kinetic-bond-core=1.8.1-0jessie-20180222-195118-0800`

Binary Packages:

- `ros-kinetic-bond-core=1.8.1-0jessie-20180222-195118-0800`
...
### `dpkg` source package: `ros-kinetic-bond=1.8.1-0jessie-20180222-172734-0800`

Binary Packages:

- `ros-kinetic-bond=1.8.1-0jessie-20180222-172734-0800`
...
### `dpkg` source package: `ros-kinetic-bondcpp=1.8.1-0jessie-20180222-193910-0800`

Binary Packages:

- `ros-kinetic-bondcpp=1.8.1-0jessie-20180222-193910-0800`
...
### `dpkg` source package: `ros-kinetic-bondpy=1.8.1-0jessie-20180222-194413-0800`

Binary Packages:

- `ros-kinetic-bondpy=1.8.1-0jessie-20180222-194413-0800`
...
### `dpkg` source package: `ros-kinetic-class-loader=0.3.9-0jessie-20180316-114315-0800`

Binary Packages:

- `ros-kinetic-class-loader=0.3.9-0jessie-20180316-114315-0800`
...
### `dpkg` source package: `ros-kinetic-collada-parser=1.12.11-0jessie-20180417-072818-0800`

Binary Packages:

- `ros-kinetic-collada-parser=1.12.11-0jessie-20180417-072818-0800`
...
### `dpkg` source package: `ros-kinetic-collada-urdf=1.12.11-0jessie-20180423-165730-0800`

Binary Packages:

- `ros-kinetic-collada-urdf=1.12.11-0jessie-20180423-165730-0800`
...
### `dpkg` source package: `ros-kinetic-control-msgs=1.4.0-0jessie-20180222-174730-0800`

Binary Packages:

- `ros-kinetic-control-msgs=1.4.0-0jessie-20180222-174730-0800`
...
### `dpkg` source package: `ros-kinetic-diagnostic-aggregator=1.9.2-0jessie-20180316-123325-0800`

Binary Packages:

- `ros-kinetic-diagnostic-aggregator=1.9.2-0jessie-20180316-123325-0800`
...
### `dpkg` source package: `ros-kinetic-diagnostic-analysis=1.9.2-0jessie-20180222-201130-0800`

Binary Packages:

- `ros-kinetic-diagnostic-analysis=1.9.2-0jessie-20180222-201130-0800`
...
### `dpkg` source package: `ros-kinetic-diagnostic-common-diagnostics=1.9.2-0jessie-20180316-170521-0800`

Binary Packages:

- `ros-kinetic-diagnostic-common-diagnostics=1.9.2-0jessie-20180316-170521-0800`
...
### `dpkg` source package: `ros-kinetic-diagnostic-updater=1.9.2-0jessie-20180222-195825-0800`

Binary Packages:

- `ros-kinetic-diagnostic-updater=1.9.2-0jessie-20180222-195825-0800`
...
### `dpkg` source package: `ros-kinetic-diagnostics=1.9.2-0jessie-20180316-170944-0800`

Binary Packages:

- `ros-kinetic-diagnostics=1.9.2-0jessie-20180316-170944-0800`
...
### `dpkg` source package: `ros-kinetic-dynamic-reconfigure=1.5.49-0jessie-20180316-113613-0800`

Binary Packages:

- `ros-kinetic-dynamic-reconfigure=1.5.49-0jessie-20180316-113613-0800`
...
### `dpkg` source package: `ros-kinetic-eigen-conversions=1.11.9-0jessie-20180222-173334-0800`

Binary Packages:

- `ros-kinetic-eigen-conversions=1.11.9-0jessie-20180222-173334-0800`
...
### `dpkg` source package: `ros-kinetic-eigen-stl-containers=0.1.8-0jessie-20180222-170312-0800`

Binary Packages:

- `ros-kinetic-eigen-stl-containers=0.1.8-0jessie-20180222-170312-0800`
...
### `dpkg` source package: `ros-kinetic-executive-smach=2.0.1-0jessie-20180316-140622-0800`

Binary Packages:

- `ros-kinetic-executive-smach=2.0.1-0jessie-20180316-140622-0800`
...
### `dpkg` source package: `ros-kinetic-filters=1.7.5-0jessie-20180316-123356-0800`

Binary Packages:

- `ros-kinetic-filters=1.7.5-0jessie-20180316-123356-0800`
...
### `dpkg` source package: `ros-kinetic-geometric-shapes=0.5.3-1jessie-20180423-163524-0800`

Binary Packages:

- `ros-kinetic-geometric-shapes=0.5.3-1jessie-20180423-163524-0800`
...
### `dpkg` source package: `ros-kinetic-geometry=1.11.9-0jessie-20180316-173056-0800`

Binary Packages:

- `ros-kinetic-geometry=1.11.9-0jessie-20180316-173056-0800`
...
### `dpkg` source package: `ros-kinetic-joint-state-publisher=1.12.13-0jessie-20180319-132547-0800`

Binary Packages:

- `ros-kinetic-joint-state-publisher=1.12.13-0jessie-20180319-132547-0800`
...
### `dpkg` source package: `ros-kinetic-kdl-conversions=1.11.9-0jessie-20180222-173321-0800`

Binary Packages:

- `ros-kinetic-kdl-conversions=1.11.9-0jessie-20180222-173321-0800`
...
### `dpkg` source package: `ros-kinetic-kdl-parser=1.12.10-0jessie-20180316-141418-0800`

Binary Packages:

- `ros-kinetic-kdl-parser=1.12.10-0jessie-20180316-141418-0800`
...
### `dpkg` source package: `ros-kinetic-nodelet-core=1.9.14-0jessie-20180316-141205-0800`

Binary Packages:

- `ros-kinetic-nodelet-core=1.9.14-0jessie-20180316-141205-0800`
...
### `dpkg` source package: `ros-kinetic-nodelet-topic-tools=1.9.14-0jessie-20180316-124025-0800`

Binary Packages:

- `ros-kinetic-nodelet-topic-tools=1.9.14-0jessie-20180316-124025-0800`
...
### `dpkg` source package: `ros-kinetic-nodelet=1.9.14-0jessie-20180316-123359-0800`

Binary Packages:

- `ros-kinetic-nodelet=1.9.14-0jessie-20180316-123359-0800`
...
### `dpkg` source package: `ros-kinetic-octomap=1.8.1-0jessie-20180222-171529-0800`

Binary Packages:

- `ros-kinetic-octomap=1.8.1-0jessie-20180222-171529-0800`
...
### `dpkg` source package: `ros-kinetic-orocos-kdl=1.3.1-0jessie-20180222-171733-0800`

Binary Packages:

- `ros-kinetic-orocos-kdl=1.3.1-0jessie-20180222-171733-0800`
...
### `dpkg` source package: `ros-kinetic-pluginlib=1.11.3-0jessie-20180316-115349-0800`

Binary Packages:

- `ros-kinetic-pluginlib=1.11.3-0jessie-20180316-115349-0800`
...
### `dpkg` source package: `ros-kinetic-python-orocos-kdl=1.3.1-0jessie-20180222-172324-0800`

Binary Packages:

- `ros-kinetic-python-orocos-kdl=1.3.1-0jessie-20180222-172324-0800`
...
### `dpkg` source package: `ros-kinetic-python-qt-binding=0.3.3-0jessie-20180222-173633-0800`

Binary Packages:

- `ros-kinetic-python-qt-binding=0.3.3-0jessie-20180222-173633-0800`
...
### `dpkg` source package: `ros-kinetic-random-numbers=0.3.1-0jessie-20180222-172528-0800`

Binary Packages:

- `ros-kinetic-random-numbers=0.3.1-0jessie-20180222-172528-0800`
...
### `dpkg` source package: `ros-kinetic-resource-retriever=1.12.4-0jessie-20180319-132454-0800`

Binary Packages:

- `ros-kinetic-resource-retriever=1.12.4-0jessie-20180319-132454-0800`
...
### `dpkg` source package: `ros-kinetic-robot-model=1.12.11-0jessie-20180423-172717-0800`

Binary Packages:

- `ros-kinetic-robot-model=1.12.11-0jessie-20180423-172717-0800`
...
### `dpkg` source package: `ros-kinetic-robot-state-publisher=1.13.6-0jessie-20180405-130556-0800`

Binary Packages:

- `ros-kinetic-robot-state-publisher=1.13.6-0jessie-20180405-130556-0800`
...
### `dpkg` source package: `ros-kinetic-robot=1.3.2-0jessie-20180423-173717-0800`

Binary Packages:

- `ros-kinetic-robot=1.3.2-0jessie-20180423-173717-0800`
...
### `dpkg` source package: `ros-kinetic-ros-base=1.3.2-0jessie-20180404-184853-0800`

Binary Packages:

- `ros-kinetic-ros-base=1.3.2-0jessie-20180404-184853-0800`
...
### `dpkg` source package: `ros-kinetic-self-test=1.9.2-0jessie-20180222-200604-0800`

Binary Packages:

- `ros-kinetic-self-test=1.9.2-0jessie-20180222-200604-0800`
...
### `dpkg` source package: `ros-kinetic-smach-msgs=2.0.1-0jessie-20180222-173810-0800`

Binary Packages:

- `ros-kinetic-smach-msgs=2.0.1-0jessie-20180222-173810-0800`
...
### `dpkg` source package: `ros-kinetic-smach-ros=2.0.1-0jessie-20180316-123040-0800`

Binary Packages:

- `ros-kinetic-smach-ros=2.0.1-0jessie-20180316-123040-0800`
...
### `dpkg` source package: `ros-kinetic-smach=2.0.1-0jessie-20180222-174625-0800`

Binary Packages:

- `ros-kinetic-smach=2.0.1-0jessie-20180222-174625-0800`
...
### `dpkg` source package: `ros-kinetic-smclib=1.8.1-0jessie-20180222-174545-0800`

Binary Packages:

- `ros-kinetic-smclib=1.8.1-0jessie-20180222-174545-0800`
...
### `dpkg` source package: `ros-kinetic-tf-conversions=1.11.9-0jessie-20180316-172234-0800`

Binary Packages:

- `ros-kinetic-tf-conversions=1.11.9-0jessie-20180316-172234-0800`
...
### `dpkg` source package: `ros-kinetic-tf2-kdl=0.5.17-0jessie-20180316-140947-0800`

Binary Packages:

- `ros-kinetic-tf2-kdl=0.5.17-0jessie-20180316-140947-0800`
...
### `dpkg` source package: `ros-kinetic-tf2-msgs=0.5.17-0jessie-20180222-174018-0800`

Binary Packages:

- `ros-kinetic-tf2-msgs=0.5.17-0jessie-20180222-174018-0800`
...
### `dpkg` source package: `ros-kinetic-tf2-py=0.5.17-0jessie-20180222-205704-0800`

Binary Packages:

- `ros-kinetic-tf2-py=0.5.17-0jessie-20180222-205704-0800`
...
### `dpkg` source package: `ros-kinetic-tf2-ros=0.5.17-0jessie-20180316-123109-0800`

Binary Packages:

- `ros-kinetic-tf2-ros=0.5.17-0jessie-20180316-123109-0800`
...
### `dpkg` source package: `ros-kinetic-tf2=0.5.17-0jessie-20180222-174621-0800`

Binary Packages:

- `ros-kinetic-tf2=0.5.17-0jessie-20180222-174621-0800`
...
### `dpkg` source package: `ros-kinetic-tf=1.11.9-0jessie-20180316-140913-0800`

Binary Packages:

- `ros-kinetic-tf=1.11.9-0jessie-20180316-140913-0800`
...
### `dpkg` source package: `ros-kinetic-urdf-parser-plugin=1.12.12-0jessie-20180222-175033-0800`

Binary Packages:

- `ros-kinetic-urdf-parser-plugin=1.12.12-0jessie-20180222-175033-0800`
...
### `dpkg` source package: `ros-kinetic-urdf=1.12.12-0jessie-20180316-123530-0800`

Binary Packages:

- `ros-kinetic-urdf=1.12.12-0jessie-20180316-123530-0800`
...
### `dpkg` source package: `ros-kinetic-xacro=1.11.3-0jessie-20180328-050539-0800`

Binary Packages:

- `ros-kinetic-xacro=1.11.3-0jessie-20180328-050539-0800`
