...
### `flink:1.5.1-hadoop28-alpine` - linux; arm64 variant v8
...
### `flink:1.5.1-hadoop28-alpine` - linux; 386
...
### `flink:1.5.1-hadoop28-alpine` - linux; ppc64le
...
### `flink:1.5.1-hadoop28-alpine` - linux; s390x
