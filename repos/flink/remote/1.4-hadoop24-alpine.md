...
### `flink:1.4-hadoop24-alpine` - linux; arm variant v6
...
### `flink:1.4-hadoop24-alpine` - linux; arm64 variant v8
...
### `flink:1.4-hadoop24-alpine` - linux; 386
...
### `flink:1.4-hadoop24-alpine` - linux; ppc64le
...
### `flink:1.4-hadoop24-alpine` - linux; s390x
