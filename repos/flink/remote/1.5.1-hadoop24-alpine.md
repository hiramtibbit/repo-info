...
### `flink:1.5.1-hadoop24-alpine` - linux; arm64 variant v8
...
### `flink:1.5.1-hadoop24-alpine` - linux; 386
...
### `flink:1.5.1-hadoop24-alpine` - linux; ppc64le
...
### `flink:1.5.1-hadoop24-alpine` - linux; s390x
