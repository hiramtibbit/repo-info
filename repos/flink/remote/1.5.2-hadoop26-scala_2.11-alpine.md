...
### `flink:1.5.2-hadoop26-scala_2.11-alpine` - linux; arm64 variant v8
...
### `flink:1.5.2-hadoop26-scala_2.11-alpine` - linux; 386
...
### `flink:1.5.2-hadoop26-scala_2.11-alpine` - linux; ppc64le
