...
### `flink:1.7.0-hadoop27` - linux; arm variant v5
...
### `flink:1.7.0-hadoop27` - linux; arm variant v7
...
### `flink:1.7.0-hadoop27` - linux; arm64 variant v8
...
### `flink:1.7.0-hadoop27` - linux; 386
...
### `flink:1.7.0-hadoop27` - linux; ppc64le
