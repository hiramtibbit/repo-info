...
### `flink:1.7.0-hadoop24-scala_2.12` - linux; amd64
...
### `flink:1.7.0-hadoop24-scala_2.12` - linux; arm variant v5
...
### `flink:1.7.0-hadoop24-scala_2.12` - linux; arm variant v7
...
### `flink:1.7.0-hadoop24-scala_2.12` - linux; arm64 variant v8
...
### `flink:1.7.0-hadoop24-scala_2.12` - linux; 386
...
### `flink:1.7.0-hadoop24-scala_2.12` - linux; ppc64le
