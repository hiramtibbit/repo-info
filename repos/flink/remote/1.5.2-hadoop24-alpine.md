...
### `flink:1.5.2-hadoop24-alpine` - linux; amd64
...
### `flink:1.5.2-hadoop24-alpine` - linux; arm variant v6
...
### `flink:1.5.2-hadoop24-alpine` - linux; arm64 variant v8
...
### `flink:1.5.2-hadoop24-alpine` - linux; ppc64le
