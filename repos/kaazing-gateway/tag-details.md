...
```console
$ docker pull kaazing-gateway@sha256:7df1b37e680451a45d98e44c73b95b7d626b7c457c036f456f77f6f095f93ea1
```
...
```console
$ docker pull kaazing-gateway@sha256:0411d2b3368233877a7873a4900b18550ce41735a087566936eac1c7901ff208
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **244.2 MB (244223505 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60ce0d384bb0daae3d0a1f52a4b8a20df64746df4ad960bea4c7f9b343ff51b0`
...
# Thu, 15 Feb 2018 17:22:29 GMT
RUN curl -fSL -o gateway.tar.gz $KAAZING_GATEWAY_URL 	&& curl -fSL -o gateway.tar.gz.asc ${KAAZING_GATEWAY_URL}.asc 	&& gpg --verify gateway.tar.gz.asc 	&& tar -xvf gateway.tar.gz --strip-components=1 	&& rm gateway.tar.gz*
# Thu, 15 Feb 2018 17:22:30 GMT
ENV GATEWAY_OPTS=-Xmx512m -Djava.security.egd=file:/dev/urandom
# Thu, 15 Feb 2018 17:22:30 GMT
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/kaazing-gateway/bin
# Thu, 15 Feb 2018 17:22:31 GMT
EXPOSE 8000/tcp
# Thu, 15 Feb 2018 17:22:31 GMT
CMD ["gateway.start"]
```
...
-	Layers:
	...
	-	`sha256:e511da65ffabe622bcb6fa89b699e80f94ec7185a95076cd3b4cabc101bd2d11`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:cad8547ba07969b7ab05f519d82b78b78930dd0761f7dae361db838287e24437`  
		Last Modified: Thu, 15 Feb 2018 17:22:48 GMT  
		Size: 3.3 KB (3282 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e194ffd6b62b98fe5870b54e2329748cf89ecdcacecf1a46a9090134cb22881e`  
		Last Modified: Thu, 15 Feb 2018 17:22:50 GMT  
		Size: 104.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:aefe90d5ffae2786e807563f9b2f0f2f512a3ff123ee5dc7f149ef113efd6647`  
		Last Modified: Thu, 15 Feb 2018 17:22:51 GMT  
