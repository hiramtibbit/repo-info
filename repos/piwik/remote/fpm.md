...
```console
$ docker pull piwik@sha256:ffc6125bbecf75fdc263969aa93626a24c743aea682a2e38f57dc1fb407a6cc7
```
...
```console
$ docker pull piwik@sha256:911df364f5ca0ae280dc00515ef8fb81df2c0be8ed0ce029dedc7db824cbe5bf
```
