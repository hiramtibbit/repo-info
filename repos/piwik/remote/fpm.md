...
```console
$ docker pull piwik@sha256:7d8732212fd7fe4be6c8bbff3e657d1ab685076a9fc4430d1ca74f9f2bf01ab0
```
...
```console
$ docker pull piwik@sha256:cfca74d8feed9d7a816e0361459c40794914600e1d4433f4a6e3754fba82b481
```
