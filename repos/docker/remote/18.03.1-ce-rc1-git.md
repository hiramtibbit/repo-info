...
### `docker:18.03.1-ce-rc1-git` - linux; amd64
...
### `docker:18.03.1-ce-rc1-git` - linux; arm variant v6
...
### `docker:18.03.1-ce-rc1-git` - linux; arm64 variant v8
...
### `docker:18.03.1-ce-rc1-git` - linux; ppc64le
...
### `docker:18.03.1-ce-rc1-git` - linux; s390x
