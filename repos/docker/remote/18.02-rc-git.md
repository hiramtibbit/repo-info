...
```console
$ docker pull docker@sha256:26e95afbfadb87a57a9715c0ee344119990862c5377a2077b69d8b098ef241e6
```
...
### `docker:18.02-rc-git` - linux; arm variant v6
...
### `docker:18.02-rc-git` - linux; arm64 variant v8
