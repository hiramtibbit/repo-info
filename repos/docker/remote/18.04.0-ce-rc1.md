...
### `docker:18.04.0-ce-rc1` - linux; arm variant v6
...
### `docker:18.04.0-ce-rc1` - linux; arm64 variant v8
...
### `docker:18.04.0-ce-rc1` - linux; ppc64le
...
### `docker:18.04.0-ce-rc1` - linux; s390x
