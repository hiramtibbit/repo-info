...
```console
$ docker pull docker@sha256:fd6f98c37d1f9d550097dbd0193927aa0ab4d290bc9f0fe25b52e9f2cec3f2e7
```
...
```console
$ docker pull docker@sha256:f56d2e43b96246e63eae63dd815c3ab91849c91b7e4e04cf3ff43974977f03d1
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **46.8 MB (46833173 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8ca803853d12a3446c7b0141698524ff94791fb996571aede92114701b48e553`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["sh"]`
