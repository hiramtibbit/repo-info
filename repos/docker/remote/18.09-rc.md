...
```console
$ docker pull docker@sha256:bea298382299fcc3eeea8d6367ffe1d67b51de6a1bad12614b03bc716c8442c9
```
...
```console
$ docker pull docker@sha256:ceaed0d09f46e8747d4c06611afd1aa9e95a22c227f311318a4fddcd61146551
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **47.2 MB (47218500 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:387d20ca9c8c749f907765932310cb0161e3575880d2278c1fc9ce8bcadd5758`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["sh"]`
...
```console
$ docker pull docker@sha256:9c4318a9390d0f7a3d2a2fcbee4b1cf66d59450576b62d7b13c7a1feed4ddb42
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **45.2 MB (45172877 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3a4f95b2c047de3fd0a2e43e5b1d10be5f0a76b56dc2c0ca300f7f9746415314`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["sh"]`
