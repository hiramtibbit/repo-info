...
-	[`docker:18.09.5`](#docker18095)
-	[`docker:18.09.5-dind`](#docker18095-dind)
-	[`docker:18.09.5-git`](#docker18095-git)
-	[`docker:18.09-dind`](#docker1809-dind)
-	[`docker:18.09-git`](#docker1809-git)
-	[`docker:18-dind`](#docker18-dind)
-	[`docker:18-git`](#docker18-git)
-	[`docker:19.03.0-beta2`](#docker19030-beta2)
-	[`docker:19.03.0-beta2-dind`](#docker19030-beta2-dind)
-	[`docker:19.03.0-beta2-git`](#docker19030-beta2-git)
...
```console
$ docker pull docker@sha256:991ea33ef5a2c9cb90733f5916eca9d1a920b47e60ca22b774da8a23700d1c3b
```
...
```console
$ docker pull docker@sha256:36c79a394eb9bf14c9101044bb427f9ddfbd3d631e2f42e2685e0cf30d1394c2
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **48.7 MB (48727533 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:59879be5a431d9009ffd2138ce6e5e87a7ec987c8f66b199fbac74bf0b42c50c`
-	Entrypoint: `["dockerd-entrypoint.sh"]`
-	Default Command: `[]`
...
RUN set -eux; 	wget -O /usr/local/bin/dind "https://raw.githubusercontent.com/docker/docker/${DIND_COMMIT}/hack/dind"; 	chmod +x /usr/local/bin/dind
# Thu, 18 Apr 2019 07:49:56 GMT
COPY file:779dca3bbfbd33f9223bd74feaf003513d1936b73cdbfb2a8e52d9a12505d90c in /usr/local/bin/ 
# Thu, 18 Apr 2019 07:49:57 GMT
VOLUME [/var/lib/docker]
# Thu, 18 Apr 2019 07:49:57 GMT
EXPOSE 2375
# Thu, 18 Apr 2019 07:49:58 GMT
ENTRYPOINT ["dockerd-entrypoint.sh"]
# Thu, 18 Apr 2019 07:49:58 GMT
CMD []
```
...
-	Layers:
	...
	-	`sha256:d34ebaf94d3db7687744b9f260cbf918f1c9431ef8001d4a3ce5c14ec2c33c92`  
		...
		Size: 757.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:14beb5dd3cf9e6b3747f87c9b4a7ffead62464ad8bf3476ad1d95ca6be984cea`  
		Last Modified: Thu, 18 Apr 2019 07:50:53 GMT  
		Size: 580.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull docker@sha256:7e51240d3cd892ebea32037d102e609176dce9637fd6bc311df954ef06b192e1
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.0 MB (49021784 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e34b4c53f7c829d71622c4f08930e9670f154468b78a5bfa2658d3e434cb7690`
-	Entrypoint: `["dockerd-entrypoint.sh"]`
-	Default Command: `[]`
...
RUN set -eux; 	wget -O /usr/local/bin/dind "https://raw.githubusercontent.com/docker/docker/${DIND_COMMIT}/hack/dind"; 	chmod +x /usr/local/bin/dind
# Thu, 18 Apr 2019 08:40:16 GMT
COPY file:779dca3bbfbd33f9223bd74feaf003513d1936b73cdbfb2a8e52d9a12505d90c in /usr/local/bin/ 
# Thu, 18 Apr 2019 08:40:17 GMT
VOLUME [/var/lib/docker]
# Thu, 18 Apr 2019 08:40:18 GMT
EXPOSE 2375
# Thu, 18 Apr 2019 08:40:19 GMT
ENTRYPOINT ["dockerd-entrypoint.sh"]
# Thu, 18 Apr 2019 08:40:19 GMT
CMD []
```
...
-	Layers:
	...
	-	`sha256:b7423cacabf10cdf2605795d9f46ee8436542d27935da2596a3f833dea772671`  
		...
		Size: 756.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4b2d9ef56a5b6b810a3c3dfb42e14e48664cd3eb7a653d1042ae9c54a3ea6152`  
		Last Modified: Thu, 18 Apr 2019 08:41:36 GMT  
		Size: 578.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull docker@sha256:0488c2c9a1b10cba2589019d286bec6973dcd4b783332988ff63d43c2eb571ea
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **49.0 MB (49037614 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9fe2951fe73b3ce0f2a0847a13c2a2d7f7533d0629d3ac33641ec5c64623d87a`
-	Entrypoint: `["dockerd-entrypoint.sh"]`
-	Default Command: `[]`
...
RUN set -eux; 	wget -O /usr/local/bin/dind "https://raw.githubusercontent.com/docker/docker/${DIND_COMMIT}/hack/dind"; 	chmod +x /usr/local/bin/dind
# Thu, 18 Apr 2019 08:18:21 GMT
COPY file:779dca3bbfbd33f9223bd74feaf003513d1936b73cdbfb2a8e52d9a12505d90c in /usr/local/bin/ 
# Thu, 18 Apr 2019 08:18:23 GMT
VOLUME [/var/lib/docker]
# Thu, 18 Apr 2019 08:18:25 GMT
EXPOSE 2375
# Thu, 18 Apr 2019 08:18:26 GMT
ENTRYPOINT ["dockerd-entrypoint.sh"]
# Thu, 18 Apr 2019 08:18:28 GMT
CMD []
```
...
-	Layers:
	...
	-	`sha256:dee7618dbbe6495a0210b1ecc08a0a4420afe837d3d911172fc71fcb189737f0`  
		...
		Size: 757.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4c79119fd26303475858425d1317a34c63d317f37ce37e8b28cb0b84c2fcb891`  
		Last Modified: Thu, 18 Apr 2019 08:19:01 GMT  
		Size: 581.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull docker@sha256:d15ca3160f6dd2ba0a8c543786d7ae33dbea8df10124809d64ccd7ec1060a616
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **51.7 MB (51698697 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9b847d426618a3d4d9098b79d775e95d8b6bcd2b4e75ccea77b31b9f1eff9278`
-	Entrypoint: `["dockerd-entrypoint.sh"]`
-	Default Command: `[]`
...
RUN set -eux; 	wget -O /usr/local/bin/dind "https://raw.githubusercontent.com/docker/docker/${DIND_COMMIT}/hack/dind"; 	chmod +x /usr/local/bin/dind
# Thu, 18 Apr 2019 14:18:09 GMT
COPY file:779dca3bbfbd33f9223bd74feaf003513d1936b73cdbfb2a8e52d9a12505d90c in /usr/local/bin/ 
# Thu, 18 Apr 2019 14:18:10 GMT
VOLUME [/var/lib/docker]
# Thu, 18 Apr 2019 14:18:11 GMT
EXPOSE 2375
# Thu, 18 Apr 2019 14:18:12 GMT
ENTRYPOINT ["dockerd-entrypoint.sh"]
# Thu, 18 Apr 2019 14:18:13 GMT
CMD []
```
...
-	Layers:
	...
	-	`sha256:7f00da0a39e6490a789e9527cafedc18ee76d89c053c0a3fae8375fe791a453a`  
		...
		Size: 752.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19dda983ebc037935f910b8332cb0190bd27aae83ae0674af0aeaa7ce84d43a0`  
		Last Modified: Thu, 18 Apr 2019 14:18:56 GMT  
		Size: 584.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `docker:18.09.5-git` - linux; arm variant v6
...
### `docker:18.09.5-git` - linux; arm64 variant v8
...
```console
$ docker pull docker@sha256:adb5f6ab4f82d2bcf2cc5a65c5d287c4b88ea54d7276c427ce7f633ff484d658
```
...
### `docker:19.03.0-beta2-git` - linux; amd64
...
### `docker:19.03.0-beta2-git` - linux; arm variant v6

```console
$ docker pull docker@sha256:51980bb5371b459f9caa9b23caa1e376b5734f85397385dd9611f0e33a2c8d6d
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **70.7 MB (70678075 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:753aee5bbd506736144634b395b8a91209125a9fe36f6a717ab9bac366eb8348`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["sh"]`
...
-	Layers:
	...
	-	`sha256:847bee0739d2e67101befbd13b0f1e9a4e2e486541c3633f312aa576c414373b`  
		...
		Size: 737.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:00602d240f06a33c1c7dff05b12d95c0114c523f1423bd91dd673e3d9c103a77`  
		Last Modified: Tue, 23 Apr 2019 08:00:48 GMT  
		Size: 8.8 MB (8769059 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `docker:19.03.0-beta2-git` - linux; arm64 variant v8

```console
$ docker pull docker@sha256:76f50bea57e08e1fc9177b16c29b8cce4885d99255f924f36019e19023d9bf06
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **69.1 MB (69091081 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:47f0c1461f8512b466d956a304a4747eef94ca8e57dbaea3c1c43edc192a201f`
-	Entrypoint: `["docker-entrypoint.sh"]`
-	Default Command: `["sh"]`
...
-	Layers:
	...
	-	`sha256:7c504164bf5e6e676bb20a96cf8fb8a3a8e1caa8525d39843ed33e57fc9a00e0`  
		...
		Size: 736.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d2d5c44cd9106faafd6faba57b63beea5dc759051ac418ad4684a1984d25f205`  
		Last Modified: Tue, 23 Apr 2019 08:42:58 GMT  
		Size: 9.5 MB (9520195 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
