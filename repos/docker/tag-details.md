...
### `docker:18.09.0-beta5` - linux; amd64
...
### `docker:18.09.0-beta5` - linux; arm variant v6
...
### `docker:18.09.0-beta5` - linux; arm64 variant v8
...
### `docker:18.09.0-beta5-git` - linux; amd64
...
### `docker:18.09.0-beta5-git` - linux; arm variant v6
...
### `docker:18.09.0-beta5-git` - linux; arm64 variant v8
