...
-	[`docker:18.09.1-beta2`](#docker18091-beta2)
-	[`docker:18.09.1-beta2-dind`](#docker18091-beta2-dind)
-	[`docker:18.09.1-beta2-git`](#docker18091-beta2-git)
...
### `docker:18.09.1-beta2` - linux; amd64
...
### `docker:18.09.1-beta2` - linux; arm variant v6
...
### `docker:18.09.1-beta2` - linux; arm64 variant v8
...
### `docker:18.09.1-beta2-dind` - linux; amd64
...
### `docker:18.09.1-beta2-dind` - linux; arm variant v6
...
### `docker:18.09.1-beta2-dind` - linux; arm64 variant v8
