...
-	[`docker:18.09.0-rc1`](#docker18090-rc1)
-	[`docker:18.09.0-rc1-dind`](#docker18090-rc1-dind)
-	[`docker:18.09.0-rc1-git`](#docker18090-rc1-git)
...
### `docker:18.09.0-rc1` - linux; amd64
...
### `docker:18.09.0-rc1` - linux; arm variant v6
...
### `docker:18.09.0-rc1` - linux; arm64 variant v8
...
### `docker:18.09.0-rc1-dind` - linux; arm64 variant v8
...
### `docker:18.09.0-rc1-git` - linux; amd64
...
### `docker:18.09.0-rc1-git` - linux; arm variant v6
...
### `docker:18.09.0-rc1-git` - linux; arm64 variant v8
