...
- Created: `2018-11-16T13:15:59.83536953Z`
...
```console
$ apt-get source -qq --print-uris neurodebian=0.38.1
'http://deb.debian.org/debian/pool/main/n/neurodebian/neurodebian_0.38.1.dsc' neurodebian_0.38.1.dsc 2078 SHA256:f0ee3470099f174079203cdf057b69a5185287d7fbe7d3d3a767318755bbf6f3
'http://deb.debian.org/debian/pool/main/n/neurodebian/neurodebian_0.38.1.tar.xz' neurodebian_0.38.1.tar.xz 8324504 SHA256:1134bcdc1bf63bea7e332bcb50fe6130bf5648a5c443baf7008fed966d0febcf
```

Other potentially useful URLs:

- https://sources.debian.net/src/neurodebian/0.38.1/ (for browsing the source)
- https://sources.debian.net/src/neurodebian/0.38.1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/neurodebian/0.38.1/ (for access to the source package after it no longer exists in the archive)
