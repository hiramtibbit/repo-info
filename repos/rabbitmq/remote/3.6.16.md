...
```console
$ docker pull rabbitmq@sha256:d6771df0ab08e2fe6bfe1188fb2323485e01b460bcbf773f59375ea0830dfb6b
```
...
```console
$ docker pull rabbitmq@sha256:47395e1ef239fdb101ccc5cd5eaa2d5f1b3beae9e5b6e360ce2954069e0e2e16
```
