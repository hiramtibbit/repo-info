...
```console
$ docker pull rabbitmq@sha256:fec1013fe1a1cad63a2e7e63bbcc063fc9ce2ddeeec76c63d0578e1e077844ef
```
...
```console
$ docker pull rabbitmq@sha256:a5cf602d9a51a32b90a0c5f9d43f6f4f486e1e6360d3259019132c750b2e58d5
```
