...
- Created: `2018-05-10T20:37:15.469830355Z`
- Virtual Size: ~ 124.59 Mb  
...
- Environment:
  ...
  - `RABBITMQ_DEBIAN_VERSION=3.7.5.rc.1-1`
  - `LANG=C.UTF-8`
...
### `dpkg` source package: `rabbitmq-server=3.7.5~rc.1-1`

Binary Packages:

- `rabbitmq-server=3.7.5~rc.1-1`
