...
- Created: `2019-05-15T21:47:22.046500804Z`
...
### `dpkg` source package: `binutils=2.31.1-6ubuntu1.1`

Binary Packages:

- `binutils=2.31.1-6ubuntu1.1`
- `binutils-common:amd64=2.31.1-6ubuntu1.1`
- `binutils-x86-64-linux-gnu=2.31.1-6ubuntu1.1`
- `libbinutils:amd64=2.31.1-6ubuntu1.1`
...
### `dpkg` source package: `cairo=1.15.12-1ubuntu0.1`

Binary Packages:

- `libcairo-gobject2:amd64=1.15.12-1ubuntu0.1`
- `libcairo-script-interpreter2:amd64=1.15.12-1ubuntu0.1`
- `libcairo2:amd64=1.15.12-1ubuntu0.1`
- `libcairo2-dev:amd64=1.15.12-1ubuntu0.1`
...
```console
$ apt-get source -qq --print-uris cairo=1.15.12-1ubuntu0.1
'http://archive.ubuntu.com/ubuntu/pool/main/c/cairo/cairo_1.15.12-1ubuntu0.1.dsc' cairo_1.15.12-1ubuntu0.1.dsc 2260 SHA256:e8abc91429167c83abbf86593d1cef547ce3a4b3db4707b2532710819ed084c6
...
'http://archive.ubuntu.com/ubuntu/pool/main/c/cairo/cairo_1.15.12-1ubuntu0.1.debian.tar.xz' cairo_1.15.12-1ubuntu0.1.debian.tar.xz 31200 SHA256:13b7b5dea0b760e317fe14205a5c6d0f9fd218028da42dc07e5cca53e0d946da
```
...
- `libcurl3-gnutls:amd64=7.61.0-1ubuntu2.3`
...
### `dpkg` source package: `e2fsprogs=1.44.4-2ubuntu0.2`

Binary Packages:

- `comerr-dev:amd64=2.1-1.44.4-2ubuntu0.2`
- `e2fsprogs=1.44.4-2ubuntu0.2`
- `libcom-err2:amd64=1.44.4-2ubuntu0.2`
- `libext2fs2:amd64=1.44.4-2ubuntu0.2`
- `libss2:amd64=1.44.4-2ubuntu0.2`
...
```console
$ apt-get source -qq --print-uris e2fsprogs=1.44.4-2ubuntu0.2
'http://archive.ubuntu.com/ubuntu/pool/main/e/e2fsprogs/e2fsprogs_1.44.4-2ubuntu0.2.dsc' e2fsprogs_1.44.4-2ubuntu0.2.dsc 2954 SHA256:b14355ba4f9cc6b7b8a37af1c7321772040a15064a30a726136656cd5f7e31c2
...
'http://archive.ubuntu.com/ubuntu/pool/main/e/e2fsprogs/e2fsprogs_1.44.4-2ubuntu0.2.debian.tar.xz' e2fsprogs_1.44.4-2ubuntu0.2.debian.tar.xz 82568 SHA256:2d2f61e20d5ffb373d2b3fe6b589aa046b42bc7bf9f149713668e6ca33a535fd
```
...
### `dpkg` source package: `file=1:5.34-2ubuntu0.1`

Binary Packages:

- `file=1:5.34-2ubuntu0.1`
- `libmagic-mgc=1:5.34-2ubuntu0.1`
- `libmagic1:amd64=1:5.34-2ubuntu0.1`
...
```console
$ apt-get source -qq --print-uris file=1:5.34-2ubuntu0.1
'http://archive.ubuntu.com/ubuntu/pool/main/f/file/file_5.34-2ubuntu0.1.dsc' file_5.34-2ubuntu0.1.dsc 2067 SHA256:c79bb4139d6823eda991f176f600614709ac74dd671cc2fd695d17112c7e1750
...
'http://archive.ubuntu.com/ubuntu/pool/main/f/file/file_5.34-2ubuntu0.1.debian.tar.xz' file_5.34-2ubuntu0.1.debian.tar.xz 36320 SHA256:cbdaf035ef5c2c30b0e875742b91f2707de3846286d1ecaa12a3f2b4df349498
```
...
- `cpp-8=8.3.0-6ubuntu1~18.10`
- `g++-8=8.3.0-6ubuntu1~18.10`
- `gcc-8=8.3.0-6ubuntu1~18.10`
- `gcc-8-base:amd64=8.3.0-6ubuntu1~18.10`
- `libasan5:amd64=8.3.0-6ubuntu1~18.10`
- `libatomic1:amd64=8.3.0-6ubuntu1~18.10`
- `libcc1-0:amd64=8.3.0-6ubuntu1~18.10`
- `libgcc-8-dev:amd64=8.3.0-6ubuntu1~18.10`
- `libgcc1:amd64=1:8.3.0-6ubuntu1~18.10`
- `libgomp1:amd64=8.3.0-6ubuntu1~18.10`
- `libitm1:amd64=8.3.0-6ubuntu1~18.10`
- `liblsan0:amd64=8.3.0-6ubuntu1~18.10`
- `libmpx2:amd64=8.3.0-6ubuntu1~18.10`
- `libquadmath0:amd64=8.3.0-6ubuntu1~18.10`
- `libstdc++-8-dev:amd64=8.3.0-6ubuntu1~18.10`
- `libstdc++6:amd64=8.3.0-6ubuntu1~18.10`
- `libtsan0:amd64=8.3.0-6ubuntu1~18.10`
- `libubsan1:amd64=8.3.0-6ubuntu1~18.10`
...
- `cpp=4:8.3.0-1ubuntu1.1`
- `g++=4:8.3.0-1ubuntu1.1`
...
### `dpkg` source package: `gnupg2=2.2.8-3ubuntu1.1`

Binary Packages:

- `dirmngr=2.2.8-3ubuntu1.1`
- `gnupg=2.2.8-3ubuntu1.1`
- `gnupg-l10n=2.2.8-3ubuntu1.1`
- `gnupg-utils=2.2.8-3ubuntu1.1`
- `gpg=2.2.8-3ubuntu1.1`
- `gpg-agent=2.2.8-3ubuntu1.1`
- `gpg-wks-client=2.2.8-3ubuntu1.1`
- `gpg-wks-server=2.2.8-3ubuntu1.1`
- `gpgconf=2.2.8-3ubuntu1.1`
- `gpgsm=2.2.8-3ubuntu1.1`
- `gpgv=2.2.8-3ubuntu1.1`
...
```console
$ apt-get source -qq --print-uris gnupg2=2.2.8-3ubuntu1.1
'http://archive.ubuntu.com/ubuntu/pool/main/g/gnupg2/gnupg2_2.2.8-3ubuntu1.1.dsc' gnupg2_2.2.8-3ubuntu1.1.dsc 3605 SHA256:47b22310816846275ab6add391723f7f198a95af9d464b4af8bae95c3a617e30
...
### `dpkg` source package: `krb5=1.16-2ubuntu1.1`

Binary Packages:

- `krb5-multidev:amd64=1.16-2ubuntu1.1`
- `libgssapi-krb5-2:amd64=1.16-2ubuntu1.1`
- `libgssrpc4:amd64=1.16-2ubuntu1.1`
- `libk5crypto3:amd64=1.16-2ubuntu1.1`
- `libkadm5clnt-mit11:amd64=1.16-2ubuntu1.1`
- `libkadm5srv-mit11:amd64=1.16-2ubuntu1.1`
- `libkdb5-9:amd64=1.16-2ubuntu1.1`
- `libkrb5-3:amd64=1.16-2ubuntu1.1`
- `libkrb5-dev:amd64=1.16-2ubuntu1.1`
- `libkrb5support0:amd64=1.16-2ubuntu1.1`
...
```console
$ apt-get source -qq --print-uris krb5=1.16-2ubuntu1.1
'http://archive.ubuntu.com/ubuntu/pool/main/k/krb5/krb5_1.16-2ubuntu1.1.dsc' krb5_1.16-2ubuntu1.1.dsc 3656 SHA256:08829d313fdc05290b70e626792f1e55b6d7bcee56795e3da91bf6ce03df9373
...
'http://archive.ubuntu.com/ubuntu/pool/main/k/krb5/krb5_1.16-2ubuntu1.1.debian.tar.xz' krb5_1.16-2ubuntu1.1.debian.tar.xz 100996 SHA256:88130b57327cff7780009c20e5bafd617838614927669f03a96ae5cf32af33f8
```
...
### `dpkg` source package: `libpng1.6=1.6.34-2ubuntu0.1`

Binary Packages:

- `libpng-dev:amd64=1.6.34-2ubuntu0.1`
- `libpng16-16:amd64=1.6.34-2ubuntu0.1`
...
```console
$ apt-get source -qq --print-uris libpng1.6=1.6.34-2ubuntu0.1
'http://archive.ubuntu.com/ubuntu/pool/main/libp/libpng1.6/libpng1.6_1.6.34-2ubuntu0.1.dsc' libpng1.6_1.6.34-2ubuntu0.1.dsc 2309 SHA256:d5270afd62f7ba0e57a5edc8a50b1f02eb23d6e943713770c4c7d7ce679d8d21
...
'http://archive.ubuntu.com/ubuntu/pool/main/libp/libpng1.6/libpng1.6_1.6.34-2ubuntu0.1.debian.tar.xz' libpng1.6_1.6.34-2ubuntu0.1.debian.tar.xz 24532 SHA256:1b9496aeb6d5d643ba233e225624fa7f12cd7137adb8b767541b092efce7fa79
```
...
### `dpkg` source package: `linux=4.18.0-20.21`

Binary Packages:

- `linux-libc-dev:amd64=4.18.0-20.21`
...
'http://archive.ubuntu.com/ubuntu/pool/main/l/linux/linux_4.18.0-20.21.dsc' linux_4.18.0-20.21.dsc 8333 SHA256:a3b44066dc85fb7b2460038d275dfb3a6537c4bdff5acd0d7ffc1415768b5007
...
'http://archive.ubuntu.com/ubuntu/pool/main/l/linux/linux_4.18.0-20.21.diff.gz' linux_4.18.0-20.21.diff.gz 7582915 SHA256:7e30d472870cf303ef9b9c8bdd93cf9551e184622a72a7ac12854120059b11ec
```
...
### `dpkg` source package: `mysql-5.7=5.7.26-0ubuntu0.18.10.1`

Binary Packages:

- `libmysqlclient-dev=5.7.26-0ubuntu0.18.10.1`
- `libmysqlclient20:amd64=5.7.26-0ubuntu0.18.10.1`
...
```console
$ apt-get source -qq --print-uris mysql-5.7=5.7.26-0ubuntu0.18.10.1
'http://archive.ubuntu.com/ubuntu/pool/main/m/mysql-5.7/mysql-5.7_5.7.26-0ubuntu0.18.10.1.dsc' mysql-5.7_5.7.26-0ubuntu0.18.10.1.dsc 3380 SHA256:0589051f5ecfcfa88ce5532a9216c4640a90c1614029edda253ac796fd836d11
...
'http://archive.ubuntu.com/ubuntu/pool/main/m/mysql-5.7/mysql-5.7_5.7.26-0ubuntu0.18.10.1.debian.tar.xz' mysql-5.7_5.7.26-0ubuntu0.18.10.1.debian.tar.xz 157780 SHA256:169cbabb8419c4e009b9ec8f816b2c7e54c07a9cae203052e3bb7a4253334cd8
```
...
### `dpkg` source package: `openssh=1:7.7p1-4ubuntu0.3`
...
```console
$ apt-get source -qq --print-uris openssh=1:7.7p1-4ubuntu0.3
'http://archive.ubuntu.com/ubuntu/pool/main/o/openssh/openssh_7.7p1-4ubuntu0.3.dsc' openssh_7.7p1-4ubuntu0.3.dsc 2992 SHA256:adeeb73d1db5ac2f01dd796ce91a401fbddeffc4df69a59f28bc5f9b5f9e15f2
...
'http://archive.ubuntu.com/ubuntu/pool/main/o/openssh/openssh_7.7p1-4ubuntu0.3.debian.tar.xz' openssh_7.7p1-4ubuntu0.3.debian.tar.xz 167776 SHA256:93349a54582a9449e36dc679aac58f2ac8da8a400d0b3d42b13c900c2d88f034
```

### `dpkg` source package: `openssl1.0=1.0.2n-1ubuntu6.2`

Binary Packages:

- `libssl1.0.0:amd64=1.0.2n-1ubuntu6.2`
...
```console
$ apt-get source -qq --print-uris openssl1.0=1.0.2n-1ubuntu6.2
'http://archive.ubuntu.com/ubuntu/pool/main/o/openssl1.0/openssl1.0_1.0.2n-1ubuntu6.2.dsc' openssl1.0_1.0.2n-1ubuntu6.2.dsc 2713 SHA256:86951676536ccd69cd59cdd47ba85c033a192f4a4631e0e316bf8b80cf84fd4d
...
'http://archive.ubuntu.com/ubuntu/pool/main/o/openssl1.0/openssl1.0_1.0.2n-1ubuntu6.2.debian.tar.xz' openssl1.0_1.0.2n-1ubuntu6.2.debian.tar.xz 110100 SHA256:2bbcc1c6cb10d2093aea95de54415e96d279c3e9f1ca7de19a09c640dded23d6
```
...
### `dpkg` source package: `pam=1.1.8-3.6ubuntu3`

Binary Packages:

- `libpam-modules:amd64=1.1.8-3.6ubuntu3`
- `libpam-modules-bin=1.1.8-3.6ubuntu3`
- `libpam-runtime=1.1.8-3.6ubuntu3`
- `libpam0g:amd64=1.1.8-3.6ubuntu3`
...
```console
$ apt-get source -qq --print-uris pam=1.1.8-3.6ubuntu3
'http://archive.ubuntu.com/ubuntu/pool/main/p/pam/pam_1.1.8-3.6ubuntu3.dsc' pam_1.1.8-3.6ubuntu3.dsc 2180 SHA256:630eee0cd9c27e3ed74a3eab93874c464fb6d76c1b1feb67f1d7e78ce68bbce4
...
- `libpcre16-3:amd64=2:8.39-12~18.10`
- `libpcre3:amd64=2:8.39-12~18.10`
- `libpcre3-dev:amd64=2:8.39-12~18.10`
- `libpcre32-3:amd64=2:8.39-12~18.10`
- `libpcrecpp0v5:amd64=2:8.39-12~18.10`
...
### `dpkg` source package: `postgresql-10=10.8-0ubuntu0.18.10.1`

Binary Packages:

- `libpq-dev=10.8-0ubuntu0.18.10.1`
- `libpq5:amd64=10.8-0ubuntu0.18.10.1`
...
```console
$ apt-get source -qq --print-uris postgresql-10=10.8-0ubuntu0.18.10.1
'http://archive.ubuntu.com/ubuntu/pool/main/p/postgresql-10/postgresql-10_10.8-0ubuntu0.18.10.1.dsc' postgresql-10_10.8-0ubuntu0.18.10.1.dsc 3597 SHA256:45f858d43c20561689eaa436bd86dc4e0bb9a9c541c76622d2af567da0fbaca5
...
'http://archive.ubuntu.com/ubuntu/pool/main/p/postgresql-10/postgresql-10_10.8-0ubuntu0.18.10.1.debian.tar.xz' postgresql-10_10.8-0ubuntu0.18.10.1.debian.tar.xz 34540 SHA256:e802e1197aee9115318e9abc02520da538387e3417db1dd1de3393bb922e9dce
```
...
### `dpkg` source package: `python3-stdlib-extensions=3.6.8-1~18.10`

Binary Packages:

- `python3-distutils=3.6.8-1~18.10`
- `python3-lib2to3=3.6.8-1~18.10`
...
```console
$ apt-get source -qq --print-uris python3-stdlib-extensions=3.6.8-1~18.10
'http://archive.ubuntu.com/ubuntu/pool/main/p/python3-stdlib-extensions/python3-stdlib-extensions_3.6.8-1~18.10.dsc' python3-stdlib-extensions_3.6.8-1~18.10.dsc 2547 SHA256:5fe07773b8dca7236d9319424c105b80233143a60de53add5ae4489150494297
...
'http://archive.ubuntu.com/ubuntu/pool/main/p/python3-stdlib-extensions/python3-stdlib-extensions_3.6.8-1~18.10.debian.tar.xz' python3-stdlib-extensions_3.6.8-1~18.10.debian.tar.xz 16004 SHA256:496edfa574323d0ed388002d3f554533fe53ea991d6f18c5c70ba85fe2aa19b8
```

### `dpkg` source package: `python3.6=3.6.8-1~18.10`

Binary Packages:

- `libpython3.6-minimal:amd64=3.6.8-1~18.10`
- `libpython3.6-stdlib:amd64=3.6.8-1~18.10`
- `python3.6=3.6.8-1~18.10`
- `python3.6-minimal=3.6.8-1~18.10`
...
```console
$ apt-get source -qq --print-uris python3.6=3.6.8-1~18.10
'http://archive.ubuntu.com/ubuntu/pool/main/p/python3.6/python3.6_3.6.8-1~18.10.dsc' python3.6_3.6.8-1~18.10.dsc 3459 SHA256:c56744a62ad9a695f315930d94e86695483b48f8fb1cd221bd450929aa0f2516
...
'http://archive.ubuntu.com/ubuntu/pool/main/p/python3.6/python3.6_3.6.8-1~18.10.debian.tar.xz' python3.6_3.6.8-1~18.10.debian.tar.xz 209184 SHA256:32f0872ffbe3d925cbd1af96eba9bf29e1ecf8bc1c8b73e0fe78978fb4338aeb
```
...
### `dpkg` source package: `tiff=4.0.9-6ubuntu0.2`

Binary Packages:

- `libtiff-dev=4.0.9-6ubuntu0.2`
- `libtiff5:amd64=4.0.9-6ubuntu0.2`
- `libtiff5-dev:amd64=4.0.9-6ubuntu0.2`
- `libtiffxx5:amd64=4.0.9-6ubuntu0.2`
...
```console
$ apt-get source -qq --print-uris tiff=4.0.9-6ubuntu0.2
'http://archive.ubuntu.com/ubuntu/pool/main/t/tiff/tiff_4.0.9-6ubuntu0.2.dsc' tiff_4.0.9-6ubuntu0.2.dsc 2299 SHA256:7a056c3987e850ca0d0f02f7ba7a2c245c5d1d5ea3610119d053bef66d87bf39
...
'http://archive.ubuntu.com/ubuntu/pool/main/t/tiff/tiff_4.0.9-6ubuntu0.2.debian.tar.xz' tiff_4.0.9-6ubuntu0.2.debian.tar.xz 28916 SHA256:e8025912a9a5cdf379f6937b1655e72f6680191c84c042812101e0798865cf46
```
...
### `dpkg` source package: `wget=1.19.5-1ubuntu1.1`
...
```console
$ apt-get source -qq --print-uris wget=1.19.5-1ubuntu1.1
'http://archive.ubuntu.com/ubuntu/pool/main/w/wget/wget_1.19.5-1ubuntu1.1.dsc' wget_1.19.5-1ubuntu1.1.dsc 2223 SHA256:d442c89d9a8294985948d43092c2b752b9dad38a462ad10b786357467290dcbb
...
'http://archive.ubuntu.com/ubuntu/pool/main/w/wget/wget_1.19.5-1ubuntu1.1.debian.tar.xz' wget_1.19.5-1ubuntu1.1.debian.tar.xz 65544 SHA256:4b20153eeaa0862a8b7a213bc9629f6dabb5f24fe001bcec1263cb81aded4ab5
```
