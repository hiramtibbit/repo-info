...
- Created: `2019-03-05T02:23:31.551226076Z`
- Virtual Size: ~ 792.80 Mb  
...
- http://snapshot.debian.org/package/acl/2.2.52-5/
...
- http://snapshot.debian.org/package/attr/1:2.4.47-4/
...
- `curl=7.64.0-1`
- `libcurl3-gnutls:amd64=7.64.0-1`
- `libcurl4:amd64=7.64.0-1`
- `libcurl4-openssl-dev:amd64=7.64.0-1`
...
- http://snapshot.debian.org/package/db-defaults/5.3.1/
...
- http://snapshot.debian.org/package/file/1:5.35-2/
...
- `libasan5:amd64=8.2.0-21`
- `libatomic1:amd64=8.2.0-21`
- `libcc1-0:amd64=8.2.0-21`
- `libgcc-8-dev:amd64=8.2.0-21`
- `libgcc1:amd64=1:8.2.0-21`
- `libgomp1:amd64=8.2.0-21`
- `libitm1:amd64=8.2.0-21`
- `liblsan0:amd64=8.2.0-21`
- `libmpx2:amd64=8.2.0-21`
- `libquadmath0:amd64=8.2.0-21`
- `libstdc++-8-dev:amd64=8.2.0-21`
- `libstdc++6:amd64=8.2.0-21`
- `libtsan0:amd64=8.2.0-21`
- `libubsan1:amd64=8.2.0-21`
...
- http://snapshot.debian.org/package/gcc-defaults/1.180/
...
- `libglib2.0-bin=2.58.3-1`
- `libglib2.0-data=2.58.3-1`
- `libglib2.0-dev:amd64=2.58.3-1`
- `libglib2.0-dev-bin=2.58.3-1`
...
### `dpkg` source package: `keyutils=1.6-2`

Binary Packages:

- `libkeyutils1:amd64=1.6-2`
...
- http://snapshot.debian.org/package/mariadb-10.3/1:10.3.12-2/
...
- `libncursesw5-dev:amd64=6.1+20181013-2`
...
### `dpkg` source package: `openssh=1:7.9p1-6`
...
- http://snapshot.debian.org/package/openssh/1:7.9p1-6/
...
- http://snapshot.debian.org/package/postgresql-11/11.2-1/
...
### `dpkg` source package: `python2.7=2.7.16~rc1-1`

Binary Packages:

- `libpython2.7-minimal:amd64=2.7.16~rc1-1`
- `libpython2.7-stdlib:amd64=2.7.16~rc1-1`
- `python2.7=2.7.16~rc1-1`
- `python2.7-minimal=2.7.16~rc1-1`
...
```console
$ apt-get source -qq --print-uris python2.7=2.7.16~rc1-1
'http://deb.debian.org/debian/pool/main/p/python2.7/python2.7_2.7.16~rc1-1.dsc' python2.7_2.7.16~rc1-1.dsc 3372 SHA256:e7cd53a4fc5e15e0886729155add6567e023190c513bd9629ae20342748122a9
'http://deb.debian.org/debian/pool/main/p/python2.7/python2.7_2.7.16~rc1.orig.tar.gz' python2.7_2.7.16~rc1.orig.tar.gz 17431588 SHA256:6468f1a55ca32966542284e35db21447924c87dec0064c107cf443cef958c25a
'http://deb.debian.org/debian/pool/main/p/python2.7/python2.7_2.7.16~rc1-1.diff.gz' python2.7_2.7.16~rc1-1.diff.gz 285685 SHA256:217eadfe3fea029720f09fecb6d6bab14be899bdd4dd379e404b95721c262090
```

Other potentially useful URLs:

- https://sources.debian.net/src/python2.7/2.7.16~rc1-1/ (for browsing the source)
- https://sources.debian.net/src/python2.7/2.7.16~rc1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/python2.7/2.7.16~rc1-1/ (for access to the source package after it no longer exists in the archive)
