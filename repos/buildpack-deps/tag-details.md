...
```console
$ docker pull buildpack-deps@sha256:268c358312ceedc474c38f6758c6bc396b0f196451aa671f3d6e2dcbf1417055
```
...
```console
$ docker pull buildpack-deps@sha256:60f05d3157d3e90e2a084694e27e15970eb203e6eea9dd911b97f3e7ccc51536
```
