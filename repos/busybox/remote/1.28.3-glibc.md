...
### `busybox:1.28.3-glibc` - linux; arm variant v5
...
### `busybox:1.28.3-glibc` - linux; arm variant v7
...
### `busybox:1.28.3-glibc` - linux; arm64 variant v8
...
### `busybox:1.28.3-glibc` - linux; ppc64le
...
### `busybox:1.28.3-glibc` - linux; s390x
