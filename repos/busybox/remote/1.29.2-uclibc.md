...
### `busybox:1.29.2-uclibc` - linux; amd64
...
### `busybox:1.29.2-uclibc` - linux; arm variant v5
...
### `busybox:1.29.2-uclibc` - linux; arm variant v7
...
### `busybox:1.29.2-uclibc` - linux; arm64 variant v8
...
### `busybox:1.29.2-uclibc` - linux; 386
