...
### `ruby:2.6.0-rc2-slim` - linux; amd64
...
### `ruby:2.6.0-rc2-slim` - linux; arm variant v5
...
### `ruby:2.6.0-rc2-slim` - linux; arm variant v7
...
### `ruby:2.6.0-rc2-slim` - linux; arm64 variant v8
...
### `ruby:2.6.0-rc2-slim` - linux; ppc64le
...
### `ruby:2.6.0-rc2-slim` - linux; s390x
