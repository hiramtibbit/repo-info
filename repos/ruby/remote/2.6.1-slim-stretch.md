...
### `ruby:2.6.1-slim-stretch` - linux; amd64
...
### `ruby:2.6.1-slim-stretch` - linux; arm variant v5
...
### `ruby:2.6.1-slim-stretch` - linux; arm variant v7
...
### `ruby:2.6.1-slim-stretch` - linux; arm64 variant v8
...
### `ruby:2.6.1-slim-stretch` - linux; 386
...
### `ruby:2.6.1-slim-stretch` - linux; ppc64le
...
### `ruby:2.6.1-slim-stretch` - linux; s390x
