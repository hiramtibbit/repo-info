...
- Created: `2019-03-27T11:19:41.646933457Z`
...
### `dpkg` source package: `linux=3.16.64-1`

Binary Packages:

- `linux-libc-dev:amd64=3.16.64-1`
...
```console
$ apt-get source -qq --print-uris linux=3.16.64-1
'http://security.debian.org/debian-security/pool/updates/main/l/linux/linux_3.16.64-1.dsc' linux_3.16.64-1.dsc 140642 SHA256:db821d3dcc07e21f53150c589c95ef4b5910b48ce5d3aa3725a26376addde9ed
...
'http://security.debian.org/debian-security/pool/updates/main/l/linux/linux_3.16.64-1.debian.tar.xz' linux_3.16.64-1.debian.tar.xz 1158404 SHA256:7c6c0276d7b35a3dbe51c5102682cbb1c842c65e7cdee929c5635438c95a3294
```

Other potentially useful URLs:

- https://sources.debian.net/src/linux/3.16.64-1/ (for browsing the source)
- https://sources.debian.net/src/linux/3.16.64-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/linux/3.16.64-1/ (for access to the source package after it no longer exists in the archive)
