...
```console
$ docker pull tomcat@sha256:4a4b0f109ccae0c6a8276d32f5ab96b77f02b5bd4d17f6961bf9bf0132ac85f1
```
...
```console
$ docker pull tomcat@sha256:8ed57211ae60bd75aca701b7e78f7cb0ba020cf500763c03a8d68d8763eed17e
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.3 MB (186302071 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a709924b1dceedff5b835ae44b5dc46f1850cf47365bec9e4c734a915d07773a`
-	Default Command: `["catalina.sh","run"]`
