...
```console
$ docker pull tomcat@sha256:a01a5f5ba90966b65d94fe2186a6517ce04d55e31e803b8a0dc412e33ce7660a
```
...
```console
$ docker pull tomcat@sha256:d384105b42aab6a1c959be6de89bfa62e022842e303197cf99fd7017073cdc22
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **178.9 MB (178910299 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f0d363ee7e2c5e107d9729ff87618879713e3278162a83b2cd873336a918a855`
-	Default Command: `["catalina.sh","run"]`
