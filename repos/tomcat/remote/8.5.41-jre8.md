...
### `tomcat:8.5.41-jre8` - linux; amd64
...
### `tomcat:8.5.41-jre8` - linux; arm variant v5
...
### `tomcat:8.5.41-jre8` - linux; arm variant v7
...
### `tomcat:8.5.41-jre8` - linux; arm64 variant v8
...
### `tomcat:8.5.41-jre8` - linux; ppc64le
...
### `tomcat:8.5.41-jre8` - linux; s390x
