...
```console
$ docker pull tomcat@sha256:60f16602fcca0affe45bed44577e382fc0db384dd5d7c63fa588e26d1e168124
```
...
### `tomcat:7.0.86-jre8-alpine` - linux; 386

```console
$ docker pull tomcat@sha256:3bdd65f6b378487cc4a982a1c4bf0557d731f79d69f87f8c0b88b8dd500e7df8
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **70.1 MB (70076908 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f8054f567779941e2a6b7012cb5ff4906cc0f00eb997d7e0b4397d3f1e1cc689`
-	Default Command: `["catalina.sh","run"]`
