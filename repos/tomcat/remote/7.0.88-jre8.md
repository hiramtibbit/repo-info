...
```console
$ docker pull tomcat@sha256:a0fa3d7fc423de3dc62e26325317e0bd247ea1d5884cb0bb5f7b69052c77f62a
```
...
```console
$ docker pull tomcat@sha256:9c4be9e7dbd5ebf1a412853d577c858698058737fcf4d14ba62d141735272580
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **197.1 MB (197124418 bytes)**  
