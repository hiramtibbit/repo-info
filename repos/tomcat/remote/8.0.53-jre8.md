...
```console
$ docker pull tomcat@sha256:6e941901863e7fda04845337c758b9007ddaae650267b137159ca860244fc1a2
```
...
```console
$ docker pull tomcat@sha256:e913c0f2a182ce08fd16f73a3bd2ad3aa41c2c8c18d6ea595ec83b3fcf71e35e
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.2 MB (186212722 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6d9de2fbdb50b78126326d8389c11c976cf0df8cd094372e434fe08c5d370cf3`
-	Default Command: `["catalina.sh","run"]`
