...
```console
$ docker pull tomcat@sha256:925db014bd1a9b1d79e01a6797f3e5eb22f93da2ba5ded8457d5533c85e9680d
```
...
```console
$ docker pull tomcat@sha256:95aac17cf82b8a801f0cc27a747ef9f45c2de493965b65fdb9780b0ecaf2b0f1
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.7 MB (181690730 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dae1e750d36e99752443bf15e4cc299ed1573c8089ec3eecce46cab7fc4fd900`
-	Default Command: `["catalina.sh","run"]`
