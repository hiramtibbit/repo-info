...
```console
$ docker pull tomcat@sha256:cb46e36e0ff3e372244eda964453ac133690efa445bf83850a1daf911c6a1e3a
```
...
```console
$ docker pull tomcat@sha256:a661eb7e196cdd7b4cbfb23552ba73ed3628db22c51adba4180e4a395c9f2243
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **70.1 MB (70096006 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c8dfd29ef2ee1af307c867f7b28495a63306d9faaca59a41620b6bab414db317`
-	Default Command: `["catalina.sh","run"]`
