...
```console
$ docker pull tomcat@sha256:0dbdf5751551af9f2b3172fe50653c9c298354fead7332a809ac6d1c779a6ba2
```
...
```console
$ docker pull tomcat@sha256:b91ef6d040c86f2f3650da1ebee1fe5cbd1a0273aae7d839c5e771a23fcc7ff8
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **71.4 MB (71417279 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9a4cf2fb9d0b2d141ce6a1e2c07e2cd8204b050ec9aa4d2f02854f7dccd9d45a`
-	Default Command: `["catalina.sh","run"]`
