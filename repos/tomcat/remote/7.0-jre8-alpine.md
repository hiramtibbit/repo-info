...
```console
$ docker pull tomcat@sha256:069ec552663df92db0d45b737e33810bf9f94a9385f2917cd2d2429040172e00
```
...
```console
$ docker pull tomcat@sha256:112485e7d9876f16822388ae630e936cb08bdd895ec373bca2c05b60dbfbd73a
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **70.1 MB (70074260 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a024ec9df989431d4f00c8e0bd18d55833a807db18ffdb82d76a547fbff3f49b`
-	Default Command: `["catalina.sh","run"]`
