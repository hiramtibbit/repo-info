...
```console
$ docker pull tomcat@sha256:f46b6cca825c93586842ece76658e09fadbe57184bd4c6616fd3cd2e29147bd3
```
...
```console
$ docker pull tomcat@sha256:532e1f9d6b4e61374f226b9230ea9ec4f87e4ff1c62e9ef487b3485ef374c955
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **67.9 MB (67893995 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14e57844f8cd5376f765a28e36a27bb7bbc18298f3a73529b387f85e198c1eb9`
-	Default Command: `["catalina.sh","run"]`
