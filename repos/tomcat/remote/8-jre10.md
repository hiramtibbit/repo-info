...
```console
$ docker pull tomcat@sha256:b0641a999b3afa4493972972d387ca787679235e4175f9849d2e20f68f210f87
```
...
```console
$ docker pull tomcat@sha256:c29f515e88bc4f96f1161cf29fd9ba6eaa9ec8b75645e755254ed2f981e6396a
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **255.2 MB (255219561 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e4e0161237012952b584f4bc9e834ad3aa7da0befc7b961099472fa36639864b`
-	Default Command: `["catalina.sh","run"]`
...
# Fri, 20 Apr 2018 08:59:09 GMT
ENV JAVA_DEBIAN_VERSION=10~46-5
# Fri, 20 Apr 2018 09:00:13 GMT
RUN set -ex; 		if [ ! -d /usr/share/man/man1 ]; then 		mkdir -p /usr/share/man/man1; 	fi; 		ln -svT /docker-java-home/bin/java /usr/local/bin/java; 		apt-get update; 	apt-get install -y 		openjdk-10-jre="$JAVA_DEBIAN_VERSION" 	; 	rm -rf /var/lib/apt/lists/*; 		rm -v /usr/local/bin/java; 		[ "$(readlink -f "$JAVA_HOME")" = "$(docker-java-home)" ]; 		update-alternatives --get-selections | awk -v home="$(readlink -f "$JAVA_HOME")" 'index($3, home) == 1 { $2 = "manual"; print | "update-alternatives --set-selections" }'; 	update-alternatives --query java | grep -q 'Status: manual'
# Fri, 20 Apr 2018 09:33:08 GMT
ENV CATALINA_HOME=/usr/local/tomcat
# Fri, 20 Apr 2018 09:33:08 GMT
ENV PATH=/usr/local/tomcat/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
# Fri, 20 Apr 2018 09:33:09 GMT
RUN mkdir -p "$CATALINA_HOME"
# Fri, 20 Apr 2018 09:33:09 GMT
WORKDIR /usr/local/tomcat
# Fri, 20 Apr 2018 09:33:10 GMT
ENV TOMCAT_NATIVE_LIBDIR=/usr/local/tomcat/native-jni-lib
# Fri, 20 Apr 2018 09:33:10 GMT
ENV LD_LIBRARY_PATH=/usr/local/tomcat/native-jni-lib
# Fri, 20 Apr 2018 09:33:10 GMT
ENV OPENSSL_VERSION=1.1.0f-3+deb9u2
# Fri, 20 Apr 2018 09:33:11 GMT
RUN set -ex; 	currentVersion="$(dpkg-query --show --showformat '${Version}\n' openssl)"; 	if dpkg --compare-versions "$currentVersion" '<<' "$OPENSSL_VERSION"; then 		if ! grep -q stretch /etc/apt/sources.list; then 			{ 				echo 'deb http://deb.debian.org/debian stretch main'; 				echo 'deb http://security.debian.org stretch/updates main'; 				echo 'deb http://deb.debian.org/debian stretch-updates main'; 			} > /etc/apt/sources.list.d/stretch.list; 			{ 				echo 'Package: *'; 				echo 'Pin: release n=stretch*'; 				echo 'Pin-Priority: -10'; 				echo; 				echo 'Package: openssl libssl*'; 				echo "Pin: version $OPENSSL_VERSION"; 				echo 'Pin-Priority: 990'; 			} > /etc/apt/preferences.d/stretch-openssl; 		fi; 		apt-get update; 		apt-get install -y --no-install-recommends openssl="$OPENSSL_VERSION"; 		rm -rf /var/lib/apt/lists/*; 	fi
# Fri, 20 Apr 2018 09:33:22 GMT
RUN apt-get update && apt-get install -y --no-install-recommends 		libapr1 	&& rm -rf /var/lib/apt/lists/*
# Fri, 20 Apr 2018 09:33:22 GMT
ENV GPG_KEYS=05AB33110949707C93A279E3D3EFE6B686867BA6 07E48665A34DCAFAE522E5E6266191C37C037D42 47309207D818FFD8DCD3F83F1931D684307A10A5 541FBE7D8F78B25E055DDEE13C370389288584E7 61B832AC2F1C5A90F0F9B00A1C506407564C17A3 713DA88BE50911535FE716F5208B0AB1D63011C7 79F7026C690BAA50B92CD8B66A3AD3F4F22C4FED 9BA44C2621385CB966EBA586F72C284D731FABEE A27677289986DB50844682F8ACB77FC2E86E29AC A9C5DF4D22E99998D9875A5110C01C5A2F6059E7 DCFD35E0BF8CA7344752DE8B6FB21E8933C60243 F3A04C595DB5B6A5F1ECA43E3B7BBB100D811BBE F7DA48BB64BCB84ECBA7EE6935CD23C10D498E23
# Fri, 20 Apr 2018 09:33:23 GMT
ENV TOMCAT_MAJOR=8
# Fri, 20 Apr 2018 09:33:23 GMT
ENV TOMCAT_VERSION=8.5.30
# Fri, 20 Apr 2018 09:33:23 GMT
...
-	Layers:
	...
	-	`sha256:5e430af0ee1dfb2f771f21e99b9de47af39efe60559caa1a8155753d5c73c6ed`  
		...
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15712b356aab9b23d8f8d09f91b52fcab7cdd22909dfcd71bd8a9812b7abf4c1`  
		Last Modified: Fri, 20 Apr 2018 09:11:35 GMT  
		Size: 172.1 MB (172084862 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d10ad9b79bd06acdeca2ed7a65efcdbb859214a7899e5d60268c4eba08f069b8`  
		Last Modified: Fri, 20 Apr 2018 09:41:51 GMT  
		Size: 173.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:22e9fb0e6890127bc9437fc98e172ade71637dcf27c93b3b081d21eb53de7cc6`  
		Last Modified: Fri, 20 Apr 2018 09:41:52 GMT  
		Size: 548.4 KB (548376 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:15b05cb2db59f44e7216e2a074dc345ea7515ccadc93f4383a1ed8e620a46034`  
		Last Modified: Fri, 20 Apr 2018 09:41:55 GMT  
		Size: 19.0 MB (19025773 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:d9015ebf13315e94dda9a5090fe6b3f3d6b527f2fbded10840a0d3aeed6929f4`  
		Last Modified: Fri, 20 Apr 2018 09:41:51 GMT  
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
