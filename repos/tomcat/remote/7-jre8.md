...
```console
$ docker pull tomcat@sha256:45686721c54adb760d01ebd9af41b453a03a2e6a4e9c39a60beb6ec9d1d51472
```
...
```console
$ docker pull tomcat@sha256:23f720f4c8284b2fdea0ff55b95f1265817eee156370cade60edde6a08960e2a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **181.6 MB (181564669 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:078f726410d02d86f6a845c578d66189d72960759c2300fb2eebbd11bf1be7ac`
-	Default Command: `["catalina.sh","run"]`
