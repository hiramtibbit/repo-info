...
### `tomcat:9.0.17-jre8-alpine` - linux; arm variant v6
...
### `tomcat:9.0.17-jre8-alpine` - linux; arm variant v7
...
### `tomcat:9.0.17-jre8-alpine` - linux; arm64 variant v8
...
### `tomcat:9.0.17-jre8-alpine` - linux; 386
...
### `tomcat:9.0.17-jre8-alpine` - linux; ppc64le
