...
```console
$ docker pull tomcat@sha256:aacce4e5ca37a3b8241c544deffd65f4cafbfb1a2fb2066f97621253c34f7dc4
```
...
```console
$ docker pull tomcat@sha256:d8e0e622171d2a3c50c598f68e17f9bc4c736de3f18b71e259880afcdbf7c1f1
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **196.0 MB (195982926 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:240119bed4dc6b4fa5be1763dcbdc75adae20e0d90f27c52f5ff421fe070997a`
-	Default Command: `["catalina.sh","run"]`
