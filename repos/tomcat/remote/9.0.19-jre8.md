...
```console
$ docker pull tomcat@sha256:c29bc6c36d7db9e295cb3860df163f201e1aab470c80faafb244c2f460360dad
```
...
### `tomcat:9.0.19-jre8` - linux; arm variant v7
...
### `tomcat:9.0.19-jre8` - linux; s390x
