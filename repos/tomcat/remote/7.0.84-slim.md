...
```console
$ docker pull tomcat@sha256:36a17e02d8fa3d3a7f025cecfc0ee569d42dd12243ea929b1a6dc7c53791f184
```
...
### `tomcat:7.0.84-slim` - linux; amd64
...
### `tomcat:7.0.84-slim` - linux; arm variant v5
...
### `tomcat:7.0.84-slim` - linux; arm variant v7
...
### `tomcat:7.0.84-slim` - linux; arm64 variant v8
...
### `tomcat:7.0.84-slim` - linux; ppc64le
...
### `tomcat:7.0.84-slim` - linux; s390x
