...
### `tomcat:9.0.11-jre8` - linux; amd64
...
### `tomcat:9.0.11-jre8` - linux; arm variant v5
...
### `tomcat:9.0.11-jre8` - linux; arm64 variant v8
...
### `tomcat:9.0.11-jre8` - linux; ppc64le
...
### `tomcat:9.0.11-jre8` - linux; s390x
