...
```console
$ docker pull tomcat@sha256:aa59a96ece1f4541449db9581a844064618a19ad119f0b2fed7ed28bdada6859
```
...
### `tomcat:8.0.51` - linux; arm variant v5
...
### `tomcat:8.0.51` - linux; arm variant v7
...
### `tomcat:8.0.51` - linux; arm64 variant v8
