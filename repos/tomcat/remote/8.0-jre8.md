...
```console
$ docker pull tomcat@sha256:68c627736a0e601a932e1545317e02a9e72d975939ac86d0d3b061d6dae1277f
```
...
```console
$ docker pull tomcat@sha256:3c2076cb0248bb1e1acdf696a05c862de57f1494dde4542051821a203ed902ea
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.0 MB (230977761 bytes)**  
