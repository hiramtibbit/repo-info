...
- Created: `2019-05-15T22:06:52.399001092Z`
- Virtual Size: ~ 801.16 Mb  
...
### `dpkg` source package: `libmemcached=1.0.8-1`

Binary Packages:

- `libmemcached10:amd64=1.0.8-1`
...
- http://snapshot.debian.org/package/libmemcached/1.0.8-1/
...
- `libapache2-mod-php-5.6-zend-server=5.6.40+b285`
...
- `php-5.6-pdo-mysql-zend-server=5.6.40+b38`
...
- `php-5.6-pdo-odbc-zend-server=5.6.40+b38`
...
- `php-5.6-bcmath-zend-server=5.6.40+b40`
...
- `php-5.6-bin-zend-server=5.6.40+b279`
...
- `php-5.6-bz2-zend-server=5.6.40+b39`
...
- `php-5.6-calendar-zend-server=5.6.40+b39`
...
- `php-5.6-ctype-zend-server=5.6.40+b39`
...
- `php-5.6-curl-zend-server=5.6.40+b40`
...
- `php-5.6-dev-zend-server=5.6.40+b268`
...
- `php-5.6-exif-zend-server=5.6.40+b40`
...
- `php-5.6-fcgi-zend-server=5.6.40+b40`
...
- `php-5.6-fileinfo-zend-server=5.6.40+b39`
...
- `php-5.6-ftp-zend-server=5.6.40+b39`
...
- `php-5.6-gd-zend-server=5.6.40+b39`
...
- `php-5.6-gettext-zend-server=5.6.40+b39`
...
- `php-5.6-gmp-zend-server=5.6.40+b39`
...
- `php-5.6-imagick-zend-server=5.6.40+b40`
...
- `php-5.6-imap-zend-server=5.6.40+b39`
...
- `php-5.6-intl-zend-server=5.6.40+b39`
...
- `php-5.6-ldap-zend-server=5.6.40+b39`
...
- `php-5.6-mbstring-zend-server=5.6.40+b39`
...
- `php-5.6-mcrypt-zend-server=5.6.40+b39`
...
- `php-5.6-memcache-zend-server=5.6.40+b39`
...
- `php-5.6-memcached-zend-server=5.6.40+b39`
...
- `php-5.6-mongo-zend-server=5.6.40+b49`
...
- `php-5.6-mssql-zend-server=5.6.40+b39`
...
- `php-5.6-mysql-zend-server=5.6.40+b38`
...
- `php-5.6-mysqli-zend-server=5.6.40+b38`
...
- `php-5.6-oci8-zend-server=5.6.40+b38`
...
- `php-5.6-odbc-zend-server=5.6.40+b38`
...
- `php-5.6-pcntl-zend-server=5.6.40+b38`
...
- `php-5.6-pdo-dblib-zend-server=5.6.40+b38`
...
- `php-5.6-pdo-pgsql-zend-server=5.6.40+b38`
...
- `php-5.6-pgsql-zend-server=5.6.40+b38`
...
- `php-5.6-phar-zend-server=5.6.40+b38`
...
- `php-5.6-posix-zend-server=5.6.40+b38`
...
- `php-5.6-redis-zend-server=5.6.40+b38`
...
- `php-5.6-shmop-zend-server=5.6.40+b38`
...
- `php-5.6-soap-zend-server=5.6.40+b38`
...
- `php-5.6-sockets-zend-server=5.6.40+b38`
...
- `php-5.6-ssh2-zend-server=5.6.40+b38`
...
- `php-5.6-sysvmsg-zend-server=5.6.40+b38`
...
- `php-5.6-sysvsem-zend-server=5.6.40+b37`
...
- `php-5.6-sysvshm-zend-server=5.6.40+b38`
...
- `php-5.6-tidy-zend-server=5.6.40+b38`
...
- `php-5.6-tokenizer-zend-server=5.6.40+b38`
...
- `php-5.6-wddx-zend-server=5.6.40+b38`
...
- `php-5.6-xdebug-zend-server=5.6.40+b38`
...
- `php-5.6-xmlrpc-zend-server=5.6.40+b38`
...
- `php-5.6-xsl-zend-server=5.6.40+b38`
...
- `php-5.6-zip-zend-server=5.6.40+b38`
...
- `zend-server-php-5.6-common=8.5.12+b817`
