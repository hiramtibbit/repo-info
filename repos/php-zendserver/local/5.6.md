...
### `dpkg` source package: `apache2=2.4.7-1ubuntu4.21`
...
Licenses: (parsed from: `/usr/share/doc/apache2/copyright`, `/usr/share/doc/apache2-bin/copyright`, `/usr/share/doc/apache2-data/copyright`)
...
### `dpkg` source package: `freetds=0.91-5`
...
```console
$ apt-get source -qq --print-uris freetds=0.91-5
'http://archive.ubuntu.com/ubuntu/pool/main/f/freetds/freetds_0.91-5.dsc' freetds_0.91-5.dsc 2219 SHA256:2781b5030296b39a67cb31725fa9ad54a6b12fd0d57b1f03b470544437011717
...
'http://archive.ubuntu.com/ubuntu/pool/main/f/freetds/freetds_0.91-5.diff.gz' freetds_0.91-5.diff.gz 22214 SHA256:31f67434d8254eff77893a957512c8cdf708420f7abd0eca5ca4895291bd5143
```
...
Licenses: (parsed from: `/usr/share/doc/gcc-4.8-base/copyright`, `/usr/share/doc/libgomp1/copyright`, `/usr/share/doc/libstdc++6/copyright`)
...
### `dpkg` source package: `libmcrypt=2.5.8-3.1ubuntu1`
...
```console
$ apt-get source -qq --print-uris libmcrypt=2.5.8-3.1ubuntu1
'http://archive.ubuntu.com/ubuntu/pool/universe/libm/libmcrypt/libmcrypt_2.5.8-3.1ubuntu1.dsc' libmcrypt_2.5.8-3.1ubuntu1.dsc 1686 SHA256:e6466c7fd1c92083e892023918e5321ce5d4fc8c0d7426e4492e6a115aa5f8e5
...
'http://archive.ubuntu.com/ubuntu/pool/universe/libm/libmcrypt/libmcrypt_2.5.8-3.1ubuntu1.diff.gz' libmcrypt_2.5.8-3.1ubuntu1.diff.gz 5884 SHA256:c244480b3f84daa49ab40bfd52b410e32c0770d52cc4d213d9cec20275474cf9
```
...
'http://archive.ubuntu.com/ubuntu/pool/main/libm/libmemcached/libmemcached_1.0.8-1ubuntu2.dsc' libmemcached_1.0.8-1ubuntu2.dsc 1820 SHA256:74f85da40b67831ad16347f7e0dbbafe077f986d515f414ba62297d4cf3b9531
'http://archive.ubuntu.com/ubuntu/pool/main/libm/libmemcached/libmemcached_1.0.8.orig.tar.gz' libmemcached_1.0.8.orig.tar.gz 1084343 SHA256:03f4eb91634f1434a93d4709eccd0c4cce3eb296b54f2b1998ca4a9ce1661ca5
'http://archive.ubuntu.com/ubuntu/pool/main/libm/libmemcached/libmemcached_1.0.8-1ubuntu2.debian.tar.gz' libmemcached_1.0.8-1ubuntu2.debian.tar.gz 9415 SHA256:9d224f85a9680c60626ce6407e6028243142a9dec0b398347742569932ef8005
```
...
- `libapache2-mod-php-5.6-zend-server=5.6.36+b281`
...
- `libpng3:amd64=1.2.50-1ubuntu2.14.04.3`
...
### `dpkg` source package: `libssh2=1.4.3-2ubuntu0.2`

Binary Packages:

- `libssh2-1:amd64=1.4.3-2ubuntu0.2`
...
```console
$ apt-get source -qq --print-uris libssh2=1.4.3-2ubuntu0.2
'http://archive.ubuntu.com/ubuntu/pool/universe/libs/libssh2/libssh2_1.4.3-2ubuntu0.2.dsc' libssh2_1.4.3-2ubuntu0.2.dsc 1952 SHA256:92f7f1170df251431d50723264d4edfca43377c4b44a3d3916cd0cd8be20f4d7
'http://archive.ubuntu.com/ubuntu/pool/universe/libs/libssh2/libssh2_1.4.3.orig.tar.gz' libssh2_1.4.3.orig.tar.gz 685712 SHA256:eac6f85f9df9db2e6386906a6227eb2cd7b3245739561cad7d6dc1d5d021b96d
'http://archive.ubuntu.com/ubuntu/pool/universe/libs/libssh2/libssh2_1.4.3-2ubuntu0.2.debian.tar.gz' libssh2_1.4.3-2ubuntu0.2.debian.tar.gz 7909 SHA256:159b5ed64642e972543a020b7b05d7d93dda91cf520dce5efa943e31b4e00377
```
...
- `php-5.6-pdo-mysql-zend-server=5.6.36+b34`
...
- `php-5.6-pdo-odbc-zend-server=5.6.36+b34`
...
- `php-5.6-bcmath-zend-server=5.6.36+b36`
...
- `php-5.6-bin-zend-server=5.6.36+b275`
...
- `php-5.6-bz2-zend-server=5.6.36+b35`
...
- `php-5.6-calendar-zend-server=5.6.36+b35`
...
- `php-5.6-ctype-zend-server=5.6.36+b35`
...
- `php-5.6-curl-zend-server=5.6.36+b36`
...
- `php-5.6-dev-zend-server=5.6.36+b264`
...
- `php-5.6-exif-zend-server=5.6.36+b36`
...
- `php-5.6-fcgi-zend-server=5.6.36+b36`
...
- `php-5.6-fileinfo-zend-server=5.6.36+b35`
...
- `php-5.6-ftp-zend-server=5.6.36+b35`
...
- `php-5.6-gd-zend-server=5.6.36+b35`
...
- `php-5.6-gettext-zend-server=5.6.36+b35`
...
- `php-5.6-gmp-zend-server=5.6.36+b35`
...
- `php-5.6-imagick-zend-server=5.6.36+b36`
...
- `php-5.6-imap-zend-server=5.6.36+b35`
...
- `php-5.6-intl-zend-server=5.6.36+b35`
...
- `php-5.6-ldap-zend-server=5.6.36+b35`
...
- `php-5.6-mbstring-zend-server=5.6.36+b35`
...
- `php-5.6-mcrypt-zend-server=5.6.36+b35`
...
- `php-5.6-memcache-zend-server=5.6.36+b35`
...
- `php-5.6-memcached-zend-server=5.6.36+b35`
...
- `php-5.6-mongo-zend-server=5.6.36+b45`
...
- `php-5.6-mssql-zend-server=5.6.36+b35`
...
- `php-5.6-mysql-zend-server=5.6.36+b34`
...
- `php-5.6-mysqli-zend-server=5.6.36+b34`
...
- `php-5.6-oci8-zend-server=5.6.36+b34`
...
- `php-5.6-odbc-zend-server=5.6.36+b34`
...
- `php-5.6-pcntl-zend-server=5.6.36+b34`
...
- `php-5.6-pdo-dblib-zend-server=5.6.36+b34`
...
- `php-5.6-pdo-pgsql-zend-server=5.6.36+b34`
...
- `php-5.6-pgsql-zend-server=5.6.36+b34`
...
- `php-5.6-phar-zend-server=5.6.36+b34`
...
- `php-5.6-posix-zend-server=5.6.36+b34`
...
- `php-5.6-redis-zend-server=5.6.36+b34`
...
- `php-5.6-shmop-zend-server=5.6.36+b34`
...
- `php-5.6-soap-zend-server=5.6.36+b34`
...
- `php-5.6-sockets-zend-server=5.6.36+b34`
...
- `php-5.6-ssh2-zend-server=5.6.36+b34`
...
- `php-5.6-sysvmsg-zend-server=5.6.36+b34`
...
- `php-5.6-sysvsem-zend-server=5.6.36+b33`
...
- `php-5.6-sysvshm-zend-server=5.6.36+b34`
...
- `php-5.6-tidy-zend-server=5.6.36+b34`
...
- `php-5.6-tokenizer-zend-server=5.6.36+b34`
...
- `php-5.6-wddx-zend-server=5.6.36+b34`
...
- `php-5.6-xdebug-zend-server=5.6.36+b34`
...
- `php-5.6-xmlrpc-zend-server=5.6.36+b34`
...
- `php-5.6-xsl-zend-server=5.6.36+b34`
...
- `php-5.6-zip-zend-server=5.6.36+b34`
...
### `dpkg` source package: `prelink=0.0.20090925-8`

Binary Packages:

- `execstack=0.0.20090925-8`
...
```console
$ apt-get source -qq --print-uris prelink=0.0.20090925-8
'http://archive.ubuntu.com/ubuntu/pool/main/p/prelink/prelink_0.0.20090925-8.dsc' prelink_0.0.20090925-8.dsc 1832 SHA256:561addf66ce660f662a28d7087796ebbeddbc3627eae28e7a4d00da2d04f776d
'http://archive.ubuntu.com/ubuntu/pool/main/p/prelink/prelink_0.0.20090925.orig.tar.gz' prelink_0.0.20090925.orig.tar.gz 1044288 SHA256:2110261aedd8423fa3f1dba5ecb08bd61beb708883f82753b09835076cba2e36
'http://archive.ubuntu.com/ubuntu/pool/main/p/prelink/prelink_0.0.20090925-8.debian.tar.gz' prelink_0.0.20090925-8.debian.tar.gz 25634 SHA256:02461540f645a9fa137612b9b51dd9d4ec754f9e9c80928e58b9dcb78879dc8b
```
...
### `dpkg` source package: `ssl-cert=1.0.33`
...
```console
$ apt-get source -qq --print-uris ssl-cert=1.0.33
'http://archive.ubuntu.com/ubuntu/pool/main/s/ssl-cert/ssl-cert_1.0.33.dsc' ssl-cert_1.0.33.dsc 994 SHA256:1f7e3a6e157710a5d57520cd289274bdf358232d98b06b9204ce326f87758f10
'http://archive.ubuntu.com/ubuntu/pool/main/s/ssl-cert/ssl-cert_1.0.33.tar.gz' ssl-cert_1.0.33.tar.gz 28850 SHA256:589cb90239fb51d14f9966bfcdaddeed82e5f2b3085307b8b8c59807a39636e9
```
...
### `dpkg` source package: `xauth=1:1.0.7-1ubuntu1`
...
```console
$ apt-get source -qq --print-uris xauth=1:1.0.7-1ubuntu1
'http://archive.ubuntu.com/ubuntu/pool/main/x/xauth/xauth_1.0.7-1ubuntu1.dsc' xauth_1.0.7-1ubuntu1.dsc 2081 SHA256:66622644fd1530e0984eb9b1b3f5b7cc3a74add3ae81600e6a6a2fc65511a717
'http://archive.ubuntu.com/ubuntu/pool/main/x/xauth/xauth_1.0.7.orig.tar.gz' xauth_1.0.7.orig.tar.gz 172607 SHA256:461afbfc508ff5ac2e600c41dd5da92fe05c389cefbb20425958bdee99b683d6
'http://archive.ubuntu.com/ubuntu/pool/main/x/xauth/xauth_1.0.7-1ubuntu1.diff.gz' xauth_1.0.7-1ubuntu1.diff.gz 8948 SHA256:4267f9dc7ac5a767edd182edda95997d8d97fd74cdd25f0affa049a24a780f41
```
...
- `zend-server-php-5.6=8.5.10+b798`
- `zend-server-php-5.6-common=8.5.10+b798`
