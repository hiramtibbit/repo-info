...
```console
$ docker pull znc@sha256:2b27bfc9eaa83f5a6a825d4eea5f3061423bf00519bee03a024d2b5c38d87c67
```
...
```console
$ docker pull znc@sha256:5d5186cb030c50eeaf486dbfc819dece47e1abefb5daa768d26f2801f6c7d367
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **112.9 MB (112878339 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d91e8ade93790632cb2ca5dbc733f33c77f23d05fea2740619d4a935d870a403`
-	Entrypoint: `["\/entrypoint.sh"]`
...
# Tue, 02 Apr 2019 10:56:50 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 02 Apr 2019 10:57:29 GMT
RUN set -x     && apk add --no-cache         build-base         cmake         icu-dev         libressl-dev         perl         python3
# Tue, 02 Apr 2019 10:57:31 GMT
COPY file:765473e154cb7674cba99ed8ee42b51feda01581be870e3d1e7e4930b82a0f37 in /startup-sequence/ 
```
...
-	Layers:
	...
	-	`sha256:5e773139f03da4ff3f61f376cbd42ae65dca8e0540055685b82c0da60d43fd06`  
		...
		Size: 342.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:59b3b4f27ce8532839182fad39ccc0b8f94dbe17e6b823e3640236b7553fb86b`  
		Last Modified: Tue, 02 Apr 2019 10:58:58 GMT  
		Size: 82.7 MB (82717644 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:19d10df9fd31431f20e1392094149233e44242ce52c81e5613f14f56c63ef5c3`  
		Last Modified: Tue, 02 Apr 2019 10:58:22 GMT  
		Size: 335.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
