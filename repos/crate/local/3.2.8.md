...
- Created: `2019-05-14T23:20:11.939579712Z`
...
### `rpm` package: `python36u-3.6.7-1.ius.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls python36u-3.6.7-1.ius.el7
Enabling epel-source repository
Enabling updates-source repository
Enabling base-source repository
Enabling ius-source repository
Enabling extras-source repository
https://repo.ius.io/7/src//packages/p/python36u-3.6.7-1.ius.el7.src.rpm
```

### `rpm` package: `python36u-libs-3.6.7-1.ius.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls python36u-libs-3.6.7-1.ius.el7
Enabling epel-source repository
Enabling updates-source repository
Enabling base-source repository
Enabling ius-source repository
