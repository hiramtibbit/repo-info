...
```console
$ docker pull bash@sha256:2d3c80db8c18e38035046a79efd3623cbb6ed06a3dd186246fa1d3e4e0e6a224
```
...
### `bash:5.0-rc1` - linux; arm variant v6
...
### `bash:5.0-rc1` - linux; arm64 variant v8
