...
```console
$ docker pull express-gateway@sha256:bf4093322c0236dc63c4693ac50d15f33dcad8cdad5a036bc5a0ab900be0d689
```
...
```console
$ docker pull express-gateway@sha256:d707a296068c802ca1858115002a957c0a7e9318a96685091eb9be92cd04f5e3
```
