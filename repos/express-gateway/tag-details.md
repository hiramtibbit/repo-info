...
```console
$ docker pull express-gateway@sha256:3ddbde88c22d9973f237b0204b9e32e65c2add75138f6e44e4b51729b820a818
```
...
### `express-gateway:1.16.1` - linux; amd64
...
### `express-gateway:1.16.1` - linux; arm64 variant v8
...
### `express-gateway:1.16.1` - linux; 386
...
### `express-gateway:1.16.1` - linux; ppc64le
...
### `express-gateway:1.16.1` - linux; s390x
