...
- `krb5-locales=1.12.1+dfsg-19+deb8u5`
...
### `dpkg` source package: `protobuf=2.6.1-1`

Binary Packages:

- `libprotobuf9:amd64=2.6.1-1`

Licenses: (parsed from: `/usr/share/doc/libprotobuf9/copyright`)
...
```console
$ apt-get source -qq --print-uris protobuf=2.6.1-1
'http://deb.debian.org/debian/pool/main/p/protobuf/protobuf_2.6.1-1.dsc' protobuf_2.6.1-1.dsc 2564 SHA256:5183d506f77488a02349cdf9ee1a1b0936e3717c2a63746ea883695c1f119fe8
'http://deb.debian.org/debian/pool/main/p/protobuf/protobuf_2.6.1.orig.tar.gz' protobuf_2.6.1.orig.tar.gz 2641426 SHA256:dbbd7bdd2381633995404de65a945ff1a7610b0da14593051b4738c90c6dd164
'http://deb.debian.org/debian/pool/main/p/protobuf/protobuf_2.6.1-1.debian.tar.xz' protobuf_2.6.1-1.debian.tar.xz 12744 SHA256:d871f905916d6de94a3e062d29b90ae83f52cacc53854360975cdd0240dc0322
```

Other potentially useful URLs:

- https://sources.debian.net/src/protobuf/2.6.1-1/ (for browsing the source)
- https://sources.debian.net/src/protobuf/2.6.1-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/protobuf/2.6.1-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `rethinkdb=2.3.6~0jessie`

Binary Packages:

- `rethinkdb=2.3.6~0jessie`
