...
### `gradle:4.9.0-jre7-alpine` - linux; arm64 variant v8
...
### `gradle:4.9.0-jre7-alpine` - linux; 386
...
### `gradle:4.9.0-jre7-alpine` - linux; ppc64le
...
### `gradle:4.9.0-jre7-alpine` - linux; s390x
