...
### `gradle:5.1.1-jdk8-slim` - linux; arm variant v5
...
### `gradle:5.1.1-jdk8-slim` - linux; arm variant v7
...
### `gradle:5.1.1-jdk8-slim` - linux; arm64 variant v8
...
### `gradle:5.1.1-jdk8-slim` - linux; 386
...
### `gradle:5.1.1-jdk8-slim` - linux; s390x
