...
```console
$ docker pull gradle@sha256:e7c721b448a40ef3e97823fe71c2b3709cd5580e9276e52309f6c5755be8ad33
```
...
### `gradle:5.2.1-jdk8-alpine` - linux; 386
...
### `gradle:5.2.1-jdk8-alpine` - linux; s390x
