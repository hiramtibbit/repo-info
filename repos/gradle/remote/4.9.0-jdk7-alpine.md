...
```console
$ docker pull gradle@sha256:dcdd926c301def1a8fb354d1baa089435df0fad4ad30df83ad415d2106a767be
```
...
### `gradle:4.9.0-jdk7-alpine` - linux; 386
...
### `gradle:4.9.0-jdk7-alpine` - linux; ppc64le
