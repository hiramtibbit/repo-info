...
### `gradle:5.3.0-jdk8-alpine` - linux; arm64 variant v8
...
### `gradle:5.3.0-jdk8-alpine` - linux; 386
...
### `gradle:5.3.0-jdk8-alpine` - linux; ppc64le
...
### `gradle:5.3.0-jdk8-alpine` - linux; s390x
