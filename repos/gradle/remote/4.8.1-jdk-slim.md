...
### `gradle:4.8.1-jdk-slim` - linux; arm variant v7
...
### `gradle:4.8.1-jdk-slim` - linux; arm64 variant v8
...
### `gradle:4.8.1-jdk-slim` - linux; 386
...
### `gradle:4.8.1-jdk-slim` - linux; ppc64le
...
### `gradle:4.8.1-jdk-slim` - linux; s390x
