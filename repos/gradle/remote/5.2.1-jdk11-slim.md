...
```console
$ docker pull gradle@sha256:d76c7448ee9923493a9155c771a904ff6cedc3e3f4813416402debd125d21a48
```
...
### `gradle:5.2.1-jdk11-slim` - linux; amd64
...
### `gradle:5.2.1-jdk11-slim` - linux; arm variant v5
...
### `gradle:5.2.1-jdk11-slim` - linux; arm variant v7
...
### `gradle:5.2.1-jdk11-slim` - linux; arm64 variant v8
...
### `gradle:5.2.1-jdk11-slim` - linux; 386
...
### `gradle:5.2.1-jdk11-slim` - linux; ppc64le
...
### `gradle:5.2.1-jdk11-slim` - linux; s390x
