...
```console
$ docker pull gradle@sha256:571cd9cc44a837b9d4d8451812bee86d65ffe06c96f3e70d9b820946263f05c4
```
...
### `gradle:5.2.0-jdk8` - linux; arm variant v5
...
### `gradle:5.2.0-jdk8` - linux; arm64 variant v8
...
### `gradle:5.2.0-jdk8` - linux; ppc64le
