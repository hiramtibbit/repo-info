...
### `jetty:9.4.18-alpine` - linux; arm variant v6
...
### `jetty:9.4.18-alpine` - linux; arm64 variant v8
...
### `jetty:9.4.18-alpine` - linux; ppc64le
...
### `jetty:9.4.18-alpine` - linux; s390x
