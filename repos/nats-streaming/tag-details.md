...
-	[`nats-streaming:0.7.2`](#nats-streaming072)
-	[`nats-streaming:0.7.2-linux`](#nats-streaming072-linux)
-	[`nats-streaming:0.7.2-nanoserver`](#nats-streaming072-nanoserver)
-	[`nats-streaming:0.7.2-windowsservercore`](#nats-streaming072-windowsservercore)
...
```console
$ docker pull nats-streaming@sha256:4669969b2d0ae4054dcb68ecf71b2f3716d9dce9801e3a68729f81781918b34e
```
...
### `nats-streaming:0.7.2` - linux; amd64
...
### `nats-streaming:0.7.2` - linux; arm variant v7
...
### `nats-streaming:0.7.2` - windows version 10.0.14393.2007; amd64
...
```console
$ docker pull nats-streaming@sha256:632aaff82b2a3b87443df73404f9874bde969bcf523531d501a8aab481352847
```
