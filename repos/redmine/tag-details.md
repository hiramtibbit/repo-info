...
```console
$ docker pull redmine@sha256:bfff582b4f9945b36bd6b9d687a95060191f6cebfc190f92c0cb673cd2f70dfb
```
...
```console
$ docker pull redmine@sha256:6169a93814f20e49149e611eb7fdda5975ce255e3ab35b9d971f05ae7c874e0a
```
