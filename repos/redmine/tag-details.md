...
```console
$ docker pull redmine@sha256:b65307d3609c2503df0a8a6751f818679144105db9c29dd0091c2f67b14dada5
```
...
```console
$ docker pull redmine@sha256:ea1490044c195a8f3bce65e5b181712bfe7c4b1690320539880fbcdab946fb8b
```
