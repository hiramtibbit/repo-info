...
```console
$ docker pull redmine@sha256:f4d148046d6da42bdc4b2e79d642223451a333c65b8e01f3bb45aa66c23049fa
```
...
```console
$ docker pull redmine@sha256:99c0a3a44f58207407c5f46fa45eda5a4c9f5002fd57d2a89044f4e5db781cab
```
