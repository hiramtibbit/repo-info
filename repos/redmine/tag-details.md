...
```console
$ docker pull redmine@sha256:9298e5657fe2b097488dc616576ea0f2b538941318848e7ca9b68cbb43eeeae8
```
...
```console
$ docker pull redmine@sha256:baf74189a1e70359b85099b2ad8ebf74366bb7c16cc0b5a3b5ed012d3a415439
```
