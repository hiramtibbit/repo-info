...
```console
$ docker pull redmine@sha256:fbfe3470151daa0e260183a0864a6be881f1393543353bb4d7eb45988da97622
```
...
```console
$ docker pull redmine@sha256:0a73e6955069ceeeffce9372ebfbcc5554ad6fc0a17bbcdf85dd5d75ef9818d3
```
