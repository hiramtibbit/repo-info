...
```console
$ docker pull redmine@sha256:3e14bacc7eec4d2d0290fa9e48ba76f1c2e78e294c222d859a429735e2dac228
```
...
```console
$ docker pull redmine@sha256:491faea580e1b1a28597b6f5e4b634304000ffe3df39c13792393f0fe52046d5
```
