...
```console
$ docker pull redmine@sha256:d9b106194152302f36c2b1e1ff9cc1ff7194f756274e8a0eceff9191e774b0a2
```
...
```console
$ docker pull redmine@sha256:0ad8ca2ca410962ed0eed82b3a2bff4c7daa6632981cba2a3a29181bd37053f4
```
