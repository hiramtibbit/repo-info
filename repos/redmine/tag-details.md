...
```console
$ docker pull redmine@sha256:a4542108081ab2e29f1e4685e528625f8e753201804f12718c0c44847295d21c
```
...
```console
$ docker pull redmine@sha256:d2683dfad3ccd05ca3cffe2f2d73ecd69c6de6946d299a17f8937212fbc391a8
```
