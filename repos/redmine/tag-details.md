...
```console
$ docker pull redmine@sha256:7ed695f4c1387cf4004d4aa866babf6e130712f39b7e3e17893baab6b363d2b8
```
...
```console
$ docker pull redmine@sha256:31d6528569728dceac4b928562642a4b6f587cf101db5ed549f046c31318b55b
```
