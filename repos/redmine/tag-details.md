...
```console
$ docker pull redmine@sha256:8db6d63a0ac3a5de2302e3686fd729424892e2ec8e394bc2600c33d38db529c0
```
...
```console
$ docker pull redmine@sha256:831fcda012714985572b6fdb44f1ad05e99eb548300d6ed5c036c352ce219350
```
