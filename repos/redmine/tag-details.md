...
```console
$ docker pull redmine@sha256:26f531b12729dac4a5bc8efd84b9cc4008b36116663b8f1fb9e40a520b54db04
```
...
```console
$ docker pull redmine@sha256:b6baf7c1d382ffcedf531765faeb90f6766d71a345145c960184f687f1cf4fb2
```
