...
- Created: `2018-04-20T05:44:42.967776533Z`
...
- https://sources.debian.net/src/gettext/0.19.3-2/ (for browsing the source)
- https://sources.debian.net/src/gettext/0.19.3-2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/gettext/0.19.3-2/ (for access to the source package after it no longer exists in the archive)
...
- https://sources.debian.net/src/libunistring/0.9.3-5.2/ (for browsing the source)
- https://sources.debian.net/src/libunistring/0.9.3-5.2/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/libunistring/0.9.3-5.2/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `liburcu=0.8.5-1`

Binary Packages:

- `liburcu2:amd64=0.8.5-1`

Licenses: (parsed from: `/usr/share/doc/liburcu2/copyright`)
...
```console
$ apt-get source -qq --print-uris liburcu=0.8.5-1
'http://deb.debian.org/debian/pool/main/libu/liburcu/liburcu_0.8.5-1.dsc' liburcu_0.8.5-1.dsc 1911 SHA256:683ce1d7943b5fcba6fa7cce3eecef51abac81d6eb71140217311efa975c02c4
'http://deb.debian.org/debian/pool/main/libu/liburcu/liburcu_0.8.5.orig.tar.bz2' liburcu_0.8.5.orig.tar.bz2 423913 SHA256:a2562eaca107ec6eca2856632b6035c6aaf38df79020195ed8955a7b4773312a
'http://deb.debian.org/debian/pool/main/libu/liburcu/liburcu_0.8.5-1.debian.tar.xz' liburcu_0.8.5-1.debian.tar.xz 6964 SHA256:80705b59665e2b005f40325bf45316d0dcd3b1bae9b63f456b3f6e1c7af699d7
```

Other potentially useful URLs:

- https://sources.debian.net/src/liburcu/0.8.5-1/ (for browsing the source)
- https://sources.debian.net/src/liburcu/0.8.5-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/liburcu/0.8.5-1/ (for access to the source package after it no longer exists in the archive)
...
### `dpkg` source package: `ust=2.5.0-1`

Binary Packages:

- `liblttng-ust-ctl2:amd64=2.5.0-1`
- `liblttng-ust0:amd64=2.5.0-1`
...
```console
$ apt-get source -qq --print-uris ust=2.5.0-1
'http://deb.debian.org/debian/pool/main/u/ust/ust_2.5.0-1.dsc' ust_2.5.0-1.dsc 2235 SHA256:cbafd19018ab2bbeb3b6169fc498a1ca95dc192d4cbe4eb3c3f0d42d8fd42bab
'http://deb.debian.org/debian/pool/main/u/ust/ust_2.5.0.orig.tar.bz2' ust_2.5.0.orig.tar.bz2 583293 SHA256:dcd0bb81a12833e6edea110a0cc97108a7e55b1dc95ff2c97d06796866f5c3aa
'http://deb.debian.org/debian/pool/main/u/ust/ust_2.5.0-1.debian.tar.xz' ust_2.5.0-1.debian.tar.xz 6492 SHA256:a077a7ece5ee6a62e098f8115ec8d29dc577ea7158cdf8948e51b109bd9664a3
```

Other potentially useful URLs:

- https://sources.debian.net/src/ust/2.5.0-1/ (for browsing the source)
- https://sources.debian.net/src/ust/2.5.0-1/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/ust/2.5.0-1/ (for access to the source package after it no longer exists in the archive)
