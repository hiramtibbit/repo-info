...
```console
curl-7.63.0-r0 description:
URL retrival utility and library

curl-7.63.0-r0 webpage:
https://curl.haxx.se

curl-7.63.0-r0 installed size:
233472

curl-7.63.0-r0 license:
MIT
...
```console
libcurl-7.63.0-r0 description:
The multiprotocol file transfer library

libcurl-7.63.0-r0 webpage:
https://curl.haxx.se

libcurl-7.63.0-r0 installed size:
483328

libcurl-7.63.0-r0 license:
MIT
...
```console
libssh2-1.8.0-r4 description:
library for accessing ssh1/ssh2 protocol servers

libssh2-1.8.0-r4 webpage:
https://libssh2.org/

libssh2-1.8.0-r4 installed size:
180224

libssh2-1.8.0-r4 license:
BSD
...
```console
tar-1.31-r0 description:
Utility used to store, backup, and transport files

tar-1.31-r0 webpage:
https://www.gnu.org

tar-1.31-r0 installed size:
495616
