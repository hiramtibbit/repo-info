...
```console
$ docker pull tomee@sha256:3e2d8d906b122eb8cc6f59db7d0d5a3a2e6f8b413a8abe590236508f3f857582
```
...
```console
$ docker pull tomee@sha256:13b2418b3919714b4f43bb4a9e08a8e812f30d651febf06158ae862402c90a98
```
...
```console
$ docker pull tomee@sha256:ec5c0d95e8ba2784ca58f83dd2a797187deced443684c6f3515e6c5626c946ea
```
...
```console
$ docker pull tomee@sha256:d8a5f20957bdfeace971ab11d8ac75e17dd8eef022736f8306d171a11bccd92e
```
...
```console
$ docker pull tomee@sha256:d5e1baf60b82c30486552f3c1cc94ff40bff769a176692b5d04a931b7aedcb20
```
...
-	Total Size: **237.5 MB (237519532 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3884d446813443cb81e16d63057ae3cd7d595a7624ab9bfd346a460a871e2b60`
-	Default Command: `["catalina.sh","run"]`
