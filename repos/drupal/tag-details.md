...
-	[`drupal:8`](#drupal8)
-	[`drupal:8.5`](#drupal85)
-	[`drupal:8.5.10`](#drupal8510)
-	[`drupal:8.5.10-apache`](#drupal8510-apache)
-	[`drupal:8.5.10-fpm`](#drupal8510-fpm)
-	[`drupal:8.5.10-fpm-alpine`](#drupal8510-fpm-alpine)
-	[`drupal:8.5-apache`](#drupal85-apache)
-	[`drupal:8.5-fpm`](#drupal85-fpm)
-	[`drupal:8.5-fpm-alpine`](#drupal85-fpm-alpine)
-	[`drupal:8.6`](#drupal86)
-	[`drupal:8.6.8`](#drupal868)
-	[`drupal:8.6.8-apache`](#drupal868-apache)
-	[`drupal:8.6.8-fpm`](#drupal868-fpm)
-	[`drupal:8.6.8-fpm-alpine`](#drupal868-fpm-alpine)
...
```console
$ docker pull drupal@sha256:847d5c6674a6183ce9fae52c3d415fc26ec46584b3f276c733df8bf7c8c3ab93
```
...
```console
$ docker pull drupal@sha256:1a78896cd3aa9b6d268f7f9da361b44c50323de58fdaabe76b16480306f22d51
```
...
```console
$ docker pull drupal@sha256:1afa112dda2dc6dd0bf1cf7e41bbfb0e4dcf3947d9130f99cfb144062a814ab8
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **52.2 MB (52168853 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9506d48176aa283032fc0b58dc254a1afab94219f052fc8f52b0f24889386c3c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
WORKDIR /var/www/html
# Fri, 18 Jan 2019 11:39:22 GMT
ENV DRUPAL_VERSION=8.5.10
# Fri, 18 Jan 2019 11:39:22 GMT
ENV DRUPAL_MD5=39e2b451d6bc6f58c4eeb09ad26ad965
# Fri, 18 Jan 2019 11:39:30 GMT
RUN curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz 	&& echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c - 	&& tar -xz --strip-components=1 -f drupal.tar.gz 	&& rm drupal.tar.gz 	&& chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:c057254b03a52e11dec3e03c8431320c43f1245acfaf9d36e0e6cd4b3cf80567`  
		...
		Size: 335.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:469fdf13f08671bb65bf520ab5682f7348c8dc4d497e2c590ec15ac394150436`  
		Last Modified: Fri, 18 Jan 2019 11:41:13 GMT  
		Size: 15.9 MB (15922387 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `drupal:8.6.8-apache` - linux; amd64
...
### `drupal:8.6.8-fpm-alpine` - linux; amd64
