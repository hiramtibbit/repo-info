...
-	[`drupal:7`](#drupal7)
-	[`drupal:7.67`](#drupal767)
-	[`drupal:7.67-apache`](#drupal767-apache)
-	[`drupal:7.67-fpm`](#drupal767-fpm)
-	[`drupal:7.67-fpm-alpine`](#drupal767-fpm-alpine)
...
-	[`drupal:8.6`](#drupal86)
-	[`drupal:8.6.16`](#drupal8616)
-	[`drupal:8.6.16-apache`](#drupal8616-apache)
-	[`drupal:8.6.16-fpm`](#drupal8616-fpm)
-	[`drupal:8.6.16-fpm-alpine`](#drupal8616-fpm-alpine)
...
```console
$ docker pull drupal@sha256:7aad5ef0108f39f3aebd9c1362089a604d57c99ed7cc11b1fd8e6d3bfce36026
```
...
```console
$ docker pull drupal@sha256:67b454938e4993d3393f580375c47788e57006e7e706a5694a6015befba0ae70
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.4 MB (134393735 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8d567507c302f338df8682ac5f3205087bcce3a14c557c439da47637d8e85624`
-	Entrypoint: `["docker-php-entrypoint"]`
...
# Wed, 08 May 2019 10:46:53 GMT
WORKDIR /var/www/html
# Thu, 09 May 2019 23:20:14 GMT
ENV DRUPAL_VERSION=7.67
# Thu, 09 May 2019 23:20:15 GMT
ENV DRUPAL_MD5=78b1814e55fdaf40e753fd523d059f8d
# Thu, 09 May 2019 23:20:16 GMT
RUN curl -fSL "https://ftp.drupal.org/files/projects/drupal-${DRUPAL_VERSION}.tar.gz" -o drupal.tar.gz 	&& echo "${DRUPAL_MD5} *drupal.tar.gz" | md5sum -c - 	&& tar -xz --strip-components=1 -f drupal.tar.gz 	&& rm drupal.tar.gz 	&& chown -R www-data:www-data sites modules themes
```
...
-	Layers:
	...
	-	`sha256:6872373bb8d02bcc22a655c85846fea5e4b437542888905aadf1029c3496772a`  
		...
		Size: 348.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6f65d72c59630c2ab30389e52c1c43f37d9fbb5a65a66749a04ead2cb1b43b9e`  
		Last Modified: Thu, 09 May 2019 23:21:33 GMT  
		Size: 3.3 MB (3332777 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
### `drupal:8.6.16-apache` - linux; amd64
