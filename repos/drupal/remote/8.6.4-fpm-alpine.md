...
### `drupal:8.6.4-fpm-alpine` - linux; amd64
...
### `drupal:8.6.4-fpm-alpine` - linux; arm variant v6
...
### `drupal:8.6.4-fpm-alpine` - linux; arm64 variant v8
...
### `drupal:8.6.4-fpm-alpine` - linux; 386
...
### `drupal:8.6.4-fpm-alpine` - linux; ppc64le
