...
### `drupal:8.6.0-alpha1-fpm` - linux; amd64
...
### `drupal:8.6.0-alpha1-fpm` - linux; arm variant v5
...
### `drupal:8.6.0-alpha1-fpm` - linux; arm variant v7
...
### `drupal:8.6.0-alpha1-fpm` - linux; arm64 variant v8
...
### `drupal:8.6.0-alpha1-fpm` - linux; 386
...
### `drupal:8.6.0-alpha1-fpm` - linux; ppc64le
