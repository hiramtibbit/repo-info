...
### `drupal:8.6.13-apache` - linux; arm variant v5
...
### `drupal:8.6.13-apache` - linux; arm variant v7
...
### `drupal:8.6.13-apache` - linux; arm64 variant v8
...
### `drupal:8.6.13-apache` - linux; 386
...
### `drupal:8.6.13-apache` - linux; ppc64le
