...
```console
$ docker pull websphere-liberty@sha256:7d35adc999338b9cece9f5a30d5bf598a60f18fe362446362efa0e6432164323
```
...
```console
$ docker pull websphere-liberty@sha256:6be816acf31c92479d1bc0c3644a76a1730b0f49e5ca4ec242b23c8caf25383d
```
...
```console
$ docker pull websphere-liberty@sha256:71dbbed74efc69e0ccadea6d9728c480df1969e5c7dfc508a6bd14d7015dea4c
```
...
-	Total Size: **189.1 MB (189118156 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c02001fa82c76c69e66f52ddb2677921658f59988fe900646f8361b5b9c05d4`
-	Entrypoint: `["\/opt\/ibm\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ibm\/wlp\/bin\/server","run","defaultServer"]`
...
```console
$ docker pull websphere-liberty@sha256:86c7222bd08a287be3350b6eaddd1c5e789bda1acb6811c720279c8defdd9dbd
```
...
-	Total Size: **216.8 MB (216805253 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:0feab6ea2d81b6843d65ccc14f9309c557f93f989106d267f08946d57b0c853a`
-	Entrypoint: `["\/opt\/ibm\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ibm\/wlp\/bin\/server","run","defaultServer"]`
...
```console
$ docker pull websphere-liberty@sha256:a5c7ccec4a246bf1336e808772b0e59047160b69777142bf14f1c9acc9ebad37
```
...
-	Total Size: **198.7 MB (198708092 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6676a9f295efa63867d63473b8f12dac73e5f69d435b9d7bf8dcd14753236b4b`
-	Entrypoint: `["\/opt\/ibm\/helpers\/runtime\/docker-server.sh"]`
-	Default Command: `["\/opt\/ibm\/wlp\/bin\/server","run","defaultServer"]`
