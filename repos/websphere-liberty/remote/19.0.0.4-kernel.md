...
### `websphere-liberty:19.0.0.4-kernel` - linux; amd64
...
### `websphere-liberty:19.0.0.4-kernel` - linux; 386
...
### `websphere-liberty:19.0.0.4-kernel` - linux; ppc64le
...
### `websphere-liberty:19.0.0.4-kernel` - linux; s390x
