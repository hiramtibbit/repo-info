...
- Created: `2019-03-19T00:23:57.810837039Z`
- Virtual Size: ~ 197.85 Mb  
  (total size of all layers on-disk)
- Arch: `linux`/`amd64`
- Command: `["bash"]`
- Environment:
  - `PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin`
  - `MONO_VERSION=5.16.1.0`
...
### `dpkg` source package: `mono-llvm=3.6.0+mono201805011452-0xamarin1+debian9b1`

Binary Packages:

- `mono-llvm-tools=3.6.0+mono201805011452-0xamarin1+debian9b1`
...
```console
$ apt-get source -qq --print-uris mono-llvm=3.6.0+mono201805011452-0xamarin1+debian9b1
'http://download.mono-project.com/repo/debian/pool/main/m/mono-llvm/mono-llvm_3.6.0+mono201805011452-0xamarin1+debian9b1.dsc' mono-llvm_3.6.0+mono201805011452-0xamarin1+debian9b1.dsc 1280 SHA256:0afbbe1b3d77fa64d2a75bc415e8c9c498ef57c724f44d495bb3acaa60173d7a
...
'http://download.mono-project.com/repo/debian/pool/main/m/mono-llvm/mono-llvm_3.6.0+mono201805011452-0xamarin1+debian9b1.debian.tar.xz' mono-llvm_3.6.0+mono201805011452-0xamarin1+debian9b1.debian.tar.xz 5368 SHA256:3851eebc1487e9752c6e49abcdab9827e911a6585f1d9202640e983fb1fd015f
```

### `dpkg` source package: `mono=5.16.1.0-0xamarin1+debian9b1`

Binary Packages:

- `ca-certificates-mono=5.16.1.0-0xamarin1+debian9b1`
- `libmono-btls-interface4.0-cil=5.16.1.0-0xamarin1+debian9b1`
- `libmono-corlib4.5-cil=5.16.1.0-0xamarin1+debian9b1`
- `libmono-i18n-west4.0-cil=5.16.1.0-0xamarin1+debian9b1`
- `libmono-i18n4.0-cil=5.16.1.0-0xamarin1+debian9b1`
- `libmono-posix4.0-cil=5.16.1.0-0xamarin1+debian9b1`
- `libmono-security4.0-cil=5.16.1.0-0xamarin1+debian9b1`
- `libmono-system-configuration4.0-cil=5.16.1.0-0xamarin1+debian9b1`
- `libmono-system-core4.0-cil=5.16.1.0-0xamarin1+debian9b1`
- `libmono-system-numerics4.0-cil=5.16.1.0-0xamarin1+debian9b1`
- `libmono-system-security4.0-cil=5.16.1.0-0xamarin1+debian9b1`
- `libmono-system-xml4.0-cil=5.16.1.0-0xamarin1+debian9b1`
- `libmono-system4.0-cil=5.16.1.0-0xamarin1+debian9b1`
- `mono-4.0-gac=5.16.1.0-0xamarin1+debian9b1`
- `mono-gac=5.16.1.0-0xamarin1+debian9b1`
- `mono-llvm-support=5.16.1.0-0xamarin1+debian9b1`
- `mono-runtime=5.16.1.0-0xamarin1+debian9b1`
- `mono-runtime-common=5.16.1.0-0xamarin1+debian9b1`
- `mono-runtime-sgen=5.16.1.0-0xamarin1+debian9b1`
...
```console
$ apt-get source -qq --print-uris mono=5.16.1.0-0xamarin1+debian9b1
'http://download.mono-project.com/repo/debian/pool/main/m/mono/mono_5.16.1.0-0xamarin1+debian9b1.dsc' mono_5.16.1.0-0xamarin1+debian9b1.dsc 19078 SHA256:600712c85b5ded43c6dac456b1821d5ca01cfd613c201900b45f616619b4e675
'http://download.mono-project.com/repo/debian/pool/main/m/mono/mono_5.16.1.0.orig.tar.bz2' mono_5.16.1.0.orig.tar.bz2 231570995 SHA256:c2074249d8c090bac56c38e1fcbdbe215703403a0fbeccf6db7c04d8033c8537
'http://download.mono-project.com/repo/debian/pool/main/m/mono/mono_5.16.1.0-0xamarin1+debian9b1.debian.tar.xz' mono_5.16.1.0-0xamarin1+debian9b1.debian.tar.xz 155268 SHA256:e8a5874e24585f211b9aa9c7c32deeeb5feb6561013666f9374b154d04060595
```
