...
```console
$ docker pull couchbase@sha256:adb582611f434f0d02f773164ec11310bdb1604d6823718d2f2b16e87c3dc65d
```
...
```console
$ docker pull couchbase@sha256:ebc863ed5a8dd7d4faff7104e5e089bc6ee8a8724663c674dda12fd75b97b198
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **198.7 MB (198678347 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b5a7cc4e5d93a3676cfe953a2caafe23f22a47c14c718b91bca3319b08e8e57c`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["couchbase-server"]`
...
RUN groupadd -g 1000 couchbase && useradd couchbase -u 1000 -g couchbase -M
# Tue, 30 Oct 2018 06:21:36 GMT
# ARGS: CB_PACKAGE=couchbase-server-community_6.0.0-ubuntu16.04_amd64.deb CB_RELEASE_URL=https://packages.couchbase.com/releases CB_SHA256=949b1ded72776a557b9cd3ac89253a4fe6aed079966a4057c5aec41ae5a30ece CB_VERSION=6.0.0
RUN export INSTALL_DONT_START_SERVER=1 &&     wget -N $CB_RELEASE_URL/$CB_VERSION/$CB_PACKAGE &&     echo "$CB_SHA256  $CB_PACKAGE" | sha256sum -c - &&     dpkg -i ./$CB_PACKAGE && rm -f ./$CB_PACKAGE
# Tue, 30 Oct 2018 06:21:37 GMT
COPY file:9a90647aed4e88ee15c7efe9abbafbf7a89c3174cbe85d6b5492cde1aa9c6355 in /etc/service/couchbase-server/run 
# Tue, 30 Oct 2018 06:21:37 GMT
# ARGS: CB_PACKAGE=couchbase-server-community_6.0.0-ubuntu16.04_amd64.deb CB_RELEASE_URL=https://packages.couchbase.com/releases CB_SHA256=949b1ded72776a557b9cd3ac89253a4fe6aed079966a4057c5aec41ae5a30ece CB_VERSION=6.0.0
RUN chown -R couchbase:couchbase /etc/service
# Tue, 30 Oct 2018 06:21:38 GMT
COPY file:8196fd8e201c5fc3873a0faa3cec28b0d85633e363c0c5788434f5b9a81cfa5b in /usr/local/bin/ 
# Tue, 30 Oct 2018 06:21:39 GMT
# ARGS: CB_PACKAGE=couchbase-server-community_6.0.0-ubuntu16.04_amd64.deb CB_RELEASE_URL=https://packages.couchbase.com/releases CB_SHA256=949b1ded72776a557b9cd3ac89253a4fe6aed079966a4057c5aec41ae5a30ece CB_VERSION=6.0.0
RUN ln -s dummy.sh /usr/local/bin/iptables-save &&     ln -s dummy.sh /usr/local/bin/lvdisplay &&     ln -s dummy.sh /usr/local/bin/vgdisplay &&     ln -s dummy.sh /usr/local/bin/pvdisplay
# Tue, 30 Oct 2018 06:21:39 GMT
# ARGS: CB_PACKAGE=couchbase-server-community_6.0.0-ubuntu16.04_amd64.deb CB_RELEASE_URL=https://packages.couchbase.com/releases CB_SHA256=949b1ded72776a557b9cd3ac89253a4fe6aed079966a4057c5aec41ae5a30ece CB_VERSION=6.0.0
RUN chrpath -r '$ORIGIN/../lib' /opt/couchbase/bin/curl
# Tue, 30 Oct 2018 06:21:40 GMT
COPY file:5d67fa23771c82cbce2e1a74900e7c0ce4d1466a002273f57ab13d52d6b844b3 in / 
# Tue, 30 Oct 2018 06:21:40 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Tue, 30 Oct 2018 06:21:40 GMT
CMD ["couchbase-server"]
# Tue, 30 Oct 2018 06:21:41 GMT
EXPOSE 11207/tcp 11210/tcp 11211/tcp 18091/tcp 18092/tcp 18093/tcp 18094/tcp 18095/tcp 18096/tcp 8091/tcp 8092/tcp 8093/tcp 8094/tcp 8095/tcp 8096/tcp
# Tue, 30 Oct 2018 06:21:41 GMT
VOLUME [/opt/couchbase/var]
```
...
-	Layers:
	...
	-	`sha256:1b11929e4bbad8aa238c76bf17ddd138911e9ad8aad6c012f84bc61453661c53`  
		...
		Size: 14.3 MB (14297801 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8c30a9949d95281bd63631742ee65def7b3c44ca7aaa4539fdfab3daf7de8376`  
		Last Modified: Tue, 30 Oct 2018 06:23:47 GMT  
		Size: 2.1 KB (2081 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:7d7871f9cd1dbdb9bbead97f7eeb8695361c8031f9d0bb669aafc3f661d98e4e`  
		Last Modified: Tue, 30 Oct 2018 06:24:12 GMT  
		Size: 140.9 MB (140901250 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c70e2dd03805ee3ad31638539edae3936e7b9f559392180ddea5457efa7a361d`  
		Last Modified: Tue, 30 Oct 2018 06:23:48 GMT  
		Size: 404.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9d21058e565cd46aba89afcbeb783ebd85e543163597e6d3970286c75f300426`  
		Last Modified: Tue, 30 Oct 2018 06:23:46 GMT  
		Size: 412.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9dd083cbd9513a3f873dc9b2f8862c133ff80ff6d7322de8f494cc796d768e49`  
		Last Modified: Tue, 30 Oct 2018 06:23:46 GMT  
		Size: 237.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:228d755e237ce4e082d1bb61259de2498ea880b02a48aacda25b6ea7ec252282`  
		Last Modified: Tue, 30 Oct 2018 06:23:47 GMT  
		Size: 219.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:1c85de688a84769942a44deeffae2f7556a8ec27d73b5a2e1a6a50d493216ffb`  
		Last Modified: Tue, 30 Oct 2018 06:23:47 GMT  
		Size: 120.6 KB (120598 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:6b844418e539b14796f4b5bc04b366f2176b4a44b7916c0bdb815b8e0a78fb84`  
		Last Modified: Tue, 30 Oct 2018 06:23:46 GMT  
		Size: 857.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
