...
```console
$ docker pull haxe@sha256:63d34a64a9bf6c5520cd5c1193801fe125f4ec4a7b1b1243907d9e4dca7b0070
```
...
```console
$ docker pull haxe@sha256:2c37e84f5207df979ff28dd1fdf584cbdcefb7d07d62aa79bf7c122724f1e782
```

-	Docker Version: 18.03.1-ee-4
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **5.7 GB (5680018012 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:402b6274b9bddbae77f9e7870bd92fac156ebfd6090ffeb6c5539ff795cf35a1`
...
# Tue, 05 Feb 2019 10:16:14 GMT
ENV HAXE_VERSION=4.0.0-rc.1
# Tue, 05 Feb 2019 10:20:51 GMT
RUN $url = 'https://github.com/HaxeFoundation/haxe/releases/download/4.0.0-rc.1/haxe-4.0.0-rc.1-win64.zip'; 	Write-Host ('Downloading {0} ...' -f $url); 	[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12; 	Invoke-WebRequest -Uri $url -OutFile haxe.zip; 		Write-Host 'Verifying sha256 (ef533d35e628cf8bb28753ef25c242ecc439173bfb2abaddcad9eee690d0b9c0) ...'; 	if ((Get-FileHash haxe.zip -Algorithm sha256).Hash -ne 'ef533d35e628cf8bb28753ef25c242ecc439173bfb2abaddcad9eee690d0b9c0') { 		Write-Host 'FAILED!'; 		exit 1; 	}; 		Write-Host 'Expanding ...'; 	New-Item -ItemType directory -Path tmp; 	Expand-Archive -Path haxe.zip -DestinationPath tmp; 	if (Test-Path tmp\haxe.exe) { Move-Item tmp $env:HAXEPATH } 	else { Move-Item (Resolve-Path tmp\haxe* | Select -ExpandProperty Path) $env:HAXEPATH }; 		Write-Host 'Removing ...'; 	Remove-Item -Path haxe.zip, tmp -Force -Recurse -ErrorAction Ignore; 		Write-Host 'Verifying install ...'; 	Write-Host '  haxe -version'; haxe -version; 		Write-Host 'Complete.';
# Tue, 05 Feb 2019 10:21:47 GMT
RUN New-Item -ItemType directory -Path $env:HAXELIB_PATH;
# Tue, 05 Feb 2019 10:21:49 GMT
ENV HOMEDRIVE=C:
# Tue, 05 Feb 2019 10:22:46 GMT
RUN $newPath = ('{0}\Users\{1}' -f $env:HOMEDRIVE, $env:USERNAME); 	Write-Host ('Updating HOMEPATH: {0}' -f $newPath); 	[Environment]::SetEnvironmentVariable('HOMEPATH', $newPath, [EnvironmentVariableTarget]::Machine);
# Tue, 05 Feb 2019 10:22:48 GMT
CMD ["haxe"]
```
...
-	Layers:
	...
	-	`sha256:3c6bc876d97693ce17a9016fc87779a71ee81f1330c6da72718e173f5345790a`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:12dda8f48c329b46e10d6bb13206075c5527832e26eb4567b460fbb2bb01952f`  
		Last Modified: Tue, 05 Feb 2019 10:23:17 GMT  
		Size: 1.2 KB (1207 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:679eca147eb500ba0cd552b16730e8c43ef8dcac1846a9b51b6b94db5f3cb95f`  
		Last Modified: Tue, 05 Feb 2019 10:23:34 GMT  
		Size: 16.6 MB (16603261 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:89670010d46467307c553c80653c865ccf5ecac0f2054e5076b55d121de9df54`  
		Last Modified: Tue, 05 Feb 2019 10:23:16 GMT  
		Size: 5.2 MB (5163167 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:98af327d6e87409080ffe0592df5e13cba3088909c3a55cc5fcebb98bf53508b`  
		Last Modified: Tue, 05 Feb 2019 10:23:13 GMT  
		Size: 1.2 KB (1211 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:fae1d69a831b12503c472ae33c1cd6afc303818d5844094cc7a74cb7021c08a3`  
		Last Modified: Tue, 05 Feb 2019 10:23:16 GMT  
		Size: 5.2 MB (5162543 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3948c3fa461451b5d4443ebfae09663cfc72765fcb92b110b79207135d3c7273`  
		Last Modified: Tue, 05 Feb 2019 10:23:13 GMT  
