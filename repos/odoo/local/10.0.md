...
- Created: `2018-12-29T01:25:48.210040788Z`
- Virtual Size: ~ 875.02 Mb  
...
### `dpkg` source package: `odoo=10.0.20181126`
...
- `postgresql-client-9.4=9.4.19-0+deb8u1`
...
### `dpkg` source package: `postgresql-common=165+deb8u3`
...
```console
$ apt-get source -qq --print-uris postgresql-common=165+deb8u3
'http://deb.debian.org/debian/pool/main/p/postgresql-common/postgresql-common_165+deb8u3.dsc' postgresql-common_165+deb8u3.dsc 2304 SHA256:a7597c675757989bfff51640c1ef0f19be048beff3eb28ceb7a67cf38215891d
'http://deb.debian.org/debian/pool/main/p/postgresql-common/postgresql-common_165+deb8u3.tar.xz' postgresql-common_165+deb8u3.tar.xz 187796 SHA256:3fd14182eca078f547f8cebc08346572d0489304dd2dfbd31868cf7a787af1a2
```

Other potentially useful URLs:

- https://sources.debian.net/src/postgresql-common/165+deb8u3/ (for browsing the source)
- https://sources.debian.net/src/postgresql-common/165+deb8u3/debian/copyright/ (for direct copyright/license information)
- http://snapshot.debian.org/package/postgresql-common/165+deb8u3/ (for access to the source package after it no longer exists in the archive)
