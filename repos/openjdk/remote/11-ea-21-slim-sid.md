...
### `openjdk:11-ea-21-slim-sid` - linux; amd64
...
### `openjdk:11-ea-21-slim-sid` - linux; arm variant v7
...
### `openjdk:11-ea-21-slim-sid` - linux; arm64 variant v8
...
### `openjdk:11-ea-21-slim-sid` - linux; 386
...
### `openjdk:11-ea-21-slim-sid` - linux; ppc64le
