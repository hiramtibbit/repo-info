...
### `openjdk:8u162-slim` - linux; amd64
...
### `openjdk:8u162-slim` - linux; arm variant v5
...
### `openjdk:8u162-slim` - linux; arm variant v7
...
### `openjdk:8u162-slim` - linux; arm64 variant v8
...
### `openjdk:8u162-slim` - linux; ppc64le
...
### `openjdk:8u162-slim` - linux; s390x
