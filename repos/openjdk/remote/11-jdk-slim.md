...
```console
$ docker pull openjdk@sha256:23cf774ed84fb3764ceb3a31f5e1363ca2cbb06a9416555311eebdc08ae38111
```
...
```console
$ docker pull openjdk@sha256:38b552d1ee8b43efc802417382a404cdb180d3e65ce187010a8529933044fdff
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **248.8 MB (248829358 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:78a3ad6a907b3e3392f63cbb96dfe00fce37cc712e9d979415da570e6d9fdc7a`
-	Default Command: `["jshell"]`
...
```console
$ docker pull openjdk@sha256:92db173aa996eff6e35a4342c9bef26af07ddef672cb905a93b8cb132a12895b
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **271.4 MB (271425397 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:29a4c2177416a5ca43bd9cc63f30878fb58de9579b215c7874a9f8d8d1d0ca08`
-	Default Command: `["jshell"]`
