...
### `openjdk:11-ea-9-jdk-slim-sid` - linux; amd64
...
### `openjdk:11-ea-9-jdk-slim-sid` - linux; arm variant v5
...
### `openjdk:11-ea-9-jdk-slim-sid` - linux; ppc64le
...
### `openjdk:11-ea-9-jdk-slim-sid` - linux; s390x
