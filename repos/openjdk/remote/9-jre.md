...
```console
$ docker pull openjdk@sha256:a53973f1fd9b19fcda33291ec35c4bd79c71e0de33df04debbe39927373f874f
```
...
```console
$ docker pull openjdk@sha256:85d0cc6be1b6eaa6507c910fcd675a17912d04da8bd718e0e6bab42865229e4f
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **261.6 MB (261553623 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7636273b46d2f91e8590e59ddafe36feaddfbc282eeaa88116ccffc5b6d8fa56`
-	Default Command: `["bash"]`
