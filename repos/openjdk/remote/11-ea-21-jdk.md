...
### `openjdk:11-ea-21-jdk` - linux; amd64
...
### `openjdk:11-ea-21-jdk` - linux; arm variant v7
...
### `openjdk:11-ea-21-jdk` - linux; arm64 variant v8
...
### `openjdk:11-ea-21-jdk` - linux; 386
...
### `openjdk:11-ea-21-jdk` - linux; ppc64le
