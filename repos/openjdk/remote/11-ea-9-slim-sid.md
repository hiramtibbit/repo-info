...
### `openjdk:11-ea-9-slim-sid` - linux; amd64
...
### `openjdk:11-ea-9-slim-sid` - linux; arm variant v5
...
### `openjdk:11-ea-9-slim-sid` - linux; ppc64le
...
### `openjdk:11-ea-9-slim-sid` - linux; s390x
