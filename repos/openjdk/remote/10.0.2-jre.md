...
```console
$ docker pull openjdk@sha256:24dd387c6d1a3379952038dc5959c365e59d384019c97d199b36edca18acefd3
```
...
```console
$ docker pull openjdk@sha256:1b12208a92bd36ec8e2893c7f0a14c654235f327cd3f78d1d92bffc74b1344ef
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.0 MB (248965011 bytes)**  
