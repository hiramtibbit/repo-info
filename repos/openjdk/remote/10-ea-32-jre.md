...
### `openjdk:10-ea-32-jre` - linux; amd64
...
### `openjdk:10-ea-32-jre` - linux; arm variant v5
...
### `openjdk:10-ea-32-jre` - linux; arm variant v7
...
### `openjdk:10-ea-32-jre` - linux; arm64 variant v8
...
### `openjdk:10-ea-32-jre` - linux; 386
...
### `openjdk:10-ea-32-jre` - linux; ppc64le
...
### `openjdk:10-ea-32-jre` - linux; s390x
