...
### `openjdk:11.0.3-slim` - linux; arm variant v5
...
### `openjdk:11.0.3-slim` - linux; arm variant v7
...
### `openjdk:11.0.3-slim` - linux; ppc64le
...
### `openjdk:11.0.3-slim` - linux; s390x
