...
### `openjdk:10.0.2-jdk` - linux; arm variant v5
...
### `openjdk:10.0.2-jdk` - linux; arm variant v7
...
### `openjdk:10.0.2-jdk` - linux; arm64 variant v8
...
### `openjdk:10.0.2-jdk` - linux; ppc64le
...
### `openjdk:10.0.2-jdk` - linux; s390x
