...
### `openjdk:9.0.4-jre-slim` - linux; amd64
...
### `openjdk:9.0.4-jre-slim` - linux; arm64 variant v8
...
### `openjdk:9.0.4-jre-slim` - linux; 386
...
### `openjdk:9.0.4-jre-slim` - linux; ppc64le
...
### `openjdk:9.0.4-jre-slim` - linux; s390x
