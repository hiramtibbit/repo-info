...
### `openjdk:7u211-jre-alpine` - linux; amd64
...
### `openjdk:7u211-jre-alpine` - linux; arm variant v6
...
### `openjdk:7u211-jre-alpine` - linux; arm variant v7
...
### `openjdk:7u211-jre-alpine` - linux; arm64 variant v8
...
### `openjdk:7u211-jre-alpine` - linux; 386
...
### `openjdk:7u211-jre-alpine` - linux; ppc64le
...
### `openjdk:7u211-jre-alpine` - linux; s390x
