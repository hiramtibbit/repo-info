...
```console
$ docker pull openjdk@sha256:ab81dc82826b2f524d15989be60bedc3854fbc4797ac850fddb1de3b6acd96b7
```
...
```console
$ docker pull openjdk@sha256:71f7a8b5a8e99df5d5cda7dba02f44097af273de52eda7e488a20e1cfd4b19d4
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **186.6 MB (186634084 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:884efc6b0996af6f10c636e4fe106ac4a19be54297fbf70af91d4286657d4d45`
-	Default Command: `["jshell"]`
