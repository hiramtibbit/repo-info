...
### `openjdk:10.0.1-10-jdk` - linux; amd64
...
### `openjdk:10.0.1-10-jdk` - linux; arm variant v5
...
### `openjdk:10.0.1-10-jdk` - linux; arm variant v7
...
### `openjdk:10.0.1-10-jdk` - linux; arm64 variant v8
...
### `openjdk:10.0.1-10-jdk` - linux; 386
...
### `openjdk:10.0.1-10-jdk` - linux; ppc64le
...
### `openjdk:10.0.1-10-jdk` - linux; s390x
