## `openjdk:11-ea-11-jdk-slim`

```console
$ docker pull openjdk@sha256:f9855951f28ddca2586d796d4f85d57a7389d45c817f1a5aff13cc6a9b34197b
```
...
### `openjdk:11-ea-11-jdk-slim` - linux; amd64
...
### `openjdk:11-ea-11-jdk-slim` - linux; arm variant v5
...
### `openjdk:11-ea-11-jdk-slim` - linux; arm variant v7

```console
$ docker pull openjdk@sha256:c783ede2c6200aa5a840756e9545a7f38fc9163b82e114a154f0b57ee04f270c
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **219.3 MB (219264116 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c3b3d130611c5b6e6405e1c1e35c376c3e167c1d4e552cad4d23eda71b9ab3c1`
-	Default Command: `["jshell"]`
...
### `openjdk:11-ea-11-jdk-slim` - linux; arm64 variant v8

```console
$ docker pull openjdk@sha256:6cf5e9b43bd2176d58489b8f2cc6e9ce531513dfec45fe49ff1c0a98acfc77a7
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **225.4 MB (225408210 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8fadd955fecd4884ae270469e984f585a74a544afcbe7451da86b00744c1af8f`
-	Default Command: `["jshell"]`
...
ENV JAVA_HOME=/docker-java-home
# Sat, 05 May 2018 11:18:08 GMT
ENV JAVA_VERSION=11-ea+11
# Sat, 05 May 2018 11:18:09 GMT
ENV JAVA_DEBIAN_VERSION=11~11-2
# Sat, 05 May 2018 11:32:57 GMT
RUN set -ex; 		if [ ! -d /usr/share/man/man1 ]; then 		mkdir -p /usr/share/man/man1; 	fi; 		apt-get update; 	apt-get install -y 		openjdk-11-jdk="$JAVA_DEBIAN_VERSION" 	; 	rm -rf /var/lib/apt/lists/*; 		[ "$(readlink -f "$JAVA_HOME")" = "$(docker-java-home)" ]; 		update-alternatives --get-selections | awk -v home="$(readlink -f "$JAVA_HOME")" 'index($3, home) == 1 { $2 = "manual"; print | "update-alternatives --set-selections" }'; 	update-alternatives --query java | grep -q 'Status: manual'
# Sat, 05 May 2018 11:32:59 GMT
CMD ["jshell"]
```
...
-	Layers:
	...
	-	`sha256:18bceddcea152b65343ee7a3e4405bd12c3ee093a5afdc3b0ffb6facce8ddc6b`  
		...
		Size: 130.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:015c5e4564f0068fc226ea9e5d74aa1100610f77da6d99f8987cdc29fd74fa91`  
		Last Modified: Sat, 05 May 2018 12:46:54 GMT  
		Size: 201.6 MB (201598001 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `openjdk:11-ea-11-jdk-slim` - linux; 386

```console
$ docker pull openjdk@sha256:ef4d727c474bc178660400d3cd1228e87dbe4288f165153511551d0fc4018c69
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **260.2 MB (260230160 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:72bef0c7ed8d79a7d81f8a7c5763f271f5682ff9cdcb05fc743a21a8c649d1ca`
-	Default Command: `["jshell"]`
...
### `openjdk:11-ea-11-jdk-slim` - linux; ppc64le

```console
$ docker pull openjdk@sha256:b67bae4e1af7f41dc36a4f331439b04af2b66886260b250ed479d4661014e19d
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **237.1 MB (237057618 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9776e40a23b8aa1e6be700a3378f5fd800b5c0efb4b46ef45cf58ae9b888ef4e`
-	Default Command: `["jshell"]`
