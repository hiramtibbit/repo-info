...
### `openjdk:11.0.3-jdk-slim` - linux; arm variant v5
...
### `openjdk:11.0.3-jdk-slim` - linux; arm variant v7
...
### `openjdk:11.0.3-jdk-slim` - linux; 386
...
### `openjdk:11.0.3-jdk-slim` - linux; ppc64le
...
### `openjdk:11.0.3-jdk-slim` - linux; s390x
