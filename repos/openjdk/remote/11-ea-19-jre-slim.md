...
### `openjdk:11-ea-19-jre-slim` - linux; arm variant v7
...
### `openjdk:11-ea-19-jre-slim` - linux; arm64 variant v8
...
### `openjdk:11-ea-19-jre-slim` - linux; 386
...
### `openjdk:11-ea-19-jre-slim` - linux; s390x
