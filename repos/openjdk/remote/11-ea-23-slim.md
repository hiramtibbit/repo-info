...
### `openjdk:11-ea-23-slim` - linux; arm variant v5
...
### `openjdk:11-ea-23-slim` - linux; arm variant v7
...
### `openjdk:11-ea-23-slim` - linux; arm64 variant v8
...
### `openjdk:11-ea-23-slim` - linux; 386
...
### `openjdk:11-ea-23-slim` - linux; s390x
