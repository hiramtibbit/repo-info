...
```console
$ docker pull openjdk@sha256:9d1f97b560a4da225015f2c73df41fb13449387504ba22b1651c048266cc81b3
```
...
### `openjdk:11.0.3-jdk` - linux; amd64
...
### `openjdk:11.0.3-jdk` - linux; arm variant v5
...
### `openjdk:11.0.3-jdk` - linux; arm variant v7
...
### `openjdk:11.0.3-jdk` - linux; arm64 variant v8

```console
$ docker pull openjdk@sha256:b45a4215d8a691fb8caaa485714d5a68380523c1346949ffe2a20e8b3a2abb4f
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **402.4 MB (402385071 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:bd156bae4d1a03b48cd738076a654c4478754c6117ae31c662e4003167e565b5`
-	Default Command: `["jshell"]`
...
RUN apt-get update && apt-get install -y --no-install-recommends 		bzip2 		unzip 		xz-utils 	&& rm -rf /var/lib/apt/lists/*
# Fri, 17 May 2019 22:43:39 GMT
RUN echo 'deb http://deb.debian.org/debian stretch-backports main' > /etc/apt/sources.list.d/stretch-backports.list
# Fri, 17 May 2019 22:43:40 GMT
ENV LANG=C.UTF-8
# Fri, 17 May 2019 22:43:41 GMT
RUN { 		echo '#!/bin/sh'; 		echo 'set -e'; 		echo; 		echo 'dirname "$(dirname "$(readlink -f "$(which javac || which java)")")"'; 	} > /usr/local/bin/docker-java-home 	&& chmod +x /usr/local/bin/docker-java-home
# Fri, 17 May 2019 22:43:43 GMT
RUN ln -svT "/usr/lib/jvm/java-11-openjdk-$(dpkg --print-architecture)" /docker-java-home
# Fri, 17 May 2019 22:43:44 GMT
ENV JAVA_HOME=/docker-java-home
# Fri, 17 May 2019 22:43:44 GMT
ENV JAVA_VERSION=11.0.3
# Fri, 17 May 2019 22:43:44 GMT
ENV JAVA_DEBIAN_VERSION=11.0.3+1-1~bpo9+1
# Fri, 17 May 2019 22:45:10 GMT
RUN set -ex; 		if [ ! -d /usr/share/man/man1 ]; then 		mkdir -p /usr/share/man/man1; 	fi; 		ln -svT /docker-java-home/bin/java /usr/local/bin/java; 		apt-get update; 	apt-get install -y --no-install-recommends 		openjdk-11-jdk="$JAVA_DEBIAN_VERSION" 	; 	rm -rf /var/lib/apt/lists/*; 		rm -v /usr/local/bin/java; 		keytool -importkeystore -srckeystore /etc/ssl/certs/java/cacerts -destkeystore /etc/ssl/certs/java/cacerts.jks -deststoretype JKS -srcstorepass changeit -deststorepass changeit -noprompt; 	mv /etc/ssl/certs/java/cacerts.jks /etc/ssl/certs/java/cacerts; 	/var/lib/dpkg/info/ca-certificates-java.postinst configure; 		[ "$(readlink -f "$JAVA_HOME")" = "$(docker-java-home)" ]; 		update-alternatives --get-selections | awk -v home="$(readlink -f "$JAVA_HOME")" 'index($3, home) == 1 { $2 = "manual"; print | "update-alternatives --set-selections" }'; 	update-alternatives --query java | grep -q 'Status: manual'
# Fri, 17 May 2019 22:45:13 GMT
CMD ["jshell"]
```
...
-	Layers:
	...
	-	`sha256:84d24874c96b4e342338c5e1725995d211d1b087d4a4a4dd5f95b49a782baf8d`  
		...
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e27dcf52f984c1713f87a6462641b5c6a80cf87b301508b852e475b9a983a83d`  
		Last Modified: Fri, 17 May 2019 22:54:02 GMT  
		Size: 226.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:4231ac5e3fc4445e4ce06a70b046c018ed924239aa6eee728af1f773d31c3771`  
		Last Modified: Fri, 17 May 2019 22:54:02 GMT  
		Size: 248.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4087e343d530b318259f54291ef1c7306f16451c16cbe80465a3817fe85ab06`  
		Last Modified: Fri, 17 May 2019 22:54:03 GMT  
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eaa796652420c6716d0a9170bf54721ea70c75f91444bb87d2890e85d4f896ec`  
		Last Modified: Fri, 17 May 2019 22:54:56 GMT  
		Size: 296.5 MB (296529440 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `openjdk:11.0.3-jdk` - linux; 386
...
### `openjdk:11.0.3-jdk` - linux; ppc64le
...
### `openjdk:11.0.3-jdk` - linux; s390x
