...
```console
$ docker pull openjdk@sha256:7b07b0301de565124968762dd9e1bd603f27161c63171f56eed439c16ffae9e2
```
...
```console
$ docker pull openjdk@sha256:d7966c099db7317e8ba391a2e70400ada97418ff1311e631a68cf30eb4055672
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **203.4 MB (203375381 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7f283df99817556b9cddbbd6a0171e04923e88254f7fe64a95dd397504400cb8`
-	Default Command: `["bash"]`
