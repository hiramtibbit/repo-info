...
```console
$ docker pull openjdk@sha256:db664aeefa56cb74b1c967089a064c9a1f9d3db33def7eb08c26c2afe8f137f0
```
...
### `openjdk:8u212-jdk-stretch` - linux; amd64

```console
$ docker pull openjdk@sha256:9fb500a122291ab29201a996612a8cdcffdab0f0c7455fac936609e760945b73
```
...
-	Image ID: `sha256:bec43387959ad10b6495704cd8aa4141f503e9648fc453704eb00c70bfc77d02`
...
### `openjdk:8u212-jdk-stretch` - linux; arm variant v5

```console
$ docker pull openjdk@sha256:a531a9ef0394e3d55e03c01084f7f347d3013f75523094b524294679ea7f136f
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **228.7 MB (228659817 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:687e0d9d1f2f7be1b6db520828ae139444d4c48fa947d0be02d2b30a8787e28d`
-	Default Command: `["bash"]`
...
### `openjdk:8u212-jdk-stretch` - linux; arm variant v7

```console
$ docker pull openjdk@sha256:29530ac212bd16f3a89ad413ae8d6c527103b92fbd5575d493aa7184c8b293e6
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **223.6 MB (223636505 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:403fda3916a3438cc96be6319809b4fea410b68778d9342f21b5a5819ba92c80`
-	Default Command: `["bash"]`
...
### `openjdk:8u212-jdk-stretch` - linux; arm64 variant v8

```console
$ docker pull openjdk@sha256:1fbd49e3fc5e53154fa93cad15f211112d899a6b0c5dc1e8661d6eb6c18b30a6
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **231.5 MB (231520714 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1f39b7184ace0f20267d8d7110038eb6206f99fcf81efcc531d5f4b591bf4be3`
-	Default Command: `["bash"]`
...
### `openjdk:8u212-jdk-stretch` - linux; 386

```console
$ docker pull openjdk@sha256:52bfd3c732accd2655310758f9c198f3404dab3d5a326150450c7f45dd7da16a
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **249.0 MB (249009979 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c574e963a5a640146cb373caad87544e432b25674cf9415b31f59ba133c8784a`
-	Default Command: `["bash"]`
...
### `openjdk:8u212-jdk-stretch` - linux; ppc64le

```console
$ docker pull openjdk@sha256:697ed13e046a7805c3861bcc3564df22ac783f6c2c0c6922aced9e786f858fb0
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **236.0 MB (235985769 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e3905d30c3110d290ba2609190dd2f3fe7f20f8bcda6818e4431febe85be9fce`
-	Default Command: `["bash"]`
...
### `openjdk:8u212-jdk-stretch` - linux; s390x

```console
$ docker pull openjdk@sha256:66d2c06cae73755e1c69490be370a145990ae1daaec41152d5d5cf8791112d26
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **235.4 MB (235390393 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:325cda701da97ddad678116fcf5a68e627eac0bb87a25b9261173097482009d1`
-	Default Command: `["bash"]`
