...
### `openjdk:10-ea-46-jdk-experimental` - linux; amd64
...
### `openjdk:10-ea-46-jdk-experimental` - linux; arm variant v5
...
### `openjdk:10-ea-46-jdk-experimental` - linux; arm64 variant v8
...
### `openjdk:10-ea-46-jdk-experimental` - linux; 386
...
### `openjdk:10-ea-46-jdk-experimental` - linux; ppc64le
...
### `openjdk:10-ea-46-jdk-experimental` - linux; s390x
