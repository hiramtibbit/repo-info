...
### `openjdk:11-ea-16-jre-slim` - linux; arm variant v5
...
### `openjdk:11-ea-16-jre-slim` - linux; arm variant v7
...
### `openjdk:11-ea-16-jre-slim` - linux; arm64 variant v8
...
### `openjdk:11-ea-16-jre-slim` - linux; ppc64le
...
### `openjdk:11-ea-16-jre-slim` - linux; s390x
