...
### `openjdk:11-ea-9-jdk-sid` - linux; amd64
...
### `openjdk:11-ea-9-jdk-sid` - linux; arm variant v5
...
### `openjdk:11-ea-9-jdk-sid` - linux; ppc64le
...
### `openjdk:11-ea-9-jdk-sid` - linux; s390x
