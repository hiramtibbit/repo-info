...
### `openjdk:10-ea-jdk-sid` - linux; amd64
...
### `openjdk:10-ea-jdk-sid` - linux; arm variant v5
...
### `openjdk:10-ea-jdk-sid` - linux; arm variant v7
...
### `openjdk:10-ea-jdk-sid` - linux; ppc64le
