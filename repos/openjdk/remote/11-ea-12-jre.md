...
```console
$ docker pull openjdk@sha256:5f6535a7662c4980cbf4b490fc53d34b6dc06833fc86c01e65c48489d2700d73
```
...
### `openjdk:11-ea-12-jre` - linux; amd64
...
### `openjdk:11-ea-12-jre` - linux; arm variant v5
...
### `openjdk:11-ea-12-jre` - linux; arm variant v7
...
### `openjdk:11-ea-12-jre` - linux; arm64 variant v8
...
### `openjdk:11-ea-12-jre` - linux; 386
...
### `openjdk:11-ea-12-jre` - linux; s390x
