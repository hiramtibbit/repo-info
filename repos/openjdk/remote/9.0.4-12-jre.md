...
### `openjdk:9.0.4-12-jre` - linux; amd64
...
### `openjdk:9.0.4-12-jre` - linux; arm64 variant v8
...
### `openjdk:9.0.4-12-jre` - linux; 386
...
### `openjdk:9.0.4-12-jre` - linux; ppc64le
...
### `openjdk:9.0.4-12-jre` - linux; s390x
