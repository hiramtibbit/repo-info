...
### `openjdk:11-ea-24-sid` - linux; amd64
...
### `openjdk:11-ea-24-sid` - linux; arm variant v5
...
### `openjdk:11-ea-24-sid` - linux; arm variant v7
...
### `openjdk:11-ea-24-sid` - linux; arm64 variant v8
...
### `openjdk:11-ea-24-sid` - linux; 386
...
### `openjdk:11-ea-24-sid` - linux; ppc64le
...
### `openjdk:11-ea-24-sid` - linux; s390x
