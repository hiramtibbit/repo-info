...
### `openjdk:8u151-jdk-slim-stretch` - linux; amd64
...
### `openjdk:8u151-jdk-slim-stretch` - linux; arm variant v5
...
### `openjdk:8u151-jdk-slim-stretch` - linux; arm64 variant v8
...
### `openjdk:8u151-jdk-slim-stretch` - linux; 386
...
### `openjdk:8u151-jdk-slim-stretch` - linux; ppc64le
...
### `openjdk:8u151-jdk-slim-stretch` - linux; s390x
