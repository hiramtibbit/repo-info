...
### `openjdk:10-ea-46-slim-experimental` - linux; amd64
...
### `openjdk:10-ea-46-slim-experimental` - linux; arm64 variant v8
...
### `openjdk:10-ea-46-slim-experimental` - linux; 386
...
### `openjdk:10-ea-46-slim-experimental` - linux; ppc64le
...
### `openjdk:10-ea-46-slim-experimental` - linux; s390x
