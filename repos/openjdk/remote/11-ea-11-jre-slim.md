...
### `openjdk:11-ea-11-jre-slim` - linux; amd64
...
### `openjdk:11-ea-11-jre-slim` - linux; arm variant v5
...
### `openjdk:11-ea-11-jre-slim` - linux; arm variant v7
...
### `openjdk:11-ea-11-jre-slim` - linux; arm64 variant v8
...
### `openjdk:11-ea-11-jre-slim` - linux; 386
...
### `openjdk:11-ea-11-jre-slim` - linux; ppc64le
