...
### `openjdk:11-ea-9-jdk-slim` - linux; amd64
...
### `openjdk:11-ea-9-jdk-slim` - linux; arm variant v5
...
### `openjdk:11-ea-9-jdk-slim` - linux; ppc64le
...
### `openjdk:11-ea-9-jdk-slim` - linux; s390x
