...
### `openjdk:11.0.2-jdk` - linux; arm variant v5
...
### `openjdk:11.0.2-jdk` - linux; arm64 variant v8
...
### `openjdk:11.0.2-jdk` - linux; ppc64le
...
### `openjdk:11.0.2-jdk` - linux; s390x
