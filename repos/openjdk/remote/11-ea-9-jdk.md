...
```console
$ docker pull openjdk@sha256:aec9bd823c8deef94600cffcc119cc29170f08d683d0affa8e53a50233dbb9a1
```
...
### `openjdk:11-ea-9-jdk` - linux; amd64
...
### `openjdk:11-ea-9-jdk` - linux; arm variant v5
...
### `openjdk:11-ea-9-jdk` - linux; ppc64le
