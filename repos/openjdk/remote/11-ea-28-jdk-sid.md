## `openjdk:11-ea-28-jdk-sid`

```console
$ docker pull openjdk@sha256:05d74d7500b98ef70493ee56125108b86afd005bdbea86d60f1c6e73b07829a4
```
...
### `openjdk:11-ea-28-jdk-sid` - linux; amd64
...
### `openjdk:11-ea-28-jdk-sid` - linux; arm variant v5
...
### `openjdk:11-ea-28-jdk-sid` - linux; arm variant v7
...
### `openjdk:11-ea-28-jdk-sid` - linux; arm64 variant v8

```console
$ docker pull openjdk@sha256:3b7f5a35ae3470d11d3793d1c14b989471cf3fdd74ad989bc88e70b885983f2f
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **493.3 MB (493292339 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:981ccc8cc11f528e7c52fd57816fe01d671277eda1a697fae8fa8bf14c356716`
-	Default Command: `["jshell"]`
...
ENV JAVA_HOME=/docker-java-home
# Sat, 15 Sep 2018 10:12:19 GMT
ENV JAVA_VERSION=11-ea+28
# Sat, 15 Sep 2018 10:12:21 GMT
ENV JAVA_DEBIAN_VERSION=11~28-1
# Sat, 15 Sep 2018 10:18:10 GMT
RUN set -ex; 		if [ ! -d /usr/share/man/man1 ]; then 		mkdir -p /usr/share/man/man1; 	fi; 		apt-get update; 	apt-get install -y --no-install-recommends 		openjdk-11-jdk="$JAVA_DEBIAN_VERSION" 	; 	rm -rf /var/lib/apt/lists/*; 		[ "$(readlink -f "$JAVA_HOME")" = "$(docker-java-home)" ]; 		update-alternatives --get-selections | awk -v home="$(readlink -f "$JAVA_HOME")" 'index($3, home) == 1 { $2 = "manual"; print | "update-alternatives --set-selections" }'; 	update-alternatives --query java | grep -q 'Status: manual'
# Sat, 15 Sep 2018 10:18:13 GMT
CMD ["jshell"]
```
...
-	Layers:
	...
	-	`sha256:67978f5b4f74c3c19deae6d8ebe0553b0f1ad666e946a6f7363444ed9c738f09`  
		...
		Size: 131.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:3f987279c84de5e70f150f89e3db9e6c7df253633ca8a975433b5d8e4969ba33`  
		Last Modified: Sat, 15 Sep 2018 10:37:29 GMT  
		Size: 377.5 MB (377501525 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `openjdk:11-ea-28-jdk-sid` - linux; 386
...
### `openjdk:11-ea-28-jdk-sid` - linux; ppc64le
...
### `openjdk:11-ea-28-jdk-sid` - linux; s390x
