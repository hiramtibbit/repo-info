...
### `openjdk:11-ea-11-sid` - linux; arm variant v5
...
### `openjdk:11-ea-11-sid` - linux; arm variant v7
...
### `openjdk:11-ea-11-sid` - linux; arm64 variant v8
...
### `openjdk:11-ea-11-sid` - linux; 386
...
### `openjdk:11-ea-11-sid` - linux; ppc64le
