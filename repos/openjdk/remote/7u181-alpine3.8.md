...
```console
$ docker pull openjdk@sha256:dc14f22543c83c7425579ba12c5af8a302102f4dd400c2371fbb3f4ccd636ff5
```
...
```console
$ docker pull openjdk@sha256:46bee1f5f7e57d0adae4f1aae5de4244912188c83da0ec184f0d025e469b0ba5
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **80.5 MB (80471579 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:b712aa06d3040446822377afbd77008f6d565795e7fa7924e722bb5d54baa5ab`
...
### `openjdk:7u181-alpine3.8` - linux; arm64 variant v8
...
### `openjdk:7u181-alpine3.8` - linux; 386

```console
$ docker pull openjdk@sha256:645d36fad1e48e82f5946c36bd3d6a9b504605dde25bd3a16433c9ffa592073a
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **83.6 MB (83572645 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4185ba0d11f2ae2897bf1f8a94089219861822eda6cfcdf2995b0ea6db712dcb`
-	Default Command: `["\/bin\/sh"]`
...
### `openjdk:7u181-alpine3.8` - linux; ppc64le

```console
$ docker pull openjdk@sha256:d4fcbf6cdbb6ed65640914b8fdb260477248215b9005f7edf6d67a453d142d55
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **72.4 MB (72433651 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:58fb0c481f0b0bf64a5564e9edf6af50a7ec458bd2348439133e8a23f60d9d91`
-	Default Command: `["\/bin\/sh"]`
...
### `openjdk:7u181-alpine3.8` - linux; s390x

```console
$ docker pull openjdk@sha256:606ee20259871381f9d32caf194054329d445e912de88fdea3c16695f6a4d948
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **72.8 MB (72775763 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:8bf8c97272144f792778577bc62903c9ed9f2199a97c586a5eab36e62c587117`
-	Default Command: `["\/bin\/sh"]`
