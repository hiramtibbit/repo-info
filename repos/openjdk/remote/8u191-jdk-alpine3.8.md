...
### `openjdk:8u191-jdk-alpine3.8` - linux; amd64
...
### `openjdk:8u191-jdk-alpine3.8` - linux; arm variant v6
...
### `openjdk:8u191-jdk-alpine3.8` - linux; arm64 variant v8
...
### `openjdk:8u191-jdk-alpine3.8` - linux; 386
...
### `openjdk:8u191-jdk-alpine3.8` - linux; ppc64le
...
### `openjdk:8u191-jdk-alpine3.8` - linux; s390x
