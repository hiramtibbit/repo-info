...
### `openjdk:11-ea-9-jre-slim` - linux; amd64
...
### `openjdk:11-ea-9-jre-slim` - linux; arm variant v5
...
### `openjdk:11-ea-9-jre-slim` - linux; ppc64le
...
### `openjdk:11-ea-9-jre-slim` - linux; s390x
