...
### `openjdk:10-ea-jre-slim-sid` - linux; amd64
...
### `openjdk:10-ea-jre-slim-sid` - linux; arm variant v5
...
### `openjdk:10-ea-jre-slim-sid` - linux; arm variant v7
...
### `openjdk:10-ea-jre-slim-sid` - linux; ppc64le
