...
```console
$ docker pull openjdk@sha256:bb39f365e647d751e4722d7fd478ab50e2c2c093b0c94da9c2e05290cf122838
```
...
### `openjdk:jdk-alpine3.8` - linux; amd64
...
### `openjdk:jdk-alpine3.8` - linux; arm variant v6
...
### `openjdk:jdk-alpine3.8` - linux; arm64 variant v8
...
### `openjdk:jdk-alpine3.8` - linux; 386
...
### `openjdk:jdk-alpine3.8` - linux; ppc64le
