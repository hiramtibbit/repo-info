...
```console
$ docker pull openjdk@sha256:74968ff7a4a7823febccfac0165e65e5d3b20cc1e0190768d1f6b126209b0e04
```
...
```console
$ docker pull openjdk@sha256:56dcb7fbebc7fa1e43cf99e76cdbe60d33bdc74cf626053cc309af591e8cf1a1
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **93.7 MB (93714670 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1c6b3c9768cae1b6eecf9b44cdfa8da52c7c96d59f0376ed276557d4abb53b73`
-	Default Command: `["bash"]`
