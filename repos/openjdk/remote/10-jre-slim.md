...
```console
$ docker pull openjdk@sha256:04bbce339cd7c5e909cd042bb70e5960738f6c1b0e7e3ed8e44e595de8d27757
```
...
```console
$ docker pull openjdk@sha256:63cf3aa63598278657976320a96a51aa7e2bb35f6fda0ae6763fede4911875c8
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **108.0 MB (108039484 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3cf696cb3e79558d130993693652ff9bd191817a88125c1c06892ff93ec02af6`
-	Default Command: `["bash"]`
