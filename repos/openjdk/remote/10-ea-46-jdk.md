...
### `openjdk:10-ea-46-jdk` - linux; amd64
...
### `openjdk:10-ea-46-jdk` - linux; arm variant v5
...
### `openjdk:10-ea-46-jdk` - linux; arm64 variant v8
...
### `openjdk:10-ea-46-jdk` - linux; 386
...
### `openjdk:10-ea-46-jdk` - linux; ppc64le
...
### `openjdk:10-ea-46-jdk` - linux; s390x
