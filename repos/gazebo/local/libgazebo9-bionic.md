...
- `cpp-7=7.4.0-1ubuntu1~18.04`
- `g++-7=7.4.0-1ubuntu1~18.04`
- `gcc-7=7.4.0-1ubuntu1~18.04`
- `gcc-7-base:amd64=7.4.0-1ubuntu1~18.04`
- `libasan4:amd64=7.4.0-1ubuntu1~18.04`
- `libcilkrts5:amd64=7.4.0-1ubuntu1~18.04`
- `libgcc-7-dev:amd64=7.4.0-1ubuntu1~18.04`
- `libgfortran4:amd64=7.4.0-1ubuntu1~18.04`
- `libstdc++-7-dev:amd64=7.4.0-1ubuntu1~18.04`
- `libubsan0:amd64=7.4.0-1ubuntu1~18.04`
...
'http://archive.ubuntu.com/ubuntu/pool/main/g/gcc-7/gcc-7_7.4.0-1ubuntu1~18.04.dsc' gcc-7_7.4.0-1ubuntu1~18.04.dsc 28375 SHA256:f8782639aa4fb91b6b93ef285e3fa2dc2c9e13d1719948bb06c5d186efd81a29
...
'http://archive.ubuntu.com/ubuntu/pool/main/g/gcc-7/gcc-7_7.4.0-1ubuntu1~18.04.diff.gz' gcc-7_7.4.0-1ubuntu1~18.04.diff.gz 569258 SHA256:d87ae43d939cf83805e8f1fb14e21cf4ad82e6219dcd32a516a3d65dda6be0de
```
...
- `libatomic1:amd64=8.3.0-6ubuntu1~18.04`
- `libcc1-0:amd64=8.3.0-6ubuntu1~18.04`
- `libgcc1:amd64=1:8.3.0-6ubuntu1~18.04`
- `libgomp1:amd64=8.3.0-6ubuntu1~18.04`
- `libitm1:amd64=8.3.0-6ubuntu1~18.04`
- `liblsan0:amd64=8.3.0-6ubuntu1~18.04`
- `libmpx2:amd64=8.3.0-6ubuntu1~18.04`
- `libquadmath0:amd64=8.3.0-6ubuntu1~18.04`
- `libstdc++6:amd64=8.3.0-6ubuntu1~18.04`
- `libtsan0:amd64=8.3.0-6ubuntu1~18.04`
...
### `dpkg` source package: `gcc-defaults=1.176ubuntu2.2`

Binary Packages:

- `cpp=4:7.4.0-1ubuntu2.2`
...
```console
$ apt-get source -qq --print-uris gcc-defaults=1.176ubuntu2.2
'http://archive.ubuntu.com/ubuntu/pool/main/g/gcc-defaults/gcc-defaults_1.176ubuntu2.2.dsc' gcc-defaults_1.176ubuntu2.2.dsc 15833 SHA256:22d1b372b4417d91527beabb31afd6eb3e6f8f2a23007937310d3972b9b14e15
'http://archive.ubuntu.com/ubuntu/pool/main/g/gcc-defaults/gcc-defaults_1.176ubuntu2.2.tar.gz' gcc-defaults_1.176ubuntu2.2.tar.gz 208517 SHA256:dcc77e6da879203496c5ff9afa7315ae40033c68e08dc84c5d400e3b26e5cc75
```
...
### `dpkg` source package: `glib2.0=2.56.4-0ubuntu0.18.04.2`

Binary Packages:

- `libglib2.0-0:amd64=2.56.4-0ubuntu0.18.04.2`
- `libglib2.0-bin=2.56.4-0ubuntu0.18.04.2`
- `libglib2.0-data=2.56.4-0ubuntu0.18.04.2`
- `libglib2.0-dev:amd64=2.56.4-0ubuntu0.18.04.2`
...
```console
$ apt-get source -qq --print-uris glib2.0=2.56.4-0ubuntu0.18.04.2
'http://archive.ubuntu.com/ubuntu/pool/main/g/glib2.0/glib2.0_2.56.4-0ubuntu0.18.04.2.dsc' glib2.0_2.56.4-0ubuntu0.18.04.2.dsc 3583 SHA256:5e500ed9a33e8fa14f884bd041b879b1b248b3992181d9f266bb75b6de38d264
...
'http://archive.ubuntu.com/ubuntu/pool/main/g/glib2.0/glib2.0_2.56.4-0ubuntu0.18.04.2.debian.tar.xz' glib2.0_2.56.4-0ubuntu0.18.04.2.debian.tar.xz 80216 SHA256:fea03bc8b1631b708aaba7151831b8d2ba749b832440d0ba3fffe07e6e1f8d12
```
...
### `dpkg` source package: `gtk+3.0=3.22.30-1ubuntu3`

Binary Packages:

- `gtk-update-icon-cache=3.22.30-1ubuntu3`
- `libgtk-3-0:amd64=3.22.30-1ubuntu3`
- `libgtk-3-bin=3.22.30-1ubuntu3`
...
### `dpkg` source package: `libarchive=3.2.2-3.1ubuntu0.3`
...
### `dpkg` source package: `libdrm=2.4.95-1~18.04.1`

Binary Packages:

- `libdrm-amdgpu1:amd64=2.4.95-1~18.04.1`
- `libdrm-common=2.4.95-1~18.04.1`
- `libdrm-dev:amd64=2.4.95-1~18.04.1`
...
### `dpkg` source package: `libssh=0.8.0~20170825.94fa1e38-1ubuntu0.2`
...
### `dpkg` source package: `linux=4.15.0-50.54`

Binary Packages:

- `linux-libc-dev:amd64=4.15.0-50.54`
...
```console
$ apt-get source -qq --print-uris llvm-toolchain-7=1:7-3~ubuntu0.18.04.1
'http://archive.ubuntu.com/ubuntu/pool/main/l/llvm-toolchain-7/llvm-toolchain-7_7-3~ubuntu0.18.04.1.dsc' llvm-toolchain-7_7-3~ubuntu0.18.04.1.dsc 8161 SHA256:37aa6300376eeae759f53bef7060aba5af65df573bba7baeea1413bf68ede412
'http://archive.ubuntu.com/ubuntu/pool/main/l/llvm-toolchain-7/llvm-toolchain-7_7.orig-clang-tools-extra.tar.bz2' llvm-toolchain-7_7.orig-clang-tools-extra.tar.bz2 966611 SHA256:6cd002c87c5a909ed033ddc49857b342a321a803c0e34347061373bc2b942838
'http://archive.ubuntu.com/ubuntu/pool/main/l/llvm-toolchain-7/llvm-toolchain-7_7.orig-clang.tar.bz2' llvm-toolchain-7_7.orig-clang.tar.bz2 13921041 SHA256:ea024ff72fb2bfa8ab99d0e72412a3d2e6958d3854958d4220da787f26778bda
'http://archive.ubuntu.com/ubuntu/pool/main/l/llvm-toolchain-7/llvm-toolchain-7_7.orig-compiler-rt.tar.bz2' llvm-toolchain-7_7.orig-compiler-rt.tar.bz2 2344759 SHA256:dafdee1dfe5572b5fd258616515fc4e56c580fec4c8cb38a670ef9e15a00c05d
'http://archive.ubuntu.com/ubuntu/pool/main/l/llvm-toolchain-7/llvm-toolchain-7_7.orig-libcxx.tar.bz2' llvm-toolchain-7_7.orig-libcxx.tar.bz2 1788153 SHA256:7621f795ffe9c37162f28654ab87fda0a9d9af15fb7b4bc487717033098103e0
'http://archive.ubuntu.com/ubuntu/pool/main/l/llvm-toolchain-7/llvm-toolchain-7_7.orig-libcxxabi.tar.bz2' llvm-toolchain-7_7.orig-libcxxabi.tar.bz2 542373 SHA256:97eb42a6da7eadcb6f670f49e5b72472ed942db5046ed61da6a1fd4837146af8
'http://archive.ubuntu.com/ubuntu/pool/main/l/llvm-toolchain-7/llvm-toolchain-7_7.orig-lld.tar.bz2' llvm-toolchain-7_7.orig-lld.tar.bz2 998436 SHA256:60683271fb4cdc8264bcdc2cc4b7f6ff5e9d2dedc5b64089fb6c114e8ff03796
'http://archive.ubuntu.com/ubuntu/pool/main/l/llvm-toolchain-7/llvm-toolchain-7_7.orig-lldb.tar.bz2' llvm-toolchain-7_7.orig-lldb.tar.bz2 11323370 SHA256:3652c2abfcc2eec02324aeff21be6ae77ac3633ce5533488a8de301311292274
'http://archive.ubuntu.com/ubuntu/pool/main/l/llvm-toolchain-7/llvm-toolchain-7_7.orig-openmp.tar.bz2' llvm-toolchain-7_7.orig-openmp.tar.bz2 993595 SHA256:5a87f9a4a1c533502ca20b751b6f4ec9136a18a91e6c2eb6286c08e2d9b1624b
'http://archive.ubuntu.com/ubuntu/pool/main/l/llvm-toolchain-7/llvm-toolchain-7_7.orig-polly.tar.bz2' llvm-toolchain-7_7.orig-polly.tar.bz2 3350854 SHA256:974ba7321a1b59f8e6212e6a24ba948ea2257c49e62b914fef9521a0318ecd7f
'http://archive.ubuntu.com/ubuntu/pool/main/l/llvm-toolchain-7/llvm-toolchain-7_7.orig.tar.bz2' llvm-toolchain-7_7.orig.tar.bz2 33384750 SHA256:53f2256471a3360170affe5db5a551396f00ec085a126a03ee8b094a55277edb
'http://archive.ubuntu.com/ubuntu/pool/main/l/llvm-toolchain-7/llvm-toolchain-7_7-3~ubuntu0.18.04.1.debian.tar.xz' llvm-toolchain-7_7-3~ubuntu0.18.04.1.debian.tar.xz 75656 SHA256:1d0f8af5745493156cf3de59d308b53a88331c7bf893745c037dd10725838b84
```
...
```console
$ apt-get source -qq --print-uris mysql-5.7=5.7.26-0ubuntu0.18.04.1
'http://archive.ubuntu.com/ubuntu/pool/main/m/mysql-5.7/mysql-5.7_5.7.26-0ubuntu0.18.04.1.dsc' mysql-5.7_5.7.26-0ubuntu0.18.04.1.dsc 3403 SHA256:d5fc3a3be1b72901589cabd23ab7fc0ab86e2f510c4c46768aaa2aa6d531dc44
...
'http://archive.ubuntu.com/ubuntu/pool/main/m/mysql-5.7/mysql-5.7_5.7.26-0ubuntu0.18.04.1.debian.tar.xz' mysql-5.7_5.7.26-0ubuntu0.18.04.1.debian.tar.xz 156180 SHA256:762e27e4f3f8f2e70ae24da236f867e7ed8bca029510d2929b2509a7594ab3b5
```
...
### `dpkg` source package: `poppler=0.62.0-2ubuntu2.8`

Binary Packages:

- `libpoppler-dev:amd64=0.62.0-2ubuntu2.8`
- `libpoppler-private-dev:amd64=0.62.0-2ubuntu2.8`
- `libpoppler73:amd64=0.62.0-2ubuntu2.8`
...
- `libpq5:amd64=10.8-0ubuntu0.18.04.1`
...
```console
$ apt-get source -qq --print-uris postgresql-10=10.8-0ubuntu0.18.04.1
'http://archive.ubuntu.com/ubuntu/pool/main/p/postgresql-10/postgresql-10_10.8-0ubuntu0.18.04.1.dsc' postgresql-10_10.8-0ubuntu0.18.04.1.dsc 3610 SHA256:a57bfa85468e5c64c826e8753ad32458a53da103250565aee45e3d55a54483ad
'http://archive.ubuntu.com/ubuntu/pool/main/p/postgresql-10/postgresql-10_10.8.orig.tar.gz' postgresql-10_10.8.orig.tar.gz 24792415 SHA256:369b113dad694389ba4c279a995341c1b1dfcefbe45236ab5abb993b8a98b342
'http://archive.ubuntu.com/ubuntu/pool/main/p/postgresql-10/postgresql-10_10.8-0ubuntu0.18.04.1.debian.tar.xz' postgresql-10_10.8-0ubuntu0.18.04.1.debian.tar.xz 33328 SHA256:22c8cc9cf9363fd7f68135f1def9cdfcd38cfea9cec0140e5879880dd382494a
```
...
### `dpkg` source package: `pulseaudio=1:11.1-1ubuntu7.2`
...
```console
$ apt-get source -qq --print-uris pulseaudio=1:11.1-1ubuntu7.2
'http://archive.ubuntu.com/ubuntu/pool/main/p/pulseaudio/pulseaudio_11.1-1ubuntu7.2.dsc' pulseaudio_11.1-1ubuntu7.2.dsc 3873 SHA256:3054eee21cfaa5d66597195229cacb7cb7b3a9e5995d8ac9d6714db1f4013a54
...
'http://archive.ubuntu.com/ubuntu/pool/main/p/pulseaudio/pulseaudio_11.1-1ubuntu7.2.debian.tar.xz' pulseaudio_11.1-1ubuntu7.2.debian.tar.xz 102124 SHA256:2307cf7ab31bfeea43a4e040a1be14f41a7e9821b9edea7aaa374bf728340bcb
```
...
- `libqt5concurrent5:amd64=5.9.5+dfsg-0ubuntu2`
...
- `libqt5opengl5-dev:amd64=5.9.5+dfsg-0ubuntu2`
- `libqt5printsupport5:amd64=5.9.5+dfsg-0ubuntu2`
- `libqt5sql5:amd64=5.9.5+dfsg-0ubuntu2`
- `libqt5sql5-sqlite:amd64=5.9.5+dfsg-0ubuntu2`
- `libqt5test5:amd64=5.9.5+dfsg-0ubuntu2`
- `libqt5widgets5:amd64=5.9.5+dfsg-0ubuntu2`
- `libqt5xml5:amd64=5.9.5+dfsg-0ubuntu2`
- `qt5-gtk-platformtheme:amd64=5.9.5+dfsg-0ubuntu2`
- `qt5-qmake:amd64=5.9.5+dfsg-0ubuntu2`
- `qt5-qmake-bin=5.9.5+dfsg-0ubuntu2`
- `qtbase5-dev:amd64=5.9.5+dfsg-0ubuntu2`
- `qtbase5-dev-tools=5.9.5+dfsg-0ubuntu2`
...
- `libsdformat6-dev:amd64=6.2.0-1~bionic`
...
### `dpkg` source package: `wavpack=5.1.0-2ubuntu1.3`

Binary Packages:

- `libwavpack1:amd64=5.1.0-2ubuntu1.3`
...
```console
$ apt-get source -qq --print-uris wavpack=5.1.0-2ubuntu1.3
'http://archive.ubuntu.com/ubuntu/pool/main/w/wavpack/wavpack_5.1.0-2ubuntu1.3.dsc' wavpack_5.1.0-2ubuntu1.3.dsc 2199 SHA256:90b824c1a3c07f508ec949d23621adb4126a9bd6622f7b4d9fdbe4424b853115
...
'http://archive.ubuntu.com/ubuntu/pool/main/w/wavpack/wavpack_5.1.0-2ubuntu1.3.debian.tar.xz' wavpack_5.1.0-2ubuntu1.3.debian.tar.xz 10216 SHA256:4484591fa38c86db54d6ed0e3e21c9b597e3c7185ca44f6f0bbb7484dd8e4f01
```
...
### `dpkg` source package: `zeromq3=4.2.5-1ubuntu0.1`

Binary Packages:

- `libzmq3-dev:amd64=4.2.5-1ubuntu0.1`
- `libzmq5:amd64=4.2.5-1ubuntu0.1`
