...
-	[`nextcloud:12.0.7`](#nextcloud1207)
-	[`nextcloud:12.0.7-apache`](#nextcloud1207-apache)
-	[`nextcloud:12.0.7-fpm`](#nextcloud1207-fpm)
-	[`nextcloud:12.0.7-fpm-alpine`](#nextcloud1207-fpm-alpine)
...
-	[`nextcloud:13.0.2`](#nextcloud1302)
-	[`nextcloud:13.0.2-apache`](#nextcloud1302-apache)
-	[`nextcloud:13.0.2-fpm`](#nextcloud1302-fpm)
-	[`nextcloud:13.0.2-fpm-alpine`](#nextcloud1302-fpm-alpine)
...
-	[`nextcloud:production`](#nextcloudproduction)
-	[`nextcloud:production-apache`](#nextcloudproduction-apache)
-	[`nextcloud:production-fpm`](#nextcloudproduction-fpm)
-	[`nextcloud:production-fpm-alpine`](#nextcloudproduction-fpm-alpine)
...
```console
$ docker pull nextcloud@sha256:7855fcc831fc80c732a67f252aa036d17bbe9193eb40678ca0d3d02efeac5d02
```
...
```console
$ docker pull nextcloud@sha256:15545fa0654ce53d69c49182cd56ae6cff3ef3c82c9d5a0b36153e49bd1b0435
```
...
```console
$ docker pull nextcloud@sha256:98a98d1217adfa451400ef8531af4425a1bc1078946aed8bb2b01c22013eeb8d
```
...
### `nextcloud:13.0.2-apache` - linux; amd64
