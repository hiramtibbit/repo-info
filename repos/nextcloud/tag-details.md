...
-	[`nextcloud:12.0.13`](#nextcloud12013)
-	[`nextcloud:12.0.13-apache`](#nextcloud12013-apache)
-	[`nextcloud:12.0.13-fpm`](#nextcloud12013-fpm)
-	[`nextcloud:12.0.13-fpm-alpine`](#nextcloud12013-fpm-alpine)
...
-	[`nextcloud:13.0.8`](#nextcloud1308)
-	[`nextcloud:13.0.8-apache`](#nextcloud1308-apache)
-	[`nextcloud:13.0.8-fpm`](#nextcloud1308-fpm)
-	[`nextcloud:13.0.8-fpm-alpine`](#nextcloud1308-fpm-alpine)
...
-	[`nextcloud:14.0.4`](#nextcloud1404)
-	[`nextcloud:14.0.4-apache`](#nextcloud1404-apache)
-	[`nextcloud:14.0.4-fpm`](#nextcloud1404-fpm)
-	[`nextcloud:14.0.4-fpm-alpine`](#nextcloud1404-fpm-alpine)
...
-	[`nextcloud:15.0.0-rc`](#nextcloud1500-rc)
-	[`nextcloud:15.0.0RC1`](#nextcloud1500rc1)
-	[`nextcloud:15.0.0RC1-apache`](#nextcloud1500rc1-apache)
-	[`nextcloud:15.0.0RC1-fpm`](#nextcloud1500rc1-fpm)
-	[`nextcloud:15.0.0RC1-fpm-alpine`](#nextcloud1500rc1-fpm-alpine)
-	[`nextcloud:15.0.0-rc-apache`](#nextcloud1500-rc-apache)
-	[`nextcloud:15.0.0-rc-fpm`](#nextcloud1500-rc-fpm)
-	[`nextcloud:15.0.0-rc-fpm-alpine`](#nextcloud1500-rc-fpm-alpine)
-	[`nextcloud:15.0-rc`](#nextcloud150-rc)
-	[`nextcloud:15.0-rc-apache`](#nextcloud150-rc-apache)
-	[`nextcloud:15.0-rc-fpm`](#nextcloud150-rc-fpm)
-	[`nextcloud:15.0-rc-fpm-alpine`](#nextcloud150-rc-fpm-alpine)
-	[`nextcloud:15-rc`](#nextcloud15-rc)
-	[`nextcloud:15-rc-apache`](#nextcloud15-rc-apache)
-	[`nextcloud:15-rc-fpm`](#nextcloud15-rc-fpm)
-	[`nextcloud:15-rc-fpm-alpine`](#nextcloud15-rc-fpm-alpine)
...
```console
$ docker pull nextcloud@sha256:cd53dbcc42242b8d7719dded774e3a82baa1e7160f253572eaa5bc2c05b69b94
```
...
### `nextcloud:12.0.13-apache` - linux; amd64
...
## `nextcloud:12.0.13-fpm-alpine`

```console
$ docker pull nextcloud@sha256:a6dc4bbe3b6bb7ea518ac46a1db974b9ef7698685f86e886cbf5a71d78fa1c73
```
...
### `nextcloud:13.0.8-apache` - linux; amd64
...
```console
$ docker pull nextcloud@sha256:af442ecdda7903bfc37ddad9fffb5490e291568e4bf8e5e96a4435aa0dda3953
```
...
```console
$ docker pull nextcloud@sha256:f7585174996bd4810c531ef47e4fd6ba8c1a4768d4b499afe42a6e14183c3faa
```
...
```console
$ docker pull nextcloud@sha256:8ba8ecf3aa8eaba6385a1c5afbc10264e2a51c94300adffb9a76e7650ad9a1fa
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **102.2 MB (102172393 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:dc850ef78cbf97dd1d1a9968bdbfbe4ae58db451917d36c0d967d0fb5cbcbb6d`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Mon, 26 Nov 2018 23:35:48 GMT
VOLUME [/var/www/html]
# Mon, 26 Nov 2018 23:35:49 GMT
ENV NEXTCLOUD_VERSION=13.0.8
# Mon, 26 Nov 2018 23:36:05 GMT
RUN set -ex;     apk add --no-cache --virtual .fetch-deps         bzip2         gnupg     ;         curl -fsSL -o nextcloud.tar.bz2         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2";     curl -fsSL -o nextcloud.tar.bz2.asc         "https://download.nextcloud.com/server/releases/nextcloud-${NEXTCLOUD_VERSION}.tar.bz2.asc";     export GNUPGHOME="$(mktemp -d)";     gpg --batch --keyserver ha.pool.sks-keyservers.net --recv-keys 28806A878AE423A28372792ED75899B9A724937A;     gpg --batch --verify nextcloud.tar.bz2.asc nextcloud.tar.bz2;     tar -xjf nextcloud.tar.bz2 -C /usr/src/;     gpgconf --kill all;     rm -r "$GNUPGHOME" nextcloud.tar.bz2.asc nextcloud.tar.bz2;     rm -rf /usr/src/nextcloud/updater;     mkdir -p /usr/src/nextcloud/data;     mkdir -p /usr/src/nextcloud/custom_apps;     chmod +x /usr/src/nextcloud/occ;     apk del .fetch-deps
# Mon, 26 Nov 2018 23:36:06 GMT
COPY multi:81a604c4dab97e68e347c33e116ec4b72cbaeaa1a1c71fb9375c9cc9ec06291c in / 
# Mon, 26 Nov 2018 23:36:06 GMT
COPY multi:ca4d4da57eb7f9d9da17f5414c6686894b87a363e243105b8463618fd8dc681d in /usr/src/nextcloud/config/ 
# Mon, 26 Nov 2018 23:36:06 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Mon, 26 Nov 2018 23:36:07 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:f84802d419648f60f7760b7ee87d9a2b0ee6fe3da5e0368f2da718ef36142d04`  
		...
		Size: 504.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c7b8e50b93d297ff585a4dc9fc51cbfd117697999213688109dfc82d154b019f`  
		Last Modified: Mon, 26 Nov 2018 23:51:01 GMT  
		Size: 50.2 MB (50186627 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:9beaa71a4a000b9cfdb42655e18d7f4c83b22f057521b65e117eb3723ee74e6d`  
		Last Modified: Mon, 26 Nov 2018 23:50:47 GMT  
		Size: 1.9 KB (1910 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:780a6d08c0a475acf69644aea5c339ae3c6fbc24424fd77fe19dea1cc40fec0e`  
		Last Modified: Mon, 26 Nov 2018 23:50:47 GMT  
		Size: 739.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
...
```console
$ docker pull nextcloud@sha256:4531bd2e7d3c973d1c1bddf83bd5470e69409c9b3f22d7529d3e830a975b9fc6
```
...
### `nextcloud:14.0.4-apache` - linux; amd64
...
```console
$ docker pull nextcloud@sha256:2ab9cad0c6e709a90b28d2f976e1b4da5ca204c47e33560eb5392e34a07216a9
```
...
```console
$ docker pull nextcloud@sha256:07be6e352af29059ffea483f205d896796d08c57faca1af3454435e2b3855233
```
...
### `nextcloud:15.0.0RC1` - linux; amd64
...
### `nextcloud:15.0.0RC1-apache` - linux; amd64
...
### `nextcloud:15.0.0RC1-fpm` - linux; amd64
...
### `nextcloud:15.0.0RC1-fpm-alpine` - linux; amd64
...
### `nextcloud:15.0.0-rc-apache` - linux; amd64
...
### `nextcloud:15.0.0-rc-fpm-alpine` - linux; amd64
...
### `nextcloud:15-rc-apache` - linux; amd64
