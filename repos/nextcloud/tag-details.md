...
-	[`nextcloud:13.0.12`](#nextcloud13012)
-	[`nextcloud:13.0.12-apache`](#nextcloud13012-apache)
-	[`nextcloud:13.0.12-fpm`](#nextcloud13012-fpm)
-	[`nextcloud:13.0.12-fpm-alpine`](#nextcloud13012-fpm-alpine)
...
-	[`nextcloud:14.0.8`](#nextcloud1408)
-	[`nextcloud:14.0.8-apache`](#nextcloud1408-apache)
-	[`nextcloud:14.0.8-fpm`](#nextcloud1408-fpm)
-	[`nextcloud:14.0.8-fpm-alpine`](#nextcloud1408-fpm-alpine)
...
-	[`nextcloud:15`](#nextcloud15)
-	[`nextcloud:15.0`](#nextcloud150)
-	[`nextcloud:15.0.5`](#nextcloud1505)
-	[`nextcloud:15.0.5-apache`](#nextcloud1505-apache)
-	[`nextcloud:15.0.5-fpm`](#nextcloud1505-fpm)
-	[`nextcloud:15.0.5-fpm-alpine`](#nextcloud1505-fpm-alpine)
-	[`nextcloud:15.0-apache`](#nextcloud150-apache)
-	[`nextcloud:15.0-fpm`](#nextcloud150-fpm)
-	[`nextcloud:15.0-fpm-alpine`](#nextcloud150-fpm-alpine)
-	[`nextcloud:15-apache`](#nextcloud15-apache)
-	[`nextcloud:15-fpm`](#nextcloud15-fpm)
-	[`nextcloud:15-fpm-alpine`](#nextcloud15-fpm-alpine)
...
```console
$ docker pull nextcloud@sha256:a320554b140299aa732392d4c364e32a25ca7c756410beb8d3d7ccfea56f81b5
```
...
```console
$ docker pull nextcloud@sha256:f71c1a5af2f9c45091986530ad922e3be1c1710ddf6b462eb6527a5b306d9b64
```
...
### `nextcloud:13.0.12-fpm` - linux; amd64
...
```console
$ docker pull nextcloud@sha256:de1a9c19944fe8027116ca787d36b2485b4f95a3dc20a8a12d040bf6cd79a2e0
```
...
```console
$ docker pull nextcloud@sha256:0543063ae77390f0ec4b754aae588c3adf23d71bb323bc11a0eeb9c975caadbd
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.2 MB (107168794 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e41000a517dfa889db2fbb33f3bd3a15f429685280d847e34cb9e932019d3d6`
-	Entrypoint: `["\/entrypoint.sh"]`
-	Default Command: `["php-fpm"]`
...
# Tue, 26 Feb 2019 08:50:10 GMT
VOLUME [/var/www/html]
# Thu, 28 Feb 2019 22:20:22 GMT
ENV NEXTCLOUD_VERSION=13.0.12
# Thu, 28 Feb 2019 22:20:37 GMT
...
# Thu, 28 Feb 2019 22:20:38 GMT
COPY multi:e3ee4b7af51dcf3ed52441ed3dff61bf962f6e147370b5b9bbbc163fc54eb8f6 in / 
# Thu, 28 Feb 2019 22:20:38 GMT
COPY multi:0b2ba0c397491460d621f6eb05f6634d8319beff18761265d6061d2e21097e99 in /usr/src/nextcloud/config/ 
# Thu, 28 Feb 2019 22:20:39 GMT
ENTRYPOINT ["/entrypoint.sh"]
# Thu, 28 Feb 2019 22:20:39 GMT
CMD ["php-fpm"]
```
...
-	Layers:
	...
	-	`sha256:ed4ac3c922b6f996bdd8f19078b5e755fd552d03213cd7e809d5247b91380e57`  
		...
		Size: 504.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:af1f37214f569c0360649de74924f1313bdbddec37245041a652c440c82578c9`  
		Last Modified: Thu, 28 Feb 2019 22:25:32 GMT  
		Size: 50.5 MB (50509856 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0f