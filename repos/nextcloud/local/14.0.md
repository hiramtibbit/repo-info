...
- http://snapshot.debian.org/package/busybox/1:1.22.0-19/
...
- http://snapshot.debian.org/package/libmemcached/1.0.18-4.1/
...
- http://snapshot.debian.org/package/popt/1.16-10/
...
- http://snapshot.debian.org/package/rsync/3.1.2-1+deb9u2/
