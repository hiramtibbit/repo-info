...
### `nextcloud:13.0.5-rc-fpm-alpine` - linux; amd64
...
### `nextcloud:13.0.5-rc-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:13.0.5-rc-fpm-alpine` - linux; 386
...
### `nextcloud:13.0.5-rc-fpm-alpine` - linux; ppc64le
