...
### `nextcloud:13.0.12-rc` - linux; amd64
...
### `nextcloud:13.0.12-rc` - linux; arm variant v5
...
### `nextcloud:13.0.12-rc` - linux; arm variant v7
...
### `nextcloud:13.0.12-rc` - linux; arm64 variant v8
...
### `nextcloud:13.0.12-rc` - linux; 386
...
### `nextcloud:13.0.12-rc` - linux; ppc64le
