...
### `nextcloud:14.0.11-rc` - linux; amd64
...
### `nextcloud:14.0.11-rc` - linux; arm variant v5
...
### `nextcloud:14.0.11-rc` - linux; arm variant v7
...
### `nextcloud:14.0.11-rc` - linux; arm64 variant v8
...
### `nextcloud:14.0.11-rc` - linux; 386
...
### `nextcloud:14.0.11-rc` - linux; ppc64le
