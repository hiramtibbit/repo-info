...
### `nextcloud:13.0.1-rc` - linux; amd64
...
### `nextcloud:13.0.1-rc` - linux; arm variant v5
...
### `nextcloud:13.0.1-rc` - linux; arm variant v7
...
### `nextcloud:13.0.1-rc` - linux; arm64 variant v8
...
### `nextcloud:13.0.1-rc` - linux; ppc64le
...
### `nextcloud:13.0.1-rc` - linux; s390x
