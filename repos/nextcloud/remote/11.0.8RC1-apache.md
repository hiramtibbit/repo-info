...
### `nextcloud:11.0.8RC1-apache` - linux; arm variant v5
...
### `nextcloud:11.0.8RC1-apache` - linux; arm variant v7
...
### `nextcloud:11.0.8RC1-apache` - linux; arm64 variant v8
...
### `nextcloud:11.0.8RC1-apache` - linux; ppc64le
...
### `nextcloud:11.0.8RC1-apache` - linux; s390x
