...
### `nextcloud:16.0-beta` - linux; arm variant v5
...
### `nextcloud:16.0-beta` - linux; arm variant v7
...
### `nextcloud:16.0-beta` - linux; arm64 variant v8
...
### `nextcloud:16.0-beta` - linux; ppc64le
