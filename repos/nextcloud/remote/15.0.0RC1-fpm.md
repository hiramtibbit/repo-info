...
```console
$ docker pull nextcloud@sha256:b644bec5ed55dd49e0e905eaf553f2249d7a9407b8ff8387abc52e6ccc373988
```
...
### `nextcloud:15.0.0RC1-fpm` - linux; arm variant v5
...
### `nextcloud:15.0.0RC1-fpm` - linux; ppc64le
