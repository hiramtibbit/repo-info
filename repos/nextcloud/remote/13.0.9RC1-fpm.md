## `nextcloud:13.0.9RC1-fpm`

```console
$ docker pull nextcloud@sha256:9e581bd332d74f753238dd853bcc2089fccce603687a63177b3fabe6dcafab91
```
...
### `nextcloud:13.0.9RC1-fpm` - linux; amd64
...
### `nextcloud:13.0.9RC1-fpm` - linux; arm variant v5
...
### `nextcloud:13.0.9RC1-fpm` - linux; arm64 variant v8
...
### `nextcloud:13.0.9RC1-fpm` - linux; 386
...
### `nextcloud:13.0.9RC1-fpm` - linux; ppc64le
