...
### `nextcloud:11.0.8-rc` - linux; amd64
...
### `nextcloud:11.0.8-rc` - linux; arm variant v5
...
### `nextcloud:11.0.8-rc` - linux; arm variant v7
...
### `nextcloud:11.0.8-rc` - linux; arm64 variant v8
...
### `nextcloud:11.0.8-rc` - linux; ppc64le
...
### `nextcloud:11.0.8-rc` - linux; s390x
