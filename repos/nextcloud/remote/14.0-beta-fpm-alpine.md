...
### `nextcloud:14.0-beta-fpm-alpine` - linux; amd64
...
### `nextcloud:14.0-beta-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:14.0-beta-fpm-alpine` - linux; 386
...
### `nextcloud:14.0-beta-fpm-alpine` - linux; ppc64le
