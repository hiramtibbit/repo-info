...
### `nextcloud:12.0.10-rc` - linux; amd64
...
### `nextcloud:12.0.10-rc` - linux; arm variant v5
...
### `nextcloud:12.0.10-rc` - linux; arm variant v7
...
### `nextcloud:12.0.10-rc` - linux; arm64 variant v8
...
### `nextcloud:12.0.10-rc` - linux; 386
...
### `nextcloud:12.0.10-rc` - linux; ppc64le
...
### `nextcloud:12.0.10-rc` - linux; s390x
