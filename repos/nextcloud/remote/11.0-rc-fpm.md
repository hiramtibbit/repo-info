...
### `nextcloud:11.0-rc-fpm` - linux; amd64
...
### `nextcloud:11.0-rc-fpm` - linux; arm variant v5
...
### `nextcloud:11.0-rc-fpm` - linux; arm variant v7
...
### `nextcloud:11.0-rc-fpm` - linux; arm64 variant v8
...
### `nextcloud:11.0-rc-fpm` - linux; ppc64le
...
### `nextcloud:11.0-rc-fpm` - linux; s390x
