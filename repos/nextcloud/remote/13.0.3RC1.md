...
### `nextcloud:13.0.3RC1` - linux; arm variant v5
...
### `nextcloud:13.0.3RC1` - linux; arm variant v7
...
### `nextcloud:13.0.3RC1` - linux; arm64 variant v8
...
### `nextcloud:13.0.3RC1` - linux; ppc64le
...
### `nextcloud:13.0.3RC1` - linux; s390x
