...
### `nextcloud:13.0.1-rc-apache` - linux; amd64
...
### `nextcloud:13.0.1-rc-apache` - linux; arm variant v5
...
### `nextcloud:13.0.1-rc-apache` - linux; arm variant v7
...
### `nextcloud:13.0.1-rc-apache` - linux; arm64 variant v8
...
### `nextcloud:13.0.1-rc-apache` - linux; ppc64le
...
### `nextcloud:13.0.1-rc-apache` - linux; s390x
