...
### `nextcloud:16-alpha` - linux; amd64
...
### `nextcloud:16-alpha` - linux; arm variant v5
...
### `nextcloud:16-alpha` - linux; arm variant v7
...
### `nextcloud:16-alpha` - linux; arm64 variant v8
...
### `nextcloud:16-alpha` - linux; ppc64le
