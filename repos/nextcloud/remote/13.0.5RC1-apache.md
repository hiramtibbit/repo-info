...
### `nextcloud:13.0.5RC1-apache` - linux; arm variant v7
...
### `nextcloud:13.0.5RC1-apache` - linux; 386
...
### `nextcloud:13.0.5RC1-apache` - linux; ppc64le
...
### `nextcloud:13.0.5RC1-apache` - linux; s390x
