...
### `nextcloud:13.0.7RC1-fpm-alpine` - linux; amd64
...
### `nextcloud:13.0.7RC1-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:13.0.7RC1-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:13.0.7RC1-fpm-alpine` - linux; 386
...
### `nextcloud:13.0.7RC1-fpm-alpine` - linux; ppc64le
