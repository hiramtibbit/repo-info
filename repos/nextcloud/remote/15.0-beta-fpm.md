...
### `nextcloud:15.0-beta-fpm` - linux; amd64
...
### `nextcloud:15.0-beta-fpm` - linux; arm variant v5
...
### `nextcloud:15.0-beta-fpm` - linux; arm variant v7
...
### `nextcloud:15.0-beta-fpm` - linux; arm64 variant v8
...
### `nextcloud:15.0-beta-fpm` - linux; 386
...
### `nextcloud:15.0-beta-fpm` - linux; ppc64le
