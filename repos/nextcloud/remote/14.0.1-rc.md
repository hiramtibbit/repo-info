...
### `nextcloud:14.0.1-rc` - linux; amd64
...
### `nextcloud:14.0.1-rc` - linux; arm variant v5
...
### `nextcloud:14.0.1-rc` - linux; arm variant v7
...
### `nextcloud:14.0.1-rc` - linux; arm64 variant v8
...
### `nextcloud:14.0.1-rc` - linux; ppc64le
