...
### `nextcloud:16.0.1RC1-apache` - linux; amd64
...
### `nextcloud:16.0.1RC1-apache` - linux; arm variant v5
...
### `nextcloud:16.0.1RC1-apache` - linux; arm64 variant v8
...
### `nextcloud:16.0.1RC1-apache` - linux; ppc64le
