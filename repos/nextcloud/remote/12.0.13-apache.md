...
### `nextcloud:12.0.13-apache` - linux; arm variant v5
...
### `nextcloud:12.0.13-apache` - linux; arm variant v7
...
### `nextcloud:12.0.13-apache` - linux; 386
...
### `nextcloud:12.0.13-apache` - linux; ppc64le
...
### `nextcloud:12.0.13-apache` - linux; s390x
