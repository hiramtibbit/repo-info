...
### `nextcloud:15-beta-apache` - linux; arm variant v5
...
### `nextcloud:15-beta-apache` - linux; arm64 variant v8
...
### `nextcloud:15-beta-apache` - linux; 386
...
### `nextcloud:15-beta-apache` - linux; ppc64le
