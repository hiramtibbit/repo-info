...
### `nextcloud:14.0.0RC2-fpm-alpine` - linux; amd64
...
### `nextcloud:14.0.0RC2-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:14.0.0RC2-fpm-alpine` - linux; 386
...
### `nextcloud:14.0.0RC2-fpm-alpine` - linux; ppc64le
