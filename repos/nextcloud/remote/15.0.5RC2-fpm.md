...
### `nextcloud:15.0.5RC2-fpm` - linux; amd64
...
### `nextcloud:15.0.5RC2-fpm` - linux; arm variant v5
...
### `nextcloud:15.0.5RC2-fpm` - linux; arm variant v7
...
### `nextcloud:15.0.5RC2-fpm` - linux; arm64 variant v8
...
### `nextcloud:15.0.5RC2-fpm` - linux; 386
...
### `nextcloud:15.0.5RC2-fpm` - linux; ppc64le
