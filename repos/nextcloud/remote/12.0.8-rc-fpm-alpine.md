## `nextcloud:12.0.8-rc-fpm-alpine`
...
### `nextcloud:12.0.8-rc-fpm-alpine` - linux; amd64
...
### `nextcloud:12.0.8-rc-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:12.0.8-rc-fpm-alpine` - linux; 386
...
### `nextcloud:12.0.8-rc-fpm-alpine` - linux; ppc64le
