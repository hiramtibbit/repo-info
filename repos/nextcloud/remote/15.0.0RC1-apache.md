...
### `nextcloud:15.0.0RC1-apache` - linux; arm variant v5
...
### `nextcloud:15.0.0RC1-apache` - linux; arm variant v7
...
### `nextcloud:15.0.0RC1-apache` - linux; 386
...
### `nextcloud:15.0.0RC1-apache` - linux; ppc64le
