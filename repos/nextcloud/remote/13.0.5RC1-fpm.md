...
### `nextcloud:13.0.5RC1-fpm` - linux; arm variant v5
...
### `nextcloud:13.0.5RC1-fpm` - linux; arm variant v7
...
### `nextcloud:13.0.5RC1-fpm` - linux; arm64 variant v8
...
### `nextcloud:13.0.5RC1-fpm` - linux; 386
...
### `nextcloud:13.0.5RC1-fpm` - linux; ppc64le
...
### `nextcloud:13.0.5RC1-fpm` - linux; s390x
