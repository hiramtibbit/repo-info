...
### `nextcloud:11.0.8-rc-apache` - linux; amd64
...
### `nextcloud:11.0.8-rc-apache` - linux; arm variant v5
...
### `nextcloud:11.0.8-rc-apache` - linux; arm variant v7
...
### `nextcloud:11.0.8-rc-apache` - linux; arm64 variant v8
...
### `nextcloud:11.0.8-rc-apache` - linux; ppc64le
...
### `nextcloud:11.0.8-rc-apache` - linux; s390x
