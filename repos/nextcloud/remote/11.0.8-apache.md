...
### `nextcloud:11.0.8-apache` - linux; amd64
...
### `nextcloud:11.0.8-apache` - linux; arm variant v7
...
### `nextcloud:11.0.8-apache` - linux; arm64 variant v8
...
### `nextcloud:11.0.8-apache` - linux; ppc64le
