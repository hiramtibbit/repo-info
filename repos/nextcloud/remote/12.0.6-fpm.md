...
### `nextcloud:12.0.6-fpm` - linux; amd64
...
### `nextcloud:12.0.6-fpm` - linux; arm variant v7
...
### `nextcloud:12.0.6-fpm` - linux; arm64 variant v8
...
### `nextcloud:12.0.6-fpm` - linux; 386
...
### `nextcloud:12.0.6-fpm` - linux; ppc64le
