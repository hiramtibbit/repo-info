...
### `nextcloud:14.0.1-rc-fpm` - linux; amd64
...
### `nextcloud:14.0.1-rc-fpm` - linux; arm variant v5
...
### `nextcloud:14.0.1-rc-fpm` - linux; arm variant v7
...
### `nextcloud:14.0.1-rc-fpm` - linux; arm64 variant v8
...
### `nextcloud:14.0.1-rc-fpm` - linux; 386
...
### `nextcloud:14.0.1-rc-fpm` - linux; ppc64le
