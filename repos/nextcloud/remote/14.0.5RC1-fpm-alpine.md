...
### `nextcloud:14.0.5RC1-fpm-alpine` - linux; amd64
...
### `nextcloud:14.0.5RC1-fpm-alpine` - linux; arm variant v6
...
### `nextcloud:14.0.5RC1-fpm-alpine` - linux; arm64 variant v8
...
### `nextcloud:14.0.5RC1-fpm-alpine` - linux; 386
...
### `nextcloud:14.0.5RC1-fpm-alpine` - linux; ppc64le
