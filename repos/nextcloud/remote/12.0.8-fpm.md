...
### `nextcloud:12.0.8-fpm` - linux; arm variant v5
...
### `nextcloud:12.0.8-fpm` - linux; arm variant v7
...
### `nextcloud:12.0.8-fpm` - linux; arm64 variant v8
...
### `nextcloud:12.0.8-fpm` - linux; 386
...
### `nextcloud:12.0.8-fpm` - linux; s390x
