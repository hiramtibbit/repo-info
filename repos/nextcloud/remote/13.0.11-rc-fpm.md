...
### `nextcloud:13.0.11-rc-fpm` - linux; amd64
...
### `nextcloud:13.0.11-rc-fpm` - linux; arm variant v5
...
### `nextcloud:13.0.11-rc-fpm` - linux; arm variant v7
...
### `nextcloud:13.0.11-rc-fpm` - linux; arm64 variant v8
...
### `nextcloud:13.0.11-rc-fpm` - linux; 386
...
### `nextcloud:13.0.11-rc-fpm` - linux; ppc64le
