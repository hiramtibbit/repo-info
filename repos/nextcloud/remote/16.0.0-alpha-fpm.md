...
### `nextcloud:16.0.0-alpha-fpm` - linux; amd64
...
### `nextcloud:16.0.0-alpha-fpm` - linux; arm variant v5
...
### `nextcloud:16.0.0-alpha-fpm` - linux; arm variant v7
...
### `nextcloud:16.0.0-alpha-fpm` - linux; arm64 variant v8
...
### `nextcloud:16.0.0-alpha-fpm` - linux; 386
...
### `nextcloud:16.0.0-alpha-fpm` - linux; ppc64le
