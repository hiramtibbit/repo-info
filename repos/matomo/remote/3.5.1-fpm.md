...
```console
$ docker pull matomo@sha256:ef65f4e4c7bd8215a1a5de88040bdef66f31aa8803a4c9134018ddc50245597e
```
...
```console
$ docker pull matomo@sha256:d3ee499d9c04993dd1c932abac911a4f1b47d7d3f341cc0aa4f08a6f4b56d648
```
