...
```console
$ docker pull matomo@sha256:34f428c7eb948ffd9208471df658aa13bd4f8697fd54f85d342ed801c69867c1
```
...
```console
$ docker pull matomo@sha256:f2ed220b6ff6df0f5290f528ee99fde8cc5319f03a3efc653a0d98a4f4a3fc6b
```
