...
### `matomo:3.9.0-fpm-alpine` - linux; amd64
...
### `matomo:3.9.0-fpm-alpine` - linux; arm variant v6
...
### `matomo:3.9.0-fpm-alpine` - linux; arm variant v7
...
### `matomo:3.9.0-fpm-alpine` - linux; arm64 variant v8
...
### `matomo:3.9.0-fpm-alpine` - linux; 386
...
### `matomo:3.9.0-fpm-alpine` - linux; ppc64le
