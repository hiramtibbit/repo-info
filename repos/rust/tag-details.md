...
### `rust:1.29.2` - linux; arm variant v7
...
```console
$ docker pull rust@sha256:36b0df1f76b903349ef211a98262a56489043a2c6ca47b2244cb2ec7e3b8bfd3
```
...
### `rust:1.29.2-slim` - linux; arm variant v7
