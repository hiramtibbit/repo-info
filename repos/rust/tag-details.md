...
```console
$ docker pull rust@sha256:8f2293063498174256bde7106b31552374033b16f4b7a950c4fb4aba458500e6
```
...
```console
$ docker pull rust@sha256:ef40cf13e03078d847b2fbd5f1630a757234e0073616f8ac307426f7b6833ac8
```
