...
```console
$ docker pull rust@sha256:cd69e54d5dbdc16245ebec4036cfae1c5f4a743c3df6b41b981049926862e516
```
...
```console
$ docker pull rust@sha256:d5e385140700fab007c5734b92a0a076946cba3b8b197c04a90d52a70c30dffa
```
