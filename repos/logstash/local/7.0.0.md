...
- Created: `2019-04-06T00:05:03.044855325Z`
- Virtual Size: ~ 765.09 Mb  
...
### `rpm` package: `atk-2.28.1-1.el7.x86_64`
...
### `rpm` package: `java-1.8.0-openjdk-1.8.0.201.b09-2.el7_6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-1.8.0-openjdk-1.8.0.201.b09-2.el7_6
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-1.8.0-openjdk-1.8.0.201.b09-2.el7_6.src.rpm
```

### `rpm` package: `java-1.8.0-openjdk-devel-1.8.0.201.b09-2.el7_6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-1.8.0-openjdk-devel-1.8.0.201.b09-2.el7_6
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-1.8.0-openjdk-1.8.0.201.b09-2.el7_6.src.rpm
...
### `rpm` package: `java-1.8.0-openjdk-headless-1.8.0.201.b09-2.el7_6.x86_64`
...
```console
$ yumdownloader --quiet --source --urls java-1.8.0-openjdk-headless-1.8.0.201.b09-2.el7_6
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/java-1.8.0-openjdk-1.8.0.201.b09-2.el7_6.src.rpm
...
### `rpm` package: `libgcc-4.8.5-36.el7_6.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libgcc-4.8.5-36.el7_6.1
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/gcc-4.8.5-36.el7_6.1.src.rpm
```
...
### `rpm` package: `libstdc++-4.8.5-36.el7_6.1.x86_64`
...
```console
$ yumdownloader --quiet --source --urls libstdc++-4.8.5-36.el7_6.1
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/updates/Source//SPackages/gcc-4.8.5-36.el7_6.1.src.rpm
...
### `rpm` package: `pango-1.42.4-1.el7.x86_64`
...
```console
$ yumdownloader --quiet --source --urls pango-1.42.4-1.el7
Enabling updates-source repository
Enabling base-source repository
Enabling extras-source repository
http://vault.centos.org/centos/7/os/Source//SPackages/pango-1.42.4-1.el7.src.rpm
```
