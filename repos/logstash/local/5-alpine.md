...
- Created: `2019-04-10T03:16:58.611184443Z`
...
```console
libzmq-4.3.1-r0 description:
The ZeroMQ messaging library and tools (libraries)

libzmq-4.3.1-r0 webpage:
http://www.zeromq.org/

libzmq-4.3.1-r0 installed size:
471040

libzmq-4.3.1-r0 license:
LGPL-3.0-or-later with exceptions
