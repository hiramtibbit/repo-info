...
```console
$ docker pull php@sha256:eea63aacd2572eea541a43871736884622442bc28a95d08448d91aaacfc7357d
```
...
### `php:7.1.20-jessie` - linux; arm variant v5
...
### `php:7.1.20-jessie` - linux; arm variant v7
