...
### `php:5.6.37-apache-stretch` - linux; amd64
...
### `php:5.6.37-apache-stretch` - linux; arm variant v5
...
### `php:5.6.37-apache-stretch` - linux; arm variant v7
...
### `php:5.6.37-apache-stretch` - linux; arm64 variant v8
...
### `php:5.6.37-apache-stretch` - linux; 386
...
### `php:5.6.37-apache-stretch` - linux; ppc64le
