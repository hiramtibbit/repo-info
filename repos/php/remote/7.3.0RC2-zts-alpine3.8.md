...
```console
$ docker pull php@sha256:ff57b8ab85d30fef2ee7c2207a267397f6a2d7d0b7a9284bb3533192bbd93fb4
```
...
### `php:7.3.0RC2-zts-alpine3.8` - linux; amd64
...
### `php:7.3.0RC2-zts-alpine3.8` - linux; arm variant v6
...
### `php:7.3.0RC2-zts-alpine3.8` - linux; arm64 variant v8
...
### `php:7.3.0RC2-zts-alpine3.8` - linux; ppc64le
