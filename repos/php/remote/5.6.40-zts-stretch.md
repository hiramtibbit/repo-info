...
### `php:5.6.40-zts-stretch` - linux; arm variant v5
...
### `php:5.6.40-zts-stretch` - linux; arm variant v7
...
### `php:5.6.40-zts-stretch` - linux; arm64 variant v8
...
### `php:5.6.40-zts-stretch` - linux; 386
...
### `php:5.6.40-zts-stretch` - linux; ppc64le
