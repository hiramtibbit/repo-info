...
```console
$ docker pull php@sha256:0fad4dea13a199907a2d173e6512337e45e7bdcd7a4617d03dc97ea523f6cd1c
```
...
### `php:7.0.31-fpm-stretch` - linux; arm variant v7
...
### `php:7.0.31-fpm-stretch` - linux; arm64 variant v8
...
### `php:7.0.31-fpm-stretch` - linux; 386

```console
$ docker pull php@sha256:21dd52f40842efeeb6d9c242abc0e09056d35d680c7df3158c791818feb3e497
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **134.9 MB (134889246 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:7193010cc3ac6ed8510ceaa774cf1cd0c2aa7f5644353162336f1779cb7169d1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.0.31-fpm-stretch` - linux; s390x
