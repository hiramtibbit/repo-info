...
### `php:7.1.26-fpm-alpine3.9` - linux; amd64
...
### `php:7.1.26-fpm-alpine3.9` - linux; arm variant v6
...
### `php:7.1.26-fpm-alpine3.9` - linux; arm64 variant v8
...
### `php:7.1.26-fpm-alpine3.9` - linux; 386
...
### `php:7.1.26-fpm-alpine3.9` - linux; ppc64le
