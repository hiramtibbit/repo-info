...
```console
$ docker pull php@sha256:78ab9a5485e0e5cb6b4f688061b04ba34b0790d9e8720a8050cf7940be38f540
```
...
```console
$ docker pull php@sha256:2858c70f11fc17baf50930a19e8ca25176466680eb19ac6684f52788da7250db
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.0 MB (31986411 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9ee0de8e709ff89b4d39f30e2b8672c3ee1f64f5181586a5991f305a32335057`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
