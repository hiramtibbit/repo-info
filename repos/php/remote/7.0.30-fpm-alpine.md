...
```console
$ docker pull php@sha256:2d363ac1a431c8c748cb09ac328fe53282c3158c501f1069627337736c3616cb
```
...
```console
$ docker pull php@sha256:f3738a69c7310d22988ce8dc094ae9727e1966a2074f9f8cde5be0d4727e2bfe
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.5 MB (31463936 bytes)**  
