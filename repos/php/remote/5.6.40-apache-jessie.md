...
```console
$ docker pull php@sha256:ea790fc079c6ebdec3a6ad135969f8375f12255b3dece9b296c93df0434dd091
```
...
### `php:5.6.40-apache-jessie` - linux; arm variant v5
...
### `php:5.6.40-apache-jessie` - linux; arm variant v7
...
### `php:5.6.40-apache-jessie` - linux; 386
