...
```console
$ docker pull php@sha256:87f652cc25c68e68c58dc713b7917d5f3ad229de8111ee0aff8af3af64a95331
```
...
```console
$ docker pull php@sha256:520291018692e09a469ce09614951af0977b9ff4788816065f6a72d23c535da8
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **34.2 MB (34195602 bytes)**  
