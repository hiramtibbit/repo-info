...
### `php:5.6.39-fpm-alpine3.8` - linux; amd64
...
### `php:5.6.39-fpm-alpine3.8` - linux; arm variant v6
...
### `php:5.6.39-fpm-alpine3.8` - linux; arm64 variant v8
...
### `php:5.6.39-fpm-alpine3.8` - linux; 386
...
### `php:5.6.39-fpm-alpine3.8` - linux; ppc64le
