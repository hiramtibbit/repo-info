...
### `php:7.2.10-fpm-alpine3.6` - linux; amd64
...
### `php:7.2.10-fpm-alpine3.6` - linux; arm variant v6
...
### `php:7.2.10-fpm-alpine3.6` - linux; arm64 variant v8
...
### `php:7.2.10-fpm-alpine3.6` - linux; 386
...
### `php:7.2.10-fpm-alpine3.6` - linux; ppc64le
