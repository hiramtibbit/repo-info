...
```console
$ docker pull php@sha256:98e5657aab033a767d66be547e456c42d565fdc259b1a21e27b4a75ec0f6cd7d
```
...
### `php:7.1.22-zts-alpine3.8` - linux; amd64
...
### `php:7.1.22-zts-alpine3.8` - linux; arm variant v6
...
### `php:7.1.22-zts-alpine3.8` - linux; ppc64le
