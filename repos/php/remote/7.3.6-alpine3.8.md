...
```console
$ docker pull php@sha256:41a5aa6e1ffd572a1bf16aaa6aaa77c44453e821d5020648ad274c187a710eb4
```
...
### `php:7.3.6-alpine3.8` - linux; amd64
...
### `php:7.3.6-alpine3.8` - linux; arm variant v6
...
### `php:7.3.6-alpine3.8` - linux; arm64 variant v8
...
### `php:7.3.6-alpine3.8` - linux; ppc64le
