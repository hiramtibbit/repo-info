...
### `php:5.6.38-zts-alpine3.7` - linux; amd64
...
### `php:5.6.38-zts-alpine3.7` - linux; arm variant v6
...
### `php:5.6.38-zts-alpine3.7` - linux; arm64 variant v8
...
### `php:5.6.38-zts-alpine3.7` - linux; 386
...
### `php:5.6.38-zts-alpine3.7` - linux; ppc64le
