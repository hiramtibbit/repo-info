...
```console
$ docker pull php@sha256:4bd02564adb00c3b54c6d929632bcf49c1251fddb126d267d9496553928fc877
```
...
```console
$ docker pull php@sha256:a8a03a156a0b2be5cef7c68487e659d74302c048af30fc5c9757a0cefac0ad54
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.3 MB (31283216 bytes)**  
