...
```console
$ docker pull php@sha256:bf6af2b46555110fe303df3db6ece3c4e94e8d5bb1f2b574f2df0505cf07852a
```
...
### `php:7.1.16-fpm` - linux; arm variant v5
...
### `php:7.1.16-fpm` - linux; arm variant v7
...
### `php:7.1.16-fpm` - linux; arm64 variant v8
