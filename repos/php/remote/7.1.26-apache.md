...
```console
$ docker pull php@sha256:4918e6a77b0220f3a08cd3722701d660c6b351b61ba9c8f6219f71052ecdafa6
```
...
### `php:7.1.26-apache` - linux; amd64

```console
$ docker pull php@sha256:2346205f1ca622f840fcb7b7665bb7b7c6b5bbb480c8cb717fd02bf334e23423
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.9 MB (133862648 bytes)**  
...
### `php:7.1.26-apache` - linux; arm variant v5

```console
$ docker pull php@sha256:088ff40b21e6e6e3b41e732a718ed777ce5fb2b7732a585be6ad6c7d248a4935
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.8 MB (121782963 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:934ab820573d86f5daf723a71f636d6e6b2e597c8ed30b81e4c4cd1a506b6dee`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.1.26-apache` - linux; arm variant v7

```console
$ docker pull php@sha256:1601f10e70bf05c13c5ba657509642a901190487621f9832e74037c0c0dbbba0
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **114.4 MB (114365164 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:a73358b6dc443d0d7f7479530ecafd2ce51fb5c10159b7e0a3604e236c2316c1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.1.26-apache` - linux; arm64 variant v8

```console
$ docker pull php@sha256:3e2675700f00474f5db781e5ea1284be2b2b4dc44603027efae1ac99116c6ecb
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **121.0 MB (120953432 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4659b155aa92a95f85d124098b74bde202317291d55b5c1615a30db7b538680d`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.1.26-apache` - linux; 386

```console
$ docker pull php@sha256:b26d6948d2a59881c80fb85a793de7be27a03ef1cef975c87f7ee965ea84db39
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **139.9 MB (139898076 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e01772f48b64a183f59a8fa6ac5bcbcc47134261a3dde6b38e685c345a357f64`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.1.26-apache` - linux; ppc64le

```console
$ docker pull php@sha256:58756986408924b04ad6de33406d331abd0631c7dbc0a8bc2e86d4cf05cb4b6e
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **128.9 MB (128864986 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12ce3cac410e6bdd7b6c857e655b6db6990cc29574210cec66b4e7e62359ca4e`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:7.1.26-apache` - linux; s390x

```console
$ docker pull php@sha256:e09dfe8b8bc3bcb87a50c7f9db8c97d568212ac47581ab1509673f6b286b397d
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **122.7 MB (122698824 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e8a9a8dc799dabbdf93eba60148045ace25536fcb08b59d2f1749979cc0ca797`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 06 Feb 2019 13:30:57 GMT
COPY file:ce57c04b70896f77cc11eb2766417d8a1240fcffe5bba92179ec78c458844110 in /usr/local/bin/ 
# Fri, 22 Feb 2019 13:09:36 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		libcurl4-openssl-dev 		libedit-dev 		libsqlite3-dev 		libssl-dev 		libxml2-dev 		zlib1g-dev 		${PHP_EXTRA_BUILD_DEPS:-} 	; 	rm -rf /var/lib/apt/lists/*; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 				--with-curl 		--with-libedit 		--with-openssl 		--with-zlib 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				${PHP_EXTRA_CONFIGURE_ARGS:-} 	; 	make -j "$(nproc)"; 	find -type f -name '*.a' -delete; 	make install; 	find /usr/local/bin /usr/local/sbin -type f -executable -exec strip --strip-all '{}' + || true; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		php --version; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc
# Fri, 22 Feb 2019 13:09:37 GMT
COPY multi:0a6fe33cb39694994fa567c75b399b9aa5e477c8770caa9f731607a72819b457 in /usr/local/bin/ 
# Fri, 22 Feb 2019 13:09:37 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Fri, 22 Feb 2019 13:09:37 GMT
...
-	Layers:
	...
	-	`sha256:d4bd606ecdd9cea2fad19d2ab1770ee53183e2352793ab74e9fa4af2faf32641`  
		...
		Size: 502.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:eebacb3deb8c1977114cde3c0a757bbd4aeb56e5178b7aa35478cfe2842d6c39`  
		Last Modified: Fri, 22 Feb 2019 13:41:38 GMT  
		Size: 14.7 MB (14749975 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:0557a611bb5c4ab36150c966b796df2f92eb502d8fd74a5096b4b8a7ffb222ea`  
		Last Modified: Fri, 22 Feb 2019 13:41:34 GMT  
		Size: 2.2 KB (2196 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:c143d8d1029b2ae0b52e64823bf4b178549b06e964e0766449f81b8339a7714d`  
		Last Modified: Fri, 22 Feb 2019 13:41:35 GMT  
		Size: 904.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
