...
```console
$ docker pull php@sha256:e61f3b602124d4d69de3515521d5960177dbd676767e15d2be1167d502ff72d6
```
...
### `php:7.3.6-fpm-alpine3.8` - linux; amd64
...
### `php:7.3.6-fpm-alpine3.8` - linux; arm variant v6
...
### `php:7.3.6-fpm-alpine3.8` - linux; arm64 variant v8
...
### `php:7.3.6-fpm-alpine3.8` - linux; ppc64le
