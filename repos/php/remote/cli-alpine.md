...
```console
$ docker pull php@sha256:7b0697a7c6b007ccbd623c00e73cca1c178071adaf4363b4132697421108dd74
```
...
```console
$ docker pull php@sha256:a6156088ea48486745341403cf7fc4358071bc59aa68a009275cd35f1df958f6
```
...
-	Total Size: **28.3 MB (28256469 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:e64dc43ff290f6ad0e5b13eb83416815f3164f0f7f24d4c41894a27b46fb7ce8`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
