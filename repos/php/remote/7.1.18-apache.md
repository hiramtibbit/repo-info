...
```console
$ docker pull php@sha256:c2422f22595265ab0b543004910c75dcecf28bda392dbffa274e15195ed005ec
```
...
```console
$ docker pull php@sha256:baffe5856d6421665053c5d6f1357aa7c5594e0a2ad5da5f1a59225fd09928b3
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **133.8 MB (133837081 bytes)**  
