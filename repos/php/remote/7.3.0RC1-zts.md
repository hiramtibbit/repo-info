...
```console
$ docker pull php@sha256:79e2e19df2bc5c53995c3885462ad06f2da7e33487451986d3ab54bf1e468cf7
```
...
### `php:7.3.0RC1-zts` - linux; arm variant v5
...
### `php:7.3.0RC1-zts` - linux; arm variant v7
...
### `php:7.3.0RC1-zts` - linux; ppc64le
