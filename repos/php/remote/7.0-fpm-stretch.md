...
```console
$ docker pull php@sha256:bfc1d813ef11ab593a0336a8c827cfb7f71b426b3f971b2b00db8b17a636bdce
```
...
```console
$ docker pull php@sha256:3d7c440326515d31d209ce9782b2e3d8619049dde755318928474e56c86ce50b
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **129.5 MB (129511334 bytes)**  
