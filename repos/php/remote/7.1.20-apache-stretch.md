...
### `php:7.1.20-apache-stretch` - linux; arm variant v7
...
### `php:7.1.20-apache-stretch` - linux; arm64 variant v8
...
### `php:7.1.20-apache-stretch` - linux; 386
...
### `php:7.1.20-apache-stretch` - linux; s390x
