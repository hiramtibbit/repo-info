...
```console
$ docker pull php@sha256:a232de295591359a894e1f3bdb0848206289d7c4a1037cf7cfd684846fadec75
```
...
```console
$ docker pull php@sha256:06a8ebd04036ade97b716c07124e74f9619c5e56f8901fcc8ed7dd5fff75c005
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **142.4 MB (142414548 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9728e1781955437bcc7126775cd8f2a5279a375366536a045f7d051fcf88f26a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
