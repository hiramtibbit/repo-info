...
```console
$ docker pull php@sha256:3c3f8efb44f8eb98c3a2d4a834bcd3a0b92900408fb241508ce22c09c76954db
```
...
### `php:7.3.0RC1-zts-alpine` - linux; amd64
...
### `php:7.3.0RC1-zts-alpine` - linux; arm variant v6
...
### `php:7.3.0RC1-zts-alpine` - linux; ppc64le
