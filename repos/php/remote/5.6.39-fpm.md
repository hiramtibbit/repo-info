...
```console
$ docker pull php@sha256:acc966113de60b039f70185c9b1319ee36c95a692e52b537808a511f7d1583c5
```
...
### `php:5.6.39-fpm` - linux; arm variant v5
...
### `php:5.6.39-fpm` - linux; arm variant v7

```console
$ docker pull php@sha256:3a479a07e6c93e2953d940918b349bbf6c5a38044f2fa243f63af964a084e5fa
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **107.2 MB (107180139 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4708cf773cbd7551bec2992acab1b4bc96af9514556de828b89fac738f19b1da`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:5.6.39-fpm` - linux; arm64 variant v8
