...
```console
$ docker pull php@sha256:4c8f137b7d4205097017d7a8c5b7f98267028c47dc80f92d362211865aa56f74
```
...
### `php:7.1.23-fpm-alpine3.8` - linux; arm variant v6
...
### `php:7.1.23-fpm-alpine3.8` - linux; arm64 variant v8

```console
$ docker pull php@sha256:a12a8f1537f50889c5c4bb10a89556fcb221eb8af3d16e949897cf6cc5413a7c
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.5 MB (29477447 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:51663ed83a1d54854546ec812aeac6765cf1a943a29cd214fe2de617a7c15f72`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.1.23-fpm-alpine3.8` - linux; 386

```console
$ docker pull php@sha256:1dec622f947484cba2331ecf5120a52872c3aad5e54d22d7a048f3a0038344df
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.3 MB (31301651 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c916c7d192b50e6f8d8ad300483b669b748b7bca18109749de6e364c33c4855`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.1.23-fpm-alpine3.8` - linux; ppc64le

```console
$ docker pull php@sha256:0171e3958ee9aa7363e373611a69b01a0cc6a4249fae37a4b3fcd6588e90fea8
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.3 MB (30286608 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:63c36017921772c26eed7a82c22329a9f0e2819c79275bf1207ea2d8ffc22108`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
