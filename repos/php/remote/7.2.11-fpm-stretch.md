...
### `php:7.2.11-fpm-stretch` - linux; arm variant v5
...
### `php:7.2.11-fpm-stretch` - linux; arm variant v7
...
### `php:7.2.11-fpm-stretch` - linux; arm64 variant v8
...
### `php:7.2.11-fpm-stretch` - linux; 386
...
### `php:7.2.11-fpm-stretch` - linux; ppc64le
