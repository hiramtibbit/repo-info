...
```console
$ docker pull php@sha256:51b91bee8a18c71220d326318d6dd8de8a28a0094dbfb48788fa6505eb32b49a
```
...
```console
$ docker pull php@sha256:bf6110388a0dd8a29fb469f33a502b8f2a81681f981a2b768908998ba77bb363
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **33.2 MB (33193854 bytes)**  
...
### `php:7.1.21-fpm-alpine` - linux; arm64 variant v8
...
### `php:7.1.21-fpm-alpine` - linux; 386
...
### `php:7.1.21-fpm-alpine` - linux; ppc64le
