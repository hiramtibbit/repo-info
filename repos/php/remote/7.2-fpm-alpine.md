...
```console
$ docker pull php@sha256:bf1752f6ea37f575cb4625d91a75931afa0fe3eaf93551ed1eb8fdd509e0c682
```
...
```console
$ docker pull php@sha256:788df969d5bd4a87ff9261cee20f570050825fdcb90750facdcb6cbb3802edce
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.3 MB (30285539 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:14f857576ab196b56305560a97fc5bcdcc837e5ad42293f10e4054e1077506a2`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
