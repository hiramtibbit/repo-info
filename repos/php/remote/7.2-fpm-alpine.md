...
```console
$ docker pull php@sha256:fa2cea36ebebb3ca5f7f7c7815316dfb50bc11aeb4ae2611b459058740ff2695
```
...
```console
$ docker pull php@sha256:529c8423f152cd45401950c20cc5e0dadf27253d516d9746c5a4296b8a651cda
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.3 MB (32339848 bytes)**  
