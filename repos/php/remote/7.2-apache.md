...
```console
$ docker pull php@sha256:05a950b2a1ff041be460e7588442881cd4af63a405f83f321427c2a25d869112
```
...
```console
$ docker pull php@sha256:453d79d9bfe8812eccdd70dde6cbd39da5c8f54f479e277ca168648dc7e21b87
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **140.8 MB (140832516 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:d33a2eab6f3795dbce99c6943784da2b0848eb52cd9b4cb23c88fde501da9a56`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
