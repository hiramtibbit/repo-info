...
```console
$ docker pull php@sha256:c7e9fff8947724588a8b0af22049ebaa7be223ee9a49e8c6bb34eb5e3c58d3ba
```
...
```console
$ docker pull php@sha256:9c2a3ab9e6be292e2f97ddb9ded935cfd8ac019afbfdb30a744151b3c99ffb76
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **115.1 MB (115086570 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4df1df9bfeceef21a805857a22962b96d5f48112c5408993c172000805b888bd`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
