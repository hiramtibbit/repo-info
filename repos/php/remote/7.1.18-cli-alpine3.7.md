...
```console
$ docker pull php@sha256:d8a2bc785907c324f8cc3f6f95c5a805ee26cf0ba8b858f6a7778801f47c19bf
```
...
```console
$ docker pull php@sha256:8be56c7117c041b06518dc2acd10a0ae7951ffbfe22bfdbe603162b444f097c4
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.9 MB (27892222 bytes)**  
