...
```console
$ docker pull php@sha256:fba3062f437529c157ed6f323cdecb7b588a9337ecb833e99140b421e2bd17f6
```
...
### `php:7.1.28-fpm-alpine` - linux; amd64
...
### `php:7.1.28-fpm-alpine` - linux; arm variant v6
...
### `php:7.1.28-fpm-alpine` - linux; arm variant v7
...
### `php:7.1.28-fpm-alpine` - linux; arm64 variant v8
...
### `php:7.1.28-fpm-alpine` - linux; 386

```console
$ docker pull php@sha256:0eebdedf20959981b73b79917c3024cb5d5f1a38d503509661e0e93415ef46b0
```
...
-	Total Size: **31.9 MB (31895308 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:9902bbc1d01c37b8afab024c501a728e1f26ac4babb6aff00f2925bca9176df4`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.1.28-fpm-alpine` - linux; ppc64le
