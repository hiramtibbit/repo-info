...
```console
$ docker pull php@sha256:156a856c1dabe019badaf4cc16a29590cd7e8b1d5bd9032429e2012dcd94000d
```
...
### `php:7.0.31-fpm-alpine` - linux; arm64 variant v8
...
### `php:7.0.31-fpm-alpine` - linux; 386

```console
$ docker pull php@sha256:1f20d151a366609a3c2d695a3e6fb0fbeb4409ab9fa0b273f96a6309300142ea
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.2 MB (32227999 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:2a375d64d1e625095964686ec6a48afd1b1a30836d8c56ef434b730936686adc`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.0.31-fpm-alpine` - linux; ppc64le

```console
$ docker pull php@sha256:9147ffd6ddab9cb1e15097ebfa587e9744e0e74830b7a6fbf070622c1b3074e2
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.1 MB (31138668 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5c4abf2e9d64fca457d4cf2db71ab82e72bc6b17421c63e8c6fb0c55b0f60254`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
