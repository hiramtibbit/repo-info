...
```console
$ docker pull php@sha256:fc2e03722d550552d4c5d1ccc0a38aa60c4e5cd2aaf0a49a6ae8511fe92a6f8b
```
...
```console
$ docker pull php@sha256:7b006940383b976eba315bc2b6d7e819f24fd349c04435a47bd2efaee74c83d5
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.1 MB (135148017 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:39e2f8246ace5ac373a6aba6423ddb0046c6f17a73bf50e98716f5d80db652d4`
