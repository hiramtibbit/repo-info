...
```console
$ docker pull php@sha256:d0917a2161d1948cb3754767d4f419c7efecddf1de362c57bb1aaf9881fd89c2
```
...
### `php:7.1.23-cli-alpine` - linux; amd64
...
### `php:7.1.23-cli-alpine` - linux; arm variant v6
...
### `php:7.1.23-cli-alpine` - linux; arm64 variant v8
...
### `php:7.1.23-cli-alpine` - linux; ppc64le
