...
### `php:7.3.3-apache-stretch` - linux; amd64
...
### `php:7.3.3-apache-stretch` - linux; arm variant v5
...
### `php:7.3.3-apache-stretch` - linux; arm variant v7
...
### `php:7.3.3-apache-stretch` - linux; arm64 variant v8
...
### `php:7.3.3-apache-stretch` - linux; 386
...
### `php:7.3.3-apache-stretch` - linux; ppc64le
