...
```console
$ docker pull php@sha256:933bada5b934b9d1334350ce051476b4249c8f15a4f4f53d662187128425fcf9
```
...
### `php:7.3.4-fpm-stretch` - linux; amd64

```console
$ docker pull php@sha256:b1e5ef6ddd9d0c30678faec93bb731414d5ea1dbabddd7c53db23b2621ae538a
```
...
-	Image ID: `sha256:d330e525cad6b6801324458f8bd3378f5d48fa468420c84700f388f73de12ae8`
...
### `php:7.3.4-fpm-stretch` - linux; arm variant v5

```console
$ docker pull php@sha256:aa18ec4246bdf666f46ef7048b8de1ce384d0a6df8e6db9896c5db17787f647b
```
...
-	Total Size: **118.5 MB (118515510 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:375a62621b65163c2521f30ea991cdafafeda2f48c3564d85b50ca1756b74826`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.3.4-fpm-stretch` - linux; arm variant v7
...
### `php:7.3.4-fpm-stretch` - linux; arm64 variant v8

```console
$ docker pull php@sha256:c7f58624d854504f3c1aa3e7479ee2b8e87b87d84c7fcc92dc3b5a1881df386b
```
...
-	Total Size: **117.8 MB (117788694 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5912ce63b219b25d99f3b5ded8c65ed21ee77a0dd6b282a319307b3228e3c581`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.3.4-fpm-stretch` - linux; 386
...
### `php:7.3.4-fpm-stretch` - linux; ppc64le

```console
$ docker pull php@sha256:6ca7a1c4ed26c7f0bd09ee8bce46c0d55acd7981aaf965b9938ee09be4c9889f
```
...
-	Total Size: **125.5 MB (125513908 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:4c16d32f0d7b7a53e773c960f4fca71178547a2220fb32f5a61e2877056e8e8b`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
