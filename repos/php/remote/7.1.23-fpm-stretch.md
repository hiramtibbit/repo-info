...
### `php:7.1.23-fpm-stretch` - linux; amd64
...
### `php:7.1.23-fpm-stretch` - linux; arm variant v5
...
### `php:7.1.23-fpm-stretch` - linux; arm variant v7
...
### `php:7.1.23-fpm-stretch` - linux; arm64 variant v8
...
### `php:7.1.23-fpm-stretch` - linux; 386
...
### `php:7.1.23-fpm-stretch` - linux; ppc64le
...
### `php:7.1.23-fpm-stretch` - linux; s390x
