...
```console
$ docker pull php@sha256:05e7b74c8311a405ff43a56be1ea397d1b1f06eead6552d7dbcc4e49a8deab9c
```
...
### `php:7.3.0RC6-zts-alpine3.8` - linux; amd64
...
### `php:7.3.0RC6-zts-alpine3.8` - linux; arm variant v6
...
### `php:7.3.0RC6-zts-alpine3.8` - linux; arm64 variant v8
...
### `php:7.3.0RC6-zts-alpine3.8` - linux; ppc64le
