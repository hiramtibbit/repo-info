...
```console
$ docker pull php@sha256:18b29a44669109cacc4e9494073f4124c336133889af29b84f8e7a5ec471a826
```
...
```console
$ docker pull php@sha256:78a503079f75f4286102560a279a846effc850cd6b551482a05edb9c2df714d1
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.3 MB (32292346 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:eb5bc63bcef516cb1986f4dcbda469c6abfa9af9d095c11417f0a55c97ec9e95`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
