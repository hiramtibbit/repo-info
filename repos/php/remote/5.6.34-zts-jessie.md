...
### `php:5.6.34-zts-jessie` - linux; arm variant v5
...
### `php:5.6.34-zts-jessie` - linux; arm variant v7
...
### `php:5.6.34-zts-jessie` - linux; arm64 variant v8
...
### `php:5.6.34-zts-jessie` - linux; 386
...
### `php:5.6.34-zts-jessie` - linux; ppc64le
