...
```console
$ docker pull php@sha256:4afd256a7375e59b32bdbe928de1a4c0f8ab0503cc4689ba513b2ce677019bd2
```
...
```console
$ docker pull php@sha256:92a81dba2cc5a825edebc034fa59a3f9faa87258f8a72d231868e3b98aea5aaf
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.8 MB (31814502 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:f3de404f374ff15254ed3a0d488bfe96612b3841245a767b012b19a426c083ff`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
