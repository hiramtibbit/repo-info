...
```console
$ docker pull php@sha256:507ef58e67ab0117d3acc24fe902188aa86c8585f88b68c3a20ce57c070c1728
```
...
### `php:7.1.21-cli-alpine` - linux; amd64
...
### `php:7.1.21-cli-alpine` - linux; arm64 variant v8
...
### `php:7.1.21-cli-alpine` - linux; 386

```console
$ docker pull php@sha256:4c3729ba529783e07b7fd31a8fa3ff4aca42b24d3856518d9a88af6afa5d489e
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **32.5 MB (32451444 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:fb5b96b85c5644e06ee5d2eaba8451b59c62557b5bc790e7a67af4c7583a3490`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php","-a"]`
...
### `php:7.1.21-cli-alpine` - linux; ppc64le
