...
### `php:7.4.0alpha1-alpine` - linux; amd64
...
### `php:7.4.0alpha1-alpine` - linux; arm variant v6
...
### `php:7.4.0alpha1-alpine` - linux; arm variant v7
...
### `php:7.4.0alpha1-alpine` - linux; arm64 variant v8
...
### `php:7.4.0alpha1-alpine` - linux; 386
...
### `php:7.4.0alpha1-alpine` - linux; ppc64le
