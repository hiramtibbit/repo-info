...
```console
$ docker pull php@sha256:c4cf6e0dbe89321da1b2567dcc359d8b94648e90d0c2bddf60d9f057718dd616
```
...
```console
$ docker pull php@sha256:0be9c4d9a75bb1d91e805ea116c8448894d370650f1b1097adbac87b67f52654
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **27.2 MB (27240698 bytes)**  
