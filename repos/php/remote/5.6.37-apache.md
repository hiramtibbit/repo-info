...
```console
$ docker pull php@sha256:d7cb4309ec08f4e675383ca0ef8e31aad4db7826dd5b0cc0a3e07e6ecc4f07ff
```
...
### `php:5.6.37-apache` - linux; amd64

```console
$ docker pull php@sha256:f08f730956d0ca38ccda985907a9deb9aafbfff280596531799b261abbc33ce6
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **130.0 MB (129967750 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:428644ce487b16b60d67bac0b8981f4b149167339daff58894234ed50c74936b`
...
### `php:5.6.37-apache` - linux; arm variant v5

```console
$ docker pull php@sha256:f89bc042978611df4d0959e80b32c91c404a307d0d054ee07b6de794bc477f13
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **117.8 MB (117761444 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:12b541bc6c88583fd70cf25cf14d1f550cdd16d9affd32878ccfdfc0d61dc292`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:5.6.37-apache` - linux; arm variant v7

```console
$ docker pull php@sha256:e3ed374e4afa57a9690035e245a6d97fd0ce547c5264f70cedf875433ed3bbf8
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **111.0 MB (110984443 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:60258830f898bdff869b8ea682dbb4323fa1b8fbe4ef86e4f806c17294a4b088`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
# Wed, 05 Sep 2018 16:00:08 GMT
COPY file:207c686e3fed4f71f8a7b245d8dcae9c9048d276a326d82b553c12a90af0c0ca in /usr/local/bin/ 
# Sat, 08 Sep 2018 14:05:57 GMT
RUN set -eux; 		savedAptMark="$(apt-mark showmanual)"; 	apt-get update; 	apt-get install -y --no-install-recommends 		libcurl4-openssl-dev 		libedit-dev 		libsqlite3-dev 		libssl1.0-dev 		libxml2-dev 		zlib1g-dev 		${PHP_EXTRA_BUILD_DEPS:-} 	; 	rm -rf /var/lib/apt/lists/*; 		export 		CFLAGS="$PHP_CFLAGS" 		CPPFLAGS="$PHP_CPPFLAGS" 		LDFLAGS="$PHP_LDFLAGS" 	; 	docker-php-source extract; 	cd /usr/src/php; 	gnuArch="$(dpkg-architecture --query DEB_BUILD_GNU_TYPE)"; 	debMultiarch="$(dpkg-architecture --query DEB_BUILD_MULTIARCH)"; 	if [ ! -d /usr/include/curl ]; then 		ln -sT "/usr/include/$debMultiarch/curl" /usr/local/include/curl; 	fi; 	./configure 		--build="$gnuArch" 		--with-config-file-path="$PHP_INI_DIR" 		--with-config-file-scan-dir="$PHP_INI_DIR/conf.d" 				--enable-option-checking=fatal 				--with-mhash 				--enable-ftp 		--enable-mbstring 		--enable-mysqlnd 				--with-curl 		--with-libedit 		--with-openssl 		--with-zlib 				$(test "$gnuArch" = 's390x-linux-gnu' && echo '--without-pcre-jit') 		--with-libdir="lib/$debMultiarch" 				${PHP_EXTRA_CONFIGURE_ARGS:-} 	; 	make -j "$(nproc)"; 	make install; 	find /usr/local/bin /usr/local/sbin -type f -executable -exec strip --strip-all '{}' + || true; 	make clean; 		cp -v php.ini-* "$PHP_INI_DIR/"; 		cd /; 	docker-php-source delete; 		apt-mark auto '.*' > /dev/null; 	[ -z "$savedAptMark" ] || apt-mark manual $savedAptMark; 	find /usr/local -type f -executable -exec ldd '{}' ';' 		| awk '/=>/ { print $(NF-1) }' 		| sort -u 		| xargs -r dpkg-query --search 		| cut -d: -f1 		| sort -u 		| xargs -r apt-mark manual 	; 	apt-get purge -y --auto-remove -o APT::AutoRemove::RecommendsImportant=false; 		php --version; 		pecl update-channels; 	rm -rf /tmp/pear ~/.pearrc
# Sat, 08 Sep 2018 14:05:58 GMT
COPY multi:c925dfb355ea16ba0238c8b6ca78d3cd7fe815932bf707b25bbf051070430157 in /usr/local/bin/ 
# Sat, 08 Sep 2018 14:05:58 GMT
ENTRYPOINT ["docker-php-entrypoint"]
# Sat, 08 Sep 2018 14:05:58 GMT
COPY file:24613ecbb1ce6a09f683b0753da9c26a1af07547326e8a02f6eec80ad6f2774a in /usr/local/bin/ 
# Sat, 08 Sep 2018 14:05:59 GMT
WORKDIR /var/www/html
# Sat, 08 Sep 2018 14:05:59 GMT
EXPOSE 80/tcp
# Sat, 08 Sep 2018 14:05:59 GMT
...
-	Layers:
	...
	-	`sha256:ff7a029072146ff23da648378b87071cbd97eaa7cf9e2d102554fd02a9e446d2`  
		...
		Size: 501.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:8709942c5861ec15ee8684151ceee9ed3fc38a77b0c15df86754a75d78452acb`  
		Last Modified: Sat, 08 Sep 2018 14:55:02 GMT  
		Size: 9.2 MB (9167973 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:e4116366fc63323fe87e337679a21a65b41da3bd1bf3109847da3f1db42ff1a1`  
		Last Modified: Sat, 08 Sep 2018 14:54:58 GMT  
		Size: 2.2 KB (2193 bytes)  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip
	-	`sha256:330963ad3824d2062e59dd112e5093d4199469b02ff01b5f542e459e3f7899c3`  
		Last Modified: Sat, 08 Sep 2018 14:54:58 GMT  
		Size: 904.0 B  
		MIME: application/vnd.docker.image.rootfs.diff.tar.gzip

### `php:5.6.37-apache` - linux; arm64 variant v8
...
### `php:5.6.37-apache` - linux; 386

```console
$ docker pull php@sha256:43516ba5e751687dcce247bc5fabb5fe996cdf4fc788a0591abbf61c8dc5ff78
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **135.1 MB (135142064 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:1bc612d0accf9f304f7cc590f0738bb162dad28d02d7fe9e4b88a87c2a04383a`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
...
### `php:5.6.37-apache` - linux; ppc64le

```console
$ docker pull php@sha256:7b627f373321adc5a48a16190643ef779ef4c1e938c90b665f073e90725392ce
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **124.6 MB (124641067 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:15e2b3955c260cdce6f06337525f0a186a72acd464e95ae0226f950ff613bb51`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["apache2-foreground"]`
