...
```console
$ docker pull php@sha256:83d32fea688c3d9ee3f23c5ecac08a37ffd9df1a300fa5121b7eebd0c93d78ff
```
...
### `php:7.1.17-fpm-alpine3.4` - linux; amd64

```console
$ docker pull php@sha256:84a571594f1c73fcfb5482960537be2c56f27c825245b9477c7673d4d2bb2de0
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.0 MB (31006102 bytes)**  
