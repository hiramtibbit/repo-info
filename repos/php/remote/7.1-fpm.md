...
```console
$ docker pull php@sha256:b104fecaf695a061fa5a4583a876c9721d9e6761a855048e2040ee5be657322c
```
...
```console
$ docker pull php@sha256:bbf70e14d4ce0ed96933a16dbf4f60c5ed3d544765d2b6934b888d61e1edf68b
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **110.9 MB (110931885 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:02acccc9832365f563762f6ed2a925aeb5c808bcec174dd0282ecc56edd311b1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
