...
```console
$ docker pull php@sha256:5b8b4294db4362e583ec090635784f9b304d49fae258892d7e23791e05d6f74a
```
...
### `php:5.6.40-zts` - linux; arm variant v5
...
### `php:5.6.40-zts` - linux; arm variant v7
...
### `php:5.6.40-zts` - linux; arm64 variant v8
