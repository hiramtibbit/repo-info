...
```console
$ docker pull php@sha256:48147da9ac2da6b7d2e687242fdb0537e4b176ed8b45bc89a817f6fdc43b5b08
```
...
### `php:7.1.24-fpm-alpine3.8` - linux; amd64
...
### `php:7.1.24-fpm-alpine3.8` - linux; arm variant v6
...
### `php:7.1.24-fpm-alpine3.8` - linux; arm64 variant v8

```console
$ docker pull php@sha256:906e653bd1973d60c817ac40af1d3f48577bc5a525b899458bd9f94eabdfbdfb
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.6 MB (29645361 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:5a3270d48e72e356e1243e6a7a00802a002c755b2f61406061f94f184107fcbf`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.1.24-fpm-alpine3.8` - linux; 386

```console
$ docker pull php@sha256:e263fbe5d6471017977a45857b8a6fea41c74bde7b987f5b50fbec4c588ebef9
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **31.5 MB (31530823 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:c6f39a1b6709d1f0005c49e98bf79894c206d21173e871340047834640ce79e5`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
...
### `php:7.1.24-fpm-alpine3.8` - linux; ppc64le

```console
$ docker pull php@sha256:96806cd07bf341abca69025fa4e5c8610b5041caf19b43adba4ab3a640816ab6
```

-	Docker Version: 17.06.2-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **30.5 MB (30474897 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:6e5a7b98d4a8f448bdaa3031555a9f4c67f6b6ce2a77b602f694633517821e2c`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
