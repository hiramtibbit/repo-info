...
```console
$ docker pull php@sha256:f4ed63dcfe2ffdaafdfceebcd207a0cc2e65acd5abb3e2b2f10887a90b3cb120
```
...
```console
$ docker pull php@sha256:13717127e596678a0d48a55c72245d75fb1d4f4fa03400b614b69692264ad58d
```

-	Docker Version: 18.06.1-ce
-	Manifest MIME: `application/vnd.docker.distribution.manifest.v2+json`
-	Total Size: **29.0 MB (28976743 bytes)**  
	(compressed transfer size, not on-disk size)
-	Image ID: `sha256:3331318beb1d8e3994ee7470177365604c4083599a175d339303415951fd18a1`
-	Entrypoint: `["docker-php-entrypoint"]`
-	Default Command: `["php-fpm"]`
