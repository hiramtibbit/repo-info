...
```console
$ docker pull perl@sha256:89adca4fc03b55b61a288e3b5006cede375e4e111892468785e69e1b6632baa8
```
...
```console
$ docker pull perl@sha256:aa03cddcca65e5d7a221a1939c2acc183c1b6788143d942250a45af6ce433134
```
